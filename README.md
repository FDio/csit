...
└── libraries
    ├── bash
    │   ├── config
    │   ├── entry                   # Main bootstrap directory
...
│   └── MLRsearch
├── resources
│   ├── templates                   # Templates (VPP VAT, K8S, ...)
...
[Physical testbed preparation](docs/test_code_guidelines.rst) documentation is
describing PXE and Ansible setup process. All the software requirements for
running Performance Teste are part of Ansible.
