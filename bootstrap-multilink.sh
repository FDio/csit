...
ping_addr=`ssh -i /etc/nodepool/id_rsa -o StrictHostKeyChecking=no jenkins@${subnodes[1]} "cat /sys/class/net/eth0/address"`
ssh_do jenkins@${subnodes[0]} "ping ${ping_addr}"
