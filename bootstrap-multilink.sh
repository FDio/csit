...
ssh -vv jenkins@`cat /etc/nodepool/primary_node_private` ifconfig -a
...
ssh_do jenkins@${subnodes[0]} "sudo arp -a"
ssh_do jenkins@${subnodes[1]} "sudo arp -a"
ssh_do jenkins@${subnodes[2]} "sudo arp -a"
