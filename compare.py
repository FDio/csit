...
#        if 0:#"2vhostvr1" in case_key or "-af-xdp-" in case_key or "-4c" in case_key:
        ...
        if not ("c2v2" in ver_key and "xxv710" in case_key) and not ("c6v6r2" in ver_key and "810cq" in case_key):
            continue
...
with open("comparison.csv", "wt") as fout:
    ...
    fout.write("c2v2dc6v6r2_avg,c2v2dc6v6r2_stdev\n")
    for case_key in case_keys:
        ...
        diff_avg, diff_std = relative_change_stdev(
            row["c2v2_avg"], row["c6v6r2_avg"], row["c2v2_std"], row["c6v6r2_std"]
        )
