...
PYTHONPATH=`pwd` pybot -L TRACE -v TOPOLOGY_PATH:topologies/available/virl.yaml --include VM_ENV --include 3_NODE_SINGLE_LINK_TOPO --exclude 3_NODE_DOUBLE_LINK_TOPO  tests
