...
if [ "${#}" -ne "0" ]; then
    ...
    rm -f *.deb
    wget -q "https://nexus.fd.io/service/local/repositories/fd.io.dev/content/io/fd/vpp/vpp/1.0.0-336~g7a2a378_amd64/vpp-1.0.0-336~g7a2a378_amd64.deb" || exit
    wget -q "https://nexus.fd.io/service/local/repositories/fd.io.dev/content/io/fd/vpp/vpp-dbg/1.0.0-336~g7a2a378_amd64/vpp-dbg-1.0.0-336~g7a2a378_amd64.deb" || exit
    wget -q "https://nexus.fd.io/service/local/repositories/fd.io.dev/content/io/fd/vpp/vpp-dev/1.0.0-336~g7a2a378_amd64/vpp-dev-1.0.0-336~g7a2a378_amd64.deb" || exit
    wget -q "https://nexus.fd.io/service/local/repositories/fd.io.dev/content/io/fd/vpp/vpp-dpdk-dev/1.0.0-336~g7a2a378_amd64/vpp-dpdk-dev-1.0.0-336~g7a2a378_amd64.deb" || exit
    wget -q "https://nexus.fd.io/service/local/repositories/fd.io.dev/content/io/fd/vpp/vpp-dpdk-dkms/1.0.0-336~g7a2a378_amd64/vpp-dpdk-dkms-1.0.0-336~g7a2a378_amd64.deb" || exit
    wget -q "https://nexus.fd.io/service/local/repositories/fd.io.dev/content/io/fd/vpp/vpp-lib/1.0.0-336~g7a2a378_amd64/vpp-lib-1.0.0-336~g7a2a378_amd64.deb" || exit
fi
