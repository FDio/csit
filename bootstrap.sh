...
ssh_do cisco@10.30.51.72 "sudo sh -c 'echo show hardware detail' | vpp_api_test"
ssh_do cisco@10.30.51.71 "sudo sh -c 'echo show hardware detail' | vpp_api_test"
...
#
#PYTHONPATH=`pwd` pybot -L TRACE -v TOPOLOGY_PATH:topologies/available/virl.yaml tests
