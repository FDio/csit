...
PYTHONPATH=`pwd` pybot -L TRACE -v TOPOLOGY_PATH:topologies/available/virl.yaml --exclude PERFTEST -t "Vpp forwards packets via L2 bridge domain in circular topology" tests
