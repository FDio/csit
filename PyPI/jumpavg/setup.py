...
setup(
    ...
    description=u"Library for locating changes in time series by grouping results.",
    long_description=long_description,
    long_description_content_type=u"text/x-rst",
    # TODO: Create a separate webpage for jumpavg library.
    url=u"https://gerrit.fd.io/r/gitweb?p=csit.git;a=tree;f=PyPI/jumpavg;hb=refs/heads/master",
    ...
    keywords=u"progression regression anomaly detection statistics metadata bits",
    ...
    project_urls={
        u"Bug Reports": "https://jira.fd.io/projects/CSIT/issues",
        u"Source": "https://gerrit.fd.io/r/gitweb?p=csit.git;a=tree;f=PyPI/jumpavg;hb=refs/heads/master",
    },
)
