...
JOB_ARCHIVE_ARTIFACTS=(log.html output.xml report.html /var/log/app_*.log /var/log/nStack/run*.log)
LOG_ARCHIVE_ARTIFACTS=(log.html output.xml report.html /var/log/app_*.log /var/log/nStack/run*.log)
