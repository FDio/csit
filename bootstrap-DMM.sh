...
JOB_ARCHIVE_ARTIFACTS=(log.html output.xml report.html log_install_dmm.txt log_run_dmm.txt)
LOG_ARCHIVE_ARTIFACTS=(log.html output.xml report.html log_install_dmm.txt log_run_dmm.txt)
...
# Get log_install_dmm.txt log file from virl host
scp ${SSH_OPTIONS} \
    ${VIRL_USERNAME}@${VIRL_SERVER}:\
    /tmp/DMM-testing/tests/dmm/dmm_scripts/${VIRL_SID}/log_install_dmm.txt . || true

# Get log_run_dmm.txt log file from virl host
scp ${SSH_OPTIONS} \
    ${VIRL_USERNAME}@${VIRL_SERVER}:\
    /tmp/DMM-testing/tests/dmm/dmm_scripts/${VIRL_SID}/log_run_dmm.txt . || true
