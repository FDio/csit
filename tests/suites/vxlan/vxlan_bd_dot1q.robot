...
| Force Tags | 3_NODE_SINGLE_LINK_TOPO | EXPECTED_FAILING | VM_ENV | HW_ENV | VLAN
...
| Suite Teardown | Run Keywords | Show traces | ${nodes['DUT1']}
| ...            | AND          | Show traces | ${nodes['DUT2']}

*** Test Cases ***
| VPP can encapsulate L2 in VXLAN over V4
| | [Tags] | tmp
| | Run Keyword And Ignore Error | Send and receive ICMPv4 | ${nodes['TG']} | ${tgs_to_dut1} | ${tgs_to_dut2}
| | Run Keyword And Ignore Error | Send and receive ICMPv4 | ${nodes['TG']} | ${tgs_to_dut1} | ${tgs_to_dut2}