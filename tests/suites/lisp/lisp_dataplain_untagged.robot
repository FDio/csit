...
| |      ... | ${eid_prefix4}
| |      ... | ${dut1_vni} | ${dut1_eid4} | ${dut1_deid4} | ${dut1_seid4}
| |      ... | ${dut1_rloc4}
| |      ... | ${dut2_vni} | ${dut2_eid4} | ${dut2_deid4} | ${dut2_seid4}
| |      ... | ${dut2_rloc4}
...
| |      ... | ${duts_locator_name} | ${duts_priority} | ${duts_weight}
| |      ... | ${eid_prefix6}
| |      ... | ${dut1_vni} | ${dut1_eid6} | ${dut1_deid6} | ${dut1_seid6}
| |      ... | ${dut1_rloc6}
| |      ... | ${dut2_vni} | ${dut2_eid6} | ${dut2_deid6} | ${dut2_seid6}
| |      ... | ${dut2_rloc6}
| | Then Send Packet And Check Headers
...
| |      ... | ${duts_locator_name} | ${duts_priority} | ${duts_weight}
| |      ... | ${eid_prefix4o6}
| |      ... | ${dut1_vni} | ${dut1_eid4o6} | ${dut1_deid4o6} | ${dut1_seid4o6}
| |      ... | ${dut1_rloc4o6}
| |      ... | ${dut2_vni} | ${dut2_eid4o6} | ${dut2_deid4o6} | ${dut2_seid4o6}
| |      ... | ${dut2_rloc4o6}
| | Then Send Packet And Check Headers
...
| |      ... | ${duts_locator_name} | ${duts_priority} | ${duts_weight}
| |      ... | ${eid_prefix6o4}
| |      ... | ${dut1_vni} | ${dut1_eid6o4} | ${dut1_deid6o4} | ${dut1_seid6o4}
| |      ... | ${dut1_rloc6o4}
| |      ... | ${dut2_vni} | ${dut2_eid6o4} | ${dut2_deid6o4} | ${dut2_seid6o4}
| |      ... | ${dut2_rloc6o4}
| | Then Send Packet And Check Headers
