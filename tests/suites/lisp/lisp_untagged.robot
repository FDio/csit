...
| | ...             | Test add and remove locator_set and locator
| | ...
...
| | [Documentation] | Test lisp locator_set API
| | ...             | Test add, reset and remove locator_set and locator
| | ...
...
| | ...             | Test add and remove lisp map resolver address
| | ...
