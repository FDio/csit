...
| | And Lisp locator_set data are set | ${nodes['DUT1']}
| | When Lisp locator_set are set correct | ${nodes['DUT1']}
| | Then Delete all lisp locator_set from VPP | ${nodes['DUT1']}
...
| | And Lisp eid address are set | ${nodes['DUT1']}
| | When Lisp eid address are set correct to eid table | ${nodes['DUT1']}
| | Then Delete all lisp eid address form VPP | ${nodes['DUT1']}
...
| | And Lisp map resolver address are set | ${nodes['DUT1']}
| | When Lisp map resolver address are set correct | ${nodes['DUT1']}
| | Then Delete all lisp map resolver address from VPP | ${nodes['DUT1']}
