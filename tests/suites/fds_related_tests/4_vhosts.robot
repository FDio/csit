...
| | Setup QEMU
| | Start QEMU on Dut With Namespace | ${dut1_node} | ${dut1_blue1} | ${dut1_blue2} | ${dut1_red1} | ${dut1_red2} | ${prefix_length} | vm_dut1
| | Setup Vxlan and BD on Dut | ${dut1_node} | ${dut1_if_ip} | ${dut2_if_ip}
| | Start QEMU on Dut With Namespace | ${dut2_node} | ${dut2_blue1} | ${dut2_blue2} | ${dut2_red1} | ${dut2_red2} | ${prefix_length} | vm_dut2 | 52:54:00:00:02:02
...
#| | Start QEMU on Dut With Namespace | ${dut2_node} | ${dut2_blue1} | ${dut2_blue2} | ${dut2_red1} | ${dut2_red2} | ${prefix_length} | vm_dut2
#| | Sleep | 10
#| | Make Ping From To | ${vm_dut1} | 16.0.10.2 | nmspace1
#| | Make Ping From To | ${vm_dut1} | 16.0.20.1 | nmspace1
#| | Make Ping From To | ${vm_dut1} | 16.0.20.2 | nmspace1
