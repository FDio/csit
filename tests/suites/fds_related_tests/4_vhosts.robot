...
| | When Setup QEMU On Dut | ${dut1_node} | ${BLUE_IP} | vm_dut1
| | Setup Vxlan and BD on Dut | ${dut1_node} | ${DUT1_IF_IP} | ${DUT2_IF_IP}
| | When Setup QEMU On Dut | ${dut2_node} | ${RED_IP} | vm_dut2
| | Setup Vxlan and BD on Dut | ${dut2_node} | ${DUT2_IF_IP} | ${DUT1_IF_IP}
| | Make Ping From To | ${vm_dut1} | 16.0.0.3
| | [Teardown] | Run Keywords | Show Packet Trace on All DUTs | ${nodes}
| | ...        | AND          | Stop and Clear QEMU | ${dut_node} | ${vm_node}
*** Keywords ***
| Setup QEMU On Dut
| | [Arguments] | ${dut_node} | ${ip} | ${vm_specifier}
| | When VPP 4 Vhosts are created | ${dut_node}
| | ...                           | ${sock1}
| | ...                           | ${sock2}
| | ...                           | ${sock3}
| | ...                           | ${sock4}
| | And VM for 4 Vhosts are created | ${dut_node}
| | ...                             | ${sock1}
| | ...                             | ${sock2}
| | ...                             | ${sock3}
| | ...                             | ${sock4}
