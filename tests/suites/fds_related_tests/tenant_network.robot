...
| Resource | fds_traffic_support_file.robot
...
| | Positive Scenario Ping Dut1 -> Dut2 | ${qemu_node1}
| | Positive Scenario Ping Dut2 -> Dut1 | ${qemu_node2}
| | Negative Scenario Ping Dut1 -> Dut2 | ${qemu_node1}
| | Negative Scenario Ping Dut2 -> Dut1 | ${qemu_node2}
