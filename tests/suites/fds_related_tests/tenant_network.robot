...
| | And Vpp Create Vhost User Interface | ${dut1_node} | ${sock1}
| | And Vpp Create Vhost User Interface | ${dut1_node} | ${sock2}
| | And Vpp Create Vhost User Interface | ${dut1_node} | ${sock3}
| | And Vpp Create Vhost User Interface | ${dut1_node} | ${sock4}
...
| | ... | ${dut2_node} | ${sock4}
| | And Set Test Variable | ${vhost_if1}
| | And Set Test Variable | ${vhost_if2}
| | And Set Test Variable | ${vhost_if3}
| | And Set Test Variable | ${vhost_if4}
...
| | ...
| | [Arguments] | ${dut_node} | ${src_ip} | ${dst_ip}
...
| | Interface is added to bridge domain
| | ... | ${dut_node} | ${vhost_if1} | ${bid_b} | 0
| | Interface is added to bridge domain
| | ... | ${dut_node} | ${vhost_if2} | ${bid_b} | 0
| | Interface is added to bridge domain
| | ... | ${dut_node} | ${vxlan2_if} | ${bid_r} | 0
| | Interface is added to bridge domain
| | ... | ${dut_node} | ${vhost_if3} | ${bid_r} | 0
| | Interface is added to bridge domain
| | ... | ${dut_node} | ${vhost_if4} | ${bid_r} | 0
...
| | Send Ping From Node To Dst | ${qemu_node1} | ${dut1_blue1} | nmspace2
| | Send Ping From Node To Dst | ${qemu_node1} | ${dut1_red2} | nmspace3
| | Send Ping From Node To Dst | ${qemu_node1} | ${dut1_red1} | nmspace4
...
| | Send Ping From Node To Dst | ${qemu_node2} | ${dut2_blue1} | nmspace2
| | Send Ping From Node To Dst | ${qemu_node2} | ${dut2_red2} | nmspace3
| | Send Ping From Node To Dst | ${qemu_node2} | ${dut2_red1} | nmspace4
...
| | [Documentation] | Send packets from specified namespaces to other in order
| | ...             | to test test unreachability of namespaces
...
| | ...             | to test test unreachability of namespaces
| | Run keyword and expect error | Ping Not Successful
| | ... | Send Ping From Node To Dst | ${qemu_node2} | ${dut2_red1} | nmspace1
| | Run keyword and expect error | Ping Not Successful
| | ... | Send Ping From Node To Dst | ${qemu_node2} | ${dut2_red2} | nmspace1
| | Run keyword and expect error | Ping Not Successful
| | ... | Send Ping From Node To Dst | ${qemu_node2} | ${dut2_red1} | nmspace2
| | Run keyword and expect error | Ping Not Successful
| | ... | Send Ping From Node To Dst | ${qemu_node2} | ${dut2_red2} | nmspace2
| | Run keyword and expect error | Ping Not Successful
| | ... | Send Ping From Node To Dst | ${qemu_node2} | ${dut2_blue1} | nmspace3
| | Run keyword and expect error | Ping Not Successful
| | ... | Send Ping From Node To Dst | ${qemu_node2} | ${dut2_blue2} | nmspace3
| | Run keyword and expect error | Ping Not Successful
| | ... | Send Ping From Node To Dst | ${qemu_node2} | ${dut2_blue1} | nmspace4
| | Run keyword and expect error | Ping Not Successful
| | ... | Send Ping From Node To Dst | ${qemu_node2} | ${dut2_blue2} | nmspace4
...
| | ...             | to test test unreachability of namespaces
| | Run keyword and expect error | Ping Not Successful
| | ... | Send Ping From Node To Dst | ${qemu_node2} | ${dut1_red1} | nmspace1
| | Run keyword and expect error | Ping Not Successful
| | ... | Send Ping From Node To Dst | ${qemu_node2} | ${dut1_red2} | nmspace1
| | Run keyword and expect error | Ping Not Successful
| | ... | Send Ping From Node To Dst | ${qemu_node2} | ${dut1_red1} | nmspace2
| | Run keyword and expect error | Ping Not Successful
| | ... | Send Ping From Node To Dst | ${qemu_node2} | ${dut1_red2} | nmspace2
| | Run keyword and expect error | Ping Not Successful
| | ... | Send Ping From Node To Dst | ${qemu_node2} | ${dut1_blue1} | nmspace3
| | Run keyword and expect error | Ping Not Successful
| | ... | Send Ping From Node To Dst | ${qemu_node2} | ${dut1_blue2} | nmspace3
| | Run keyword and expect error | Ping Not Successful
| | ... | Send Ping From Node To Dst | ${qemu_node2} | ${dut1_blue1} | nmspace4
| | Run keyword and expect error | Ping Not Successful
| | ... | Send Ping From Node To Dst | ${qemu_node2} | ${dut1_blue2} | nmspace4
