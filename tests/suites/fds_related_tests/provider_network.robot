...
| | L2 Tag Rewrite | ${dut_node} | ${vhost_if1} | push-1 | ${vlan_blue}
| | L2 Tag Rewrite | ${dut_node} | ${vhost_if2} | push-1 | ${vlan_blue}
| | L2 Tag Rewrite | ${dut_node} | ${vhost_if3} | push-1 | ${vlan_red}
| | L2 Tag Rewrite | ${dut_node} | ${vhost_if4} | push-1 | ${vlan_red}
