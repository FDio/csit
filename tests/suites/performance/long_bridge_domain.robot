...
*** Test Cases ***
| Find NDR by using linear search 64B frames through bridge domain in 3-node topology
| | Given L2 bridge domain initialized in a 3-node circular topology
| | Find NDR using linear search and pps | 64 | 4600000 | 100000
...
| | Log Many | RESULT_RATE: | ${result_rate}
