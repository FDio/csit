...
| | ... | using binary search start at 40GE linerate, step 100kpps, LT=0.5%.
...
| | ... | using binary search start at 40GE linerate, step 5kpps.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | NDR
...
| | ... | using binary search start at 40GE linerate, step 5kpps, LT=0.5%.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | PDR
| | ${framesize}= | Set Variable | 9000
| | ${min_rate}= | Set Variable | 5000
| | ${max_rate}= | Set Variable | ${40Ge_linerate_pps_9000B}
