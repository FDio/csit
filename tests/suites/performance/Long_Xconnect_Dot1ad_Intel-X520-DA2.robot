...
| ... | Baseline packet throughput performance of DUT L2XC (L2 cross-connect)
| ... | switching is tested between two 10GE ports, with VLAN tags applied on
| ... | the link DUT1 - DUT2.
...
| | ... | start at 10GE linerate, step 100kpps. DUT runs L2XC switching with
| | ... | dot1ad i/f config with 1 thread, 1 phy core, 1 receive queue per
| | ... | NIC port.
...
| | ... | start at 10GE linerate, step 100kpps, LT=0.5%. DUT runs L2XC switching
| | ... | with dot1ad i/f config with 1 thread, 1 phy core, 1 receive queue per
| | ... | NIC port.
...
| | [Documentation]
| | ... | RFC2544: Find NDR for 1514 Byte frames using binary search
| | ... | start at 10GE linerate, step 10kpps. DUT runs L2XC switching
| | ... | with dot1ad i/f config with 1 thread, 1 phy core, 1 receive queue per
| | ... | NIC port.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | NDR
...
| | [Documentation]
| | ... | RFC2544: Find PDR for 1514 Byte frames using binary search
| | ... | start at 10GE linerate, step 10kpps, LT=0.5%. DUT runs L2XC switching
| | ... | with dot1ad i/f config with 1 thread, 1 phy core, 1 receive queue per
| | ... | NIC port.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | PDR
| | ${framesize}= | Set Variable | 1514
...
| | ... | start at 10GE linerate, step 5kpps. DUT runs L2XC switching
| | ... | with dot1ad i/f config with 1 thread, 1 phy core, 1 receive queue per
| | ... | NIC port.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | NDR
...
| | ... | start at 10GE linerate, step 5kpps, LT=0.5%. DUT runs L2XC switching
| | ... | with dot1ad i/f config with 1 thread, 1 phy core, 1 receive queue per
| | ... | NIC port.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | PDR
| | ${framesize}= | Set Variable | 9000
...
| | [Documentation]
| | ... | RFC2544: Find NDR for 64 Byte frames using binary search
| | ... | start at 10GE linerate, step 100kpps. DUT runs L2XC switching
| | ... | with dot1ad i/f config with 2 threads, 2 phy cores, 1 receive queue
| | ... | per NIC port.
...
| | ... | RFC2544: Find PDR for 1514 Byte frames using binary search
| | ... | start at 10GE linerate, step 10kpps, LT=0.5%. DUT runs L2XC switching
| | ... | with dot1ad i/f config with 2 threads, 2 phy cores, 1 receive queue per
| | ... | NIC port.
| | [Tags] | 2_THREAD_NOHTT_RXQUEUES_1 | MULTI_THREAD | PDR
| | ${framesize}= | Set Variable | 1514
| | ${min_rate}= | Set Variable | 10000
...
| | ... | RFC2544: Find NDR for 64 Byte frames using binary search
| | ... | start at 10GE linerate, step 100kpps. DUT runs L2XC switching
| | ... | with dot1ad i/f config with 4 threads, 4 phy cores, 2 receive queues
| | ... | per NIC port.
