...
| ... | switching is tested between two 10GE ports, with VLAN tag applied on
| ... | the link DUT1 - DUT2.
...
| | ... | dot1q i/f config with 1 thread, 1 phy core, 1 receive queue per
| | ... | NIC port.
...
| | ... | with dot1q i/f config with 1 thread, 1 phy core, 1 receive queue per
| | ... | NIC port.
...
| | ... | with dot1q i/f config with 2 threads, 2 phy cores, 1 receive queue per
| | ... | NIC port.
...
| | ... | RFC2544: Find NDR for 64 Byte frames using binary search
| | ... | start at 10GE linerate, step 100kpps. DUT runs L2XC switching
| | ... | with dot1q i/f config with 4 threads, 4 phy cores, 1 receive queue per
| | ... | NIC port.
