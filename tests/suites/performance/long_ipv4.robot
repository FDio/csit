...
| | ... | linear search starting at 4.4Mpps, stepping down with step of
| | ... | 0.1Mpps.
...
| Find PDR by using RFC2544 linear search and 64B frames through IPv4 forwarding in 3-node topology
| | [Documentation]
...
| | ${framesize}= | Set Variable | 64
| | ${start_rate}= | Set Variable | 4600000
| | ${step_rate}= | Set Variable | 100000
| | ${min_rate}= | Set Variable | 100000
| | ${max_rate}= | Set Variable | 14880952
| | Given Setup '1' worker threads and rss '1' without HTT on all DUTs
...
| Find PDR by using RFC2544 linear search and 1518B frames through IPv4 forwarding in 3-node topology
| | [Documentation]
...
| Find PDR by using RFC2544 linear search and 9000B frames through IPv4 forwarding in 3-node topology
| | [Documentation]
...
| | ... | linear search starting at 8.8Mpps, stepping down with step of
| | ... | 0.1Mpps.
...
| Find PDR with 2 cores and rss 1 by using RFC2544 linear search and 64B frames through IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with partial drop rate for 64B frames by
| | ... | using linear search starting at 8.8Mpps, stepping down with step of
| | ... | 0.1Mpps. Loss acceptance is set to 0.5 percent of transmitted
| | ... | packets.
...
| Find PDR with 2 cores and rss 1 by using RFC2544 linear search and 1518B frames through IPv4 forwarding in 3-node topology
| | [Documentation]
...
| Find PDR with 2 cores and rss 1 by using RFC2544 linear search and 9000B frames through IPv4 forwarding in 3-node topology
| | [Documentation]
...
| Find PDR with 4 cores and rss 2 by using RFC2544 linear search and 64B frames through IPv4 forwarding in 3-node topology
| | [Documentation]
...
| Find PDR with 4 cores and rss 2 by using RFC2544 linear search and 1518B frames through IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rss 2 with partial drop rate for 1518B
| | ... | frames by using linear search starting at 812,743pps, stepping down
| | ... | with step of 10.000pps. Loss acceptance is set to 0.5 percent of
| | ... | transmitted packets.
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD | PDR
| | ${framesize}= | Set Variable | 1518
| | ${start_rate}= | Set Variable | 812743
...
| Find PDR with 2 cores by using RFC2544 binary search and 64B frames through IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with partial drop rate for 64B
