...
| 1core VPP passes 1518B frames through VLAN dot1ad sub-interfaces inter-connected using L2 cross connect at 2x 812,743pps in 3-node topology
| | [Documentation]
| | ... | VPP with 1 core should pass 1518B frames through VLAN dot1ad
...
| 1core VPP passes 9000B frames through VLAN dot1ad sub-interfaces inter-connected using L2 cross connect at 2x 138,580pps in 3-node topology
| | [Documentation]
