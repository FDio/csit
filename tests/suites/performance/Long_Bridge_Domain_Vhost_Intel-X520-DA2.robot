...
| TC02: 64B PDR binary search - DUT L2BD-VHOST - 1thread 1core 1rxqy
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy core, \
...
| TC05: 9000B NDR binary search - DUT L2BD-VHOST - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy core, \
...
| TC06: 9000B PDR binary search - DUT L2BD-VHOST - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy core, \
...
| TC11: 9000B NDR binary search - DUT L2BD-VHOST - 2threads 2cores 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 2 threads, 2 phy cores, \
| | ... | 1 receive queue per NIC port. [Ver] Find NDR for 9000 Byte frames
| | ... | using binary search start at 10GE linerate, step 5kpps.
...
| TC12: 9000B PDR binary search - DUT L2BD-VHOST - 2threads 2cores 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 2 threads, 2 phy cores, \
| | ... | 1 receive queue per NIC port. [Ver] Find PDR for 9000 Byte frames
| | ... | using binary search start at 10GE linerate, step 5kpps, LT=0.5%.
...
| TC13: 64B NDR binary search - DUT L2BD-VM-VHOST - 4threads 4cores 2rxq
| | [Documentation]
...
| TC17: 9000B NDR binary search - DUT L2BD-VHOST - 4threads 4cores 2rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 4 threads, 4 phy cores, \
...
| TC18: 9000B PDR binary search - DUT L2BD-VHOST - 4threads 4cores 2rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 4 threads, 4 phy cores, \
