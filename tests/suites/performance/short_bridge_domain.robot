...
| | [Documentation] | 1core VPP should pass 64B frames through bridge domain
| | ...             | at 3.5mpps in 3-node topology
...
| | [Documentation] | 1core VPP should pass 1518B frames through bridge domain
| | ...             | at 10gbps in 3-node topology
| | [Tags] | 1_THREAD_NOHTT_RSS_1 | SINGLE_THREAD
...
| | [Documentation] | 1core VPP should pass 9000B frames through bridge domain
| | ...             | at 10gbps in 3-node topology
| | [Tags] | 1_THREAD_NOHTT_RSS_1 | SINGLE_THREAD
...
| 2core VPP with rss 1 passes 64B frames through bridge domain at 7.6mpps in 3-node topology
| | [Documentation] | 2core VPP with rss 1 should pass 64B frames through
| | ...             | bridge domain at 7.6mpps in 3-node topology
...
| 4core VPP with rss 2 passes 64B frames through bridge domain at 8.8mpps in 3-node topology
| | [Documentation] | 4core VPP with rss 2 should pass 64B frames through
| | ...             | bridge domain at 8.8mpps in 3-node topology
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD
| | ${framesize}= | Set Variable | 64
| | ${duration}= | Set Variable | 10
| | ${rate}= | Set Variable | 8.8mpps
