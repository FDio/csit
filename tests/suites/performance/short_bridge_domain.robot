...
| 4core VPP with rss 2 passes 64B frames through bridge domain at 8.6mpps in 3-node topology
| | [Documentation]
| | ... | VPP with 4 cores and rss 2 should pass 64B frames through bridge
| | ... | domain at 8.6mpps in 3-node topology
