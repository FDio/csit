...
| 2core VPP with rss 1 passes 64B frames through L2 cross connect at 11.0mpps in 3-node topology
| | [Documentation]
| | ... | VPP with 2 cores should pass 64B frames through L2 cross connect
| | ... | at 11.0mpps in 3-node topology
...
| 4core VPP with rss 2 passes 64B frames through L2 cross connect at 11.6mpps in 3-node topology
| | [Documentation]
| | ... | VPP with 4 cores and rss 2 should pass 64B frames through L2 cross
| | ... | connect at 11.6mpps in 3-node topology
| | # Variables
