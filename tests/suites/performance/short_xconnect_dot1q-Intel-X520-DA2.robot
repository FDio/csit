...
*** Test Cases ***
| 1core VPP passes 64B frames through VLAN dot1q sub-interfaces inter-connected using L2 cross connect at 2x3.6Mpps in 3-node topology
| | [Documentation]
| | ... | VPP with 1 core should pass 64B frames through VLAN dot1q
| | ... | sub-interfaces inter-connected using L2 cross connect at 2x3.6Mpps in
...
| 1core VPP passes 1518B frames through VLAN dot1q sub-interfaces inter-connected using L2 cross connect at 2x 812,743pps in 3-node topology
| | [Documentation]
| | ... | VPP with 1 core should pass 1518B frames through VLAN dot1q
| | ... | sub-interfaces inter-connected using L2 cross connect at
| | ... | 2x 812,743pps (2x 10Gbps) in 3-node topology. Tagging is applied
...
| 1core VPP passes 9000B frames through VLAN dot1q sub-interfaces inter-connected using L2 cross connect at 2x 138,580pps in 3-node topology
| | [Documentation]
| | ... | VPP with 1 core should pass 9000B frames through VLAN dot1q
| | ... | sub-interfaces inter-connected using L2 cross connect at
| | ... | 2x 138,580pps (2x 10Gbps) in 3-node topology. Tagging is applied
| | ... | between DUTs inserting 4B VLAN ID into a packet header.
| | [Tags] | 1_THREAD_NOHTT_RSS_1 | SINGLE_THREAD
...
| 2core VPP with rss 1 passes 64B frames through VLAN dot1q sub-interfaces inter-connected using L2 cross connect at 2x3.6Mpps in 3-node topology
| | [Documentation]
...
| 2core VPP with rss 1 passes 1518B frames through VLAN dot1q sub-interfaces inter-connected using L2 cross connect at 2x 812,743pps in 3-node topology
| | [Documentation]
...
| 2core VPP with rss 1 passes 9000B frames through VLAN dot1q sub-interfaces inter-connected using L2 cross connect at 2x 138,580pps in 3-node topology
| | [Documentation]
...
| 4core VPP with rss 2 passes 64B frames through VLAN dot1q sub-interfaces inter-connected using L2 cross connect at 2x3.6Mpps in 3-node topology
| | [Documentation]
...
| 4core VPP with rss 2 passes 1518B frames through VLAN dot1q sub-interfaces inter-connected using L2 cross connect at 2x 812,743pps in 3-node topology
| | [Documentation]
...
| 4core VPP with rss 2 passes 9000B frames through VLAN dot1q sub-interfaces inter-connected using L2 cross connect at 2x 138,580pps in 3-node topology
| | [Documentation]
