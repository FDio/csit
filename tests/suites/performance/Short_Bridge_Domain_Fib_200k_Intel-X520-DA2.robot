...
*** Test Cases ***
| TC01: Verify 64B ref-NDR at 2x 3.2Mpps - DUT L2BD Fib 2x100k - 1thread 1core 1rxq
| | [Documentation]
...
| TC02: Verify 1518B ref-NDR at 2x 812.74kpps - DUT L2BD Fib 2x100k - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 1 thread, 1 phy core, \
...
| TC03: Verify 9000B ref-NDR at 2x 138.58kpps - DUT L2BD Fib 2x100k - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 1 thread, 1 phy core, \
...
| TC04: Verify 64B ref-NDR at 2x 6.9Mpps - DUT L2BD Fib 2x100k - 2thread 2core 1rxq
| | [Documentation]
...
| TC05: Verify 1518B ref-NDR at 2x 812.74kpps - DUT L2BD Fib 2x100k - 2thread 2core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 2 threads, 2 phy cores, \
| | ... | 1 receive queue per NIC port. [Ver] Verify ref-NDR for 1518 Byte
| | ... | frames using single trial throughput test.
...
| TC06: Verify 9000B ref-NDR at 2x 138.58kpps - DUT L2BD Fib 2x100k - 2thread 2core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 2 threads, 2 phy cores, \
| | ... | 1 receive queue per NIC port. [Ver] Verify ref-NDR for 9000 Byte
| | ... | frames using single trial throughput test.
...
| TC07: Verify 64B ref-NDR at 2x 7.4Mpps - DUT L2BD Fib 2x100k - 4thread 4core 2rxq
| | [Documentation]
...
| TC08: Verify 1518B ref-NDR at 2x 812.74kpps - DUT L2BD Fib 2x100k - 4thread 4core 2rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 4 threads, 4 phy cores, \
...
| TC09: Verify 9000B ref-NDR at 2x 138.58kpps - DUT L2BD Fib 2x100k - 4thread 4core 2rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 4 threads, 4 phy cores, \
