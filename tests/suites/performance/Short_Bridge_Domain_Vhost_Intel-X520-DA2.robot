...
| ...           | AND          | VM with dpdk-testpmd Teardown | ${dut1}
| ...                          | ${dut1_vm_refs}
| ...           | AND          | VM with dpdk-testpmd Teardown | ${dut2}
| ...                          | ${dut2_vm_refs}
...
| | ${vm1}= | And VM with dpdk-testpmd for Vhost L2BD forwarding is setup
| | ...     | ${dut1} | ${sock1} | ${sock2} | DUT1_VM1
| | Set To Dictionary | ${dut1_vm_refs} | DUT1_VM1 | ${vm1}
| | ${vm2}= | And VM with dpdk-testpmd for Vhost L2BD forwarding is setup
