...
| 2core VPP with rxqueues 1 passes 78B frames through IPv6 forwarding at 2x 7.5Mpps in 3-node topology
| | [Documentation]
...
| 4core VPP with rxqueues 2 passes 78B frames through IPv6 forwarding at 2x 7.8Mpps in 3-node topology
| | [Documentation]
...
| 1core VPP passes 1518B frames through IPv4 over IPv6 forwarding at 2x 812,743pps in 3-node topology
| | [Documentation]
| | ... | VPP with 1 core should pass 1518B frames through IPv4 over IPv6
| | ... | forwardingat 2x 812,743pps (2x 10Gbps) in 3-node topology.
| | [Tags] | 1_THREAD_NOHTT_RSS_1 | SINGLE_THREAD | NDR | LISP_IPv4oIPv6
| | ${framesize}= | Set Variable | 1518
| | ${duration}= | Set Variable | 10
| | ${rate}= | Set Variable | 812743pps
...
| 1core VPP passes 9000B frames through IPv4 over IPv6 forwarding at 2x 138,580pps in 3-node topology
| | [Documentation]
| | ... | VPP with 1 core should pass 9000B frames through IPv4 over IPv6
| | ... | forwarding at 2x 138,580pps (2x 10Gbps) in 3-node topology.
| | [Tags] | 1_THREAD_NOHTT_RSS_1 | SINGLE_THREAD | NDR | LISP_IPv4oIPv6
| | ${framesize}= | Set Variable | 9000
| | ${duration}= | Set Variable | 10
...
| 2core VPP with rxqueues 1 passes 64B frames through IPv4 over IPv6 forwarding at 2x 7.5Mpps in 3-node topology
| | [Documentation]
| | ... | VPP with 2 cores should pass 64B frames through IPv4 over IPv6
| | ... | forwarding at 2x 7.5Mpps (2x 10Gbps) in 3-node topology.
...
| 2core VPP with rxqueues 1 passes 1518B frames through IPv4 over IPv6 forwarding at 2x 812,743pps in 3-node topology
| | [Documentation]
| | ... | VPP with 2 cores should pass 1518B frames through IPv4 over IPv6 forwarding
| | ... | at 2x 812,743pps (2x 10Gbps) in 3-node topology.
| | [Tags] | 2_THREAD_NOHTT_RSS_1 | MULTI_THREAD | NDR | LISP_IPv4oIPv6
| | ${framesize}= | Set Variable | 1518
| | ${duration}= | Set Variable | 10
...
| 2core VPP with rxqueues 1 passes 9000B frames through IPv4 over IPv6 forwarding at 2x 138,580pps in 3-node topology
| | [Documentation]
| | ... | VPP with 2 cores should pass 9000B frames through IPv4 over IPv6
| | ... | forwarding at 2x 138,580pps (2x 10Gbps) in 3-node topology.
| | [Tags] | 2_THREAD_NOHTT_RSS_1 | MULTI_THREAD | NDR | LISP_IPv4oIPv6
| | ${framesize}= | Set Variable | 9000
| | ${duration}= | Set Variable | 10
...
| 4core VPP with rxqueues 2 passes 64B frames through IPv4 over IPv6 forwarding at 2x 7.8Mpps in 3-node topology
| | [Documentation]
| | ... | VPP with 4 cores and rxqueues 2 should pass 64B frames through IPv4
| | ... | over IPv6 forwarding at 2x 7.8Mpps in 3-node topology.
...
| 4core VPP with rxqueues 2 passes 1518B frames through IPv4 over IPv6 forwarding at 2x 812,743pps in 3-node topology
| | [Documentation]
| | ... | VPP with 4 cores and rxqueues 2 should pass 1518B frames through IPv4
| | ... | over IPv6 forwarding at 2x 812,743pps (2x 10Gbps) in 3-node topology.
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD | NDR | LISP_IPv4oIPv6
| | ${framesize}= | Set Variable | 1518
| | ${duration}= | Set Variable | 10
| | ${rate}= | Set Variable | 812743pps
...
| 4core VPP with rxqueues 2 passes 9000B frames through IPv4 over IPv6 forwarding at 2x 138,580pps in 3-node topology
| | [Documentation]
| | ... | VPP with 4 cores and rxqueues 2 should pass 9000B frames through IPv4
| | ... | over IPv6 forwarding at 2x 138,580pps (2x 10Gbps) in 3-node topology.
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD | NDR | LISP_IPv4oIPv6
| | ${framesize}= | Set Variable | 9000
| | ${duration}= | Set Variable | 10
| | ${rate}= | Set Variable | 138580pps
...
| 1core VPP passes 1518B frames through IPv6 over IPv4 forwarding at 2x 812,743pps in 3-node topology
| | [Documentation]
| | ... | VPP with 1 core should pass 1518B frames through IPv6 over IPv4
| | ... |  forwarding at 2x 812,743pps (2x 10Gbps) in 3-node topology.
| | [Tags] | 1_THREAD_NOHTT_RSS_1 | SINGLE_THREAD | NDR | LISP_IPv6oIPv4
| | ${framesize}= | Set Variable | 1518
| | ${duration}= | Set Variable | 10
...
| 1core VPP passes 9000B frames through IPv6 over IPv4 forwarding at 2x 138,580pps in 3-node topology
| | [Documentation]
| | ... | VPP with 1 core should pass 9000B frames through IPv6 over IPv4
| | ... | forwarding at 2x 138,580pps (2x 10Gbps) in 3-node topology.
| | [Tags] | 1_THREAD_NOHTT_RSS_1 | SINGLE_THREAD | NDR | LISP_IPv6oIPv4
| | ${framesize}= | Set Variable | 9000
| | ${duration}= | Set Variable | 10
...
| 2core VPP with rxqueues 1 passes 78B frames through IPv6 over IPv4 forwarding at 2x 7.5Mpps in 3-node topology
| | [Documentation]
| | ... | VPP with 2 cores should pass 78B frames through IPv6 over IPv4
| | ... | forwarding at 2x 7.5Mpps (2x 10Gbps) in 3-node topology.
...
| 2core VPP with rxqueues 1 passes 1518B frames through IPv6 over IPv4 forwarding at 2x 812,743pps in 3-node topology
| | [Documentation]
| | ... | VPP with 2 cores should pass 1518B frames through IPv6 over IPv4
| | ... | forwarding at 2x 812,743pps (2x 10Gbps) in 3-node topology.
| | [Tags] | 2_THREAD_NOHTT_RSS_1 | MULTI_THREAD | NDR | LISP_IPv6oIPv4
| | ${framesize}= | Set Variable | 1518
| | ${duration}= | Set Variable | 10
...
| 2core VPP with rxqueues 1 passes 9000B frames through IPv6 over IPv4 forwarding at 2x 138,580pps in 3-node topology
| | [Documentation]
| | ... | VPP with 2 cores should pass 9000B frames through IPv6 over IPv4
| | ... | forwarding at 2x 138,580pps (2x 10Gbps) in 3-node topology.
| | [Tags] | 2_THREAD_NOHTT_RSS_1 | MULTI_THREAD | NDR | LISP_IPv6oIPv4
| | ${framesize}= | Set Variable | 9000
| | ${duration}= | Set Variable | 10
...
| 4core VPP with rxqueues 2 passes 78B frames through IPv6 over IPv4 forwarding at 2x 7.8Mpps in 3-node topology
| | [Documentation]
| | ... | VPP with 4 cores and rxqueues 2 should pass 78B frames through IPv6 over IPv4
| | ... | forwarding at 2x 7.8Mpps in 3-node topology.
...
| 4core VPP with rxqueues 2 passes 1518B frames through IPv6 over IPv4 forwarding at 2x 812,743pps in 3-node topology
| | [Documentation]
| | ... | VPP with 4 cores and rxqueues 2 should pass 1518B frames through LISP_IPv6oIPv4
| | ... | forwarding at 2x 812,743pps (2x 10Gbps) in 3-node topology.
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD | NDR | LISP_IPv6oIPv4
| | ${framesize}= | Set Variable | 1518
| | ${duration}= | Set Variable | 10
...
| 4core VPP with rxqueues 2 passes 9000B frames through IPv6 over IPv4 forwarding at 2x 138,580pps in 3-node topology
| | [Documentation]
| | ... | VPP with 4 cores and rxqueues 2 should pass 9000B frames through IPv6 over IPv4
| | ... | forwarding at 2x 138,580pps (2x 10Gbps) in 3-node topology.
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD | NDR | LISP_IPv6oIPv4
| | ${framesize}= | Set Variable | 9000
| | ${duration}= | Set Variable | 10
