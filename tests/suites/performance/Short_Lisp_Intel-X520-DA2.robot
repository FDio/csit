...
| ... | all packets containing Ethernet header, IPv4 header or IPv6 header with IP protocol=61
...
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port. [Ver] Verify ref-NDR for 1480 Byte
| | ... | frames using single trial throughput test.
| | [Tags] | 1_THREAD_NOHTT_RSS_1 | SINGLE_THREAD | NDR | LISP_IPv4
...
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 4 thread, 4 phy core, \
...
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 4 thread, 4 phy core, \
| | ... | 2 receive queue per NIC port. [Ver] Verify ref-NDR for 1480 Byte
| | ... | frames using single trial throughput test.
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD | NDR | LISP_IPv4
| | ${framesize}= | Set Variable | 1480
| | ${duration}= | Set Variable | 10
...
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port. [Ver] Verify ref-NDR for 1460 Byte
| | ... | frames using single trial throughput test.
| | [Tags] | 1_THREAD_NOHTT_RSS_1 | SINGLE_THREAD | NDR | LISP_IPv6
...
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 4 thread, 4 phy core, \
| | ... | 2 receive queue per NIC port. [Ver] Verify ref-NDR for 1460 Byte
| | ... | frames using single trial throughput test.
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD | NDR | LISP_IPv6
| | ${framesize}= | Set Variable | 1460
| | ${duration}= | Set Variable | 10
