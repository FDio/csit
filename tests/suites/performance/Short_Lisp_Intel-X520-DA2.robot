...
| 2core VPP with rss 1 passes 78B frames through IPv6 forwarding at 2x 7.5Mpps in 3-node topology
| | [Documentation]
...
| 4core VPP with rss 2 passes 78B frames through IPv6 forwarding at 2x 7.8Mpps in 3-node topology
| | [Documentation]
...
| 2core VPP with rss 1 passes 64B frames through IPv4 over IPv6 forwarding at 2x 7.5Mpps in 3-node topology
| | [Documentation]
...
| 2core VPP with rss 1 passes 1518B frames through IPv4 over IPv6 forwarding at 2x 812,743pps in 3-node topology
| | [Documentation]
...
| 2core VPP with rss 1 passes 9000B frames through IPv4 over IPv6 forwarding at 2x 138,580pps in 3-node topology
| | [Documentation]
...
| 4core VPP with rss 2 passes 64B frames through IPv4 over IPv6 forwarding at 2x 7.8Mpps in 3-node topology
| | [Documentation]
| | ... | VPP with 4 cores and rss 2 should pass 64B frames through IPv4
...
| 4core VPP with rss 2 passes 1518B frames through IPv4 over IPv6 forwarding at 2x 812,743pps in 3-node topology
| | [Documentation]
| | ... | VPP with 4 cores and rss 2 should pass 1518B frames through IPv4
...
| 4core VPP with rss 2 passes 9000B frames through IPv4 over IPv6 forwarding at 2x 138,580pps in 3-node topology
| | [Documentation]
| | ... | VPP with 4 cores and rss 2 should pass 9000B frames through IPv4
...
| 2core VPP with rss 1 passes 78B frames through IPv6 over IPv4 forwarding at 2x 7.5Mpps in 3-node topology
| | [Documentation]
...
| 2core VPP with rss 1 passes 1518B frames through IPv6 over IPv4 forwarding at 2x 812,743pps in 3-node topology
| | [Documentation]
...
| 2core VPP with rss 1 passes 9000B frames through IPv6 over IPv4 forwarding at 2x 138,580pps in 3-node topology
| | [Documentation]
...
| 4core VPP with rss 2 passes 78B frames through IPv6 over IPv4 forwarding at 2x 7.8Mpps in 3-node topology
| | [Documentation]
| | ... | VPP with 4 cores and rss 2 should pass 78B frames through IPv6 over IPv4
| | ... | forwarding at 2x 7.8Mpps in 3-node topology.
...
| 4core VPP with rss 2 passes 1518B frames through IPv6 over IPv4 forwarding at 2x 812,743pps in 3-node topology
| | [Documentation]
| | ... | VPP with 4 cores and rss 2 should pass 1518B frames through LISP_IPv6oIPv4
| | ... | forwarding at 2x 812,743pps (2x 10Gbps) in 3-node topology.
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD | NDR | LISP_IPv6oIPv4
| | ${framesize}= | Set Variable | 1518
| | ${duration}= | Set Variable | 10
...
| 4core VPP with rss 2 passes 9000B frames through IPv6 over IPv4 forwarding at 2x 138,580pps in 3-node topology
| | [Documentation]
| | ... | VPP with 4 cores and rss 2 should pass 9000B frames through IPv6 over IPv4
| | ... | forwarding at 2x 138,580pps (2x 10Gbps) in 3-node topology.
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD | NDR | LISP_IPv6oIPv4
| | ${framesize}= | Set Variable | 9000
| | ${duration}= | Set Variable | 10
