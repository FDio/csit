...
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | NDR | FIB_10K | THIS
...
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | NDR | FIB_10K
...
| | [Tags] | 2_THREAD_NOHTT_RXQUEUES_1 | MULTI_THREAD | NDR | FIB_10K
| | ${framesize}= | Set Variable | 64
| | ${duration}= | Set Variable | 10
...
| | [Tags] | 4_THREAD_NOHTT_RXQUEUES_2 | MULTI_THREAD | NDR | FIB_10K
| | ${framesize}= | Set Variable | 64
| | ${duration}= | Set Variable | 10
