...
| | [Documentation]
| | ... | VPP with 2 core should pass 1514B frames through VLAN dot1ad
| | ... | sub-interfaces inter-connected using L2 cross connect at
| | ... | 2x 810,635pps in 3-node topology. Tagging is applied between DUTs
| | ... | inserting 2x 4B VLAN ID into a packet header.
| | [Tags] | 2_THREAD_NOHTT_RXQUEUES_1 | MULTI_THREAD | NDR
...
| | [Documentation]
| | ... | VPP with 2 core should pass 9000B frames through VLAN dot1ad
| | ... | sub-interfaces inter-connected using L2 cross connect at
| | ... | 2x 138,458pps in 3-node topology. Tagging is applied between DUTs
| | ... | inserting 2x 4B VLAN ID into a packet header.
| | [Tags] | 2_THREAD_NOHTT_RXQUEUES_1 | MULTI_THREAD | NDR
...
| | [Documentation]
| | ... | VPP with 4 cores and rxqueues 2 should pass 64B frames through VLAN
| | ... | dot1q sub-interfaces inter-connected using L2 cross connect at
| | ... | 2x 8.0Mpps in 3-node topology. Tagging is applied between DUTs
| | ... | inserting 2x 4B VLAN ID into a packet header.
...
| | [Documentation]
| | ... | VPP with 4 core and rxqueues 2 should pass 1514B frames through VLAN
| | ... | dot1ad sub-interfaces inter-connected using L2 cross connect at
| | ... | 2x 810,635pps in 3-node topology. Tagging is applied between DUTs
| | ... | inserting 2x 4B VLAN ID into a packet header.
| | [Tags] | 4_THREAD_NOHTT_RXQUEUES_2 | MULTI_THREAD | NDR
| | ${framesize}= | Set Variable | 1514
...
| | [Documentation]
| | ... | VPP with 4 core and rxqueues 2 should pass 9000B frames through VLAN
| | ... | dot1ad sub-interfaces inter-connected using L2 cross connect at
| | ... | 2x 138,458pps in 3-node topology. Tagging is applied between DUTs
| | ... | inserting 2x 4B VLAN ID into a packet header.
| | [Tags] | 4_THREAD_NOHTT_RXQUEUES_2 | MULTI_THREAD | NDR
