...
| 1core VPP passes 1514B frames through VLAN dot1ad sub-interfaces inter-connected using L2 cross connect at 2x 808,000pps in 3-node topology
| | [Documentation]
| | ... | VPP with 1 core should pass 1514B frames through VLAN dot1ad
| | ... | sub-interfaces inter-connected using L2 cross connect at
| | ... | 2x 808,000pps in 3-node topology. Tagging is applied between DUTs
| | ... | inserting 2x 4B VLAN ID into a packet header.
| | [Tags] | 1_THREAD_NOHTT_RSS_1 | SINGLE_THREAD | NDR
| | ${framesize}= | Set Variable | 1514
| | ${duration}= | Set Variable | 10
| | ${rate}= | Set Variable | 808000pps
| | Given Add '1' worker threads and rss '1' without HTT to all DUTs
| | And   Add all PCI devices to all DUTs
| | And   Apply startup configuration on all VPP DUTs
| | And   VPP interfaces in path are up
...
| 1core VPP passes 9000B frames through VLAN dot1ad sub-interfaces inter-connected using L2 cross connect at 2x 138,000pps in 3-node topology
| | [Documentation]
| | ... | VPP with 1 core should pass 9000B frames through VLAN dot1ad
| | ... | sub-interfaces inter-connected using L2 cross connect at
| | ... | 2x 138,000pps in 3-node topology. Tagging is applied between DUTs
| | ... | inserting 2x 4B VLAN ID into a packet header.
| | [Tags] | 1_THREAD_NOHTT_RSS_1 | SINGLE_THREAD | NDR
| | ${framesize}= | Set Variable | 9000
| | ${duration}= | Set Variable | 10
| | ${rate}= | Set Variable | 138000pps
| | Given Add '1' worker threads and rss '1' without HTT to all DUTs
| | And   Add all PCI devices to all DUTs
| | And   Apply startup configuration on all VPP DUTs
| | And   VPP interfaces in path are up
...
| 2core VPP with rss 1 passes 64B frames through VLAN dot1ad sub-interfaces inter-connected using L2 cross connect at 2x5.8Mpps in 3-node topology
| | [Documentation]
| | ... | VPP with 2 cores should pass 64B frames through VLAN dot1q
| | ... | sub-interfaces inter-connected using L2 cross connect at 2x 5.8Mpps
| | ... | in 3-node topology. Tagging is applied between DUTs inserting 2x 4B
| | ... | VLAN ID into a packet header.
...
| 2core VPP with rss 1 passes 1514B frames through VLAN dot1ad sub-interfaces inter-connected using L2 cross connect at 2x 808,000pps in 3-node topology
| | [Documentation]
| | ... | VPP with 1 core should pass 1514B frames through VLAN dot1ad
| | ... | sub-interfaces inter-connected using L2 cross connect at
| | ... | 2x 808,000pps in 3-node topology. Tagging is applied between DUTs
...
| 2core VPP with rss 1 passes 9000B frames through VLAN dot1ad sub-interfaces inter-connected using L2 cross connect at 2x 138,000pps in 3-node topology
| | [Documentation]
| | ... | VPP with 1 core should pass 9000B frames through VLAN dot1ad
| | ... | sub-interfaces inter-connected using L2 cross connect at
| | ... | 2x 138,000pps in 3-node topology. Tagging is applied between DUTs
...
| 4core VPP with rss 2 passes 64B frames through VLAN dot1ad sub-interfaces inter-connected using L2 cross connect at 2x9.0Mpps in 3-node topology
| | [Documentation]
| | ... | VPP with 2 cores should pass 64B frames through VLAN dot1q
| | ... | sub-interfaces inter-connected using L2 cross connect at 2x 9.0Mpps
| | ... | in 3-node topology. Tagging is applied between DUTs inserting 2x 4B
| | ... | VLAN ID into a packet header.
...
| 4core VPP with rss 2 passes 1514B frames through VLAN dot1ad sub-interfaces inter-connected using L2 cross connect at 2x 808,000pps in 3-node topology
| | [Documentation]
| | ... | VPP with 1 core should pass 1514B frames through VLAN dot1ad
| | ... | sub-interfaces inter-connected using L2 cross connect at
| | ... | 2x 808,000pps in 3-node topology. Tagging is applied between DUTs
...
| 4core VPP with rss 2 passes 9000B frames through VLAN dot1ad sub-interfaces inter-connected using L2 cross connect at 2x 138,000pps in 3-node topology
| | [Documentation]
| | ... | VPP with 1 core should pass 9000B frames through VLAN dot1ad
| | ... | sub-interfaces inter-connected using L2 cross connect at
| | ... | 2x 138,000pps in 3-node topology. Tagging is applied between DUTs
