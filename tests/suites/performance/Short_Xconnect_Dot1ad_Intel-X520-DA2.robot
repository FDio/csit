...
| ... | node interfaces. Baseline packet throughput performance of Xconnect
| ... | is tested with with two cross connect interfaces and applied dot1ad
| ... | tagging (8 Byte) between DUT1 and DUT2. DUT1 and DUT2 tested with
...
*** Test Cases ***
| TC01: Verify 64B ref-NDR at 2x 3.6Mpps - DUT dot1ad - 1thread 1core 1rxq
| | [Documentation]
| | ... | Verify ref-NDR for 64 Byte frames using single trial throughput
| | ... | test. DUT runs dot1ad config with 1 thread, 1 phy core, 1
...
| TC02: Verify 1514B ref-NDR at 2x 810.635kpps - DUT dot1ad - 1thread 1core 1rxq
| | [Documentation]
| | ... | Verify ref-NDR for 1514 Byte frames using single trial throughput
| | ... | test. DUT runs dot1ad config with 1 thread, 1 phy core, 1
| | ... | receive queue per NIC port.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | NDR
...
| TC03: Verify 9000B ref-NDR at 2x 138.458kpps - DUT dot1ad - 1thread 1core 1rxq
| | [Documentation]
...
| TC04: Verify 64B ref-NDR at 2x 7Mpps - DUT dot1ad - 2thread 2core 1rxq
| | [Documentation]
| | ... | Verify ref-NDR for 64 Byte frames using single trial throughput
| | ... | test. DUT runs dot1ad config with 2 thread, 2 phy core, 1
| | ... | receive queue per NIC port.
...
| TC05: Verify 1514B ref-NDR at 2x 810.635kpps - DUT dot1ad - 2thread 2core 1rxq
| | [Documentation]
| | ... | Verify ref-NDR for 1514 Byte frames using single trial throughput
| | ... | test. DUT runs dot1ad config with 2 thread, 2 phy core, 1
| | ... | receive queue per NIC port.
...
| TC06: Verify 9000B ref-NDR at 2x 138.458kpps - DUT dot1ad - 2thread 2core 1rxq
| | [Documentation]
| | ... | Verify ref-NDR for 9000 Byte frames using single trial throughput
| | ... | test. DUT runs dot1ad config with 2 thread, 2 phy core, 1
| | ... | receive queue per NIC port.
...
| TC07: Verify 64B ref-NDR at 2x 8Mpps - DUT dot1ad - 4thread 4core 2rxq
| | [Documentation]
| | ... | Verify ref-NDR for 64 Byte frames using single trial throughput
| | ... | test. DUT runs dot1ad config with 4 thread, 4 phy core, 2
| | ... | receive queue per NIC port.
...
| TC08: Verify 1514B ref-NDR at 2x 810.635kpps - DUT dot1ad - 4thread 4core 2rxq
| | [Documentation]
| | ... | Verify ref-NDR for 1514 Byte frames using single trial throughput
| | ... | test. DUT runs dot1ad config with 4 thread, 4 phy core, 2
| | ... | receive queue per NIC port.
...
| TC09: Verify 9000B ref-NDR at 2x 138.458kpps - DUT dot1ad - 4thread 4core 2rxq
| | [Documentation]
| | ... | Verify ref-NDR for 9000 Byte frames using single trial throughput
| | ... | test. DUT runs dot1ad config with 4 thread, 4 phy core, 2
| | ... | receive queue per NIC port.
