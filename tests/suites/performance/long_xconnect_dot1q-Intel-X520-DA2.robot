...
| | ... | at 4.8Mpps, stepping down with step of 0.1Mpps. Frames from and to TG
...
| | ... | to TG are 9000 long. Tagging is applied between DUTs inserting 4B
| | ... | VLAN ID into a packet header.
| | [Tags] | 1_THREAD_NOHTT_RSS_1 | SINGLE_THREAD
...
| | ... | from and to TG are 9000 long. Tagging is applied between DUTs
| | ... | inserting 4B VLAN ID into a packet header.
| | [Tags] | 2_THREAD_NOHTT_RSS_1 | MULTI_THREAD
| | ${framesize}= | Set Variable | 9000
| | ${start_rate}= | Set Variable | 138580
...
| | ... | linear search starting at 12.2Mpps, stepping down with step of 0.1Mpps.
...
| | ... | 5,000pps. Frames from and to TG are 9000 long. Tagging is applied
| | ... | between DUTs inserting 4B VLAN ID into a packet header.
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD
| | ${framesize}= | Set Variable | 9000
| | ${start_rate}= | Set Variable | 138580
