...
| Find PDR by using RFC2544 binary search and 78B frames through IPv6 forwarding with COP in 3-node topology
| | [Documentation]
...
| Find PDR by using RFC2544 binary search and 1518B frames through IPv6 forwarding with COP in 3-node topology
| | [Documentation]
...
| Find PDR by using RFC2544 binary search and 9000B frames through IPv6 forwarding with COP in 3-node topology
| | [Documentation]
