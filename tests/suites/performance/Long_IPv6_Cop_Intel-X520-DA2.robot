...
| ... | and random payload. MAC addresses are matching MAC
| ... | addresses of the TG node interfaces. DUT1 and DUT2 tested with 2p10GE
| ... | NIC X520 Niantic by Intel.
| ... | Baseline packet throughput performance of DUTs configured with IPv6
| ... | routing and IPv6 security COP whitelist ingress filtering applied on
| ... | links TG - DUT1 and DUT2 - TG, is tested with two static IPv6 /64 route
| ... | entries and additional IPv6 FIB table with index 1 with whitelist /64
| ... | filter entry.
