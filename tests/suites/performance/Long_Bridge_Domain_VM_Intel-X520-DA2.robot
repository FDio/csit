...
| Find RFC2544:NDR with binary search with 2 cores and rxqueues 1 and 64B frames through BD-VM-BD in 3-node topology
| | [Documentation]
...
| Find RFC2544:PDR with binary search with 2 cores and rxqueues 1 and 64B frames through BD-VM-BD in 3-node topology
| | [Documentation]
...
| Find RFC2544:NDR with binary search with 2 cores and rxqueues 1 and 1518B frames through BD-VM-BD in 3-node topology
| | [Documentation]
...
| Find RFC2544:PDR with binary search with 2 cores and rxqueues 1 and 1518B frames through BD-VM-BD in 3-node topology
| | [Documentation]
...
| Find RFC2544:NDR with binary search with 2 cores and rxqueues 1 and 9000B frames through BD-VM-BD in 3-node topology
| | [Documentation]
...
| Find RFC2544:PDR with binary search with 2 cores and rxqueues 1 and 9000B frames through BD-VM-BD in 3-node topology
| | [Documentation]
...
| Find RFC2544:NDR with binary search with 4 cores and rxqueues 2 and 64B frames through BD-VM-BD in 3-node topology
| | [Documentation]
...
| Find RFC2544:PDR with binary search with 4 cores and rxqueues 2 and 64B frames through BD-VM-BD in 3-node topology
| | [Documentation]
...
| Find RFC2544:NDR with binary search with 4 cores and rxqueues 2 and 1518B frames through BD-VM-BD in 3-node topology
| | [Documentation]
...
| Find RFC2544:PDR with binary search with 4 cores and rxqueues 2 and 1518B frames through BD-VM-BD in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rxqueues 2 with partial drop rate for
...
| Find RFC2544:NDR with binary search with 4 cores and rxqueues 2 and 9000B frames through BD-VM-BD in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rxqueues 2 with non drop rate for
...
| Find RFC2544:PDR with binary search with 4 cores and rxqueues 2 and 9000B frames through BD-VM-BD in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rxqueues 2 with partial drop rate for
