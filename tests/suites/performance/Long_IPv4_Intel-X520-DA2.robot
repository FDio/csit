...
| | ... | 100kpps, packet loss tolerance of 0. DUT running in IPv4 routing
| | ... | configuration with 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| | ... | binary search starting from 10GE linerate, final step of
| | ... | 100kpps, packet loss tolerance of 0.5%. DUT running in IPv4 routing
| | ... | configuration with 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| | ... | binary search starting from 10GE linerate, final step of
| | ... | 10kpps, packet loss tolerance of 0. DUT running in IPv4 routing
| | ... | configuration with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | NDR
...
| | ... | binary search starting from 10GE linerate, final step of
| | ... | 10kpps, packet loss tolerance of 0.5%. DUT running in IPv4 routing
| | ... | configuration with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | PDR
| | ${framesize}= | Set Variable | 1518
| | ${min_rate}= | Set Variable | 10000
...
| | ... | binary search starting from 10GE linerate, final step of
| | ... | 5kpps, packet loss tolerance of 0. DUT running in IPv4 routing
| | ... | configuration with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | NDR
...
| | ... | RFC2544: Find NDR throughput for 9000 Byte frames (L2 size). Use
| | ... | binary search starting from 10GE linerate, final step of
| | ... | 5kpps, packet loss tolerance of 0.5%. DUT running in IPv4 routing
| | ... | configuration with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | PDR
| | ${framesize}= | Set Variable | 9000
| | ${min_rate}= | Set Variable | 5000
...
| | ... | binary search starting from 10GE linerate, final step of
| | ... | 100kpps, packet loss tolerance of 0. DUT running in IPv4 routing
| | ... | configuration with 2 threads, 2 phy cores, 1 receive queue per NIC
| | ... | port.
...
| | ... | binary search starting from 10GE linerate, final step of
| | ... | 100kpps, packet loss tolerance of 0. DUT running in IPv4 routing
| | ... | configuration with 4 threads, 4 phy cores, 2 receive queues per NIC
| | ... | port.
...
| TC17: 1518B NDR binary search - DUT IPv4 - 4threads 4cores 2rxq
| | [Documentation]
| | ... | RFC2544: Find NDR throughput for 9000 Byte frames (L2 size). Use
| | ... | binary search starting from 10GE linerate, final step of
| | ... | 5kpps, packet loss tolerance of 0. DUT running in IPv4 routing
...
| TC18: 1518B PDR binary search - DUT IPv4 - 4threads 4cores 2rxq
| | [Documentation]
| | ... | RFC2544: Find NDR throughput for 9000 Byte frames (L2 size). Use
| | ... | binary search starting from 10GE linerate, final step of
| | ... | 5kpps, packet loss tolerance of 0.5%. DUT running in IPv4 routing
