...
*** Variables ***
| ${10GE_LINERATE_PPS_78B}= | 12755102
| ${10GE_LINERATE_PPS_1518B}= | 812743
| ${10GE_LINERATE_PPS_9000B}= | 138580
...
| Find NDR with 4 cores and rss 2 by using RFC2544 binary search and 9000B frames through IPv6 forwarding in 3-node topology
| | [Documentation]
