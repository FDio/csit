...
| ... | Baseline packet throughput performance of L2BD (L2 bridge-domain)
| ... | switching is tested with MAC learning enabled.

*** Test Cases ***
| TC01: 64B NDR binary search - DUT L2BD - 1thread 1core 1rxq
| | [Documentation]
| | ... | RFC2544: Find NDR for 64 Byte frames using binary search
| | ... | start at 10GE linerate, step 100kpps. DUT runs L2BD switching
...
| | ... | start at 10GE linerate, step 100kpps, LT=0.5%. DUT runs L2BD switching
| | ... | config with 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| | ... | start at 10GE linerate, step 10kpps. DUT runs L2BD switching
| | ... | config with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | NDR
...
| | ... | start at 10GE linerate, step 10kpps, LT=0.5%. DUT runs L2BD switching
| | ... | config with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | PDR
| | ${framesize}= | Set Variable | 1518
| | ${min_rate}= | Set Variable | 10000
...
| | ... | start at 10GE linerate, step 5kpps. DUT runs L2BD switching
| | ... | config with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | NDR
...
| | ... | start at 10GE linerate, step 5kpps, LT=0.5%. DUT runs L2BD switching
| | ... | config with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | PDR
| | ${framesize}= | Set Variable | 9000
| | ${min_rate}= | Set Variable | 5000
