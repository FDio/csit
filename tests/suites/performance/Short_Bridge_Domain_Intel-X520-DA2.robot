...
| ... | node interfaces. Baseline packet throughput performance of L2BD (L2
| ... | bridge-domain) switching is tested with MAC learning enabled. DUT1 and
...
| | ... | test. DUT runs L2BD config with 1 thread, 1 phy core, 1 receive queue
| | ... | per NIC port.
...
| | [Documentation]
| | ... | Verify ref-NDR for 64 Byte frames using single trial throughput
| | ... | test. DUT runs L2BD config with 2 thread, 2 phy core, 1 receive queue
| | ... | per NIC port.
...
| | [Documentation]
| | ... | Verify ref-NDR for 64 Byte frames using single trial throughput
| | ... | test. DUT runs L2BD config with 4 thread, 4 phy core, 2 receive queue
| | ... | per NIC port.
