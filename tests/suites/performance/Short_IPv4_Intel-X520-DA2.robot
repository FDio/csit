...
| ... | is tested with with two static IPv4 /24 route entries. DUT1 and DUT2
...
| TC07: Verify 64B ref-NDR at 2x 10.0Mpps - DUT IPv4 - 4threads, 4cores, 1rxq
| | [Documentation]
| | ... | Verify ref-NDR for 64 Byte frames using single trial throughput
| | ... | test. DUT runs IPv4 routing config with 2 threads, 2 phy cores, 2
...
| TC08: Verify 1518B ref-NDR at 2x 812.74kpps - DUT IPv4 - 4threads, 4cores, 1rxq
| | [Documentation]
| | ... | Verify ref-NDR for 1518 Byte frames using single trial throughput
| | ... | test. DUT runs IPv4 routing config with 2 threads, 2 phy cores, 2
| | ... | receive queues per NIC port.
...
| TC09: Verify 9000B ref-NDR at 2x 138.58kpps - DUT IPv4 - 4threads, 4cores, 1rxq
| | [Documentation]
| | ... | Verify ref-NDR for 9000 Byte frames using single trial throughput
| | ... | test. DUT runs IPv4 routing config with 2 threads, 2 phy cores, 2
| | ... | receive queues per NIC port.
