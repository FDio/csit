...
| ... | with two static IPv6 /64 route entries. DUT1 and DUT2 tested with
| ... | 2p10GE NIC X520 Niantic by Intel.

*** Test Cases ***
| TC01: Verify 72B ref-NDR at 2x 2.9Mpps - DUT IPv6 - 1thread 1core 1rxq
| | [Documentation]
| | ... | Verify ref-NDR for 72 Byte frames using single trial throughput
...
| TC04: Verify 72B ref-NDR at 2x 5.9Mpps - DUT IPv6 - 2thread 2core 1rxq
| | [Documentation]
| | ... | Verify ref-NDR for 72 Byte frames using single trial throughput
| | ... | test. DUT runs IPv6 routing config with 2 thread, 2 phy core, 1
| | ... | receive queue per NIC port.
...
| TC07: Verify 72B ref-NDR at 2x 7.3Mpps - DUT IPv6 - 4thread 4core 2rxq
| | [Documentation]
| | ... | Verify ref-NDR for 72 Byte frames using single trial throughput
| | ... | test. DUT runs IPv6 routing config with 4 thread, 4 phy core, 2
| | ... | receive queue per NIC port.
