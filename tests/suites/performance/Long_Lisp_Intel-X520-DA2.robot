...
| ... | IP protocol=61, IPv6 header and random payload. Ethernet header
...
| | ${min_rate}= | Set Variable | 10
| | ${max_rate}= | Set Variable | 100
...
| | [Tags] | 1_THREAD_NOHTT_RSS_1 | SINGLE_THREAD | PDR | LISP_IPv4
| | ${framesize}= | Set Variable | 64
...
| | ... | 0.5 percent of transmitted packets.
| | [Tags] | 2_THREAD_NOHTT_RSS_1 | MULTI_THREAD | PDR | LISP_IPv4
| | ${framesize}= | Set Variable | 64
| | ${min_rate}= | Set Variable | 100000
| | ${max_rate}= | Set Variable | ${10Ge_linerate_pps_64B}
| | ${binary_min}= | Set Variable | ${min_rate}
...
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD | PDR | LISP_IPv4
| | ${framesize}= | Set Variable | 64
| | ${min_rate}= | Set Variable | 100000
| | ${max_rate}= | Set Variable | ${10Ge_linerate_pps_64B}
| | ${binary_min}= | Set Variable | ${min_rate}
...
| | ... | binary search with threshold 0.1Mpps. Loss acceptance is set to 0.5
| | ... | percent of transmitted packets.
| | [Tags] | 1_THREAD_NOHTT_RSS_1 | SINGLE_THREAD | PDR | LISP_IPv6
| | ${framesize}= | Set Variable | 78
| | ${min_rate}= | Set Variable | 100000
...
| | ... | using binary search with threshold 10,000pps. Loss acceptance is set
| | ... | to 0.5 percent of transmitted packets.
| | [Tags] | 2_THREAD_NOHTT_RSS_1 | MULTI_THREAD | PDR | LISP_IPv6
| | ${framesize}= | Set Variable | 78
| | ${min_rate}= | Set Variable | 100000
| | ${max_rate}= | Set Variable | ${10Ge_linerate_pps_78B}
| | ${binary_min}= | Set Variable | ${min_rate}
...
| | ... | frames by using binary search with threshold 0.1Mpps. Loss acceptance
| | ... | is set to 0.5 percent of transmitted packets.
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD | PDR | LISP_IPv6
| | ${framesize}= | Set Variable | 78
| | ${min_rate}= | Set Variable | 100000
| | ${max_rate}= | Set Variable | ${10Ge_linerate_pps_78B}
| | ${binary_min}= | Set Variable | ${min_rate}
...
| | ... | binary search with threshold 0.1Mpps. Loss acceptance is set to 0.5
| | ... | percent of transmitted packets.
| | [Tags] | 1_THREAD_NOHTT_RSS_1 | SINGLE_THREAD | PDR | LISP_IPv4oIPv6
| | ${framesize}= | Set Variable | 64
| | ${min_rate}= | Set Variable | 100000
| | ${max_rate}= | Set Variable | ${10Ge_linerate_pps_64B}
| | ${binary_min}= | Set Variable | ${min_rate}
...
| Find NDR by using RFC2544 binary search and 1518B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput with non drop rate for 1518B frames by using
| | ... | binary search with threshold 10,000pps.
| | [Tags] | 1_THREAD_NOHTT_RSS_1 | SINGLE_THREAD | NDR | LISP_IPv4oIPv6
...
| Find PDR by using RFC2544 binary search and 1518B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput with partial drop rate for 1518B frames by using
| | ... | binary search with threshold 10,000pps. Loss acceptance is set to 0.5
| | ... | percent of transmitted packets.
...
| Find NDR with 2 cores and rss 1 by using RFC2544 binary search and 64B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with non drop rate for 64B frames by using
| | ... | binary search with threshold 0.1Mpps.
...
| Find PDR with 2 cores and rss 1 by using RFC2544 binary search and 64B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with partial drop rate for 64B frames by
| | ... | using binary search with threshold 0.1Mpps. Loss acceptance is set to
| | ... | 0.5 percent of transmitted packets.
| | [Tags] | 2_THREAD_NOHTT_RSS_1 | MULTI_THREAD | PDR | LISP_IPv4oIPv6
| | ${framesize}= | Set Variable | 64
| | ${min_rate}= | Set Variable | 100000
| | ${max_rate}= | Set Variable | ${10Ge_linerate_pps_64B}
| | ${binary_min}= | Set Variable | ${min_rate}
...
| Find NDR with 2 cores and rss 1 by using RFC2544 binary search and 1518B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with non drop rate for 1518B frames by
| | ... | using binary search with threshold 10,000pps.
| | [Tags] | 2_THREAD_NOHTT_RSS_1 | MULTI_THREAD | NDR | LISP_IPv4oIPv6
...
| Find PDR with 2 cores and rss 1 by using RFC2544 binary search and 1518B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with partial drop rate for 1518B frames by
| | ... | using binary search with threshold 10,000pps. Loss acceptance is set
| | ... | to 0.5 percent of transmitted packets.
...
| Find NDR with 2 cores and rss 1 by using RFC2544 binary search and 9000B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with non drop rate for 9000B frames by
| | ... | using binary search with threshold 5,000pps.
| | [Tags] | 2_THREAD_NOHTT_RSS_1 | MULTI_THREAD | NDR | LISP_IPv4oIPv6
...
| Find PDR with 2 cores and rss 1 by using RFC2544 binary search and 9000B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with partial drop rate for 9000B frames by
| | ... | using binary search with threshold 5,000pps. Loss acceptance is set
| | ... | to 0.5 percent of transmitted packets.
...
| Find NDR with 4 cores and rss 2 by using RFC2544 binary search and 64B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rss 2 with non drop rate for 64B
| | ... | frames by using binary search with threshold 0.1Mpps.
...
| | ... | frames by using binary search with threshold 0.1Mpps. Loss acceptance
| | ... | is set to 0.5 percent of transmitted packets.
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD | PDR | LISP_IPv4oIPv6
| | ${framesize}= | Set Variable | 64
| | ${min_rate}= | Set Variable | 100000
| | ${max_rate}= | Set Variable | ${10Ge_linerate_pps_64B}
| | ${binary_min}= | Set Variable | ${min_rate}
...
| Find NDR with 4 cores and rss 2 by using RFC2544 binary search and 1518B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rss 2 with non drop rate for 1518B
| | ... | frames by using binary search with threshold 10,000pps.
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD | NDR | LISP_IPv4oIPv6
...
| Find PDR with 4 cores and rss 2 by using RFC2544 binary search and 1518B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rss 2 with partial drop rate for 1518B
| | ... | frames by using binary search with threshold 10,000pps. Loss
| | ... | acceptance is set to 0.5 percent of transmitted packets.
...
| Find NDR with 4 cores and rss 2 by using RFC2544 linear search and 9000B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rss 2 with non drop rate for 9000B
| | ... | frames by using binary search with threshold 5,000pps.
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD | NDR | LISP_IPv4oIPv6
...
| Find PDR with 4 cores and rss 2 by using RFC2544 linear search and 9000B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rss 2 with partial drop rate for 9000B
| | ... | frames by using binary search with threshold 5,000pps. Loss
| | ... | acceptance is set to 0.5 percent of transmitted packets.
...
| Find NDR by using RFC2544 binary search and 1518B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput with non drop rate for 1518B frames by using
| | ... | binary search with threshold 10,000pps.
| | [Tags] | 1_THREAD_NOHTT_RSS_1 | SINGLE_THREAD | NDR | LISP_IPv4oIPv6
...
| Find PDR by using RFC2544 binary search and 1518B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput with partial drop rate for 1518B frames by using
| | ... | binary search with threshold 10,000pps. Loss acceptance is set to 0.5
| | ... | percent of transmitted packets.
...
| Find NDR with 2 cores and rss 1 by using RFC2544 binary search and 78B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with non drop rate for 78B frames by using
| | ... | binary search with threshold 0.1Mpps.
| | [Tags] | 2_THREAD_NOHTT_RSS_1 | MULTI_THREAD | NDR | LISP_IPv4oIPv6
...
| Find PDR with 2 cores and rss 1 by using RFC2544 binary search and 78B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with partial drop rate for 78B frames by
| | ... | using binary search with threshold 10,000pps. Loss acceptance is set
| | ... | to 0.5 percent of transmitted packets.
...
| Find NDR with 2 cores and rss 1 by using RFC2544 binary search and 1518B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with non drop rate for 1518B frames by
| | ... | using binary search with threshold 10,000pps.
| | [Tags] | 2_THREAD_NOHTT_RSS_1 | MULTI_THREAD | NDR | LISP_IPv4oIPv6
...
| Find PDR with 2 cores and rss 1 by using RFC2544 binary search and 1518B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with partial drop rate for 1518B frames by
| | ... | using binary search with threshold 10,000pps. Loss acceptance is set
| | ... | to 0.5 percent of transmitted packets.
...
| Find NDR with 2 cores and rss 1 by using RFC2544 binary search and 9000B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with non drop rate for 9000B frames by
| | ... | using binary search with threshold 5,000pps.
| | [Tags] | 2_THREAD_NOHTT_RSS_1 | MULTI_THREAD | NDR | LISP_IPv4oIPv6
...
| Find PDR with 2 cores and rss 1 by using RFC2544 binary search and 9000B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with partial drop rate for 9000B frames by
| | ... | using binary search with threshold 5,000pps. Loss acceptance is set
| | ... | to 0.5 percent of transmitted packets.
...
| Find NDR with 4 cores and rss 2 by using RFC2544 binary search and 78B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rss 2 with non drop rate for 78B
| | ... | frames by using binary search with threshold 0.1Mpps.
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD | NDR | LISP_IPv4oIPv6
...
| Find PDR with 4 cores and rss 2 by using RFC2544 binary search and 78B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rss 2 with partial drop rate for 78B
| | ... | frames by using binary search with threshold 0.1Mpps. Loss acceptance
| | ... | is set to 0.5 percent of transmitted packets.
...
| Find NDR with 4 cores and rss 2 by using RFC2544 binary search and 1518B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rss 2 with non drop rate for 1518B
| | ... | frames by using binary search with threshold 10,000pps.
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD | NDR | LISP_IPv4oIPv6
...
| Find PDR with 4 cores and rss 2 by using RFC2544 binary search and 1518B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rss 2 with partial drop rate for 1518B
| | ... | frames by using binary search with threshold 10,000pps. Loss
| | ... | acceptance is set to 0.5 percent of transmitted packets.
...
| Find NDR with 4 cores and rss 2 by using RFC2544 linear search and 9000B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rss 2 with non drop rate for 9000B
| | ... | frames by using linear search starting at 138,580pps, stepping down
| | ... | with step of 5,000pps.
...
| Find PDR with 4 cores and rss 2 by using RFC2544 linear search and 9000B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rss 2 with partial drop rate for 9000B
| | ... | frames by using binary search with threshold 5,000pps. Loss
| | ... | acceptance is set to 0.5 percent of transmitted packets.
