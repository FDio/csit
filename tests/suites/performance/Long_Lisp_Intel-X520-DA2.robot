...
| Find NDR with 2 cores and rxqueues 1 by using RFC2544 binary search and 1518B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with non drop rate for 1518B frames by
| | ... | using binary search with threshold 10,000pps.
| | [Tags] | 2_THREAD_NOHTT_RSS_1 | MULTI_THREAD | NDR | LISP_IPv4oIPv6
...
| Find PDR with 2 cores and rxqueues 1 by using RFC2544 binary search and 1518B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with partial drop rate for 1518B frames by
| | ... | using binary search with threshold 10,000pps. Loss acceptance is set
| | ... | to 0.5 percent of transmitted packets.
...
| Find NDR with 4 cores and rxqueues 2 by using RFC2544 binary search and 1518B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rxqueues 2 with non drop rate for 1518B
| | ... | frames by using binary search with threshold 10,000pps.
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD | NDR | LISP_IPv4oIPv6
...
| Find PDR with 4 cores and rxqueues 2 by using RFC2544 binary search and 1518B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rxqueues 2 with partial drop rate for 1518B
| | ... | frames by using binary search with threshold 10,000pps. Loss
| | ... | acceptance is set to 0.5 percent of transmitted packets.
...
| Find NDR with 2 cores and rxqueues 1 by using RFC2544 binary search and 1518B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with non drop rate for 1518B frames by
| | ... | using binary search with threshold 10,000pps.
| | [Tags] | 2_THREAD_NOHTT_RSS_1 | MULTI_THREAD | NDR | LISP_IPv4oIPv6
...
| Find PDR with 2 cores and rxqueues 1 by using RFC2544 binary search and 1518B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with partial drop rate for 1518B frames by
| | ... | using binary search with threshold 10,000pps. Loss acceptance is set
| | ... | to 0.5 percent of transmitted packets.
...
| Find NDR with 4 cores and rxqueues 2 by using RFC2544 binary search and 1518B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rxqueues 2 with non drop rate for 1518B
| | ... | frames by using binary search with threshold 10,000pps.
| | [Tags] | 4_THREAD_NOHTT_RSS_2 | MULTI_THREAD | NDR | LISP_IPv4oIPv6
...
| Find PDR with 4 cores and rxqueues 2 by using RFC2544 binary search and 1518B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rxqueues 2 with partial drop rate for 1518B
| | ... | frames by using binary search with threshold 10,000pps. Loss
| | ... | acceptance is set to 0.5 percent of transmitted packets.
