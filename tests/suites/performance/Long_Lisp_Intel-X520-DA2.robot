...
| Find NDR by using RFC2544 binary search and 1470B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput with non drop rate for 1470B frames by using
| | ... | binary search with threshold 10,000pps.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | NDR | LISP_IPv4oIPv6
| | ${framesize}= | Set Variable | 1470
| | ${min_rate}= | Set Variable | 10000
| | ${max_rate}= | Set Variable | ${10Ge_lisp_iph_linerate_pps_1470B}
| | ${binary_min}= | Set Variable | ${min_rate}
| | ${binary_max}= | Set Variable | ${max_rate}
| | ${threshold}= | Set Variable | ${min_rate}
| | Given Add '1' worker threads and rxqueues '1' without HTT to all DUTs
...
| Find PDR by using RFC2544 binary search and 1470B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput with partial drop rate for 1470B frames by using
| | ... | binary search with threshold 10,000pps. Loss acceptance is set to 0.5
| | ... | percent of transmitted packets.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | PDR | LISP_IPv4oIPv6
| | ${framesize}= | Set Variable | 1470
...
| Find NDR with 2 cores and rxqueues 1 by using RFC2544 binary search and 1470B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with non drop rate for 1470B frames by
| | ... | using binary search with threshold 10,000pps.
| | [Tags] | 2_THREAD_NOHTT_RXQUEUES_1 | MULTI_THREAD | NDR | LISP_IPv4oIPv6
| | ${framesize}= | Set Variable | 1470
| | ${min_rate}= | Set Variable | 10000
...
| Find PDR with 2 cores and rxqueues 1 by using RFC2544 binary search and 1470B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with partial drop rate for 1470B frames by
| | ... | using binary search with threshold 10,000pps. Loss acceptance is set
| | ... | to 0.5 percent of transmitted packets.
| | [Tags] | 2_THREAD_NOHTT_RXQUEUES_1 | MULTI_THREAD | PDR | LISP_IPv4oIPv6
| | ${framesize}= | Set Variable | 1470
...
| Find NDR with 4 cores and rxqueues 2 by using RFC2544 binary search and 1470B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rxqueues 2 with non drop rate for 1470B
| | ... | frames by using binary search with threshold 10,000pps.
| | [Tags] | 4_THREAD_NOHTT_RXQUEUES_2 | MULTI_THREAD | NDR | LISP_IPv4oIPv6
| | ${framesize}= | Set Variable | 1470
| | ${min_rate}= | Set Variable | 10000
...
| Find PDR with 4 cores and rxqueues 2 by using RFC2544 binary search and 1470B frames through IPv4 over IPv6 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rxqueues 2 with partial drop rate
| | ... | for 1470B frames by using binary search with threshold 10,000pps.
| | ... | Loss acceptance is set to 0.5 percent of transmitted packets.
| | [Tags] | 4_THREAD_NOHTT_RXQUEUES_2 | MULTI_THREAD | PDR | LISP_IPv4oIPv6
| | ${framesize}= | Set Variable | 1470
| | ${min_rate}= | Set Variable | 10000
...
| Find NDR by using RFC2544 binary search and 1470B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput with non drop rate for 1470B frames by using
| | ... | binary search with threshold 10,000pps.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | NDR | LISP_IPv6oIPv4
...
| Find PDR by using RFC2544 binary search and 1470B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput with partial drop rate for 1470B frames by using
| | ... | binary search with threshold 10,000pps. Loss acceptance is set to 0.5
| | ... | percent of transmitted packets.
...
| Find NDR with 2 cores and rxqueues 1 by using RFC2544 binary search and 1470B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with non drop rate for 1470B frames by
| | ... | using binary search with threshold 10,000pps.
| | [Tags] | 2_THREAD_NOHTT_RXQUEUES_1 | MULTI_THREAD | NDR | LISP_IPv6oIPv4
...
| Find PDR with 2 cores and rxqueues 1 by using RFC2544 binary search and 1470B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 2 cores with partial drop rate for 1470B frames by
| | ... | using binary search with threshold 10,000pps. Loss acceptance is set
| | ... | to 0.5 percent of transmitted packets.
...
| Find NDR with 4 cores and rxqueues 2 by using RFC2544 binary search and 1470B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rxqueues 2 with non drop rate for 1470B
| | ... | frames by using binary search with threshold 10,000pps.
| | [Tags] | 4_THREAD_NOHTT_RXQUEUES_2 | MULTI_THREAD | NDR | LISP_IPv6oIPv4
...
| Find PDR with 4 cores and rxqueues 2 by using RFC2544 binary search and 1470B frames through IPv6 over IPv4 forwarding in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rxqueues 2 with partial drop rate
| | ... | for 1470B frames by using binary search with threshold 10,000pps.
| | ... | Loss acceptance is set to 0.5 percent of transmitted packets.
