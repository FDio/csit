...
| ... | Baseline packet throughput performance of DUTs configured with IPv4
| ... | routing and IPv4 security iAcl whitelist ingress filtering applied on
| ... | links TG - DUT1 and DUT2 - TG, is tested with two static IPv4 /24 route
| ... | entries and additional L3 Classify table whitelist for single entry and
| ... | IPv4.dst masking.
...
| | ... | and whitelist filters config with 1 thread, 1 phy core,
...
| | ... | RFC2544: Find NDR for 64 Byte frames using binary search
| | ... | start at 10GE linerate, step 100kpps. DUT runs IPv4 routing
| | ... | and whitelist filters config with 2 threads, 2 phy cores,
| | ... | 1 receive queue per NIC port.
...
| | ... | RFC2544: Find NDR for 64 Byte frames using binary search
| | ... | start at 10GE linerate, step 100kpps. DUT runs IPv4 routing
| | ... | and whitelist filters config with 4 threads, 4 phy cores,
