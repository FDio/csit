...
| Find NDR with 2 cores and rxqueues 1 by using RFC2544 binary search and 64B frames through IPv4 forwarding with iAcl in 3-node topology
| | [Documentation]
...
| Find PDR with 2 cores and rxqueues 1 by using RFC2544 binary search and 64B frames through IPv4 forwarding with iAcl in 3-node topology
| | [Documentation]
...
| Find NDR with 2 cores and rxqueues 1 by using RFC2544 binary search and 1518B frames through IPv4 forwarding with iAcl in 3-node topology
| | [Documentation]
...
| Find PDR with 2 cores and rxqueues 1 by using RFC2544 binary search and 1518B frames through IPv4 forwarding with iAcl in 3-node topology
| | [Documentation]
...
| Find NDR with 2 cores and rxqueues 1 by using RFC2544 binary search and 9000B frames through IPv4 forwarding with iAcl in 3-node topology
| | [Documentation]
...
| Find PDR with 2 cores and rxqueues 1 by using RFC2544 binary search and 9000B frames through IPv4 forwarding with iAcl in 3-node topology
| | [Documentation]
...
| Find NDR with 4 cores and rxqueues 2 by using RFC2544 binary search and 64B frames through IPv4 forwarding with iAcl in 3-node topology
| | [Documentation]
...
| Find PDR with 4 cores and rxqueues 2 by using RFC2544 binary search and 64B frames through IPv4 forwarding with iAcl in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rxqueues 2 with partial drop rate for
| | ... | 64B frames by using binary search with threshold 0.1Mpps. Loss
...
| Find NDR with 4 cores and rxqueues 2 by using RFC2544 binary search and 1518B frames through IPv4 forwarding with iAcl in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rxqueues 2 with non drop rate for
| | ... | 1518B frames by using binary search with threshold 10,000pps.
| | [Tags] | 4_THREAD_NOHTT_RXQUEUES_2 | MULTI_THREAD | NDR
| | ${framesize}= | Set Variable | 1518
| | ${min_rate}= | Set Variable | 10000
| | ${max_rate}= | Set Variable | ${10Ge_linerate_pps_1518B}
...
| Find PDR with 4 cores and rxqueues 2 by using RFC2544 binary search and 1518B frames through IPv4 forwarding with iAcl in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rxqueues 2 with partial drop rate for
| | ... | 1518B frames by using binary search with threshold 10,000pps. Loss
| | ... | acceptance is set to 0.5 percent of transmitted packets.
| | [Tags] | 4_THREAD_NOHTT_RXQUEUES_2 | MULTI_THREAD | PDR
| | ${framesize}= | Set Variable | 1518
| | ${min_rate}= | Set Variable | 10000
...
| Find NDR with 4 cores and rxqueues 2 by using RFC2544 linear search and 9000B frames through IPv4 forwarding with iAcl in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rxqueues 2 with non drop rate for
| | ... | 9000B frames by using binary search with threshold 5,000pps.
| | [Tags] | 4_THREAD_NOHTT_RXQUEUES_2 | MULTI_THREAD | NDR
| | ${framesize}= | Set Variable | 9000
| | ${min_rate}= | Set Variable | 5000
| | ${max_rate}= | Set Variable | ${10Ge_linerate_pps_9000B}
...
| Find PDR with 4 cores and rxqueues 2 by using RFC2544 linear search and 9000B frames through IPv4 forwarding with iAcl in 3-node topology
| | [Documentation]
| | ... | Find throughput on 4 cores and rxqueues 2 with partial drop rate for
| | ... | 9000B frames by using binary search with threshold 5,000pps. Loss
| | ... | acceptance is set to 0.5 percent of transmitted packets.
| | [Tags] | 4_THREAD_NOHTT_RXQUEUES_2 | MULTI_THREAD | PDR
| | ${framesize}= | Set Variable | 9000
| | ${min_rate}= | Set Variable | 5000
