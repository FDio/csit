...
#| | Set Interface State | ${dut1} | ${vlan_int_index_1} | up
#| | Vpp Setup Bidirectional Cross Connect | ${dut1} | ${dut1_if1}
#| | ...                                   | ${vlan_int_index_1}
...
| | ...                                       | ${dut2_if1} | ${subid}
| | Set Interface State | ${dut2} | ${vlan_int_index_2} | up
| | Vpp Setup Bidirectional Cross Connect | ${dut2} | ${dut2_if1}
| | ...                                   | ${vlan_int_index_2}
