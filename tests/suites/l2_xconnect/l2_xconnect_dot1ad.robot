...
| | ${vlan_int_name} | ${vlan_int_index}= | Create Subinterface | ${dut2}
| | ...                                   | ${dut2_if2} | ${subid}
| | Set Interface State | ${dut2} | ${vlan_int_index} | up
| | L2 tag rewrite pop2 | ${dut2} | ${vlan_int_index}


| | Vpp Setup Bidirectional Cross Connect | ${dut2} | ${dut2_if1} | ${vlan_int_index}

| | L2 setup xconnect on DUT | ${dut1} | ${vlan_int_index} | ${dut1_if2} |
