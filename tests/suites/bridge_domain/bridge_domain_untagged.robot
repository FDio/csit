...
| | [Documentation] | TG-DUT Eth-IPv4-ICMPv4: On DUT configure L2 bridge-domain
...
| | [Documentation] | Eth-IPv4-ICMPv4 on links DUT1-DUT2, TG-DUT1, TG-DUT2: On
...
| | [Documentation] | Eth-IPv4-ICMPv4 on links DUT-VM, TG-DUT: On DUT configure
...
| | [Documentation] | Eth-IPv6-ICMPv6 on links DUT-VM, TG-DUT: On DUT configure
| | ...             | two L2 bridge-domains (MAC learning enabled), each with
| | ...             | one untagged interface to TG and untagged interface to
...
| | [Documentation] | Eth-IPv6-ICMPv4 on links DUT-VM, TG-DUT: On DUT configure
