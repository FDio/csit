...
| | Interfaces in Double-Link 3-node testing are UP
| | Setup Env - 2xVRF Each Node
| | Node replies to ICMP echo request | ${tg_node} | ${tg_to_dut1_if1}
| | ... | ${dut1_to_tg_if1_mac} | ${tg_to_dut1_if1_mac}
| | ... | ${dut1_to_dut2_ip1} | ${tg_dut1_ip1}
| | Node replies to ICMP echo request | ${tg_node} | ${tg_to_dut1_if2}
...
| | ... | ${tg_to_dut2_if1_mac}
| | Send Packet And Check Headers | ${tg_node}
...
| | Interfaces in Double-Link 3-node testing are UP
| | Setup Env - 2xVRF Each Node
| | Run Keyword And Expect Error | timeout | Node replies to ICMP echo request
