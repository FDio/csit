...
| ${dut1_to_tg_ip1}= | 10.0.0.4
| ${dut1_to_tg_ip2}= | 10.0.0.3
| ${dut2_to_tg_ip1}= | 10.0.0.5
| ${dut2_to_tg_ip2}= | 10.0.0.6
...
| ${tg_dut1_ip1}= | 10.0.0.2
| ${tg_dut1_ip2}= | 10.0.0.1
| ${tg_dut2_ip1}= | 10.0.0.7
| ${tg_dut2_ip2}= | 10.0.0.8
...
| | When Setup Env with 3 VRF
| | Then Node replies to ICMP echo request | ${tg_node}
| | ... | ${tg_to_dut1_if1} | ${dut1_to_tg_if1_mac}
| | ... | ${tg_to_dut1_if1_mac} | ${dut2_to_tg_ip1} | ${tg_dut1_ip1}

*** Keywords ***
| Setup Env with 3 VRF
...
| | Assign Interface To Fib Table
| | ... | ${dut2_node} | ${dut2_to_dut1_if2} | ${fib_table_1}
| | Assign Interface To Fib Table
| | ... | ${dut2_node} | ${dut2_to_tg_if1} | ${fib_table_1}
| | Assign Interface To Fib Table
| | ... | ${dut2_node} | ${dut2_to_tg_if2} | ${fib_table_1}
...
| | ... | ${tg_dut2_ip2} | ${tg_to_dut2_if2_mac} | vrf=${fib_table_1}
| | And Add Arp On Dut | ${dut2_node} | ${dut2_to_dut1_if2}
| | ... | ${dut1_to_dut2_ip2} | ${dut1_to_dut2_if2_mac} | vrf=${fib_table_1}

| | And Vpp Route Add | ${dut1_node} | ${dut2_to_tg_ip1} | ${ip_prefix}
