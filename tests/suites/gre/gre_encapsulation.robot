...
*** Settings ***
| Documentation | TBD #TODO: documentation
...
| | Given Path for 3-node testing is set | ${nodes['TG']} | ${nodes['DUT1']} | ${nodes['DUT2']}
...
| | And  IP addresses are set on interfaces
| |       ...         | ${dut1_node} | ${dut1_gre_interface} | ${dut1_gre_ip_address} | 24
| |       ...         | ${dut2_node} | ${dut2_gre_interface} | ${dut2_gre_ip_address} | 24
#| | And  IP Routes are set | ${dut1_node} | ${BID} | ${dut1s_to_tg} | ${dut1s_vxlan}


#| | Then Send and receive IPv4 | ${tg} | ${dut2_to_dut1} | ${tgs_to_dut2} | ${traffic_src_ip} | ${traffic_dst_ip}
