...
| | ${tx_dst_mac}= | And Get interface mac | ${dut1_node} | ${dut1_to_tg}
| | ${tx_src_mac}= | And Get interface mac | ${tg_node} | ${tg_to_dut1}
| | ${rx_dst_mac}= | And Get interface mac | ${tg_node} | ${tg_to_dut2}
| | ${rx_src_mac}= | And Get interface mac | ${dut2_node} | ${dut2_to_tg}
...
| |      ... | ${tg_to_dut1} | ${tx_src_mac} | ${tx_dst_mac}
| |      ... | ${tg_to_dut2} | ${rx_src_mac} | ${rx_dst_mac}
