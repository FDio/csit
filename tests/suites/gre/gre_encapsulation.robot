...
| | And   IP addresses are set on interfaces
| |       ... | ${dut1_node} | ${dut_to_tg_if2} | ${dut1_ip_address} | ${prefix}
| |       ... | ${dut1_node} | ${dut_to_tg_if1} | ${net1_gw_address} | ${prefix}
#TODO: set mac address
#| | ${dst_mac}= |
#| | And   set arp cache entree | ${dut_node} | ${dut_to_tg_if2} | ${dut2_ip_address} | ${mac}
| | ${dut1_gre_interface} | ${dut1_gre_index}=
| | | ... | When GRE tunnel interface is created and up
| | |     |      ... | ${dut1_node} | ${dut1_ip_address} | ${dut2_ip_address}
| | And  IP addresses are set on interfaces
...
| | And  Vpp Route Add | ${dut1_node} | ${net2_address} | ${prefix}
| |      ... | ${dut2_gre_ip} | ${dut1_gre_index}
| | Then Send and receive ICMPv4 and check GRE header | ${tg_node} | ${tg_to_dut1} | ${tg_to_dut2}
