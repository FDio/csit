...
| | And ACL table from VAT should be | ${node} | ${vat_acl_table2}
...
| | ... | ${node} | ${vat_acl_table['index']} | ${vat_acl_session}

| Honeycomb manages more than one ALC session on one table
...
| | ... | ${node} | ${acl_table['name']} | ${hc_acl_session2}
| | Then ACL session from Honeycomb should be
| | ... | ${node} | ${hc_acl_table['name']} | ${hc_acl_session}
| | And ACL session from VAT should be
| | ... | ${node} | ${vat_acl_table['index']} | ${vat_acl_session}
...
| | And ACL session from VAT should be
| | ... | ${node} | ${vat_acl_table['index']} | ${vat_acl_session2}

| Honeycomb enables L2 ACL on interface
| | [Documentation] | Check if Honeycomb API can enable L2 ACL on an interface.
| | Given ACL table from Honeycomb should be | ${node} | ${hc_acl_table}
| | And ACL session from Honeycomb should be
| | ... | ${node} | ${hc_acl_table['name']} | ${hc_acl_session}
...
| | ... | ${node} | ${interface} | ${vat_acl_table['index']}

| Honeycomb disables L2 ACL on interface
| | [Documentation] | Check if Honeycomb API can disable L2 ACL on an interface.
...
| | ... | ${node} | ${vat_acl_table['index']} | ${vat_acl_session}
| | And ACL session from Honeycomb should be
| | ... | ${node} | ${hc_acl_table2['name']} | ${hc_acl_session2}
| | And ACL session from VAT should be
| | ... | ${node} | ${vat_acl_table2['index']} | ${vat_acl_session2}
...
| | ... | ${node} | ${vat_acl_table['index']} | ${vat_acl_session2['index']}
