...
| ... | one link between the nodes. DUT1 and DUT2 are configured with
| ... | L2 Cross connect. DUT1 is configured with iACL on link to TG,
...
| ... | verifies if packets are dropped.
