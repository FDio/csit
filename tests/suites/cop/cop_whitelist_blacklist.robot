...
| | ${dst_mac}= | Get interface mac | ${tg} | ${tg_if2}
| | ${dut1_mac1}= | Get interface mac | ${dut1} | ${dut1_if1}
| | ${dut1_mac2}= | Get interface mac | ${dut1} | ${dut1_if2}

| | Given Add fib table | ${dut1} | ${cop_dut_ip} | ${cop_prefix} | 1 | local
| | And cop whitelist enable or disable | ${dut1} | ${dut1_if1} | ip4 | 1
| | And cop interface enable or disable | ${dut1} | ${dut1_if1} | enable
| | Then Send packet from Port to Port |
| | ... | ${tg} | ${test_src_ip} | ${test_dst_ip} | ${tg_if1} | ${src_mac} | ${dut1_mac1} | ${tg_if2} | ${dut1_mac2} | ${dst_mac}


| COP IPV4 Blacklist |
| | [Documentation] | Cop blacklist test
| | Append Nodes | ${nodes['TG']} | ${nodes['DUT1']} | ${nodes['DUT2']} | ${nodes['TG']}
| | Compute Path
| | ${tg_if1} | ${tg}= | Next Interface
| | ${dut1_if1} | ${dut1}= | Next Interface
...
| | Given Add fib table | ${dut1} | ${cop_dut_ip} | ${cop_prefix} | 1 | drop
| | And cop whitelist enable or disable | ${dut1} | ${dut1_if1} | ip4 | 1
| | And cop interface enable or disable | ${dut1} | ${dut1_if1} | enable
