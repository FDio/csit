...
*** Test Cases ***
| TC03: DUT permits IPv6 pkts with COP whitelist set with IPv6 src-addr
| | [Documentation] | Eth-IPv6-ICMPv6 on links TG-DUT1, TG-DUT2, DUT1-DUT2: On
| | ...             | DUT1 configure interface IPv6 addresses and routes in the
| | ...             | main routing domain. Add COP whitelist with IPv6 src-addr
| | ...             | matching packets generated by TG. On DUT2 configure L2
| | ...             | xconnect. Make TG send ICMPv6 Echo Req on its interface to
| | ...             | DUT1. Make TG verify received ICMPv6 Echo Replies are
| | ...             | correct.
...
| TC04: DUT drops IPv6 pkts with COP blacklist set with IPv6 src-addr
| | [Documentation] | Eth-IPv6-ICMPv6 on links TG-DUT1, TG-DUT2, DUT1-DUT2: On
| | ...             | DUT1 configure interface IPv6 addresses and routes in the
| | ...             | main routing domain. Add COP blacklist with IPv6 src-addr
| | ...             | matching packets generated by TG. On DUT2 configure L2
| | ...             | xconnect. Make TG send ICMPv6 Echo Req on its interface to
| | ...             | DUT1. Make TG verify blacklisted ICMPv6 Echo Replies are
| | ...             | dropped.
| | Given Path for 3-node testing is set
| | ... | ${tg_node} | ${dut1_node} | ${dut2_node} | ${tg_node}
| | And Interfaces in 3-node path are up
