...
| | ${vlan2_name} | ${vlan2_index}= | And Tagged Subinterface Created
| | ... | ${dut2_node} | ${dut2_to_dut1} | ${subid} | outer_vlan_id=${outer_vlan_id2} | inner_vlan_id=${inner_vlan_id2} | type_subif=two_tags dot1ad
| | And L2 Tag Rewrite Method Set On Interface | ${dut1_node} | ${vlan1_index} | translate-2-2 | tag1_id=${outer_vlan_id2} | tag2_id=${inner_vlan_id2}
| | And L2 Tag Rewrite Method Set On Interface | ${dut2_node} | ${vlan2_index} | pop-2
| | And Interfaces and VLAN sub-interfaces inter-connected using L2-xconnect
| | ... | ${dut1_node} | ${dut1_to_dut2} | ${vlan1_index}
| | ... | ${dut2_node} | ${dut2_to_tg} | ${vlan2_index}
...
| | ${vlan2_name} | ${vlan2_index}= | And Tagged Subinterface Created
| | ... | ${dut2_node} | ${dut2_to_dut1} | ${subid} | outer_vlan_id=${outer_vlan_id2} | inner_vlan_id=${inner_vlan_id2} | type_subif=two_tags dot1ad
| | And L2 Tag Rewrite Method Set On Interface | ${dut1_node} | ${vlan1_index} | translate-2-2 | tag1_id=${outer_vlan_id2} | tag2_id=${inner_vlan_wrong}
| | And L2 Tag Rewrite Method Set On Interface | ${dut2_node} | ${vlan2_index} | pop-2
| | And Interfaces and VLAN sub-interfaces inter-connected using L2-xconnect
| | ... | ${dut1_node} | ${dut1_to_dut2} | ${vlan1_index}
| | ... | ${dut2_node} | ${dut2_to_tg} | ${vlan2_index}
...
| | ${vlan2_name} | ${vlan2_index}= | And Tagged Subinterface Created
| | ... | ${dut2_node} | ${dut2_to_dut1} | ${subid} | outer_vlan_id=${outer_vlan_id2} | inner_vlan_id=${inner_vlan_id2} | type_subif=two_tags dot1ad
| | And L2 Tag Rewrite Method Set On Interface | ${dut1_node} | ${vlan1_index} | translate-2-2 | tag1_id=${outer_vlan_wrong} | tag2_id=${inner_vlan_id2}
| | And L2 Tag Rewrite Method Set On Interface | ${dut2_node} | ${vlan2_index} | pop-2
| | And Interfaces and VLAN sub-interfaces inter-connected using L2-xconnect
| | ... | ${dut1_node} | ${dut1_to_dut2} | ${vlan1_index}
| | ... | ${dut2_node} | ${dut2_to_tg} | ${vlan2_index}
...
| | ${vlan2_name} | ${vlan2_index}= | And Tagged Subinterface Created
| | ... | ${dut2_node} | ${dut2_to_dut1} | ${subid} | outer_vlan_id=${outer_vlan_id2} | inner_vlan_id=${inner_vlan_id2} | type_subif=two_tags dot1ad
| | And L2 Tag Rewrite Method Set On Interface | ${dut1_node} | ${vlan1_index} | translate-2-2 | tag1_id=${outer_vlan_wrong} | tag2_id=${inner_vlan_wrong}
| | And L2 Tag Rewrite Method Set On Interface | ${dut2_node} | ${vlan2_index} | pop-2
| | And Interfaces and VLAN sub-interfaces inter-connected using L2-xconnect
| | ... | ${dut1_node} | ${dut1_to_dut2} | ${vlan1_index}
| | ... | ${dut2_node} | ${dut2_to_tg} | ${vlan2_index}
