...
| | And L2 Tag Rewrite Method Set On Interface | ${dut1_node} | ${vlan1_index} | translate-1-2 | push_dot1q=${True} | ${outer_vlan_id2} | ${inner_vlan_id2}
...
| | [Arguments] | ${dut_node} | ${interface} | ${tag_rewrite_method} | push_dot1q=${False} | ${tag1_id}=${None} | ${tag2_id}=${None}
...
| | L2 Tag Rewrite | ${dut_node} | ${interface_name} | ${tag_rewrite_method} | ${push_dot1q} | ${tag1_id} | ${tag2_id}
