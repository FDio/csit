...
| | And L2 Tag Rewrite Method Set On Interface | ${dut1_node} | ${vlan1_index} | translate-1-1 | ${outer_vlan_id2}
...
| | ${vlan2_name} | ${vlan2_index}= | And Vlan Subinterface Created
| | ... | ${dut2_node} | ${dut2_to_dut1} | ${outer_vlan_id2}
| | And L2 Tag Rewrite Method Set On Interface | ${dut1_node} | ${vlan1_index} | translate-1-1 | ${outer_vlan_wrong}
| | And L2 Tag Rewrite Method Set On Interface | ${dut2_node} | ${vlan2_index} | pop-1
| | And Interfaces and VLAN sub-interfaces inter-connected using L2-xconnect
| | ... | ${dut1_node} | ${dut1_to_dut2} | ${vlan1_index}
| | ... | ${dut2_node} | ${dut2_to_tg} | ${vlan2_index}
...
| | ... | ${dut2_node} | ${dut2_to_dut1} | ${subid} | outer_vlan_id=${outer_vlan_id2} | inner_vlan_id=${inner_vlan_id2} | type_subif=dot1ad
#| | ... | ${dut2_node} | ${dut2_to_dut1} | ${subid} | outer_vlan_id=${outer_vlan_id2} | inner_vlan_id=${inner_vlan_id2} | type_subif=two_tags
| | And L2 Tag Rewrite Method Set On Interface | ${dut1_node} | ${vlan1_index} | translate-1-2 | push_dot1q_disable=${True} | tag1_id=${outer_vlan_id2} | tag2_id=${inner_vlan_id2}
...
| | [Arguments] | ${dut_node} | ${interface} | ${tag_rewrite_method} | ${push_dot1q_disable}=${False} | ${tag1_id}=${None} | ${tag2_id}=${None}
...
| | L2 Tag Rewrite | ${dut_node} | ${interface_name} | ${tag_rewrite_method} | push_dot1q_disable=${push_dot1q_disable} | tag1_id=${tag1_id} | tag2_id=${tag2_id}
