...
| | ${vlan11_name} | ${vlan11_index}= | Create Vlan Subinterface
| | ... | ${dut1_node} | ${dut1_to_tg_name} | ${outer_vlan_id1}
| | ${dut1_to_dut2_name}= | Get interface name | ${dut1_node} | ${dut1_to_dut2}
| | ${vlan12_name} | ${vlan12_index}= | Create Vlan Subinterface
| | ... | ${dut1_node} | ${dut1_to_dut2_name} | ${outer_vlan_id2}
| | ${dut2_to_dut1_name}= | Get interface name | ${dut1_node} | ${dut2_to_dut1}
| | ${vlan2_name} | ${vlan2_index}= | Create Vlan Subinterface
| | ... | ${dut2_node} | ${dut2_to_dut1_name} | ${outer_vlan_id2}
#| | ${dut1_to_tg_name}= | Get interface name | ${dut1_node} | ${dut1_to_tg}
#| | L2 Tag Rewrite | ${dut1_node} | ${dut1_to_tg_name} | push-1 | ${outer_vlan_id1}
#| | ${dut2_to_tg_name}= | Get interface name | ${dut1_node} | ${dut2_to_tg}
| | L2 Tag Rewrite | ${dut1_node} | ${vlan11_index} | translate-1-1 | ${outer_vlan_id2}
| | L2 Tag Rewrite | ${dut2_node} | ${vlan12_index} | pop-1
| | And Interfaces and VLAN sub-interfaces inter-connected using L2-xconnect
| | ... | ${dut1_node} | ${vlan11_index} | ${vlan12_index}
