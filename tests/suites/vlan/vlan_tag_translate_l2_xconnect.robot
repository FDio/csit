...
| | ${vlan22_name} | ${vlan22_index}= | Vlan Subinterface Created
| | ... | ${dut2_node} | ${dut2_to_tg} | ${outer_vlan_id2}
| | L2 Tag Rewrite Method Set On Interface | ${dut1_node} | ${dut1_to_tg} | push-1 | ${outer_vlan_id1}
| | L2 Tag Rewrite Method Set On Interface | ${dut2_node} | ${vlan2_index} | translate-1-1 | ${outer_vlan_id2}
#| | L2 Tag Rewrite Method Set On Interface | ${dut2_node} | ${vlan22_index} | pop-1
| | And Interfaces and VLAN sub-interfaces inter-connected using L2-xconnect
| | ... | ${dut1_node} | ${dut1_to_tg} | ${vlan1_index}
| | ... | ${dut2_node} | ${vlan22_index} | ${vlan2_index}
...
| | ${interface_name}= | Get interface name | ${dut_node} | ${interface}
| | ${subif_name} | ${subif_index}= | Create Subinterface
| | ... | ${dut_node} | ${interface_name} | ${subif_id} | type_subif=no_tags
