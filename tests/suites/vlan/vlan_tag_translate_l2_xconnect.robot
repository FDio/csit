...
| | ... | ${dut2_node} | ${dut2_to_tg} | ${vlan2_index}
| | Then Send and receive ICMP Packet
| | ... | ${tg_node} | ${tg_to_dut1} | ${tg_to_dut2} | encaps=Dot1ad | vlan1=${outer_vlan_id1} | vlan2=${inner_vlan_id1}

| TC08: DUT1 and DUT2 with L2XC and VLAN translate-2-1 switch ICMPv4 between two TG links
| | [Documentation]
| | ... | [Top] TG-DUT1-DUT2-TG. [Enc] Eth-dot1ad-IPv4-ICMPv4 on \
| | ... | DUT1-DUT2, Eth-IPv4-ICMPv4 on TG-DUTn. [Cfg] On DUT1 and DUT2
| | ... | configure L2 cross-connect (L2XC), each with one interface to TG
...
| | ${vlan2_name} | ${vlan2_index}= | And Vlan Subinterface Created
| | ... | ${dut2_node} | ${dut2_to_dut1} | ${outer_vlan_id2}
| | And L2 Tag Rewrite Method Set On Interface | ${dut1_node} | ${vlan1_index} | translate-2-1 | tag1_id=${outer_vlan_wrong}
| | And L2 Tag Rewrite Method Set On Interface | ${dut2_node} | ${vlan2_index} | pop-1
| | And Interfaces and VLAN sub-interfaces inter-connected using L2-xconnect
| | ... | ${dut1_node} | ${dut1_to_dut2} | ${vlan1_index}
| | ... | ${dut2_node} | ${dut2_to_tg} | ${vlan2_index}
| | Then Run Keyword And Expect Error | ICMP echo Rx timeout
| | ... | Send and receive ICMP Packet | ${tg_node} | ${tg_to_dut1} | ${tg_to_dut2} | encaps=Dot1ad | vlan1=${outer_vlan_id1} | vlan2=${inner_vlan_id1}
...
| | ${vlan2_name} | ${vlan2_index}= | And Tagged Subinterface Created
| | ... | ${dut2_node} | ${dut2_to_dut1} | ${subid} | outer_vlan_id=${outer_vlan_id2} | inner_vlan_id=${inner_vlan_id2} | type_subif=two_tags dot1ad
| | And L2 Tag Rewrite Method Set On Interface | ${dut1_node} | ${vlan1_index} | translate-2-2 | push_dot1q=Disabled | tag1_id=${outer_vlan_id2} | tag2_id=${inner_vlan_id2}
| | And L2 Tag Rewrite Method Set On Interface | ${dut2_node} | ${vlan2_index} | pop-2
| | And Interfaces and VLAN sub-interfaces inter-connected using L2-xconnect
| | ... | ${dut1_node} | ${dut1_to_dut2} | ${vlan1_index}
| | ... | ${dut2_node} | ${dut2_to_tg} | ${vlan2_index}
...
| TC10: DUT1 and DUT2 with L2XC and VLAN translate-2-2 switch ICMPv4 between two TG links - wrong inner tag used
| | [Documentation]
| | ... | [Top] TG-DUT1-DUT2-TG. [Enc] Eth-dot1ad-IPv4-ICMPv4 on \
| | ... | DUT1-DUT2, Eth-IPv4-ICMPv4 on TG-DUTn. [Cfg] On DUT1 and DUT2
| | ... | configure L2 cross-connect (L2XC), each with one interface to TG
...
| | ${vlan2_name} | ${vlan2_index}= | And Tagged Subinterface Created
| | ... | ${dut2_node} | ${dut2_to_dut1} | ${subid} | outer_vlan_id=${outer_vlan_id2} | inner_vlan_id=${inner_vlan_id2} | type_subif=two_tags dot1ad
| | And L2 Tag Rewrite Method Set On Interface | ${dut1_node} | ${vlan1_index} | translate-2-2 | push_dot1q=Disabled | tag1_id=${outer_vlan_id2} | tag2_id=${inner_vlan_wrong}
| | And L2 Tag Rewrite Method Set On Interface | ${dut2_node} | ${vlan2_index} | pop-2
| | And Interfaces and VLAN sub-interfaces inter-connected using L2-xconnect
| | ... | ${dut1_node} | ${dut1_to_dut2} | ${vlan1_index}
| | ... | ${dut2_node} | ${dut2_to_tg} | ${vlan2_index}
...
| TC11: DUT1 and DUT2 with L2XC and VLAN translate-2-2 switch ICMPv4 between two TG links - wrong outer tag used
| | [Documentation]
| | ... | [Top] TG-DUT1-DUT2-TG. [Enc] Eth-dot1ad-IPv4-ICMPv4 on \
| | ... | DUT1-DUT2, Eth-IPv4-ICMPv4 on TG-DUTn. [Cfg] On DUT1 and DUT2
| | ... | configure L2 cross-connect (L2XC), each with one interface to TG
...
| | ${vlan2_name} | ${vlan2_index}= | And Tagged Subinterface Created
| | ... | ${dut2_node} | ${dut2_to_dut1} | ${subid} | outer_vlan_id=${outer_vlan_id2} | inner_vlan_id=${inner_vlan_id2} | type_subif=two_tags dot1ad
| | And L2 Tag Rewrite Method Set On Interface | ${dut1_node} | ${vlan1_index} | translate-2-2 | push_dot1q=Disabled | tag1_id=${outer_vlan_wrong} | tag2_id=${inner_vlan_id2}
| | And L2 Tag Rewrite Method Set On Interface | ${dut2_node} | ${vlan2_index} | pop-2
| | And Interfaces and VLAN sub-interfaces inter-connected using L2-xconnect
| | ... | ${dut1_node} | ${dut1_to_dut2} | ${vlan1_index}
| | ... | ${dut2_node} | ${dut2_to_tg} | ${vlan2_index}
...
| TC12: DUT1 and DUT2 with L2XC and VLAN translate-2-2 switch ICMPv4 between two TG links - wrong outer and inner tags used
| | [Documentation]
| | ... | [Top] TG-DUT1-DUT2-TG. [Enc] Eth-dot1ad-IPv4-ICMPv4 on \
| | ... | DUT1-DUT2, Eth-IPv4-ICMPv4 on TG-DUTn. [Cfg] On DUT1 and DUT2
| | ... | configure L2 cross-connect (L2XC), each with one interface to TG
...
| | ${vlan2_name} | ${vlan2_index}= | And Tagged Subinterface Created
| | ... | ${dut2_node} | ${dut2_to_dut1} | ${subid} | outer_vlan_id=${outer_vlan_id2} | inner_vlan_id=${inner_vlan_id2} | type_subif=two_tags dot1ad
| | And L2 Tag Rewrite Method Set On Interface | ${dut1_node} | ${vlan1_index} | translate-2-2 | push_dot1q=Disabled | tag1_id=${outer_vlan_wrong} | tag2_id=${inner_vlan_wrong}
| | And L2 Tag Rewrite Method Set On Interface | ${dut2_node} | ${vlan2_index} | pop-2
| | And Interfaces and VLAN sub-interfaces inter-connected using L2-xconnect
| | ... | ${dut1_node} | ${dut1_to_dut2} | ${vlan1_index}
| | ... | ${dut2_node} | ${dut2_to_tg} | ${vlan2_index}
