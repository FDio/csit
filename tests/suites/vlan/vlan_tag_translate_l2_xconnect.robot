...
| | L2 Tag Rewrite | ${dut2_node} | ${dut2_to_tg_name} | translate-1-1 | ${outer_vlan_id2}
| | And Interfaces and VLAN sub-interfaces inter-connected using L2-xconnect
| | ... | ${dut1_node} | ${dut1_to_tg_name} | ${vlan1_index}
| | ... | ${dut2_node} | ${dut2_to_tg_name} | ${vlan2_index}
