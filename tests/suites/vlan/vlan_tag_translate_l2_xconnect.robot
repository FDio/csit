...
| | L2 Tag Rewrite Method Set On Interface | ${dut1_node} | ${subif1_index} | push-1 | ${outer_vlan_id1}
| | ${vlan1_name} | ${vlan1_index}= | Vlan Subinterface Created
| | ... | ${dut1_node} | ${dut1_to_dut2} | ${outer_vlan_id2}
| | L2 Tag Rewrite Method Set On Interface | ${dut1_node} | ${vlan1_index} | translate-1-1 | ${outer_vlan_id2}
...
| | ... | ${dut1_node} | ${subif1_index} | ${vlan12_index}
