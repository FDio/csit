...
| | ${vlan12_name} | ${vlan12_index}= | Vlan Subinterface Created
...
| L2 Tag Rewrite Set On Interface
...
| | ${interface_name}= | Get interface name | ${dut1_node} | ${dut1_to_tg}
| | Run Keyword If | ${tag_rewrite_method} == 'push-1' or ${tag_rewrite_method} == 'pop-1'
| | or ${tag_rewrite_method} == 'translate-1-1' or ${tag_rewrite_method} == 'translate-2-1'
| | L2 Tag Rewrite | ${dut_node} | ${interface_name} | ${tag_rewrite_method} | ${tag1_id}
| | ... | ELSE IF | ${tag_rewrite_method} == 'push-2' or ${tag_rewrite_method} == 'pop-2'
| | or ${tag_rewrite_method} == 'translate-1-2' or ${tag_rewrite_method} == 'translate-2-2'
