...
| | [Documentation] | RFC2460 IPv6 RFC4443 ICMPv6: Eth-IPv6-ICMPv6 on link
| | ...             | TG-DUT: On DUT configure interface IPv6 addresses and
| | ...             | routes in the main routing domain. Make TG send ICMPv6 Echo
| | ...             | Req to DUT ingress interface. Make TG verify ICMPv6 Echo
| | ...             | Reply is correct.
...
| | [Documentation] | RFC2460 IPv6: Eth-IPv6-ICMPv6 on link TG-DUT: On DUT
| | ...             | configure interface IPv6 addresses and routes in the main
| | ...             | routing domain. Make TG send ICMPv6 Echo Reqs to DUT
...
| | ...             | ICMPv6 Echo Replies are correct.
...
| | [Documentation] | RFC2460 IPv6: Eth-IPv6-ICMPv6 on links TG-DUT1, DUT1-DUT2:
| | ...             | On DUT1 and DUT2 configure interface IPv6 addresses and
| | ...             | routes in the main routing domain. Make TG send ICMPv6
...
| | [Documentation] | RFC2460 IPv6: Eth-IPv6-ICMPv6 on links TG-DUT1, TG-DUT2,
| | ...             | DUT1-DUT2: On DUT1 and DUT2 configure interface IPv6
| | ...             | addresses and routes in the main routing domain. Make
| | ...             | TG send ICMPv6 Echo Req towards DUT2 egress interface
| | ...             | connected to TG. Make TG verify ICMPv6 Echo Reply is
| | ...             | correct.
| | [Tags] | 3_NODE_SINGLE_LINK_TOPO | VM_ENV
...
| | ...             | DUT1-DUT2: On DUT1 and DUT2 configure interface IPv6
| | ...             | addresses and routes in the main routing domain. Make
| | ...             | TG send ICMPv6 Echo Req between its interfaces across
| | ...             | DUT1 and DUT2. Make TG verify ICMPv6 Echo Replies are
| | ...             | correct.
| | [Tags] | 3_NODE_SINGLE_LINK_TOPO | VM_ENV
...
| | [Documentation] | RFC4861 Neighbor Discovery: Eth-NS/NA on link TG-DUT: On DUT
| | ...             | configure interface IPv6 address in the main routing domain.
| | ...             | Make TG send Neighbor Solicitation message on the link to
| | ...             | DUT and verify DUT Neighbor Advertisement reply is correct.
| | [Tags] | 3_NODE_SINGLE_LINK_TOPO | VM_ENV
