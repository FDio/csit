...
| | ... | ${dut1} | deny | ${table_index} | ${skip_n} | ${match_n}
| | ... | ip6 | src | ${test_src_ip}
| | And Vpp Enable Input Acl Interface
| | ... | ${dut1} | ${dut1_if1} | ip6 | ${table_index}
| | And Add Ip Neighbor
...
| | ... | When Vpp Create Classify Table | ${dut1} | ip6 | src
| | ${table_index_2} | ${skip_n_2} | ${match_n_2}=
| | ... | When Vpp Create Classify Table | ${dut1} | ip6 | dst
| | And Vpp Configure Classify Session
| | ... | ${dut1} | deny | ${table_index_1} | ${skip_n_1} | ${match_n_2}
| | ... | ip6 | src | ${test_src_ip}
| | And Vpp Configure Classify Session
| | ... | ${dut1} | deny | ${table_index_2} | ${skip_n_2} | ${match_n_2}
| | ... | ip6 | dst | ${test_dst_ip}
| | And Vpp Enable Input Acl Interface
| | ... | ${dut1} | ${dut1_if1} | ip6 | ${table_index_1}
| | And Vpp Enable Input Acl Interface
| | ... | ${dut1} | ${dut1_if1} | ip6 | ${table_index_2}
| | And Add Ip Neighbor
| | ... | ${dut1} | ${dut1_if2} | ${dut1_if2_ip_GW} | ${tg_if2_mac}
| | And Vpp Route Add
| | ... | ${dut1} | ${test_dst_ip} | ${prefix_length} | ${dut1_if2_ip_GW}
