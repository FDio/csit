...
*** Variables ***
| ${dut1_to_tg_ip}= | fd12:3456:789a:1::1
| ${dut1_to_tg_ip_GW}= | fd12:3456:789a:1::2
| ${dut1_to_dut2_ip}= | fd12:3456:789a:2::1
| ${dut1_to_dut2_ip_GW}= | fd12:3456:789a:2::2
| ${test_dst_ip}= | 3ffe:61::1
| ${pass_test_src_ip}= | 3ffe:62::1
| ${drop_test_src_ip}= | 3ffe:63::1
| ${prefix_length}= | 64
...
| | VPP IP Source Check Setup | ${dut1_node} | ${dut1_to_tg_name}
| | And Send Packet And Check Headers | ${tg_node}
| | ... | ${pass_test_src_ip} | ${test_dst_ip} | ${tg_to_dut1}
| | ... | ${tg_to_dut1_mac} | ${dut1_to_tg_mac} | ${tg_to_dut2}
| | ... | ${dut1_to_dut2_mac} | ${tg_to_dut2_mac}
