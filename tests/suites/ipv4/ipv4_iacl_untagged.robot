...
*** Test Cases ***
| TC10:DUT with iACL IPv4 src-addr drops matching pkts
| | [Documentation] | Eth-IPv4 on links TG-DUT1, TG-DUT2, DUT1-DUT2: On DUT1 and
| | ...             | DUT2 configure interface IPv4 addresses and routes in the
| | ...             | main routing domain. On DUT1 configure classify table, add
| | ...             | source IPv4 address to table with 'deny'. Make TG send
...
| TC11:DUT with iACL IPv4 dst-addr drops matching pkts
| | [Documentation] | On DUT1 configure classify table, add destination IPv4
...
| TC12:DUT with iACL IPv4 src-addr and dst-addr drops matching pkts
| | [Documentation] | On DUT1 configure classify table, add source and
| | ...             | destination IPv4 addresses to table with 'deny'. Make TG
...
| TC13:DUT with iACL IPv4 protocol set to TCP drops matching pkts
...
| TC14:DUT with iACL IPv4 protocol set to UDP drops matching pkts
...
| TC15:DUT with iACL IPv4 TCP src-ports drops matching pkts
...
| TC16:DUT with iACL IPv4 TCP dst-ports drops matching pkts
...
| TC17:DUT with iACL IPv4 TCP src-ports and dst-ports drops matching pkts
...
| TC18:DUT with iACL IPv4 UDP src-ports drops matching pkts
...
| TC19:DUT with iACL IPv4 UDP dst-ports drops matching pkts
...
| TC20:DUT with iACL IPv4 UDP src-ports and dst-ports drops matching pkts
