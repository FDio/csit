...
echo "ifname : " $ifname " address: "  $ifaddress
...
sudo LD_LIBRARY_PATH=${LIB_PATH} ./vc_common -p 20000 -d ${man_ip_1} -a 10000 -s ${man_ip_2} -l 200 -t 50 -i 0 -f 1 -r 20000 -n 1 -w 10 -u 10000 -e 10 -x 1
fi
