...
*** Test Cases ***
| 64B--ethip6-ip6scale2m-n2n-ndrpdr
| | [Tags] | 64B
| | frame_size=${64}

| 1518B--ethip6-ip6scale2m-n2n-ndrpdr
| | [Tags] | 1518B
| | frame_size=${1518}

| 9000B--ethip6-ip6scale2m-n2n-ndrpdr
| | [Tags] | 9000B
| | frame_size=${9000}

| IMIX--ethip6-ip6scale2m-n2n-ndrpdr
| | [Tags] | IMIX
