...
| ... | NIC_Intel-X710 | ETH | IP6SCALE2M | TG-L1XC | BASE | IP6BASE
| ... | DRV_VFIO_PCI
| ... | RXQ_SIZE_0 | TXQ_SIZE_0
| ... | ethip6-ip6scale2m-tg-l1xc
|
...
*** Test Cases ***
| 64B-ethip6-ip6scale2m-tg-l1xc-ndrpdr
| | [Tags] | 64B
| | frame_size=${64}

| 1518B-ethip6-ip6scale2m-tg-l1xc-ndrpdr
| | [Tags] | 1518B
| | frame_size=${1518}

| 9000B-ethip6-ip6scale2m-tg-l1xc-ndrpdr
| | [Tags] | 9000B
| | frame_size=${9000}

| IMIX-ethip6-ip6scale2m-tg-l1xc-ndrpdr
| | [Tags] | IMIX
