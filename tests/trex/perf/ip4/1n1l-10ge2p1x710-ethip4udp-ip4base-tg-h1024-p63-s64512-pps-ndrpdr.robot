...
| ... | ethip4udp-ip4base-n2n-h1024-p63-s64512-pps
|
...
| ... | TG traffic profile contains client and server ASTF programs, generating\
| ... | packets containing Ethernet header, IPv4 header, UDP header and\
| ... | static payload.\
...
*** Test Cases ***
| 64B--ethip4udp-ip4base-n2n-h1024-p63-s64512-pps-ndrpdr
| | [Tags] | 64B
| | frame_size=${64}
