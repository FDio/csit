...
| ... | NIC_Intel-X710 | ETH | IP4SCALE2M | TG-L1XC | SCALE | DRV_VFIO_PCI
| ... | RXQ_SIZE_0 | TXQ_SIZE_0
| ... | ethip4-ip4scale2m-tg-l1xc
|
...
*** Test Cases ***
| 64B-ethip4-ip4scale2m-tg-l1xc-ndrpdr
| | [Tags] | 64B
| | frame_size=${64}

| 1518B-ethip4-ip4scale2m-tg-l1xc-ndrpdr
| | [Tags] | 1518B
| | frame_size=${1518}

| 9000B-ethip4-ip4scale2m-tg-l1xc-ndrpdr
| | [Tags] | 9000B
| | frame_size=${9000}

| IMIX-ethip4-ip4scale2m-tg-l1xc-ndrpdr
| | [Tags] | IMIX
