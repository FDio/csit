...
| ... | NIC_Intel-X710 | TREX | ETH | L2BDMACLRN | L1XC | SCALE | L2BDSCALE
| ... | FIB_1M | TG_DRV_IGB_UIO
| ... | eth-l2bdscale1mmaclrn-l1xc
|
...
*** Test Cases ***
| 64B-1c-eth-l2bdscale1mmaclrn-l1xc-ndrpdr
| | [Tags] | 64B
| | frame_size=${64}

| 1518B-1c-eth-l2bdscale1mmaclrn-l1xc-ndrpdr
| | [Tags] | 1518B
| | frame_size=${1518}

| 9000B-1c-eth-l2bdscale1mmaclrn-l1xc-ndrpdr
| | [Tags] | 9000B
| | frame_size=${9000}
