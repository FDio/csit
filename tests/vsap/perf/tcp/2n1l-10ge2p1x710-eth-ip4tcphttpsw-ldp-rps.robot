...
| ... | LDP_NGINX | TCP | TCP_RPS | NIC_Intel-X710 | DRV_VFIO_PCI
| ... | eth-ip4tcphttpsw-ldp
|
...
*** Test Cases ***
| 0B-1c-eth-ip4tcphttpsw-ldp-rps
| | [Tags] | 0B | 1C
| | frame_size=${0} | phy_cores=${1}

| 0B-2c-eth-ip4tcphttpsw-ldp-rps
| | [Tags] | 0B | 2C
| | frame_size=${0} | phy_cores=${2}

| 64B-1c-eth-ip4tcphttpsw-ldp-rps
| | [Tags] | 64B | 1C
| | frame_size=${64} | phy_cores=${1}

| 64B-2c-eth-ip4tcphttpsw-ldp-rps
| | [Tags] | 64B | 2C
| | frame_size=${64} | phy_cores=${2}

| 1024B-1c-eth-ip4tcphttpsw-ldp-rps
| | [Tags] | 1024B | 1C
| | frame_size=${1024} | phy_cores=${1}

| 1024B-2c-eth-ip4tcphttpsw-ldp-rps
| | [Tags] | 1024B | 2C
| | frame_size=${1024} | phy_cores=${2}

| 2048B-1c-eth-ip4tcphttpsw-ldp-rps
| | [Tags] | 2048B | 1C
| | frame_size=${2048} | phy_cores=${1}

| 2048B-2c-eth-ip4tcphttpsw-ldp-rps
| | [Tags] | 2048B | 2C
