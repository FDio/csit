...
| ... | LDP_NGINX | TLS | TLS_RPS | AES128-SHA | NIC_Intel-X710 | DRV_VFIO_PCI
...
*** Test Cases ***
| tc01-0B-1c-eth-ip4tcphttpssw-aes128sha-ldp-rps
| | [Tags] | 0B | 1C
| | frame_size=${0} | phy_cores=${1}

| tc02-0B-2c-eth-ip4tcphttpssw-aes128sha-ldp-rps
| | [Tags] | 0B | 2C
| | frame_size=${0} | phy_cores=${2}

| tc03-0B-4c-eth-ip4tcphttpssw-aes128sha-ldp-rps
| | [Tags] | 0B | 4C
| | frame_size=${0} | phy_cores=${4}

| tc04-64B-1c-eth-ip4tcphttpssw-aes128sha-ldp-rps
| | [Tags] | 64B | 1C
| | frame_size=${64} | phy_cores=${1}

| tc05-64B-2c-eth-ip4tcphttpssw-aes128sha-ldp-rps
| | [Tags] | 64B | 2C
| | frame_size=${64} | phy_cores=${2}

| tc06-64B-4c-eth-ip4tcphttpssw-aes128sha-ldp-rps
| | [Tags] | 64B | 4C
| | frame_size=${64} | phy_cores=${4}

| tc07-1024B-1c-eth-ip4tcphttpssw-aes128sha-ldp-rps
| | [Tags] | 1024B | 1C
| | frame_size=${1024} | phy_cores=${1}

| tc08-1024B-2c-eth-ip4tcphttpssw-aes128sha-ldp-rps
| | [Tags] | 1024B | 2C
| | frame_size=${1024} | phy_cores=${2}

| tc09-1024B-4c-eth-ip4tcphttpssw-aes128sha-ldp-rps
| | [Tags] | 1024B | 4C
| | frame_size=${1024} | phy_cores=${4}

| tc10-2048B-1c-eth-ip4tcphttpssw-aes128sha-ldp-rps
| | [Tags] | 2048B | 1C
| | frame_size=${2048} | phy_cores=${1}

| tc11-2048B-2c-eth-ip4tcphttpssw-aes128sha-ldp-rps
| | [Tags] | 2048B | 2C
| | frame_size=${2048} | phy_cores=${2}

| tc12-2048B-4c-eth-ip4tcphttpssw-aes128sha-ldp-rps
| | [Tags] | 2048B | 4C
