...
| |
| | Pci Driver Unbind | ${nodes['DUT1']} | ${DUT1_pf_pci[0]}
| | Pci Driver Unbind | ${nodes['DUT1']} | ${DUT1_pf_pci[1]}
| | Pci Driver Unbind | ${nodes['DUT2']} | ${DUT2_pf_pci[0]}
| | Pci Driver Unbind | ${nodes['DUT2']} | ${DUT2_pf_pci[1]}
