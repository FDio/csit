...
| | ... | dut1_uuid - UUID string of DUT1 /tmp volume created outside of the DUT1
| | ... |   docker in case of vpp-device test. ${EMPTY} value means that /tmp
| | ... |   directory is inside the DUT1 docker
| | ...
