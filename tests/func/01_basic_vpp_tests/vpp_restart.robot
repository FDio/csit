...
| Test Setup | Run Keywords | Setup all DUTs before test | AND | Log To Console | Number of iterations to run: ${iterations}
...
| | | Run Keyword If | ${index} == ${0} | Log To Console | \n
...
| | Run Keyword If | ${failures} == ${0} | Pass Execution | ${log_message} | INFO
