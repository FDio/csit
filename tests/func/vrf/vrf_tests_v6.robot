...
| | ... | and egress port on DUT is configured its Neighbor and each VRF is
| | ... | configured with one route.
...
| | ... | are assigned to FIB2 (the same done on DUT2, just opposite). IP
| | ... | addresses are subsequently set on interfaces, and IP Neighbors are set
...
| | ... | ${dut1_node} | ${dut1_to_dut2_if1} | ${fib_table_1} | ${TRUE}
| | Assign Interface To Fib Table
| | ... | ${dut1_node} | ${dut1_to_dut2_if2} | ${fib_table_2} | ${TRUE}
| | Assign Interface To Fib Table
| | ... | ${dut1_node} | ${dut1_to_tg_if1} | ${fib_table_1} | ${TRUE}
| | Assign Interface To Fib Table
| | ... | ${dut1_node} | ${dut1_to_tg_if2} | ${fib_table_2} | ${TRUE}

| | Assign Interface To Fib Table
| | ... | ${dut2_node} | ${dut2_to_dut1_if1} | ${fib_table_1} | ${TRUE}
| | Assign Interface To Fib Table
| | ... | ${dut2_node} | ${dut2_to_dut1_if2} | ${fib_table_2} | ${TRUE}
| | Assign Interface To Fib Table
| | ... | ${dut2_node} | ${dut2_to_tg_if1} | ${fib_table_1} | ${TRUE}
| | Assign Interface To Fib Table
| | ... | ${dut2_node} | ${dut2_to_tg_if2} | ${fib_table_2} | ${TRUE}
