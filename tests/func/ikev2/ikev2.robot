...
| | ... | ${prefix}
| | And Set Interface Address | ${dut_node} | ${dut_to_tg_if2} | 10.0.0.15
| | ... | ${prefix}
| | And Add Arp On Dut | ${dut_node} | ${dut_to_tg_if1}
| | ... | ${tg_ip} | ${tg_to_dut_if1_mac}
| | And Add Arp On Dut | ${dut_node} | ${dut_to_tg_if2}
| | ... | 10.0.0.20 | 08:00:27:04:98:31
#| | Vpp Route Add | ${dut_node} | 10.0.5.0 | 24 | 10.0.0.3 | ${dut_to_tg_if2}
| | And Set Linux Interface Arp | ${tg_node} | ${tg_if} | ${dut_if_ip} | ${dut_to_tg_if1_mac}
| | Setup IKE
| | Exec CMD No Error | ${tg_node} | ipsec start | sudo=True
| | ${rSpi} | ${rEnc} | ${rAuth}= | Get Vpp Keys | ${dut_node}
| | Set Ipsec If Up | ${dut_node} | 5 | admin-up
| | Send IKEv2 Packet | ${tg_node} | 10.0.10.0
| | ... | 10.0.0.20 | ${tg_to_dut_if1_mac}
