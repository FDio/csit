...
| ... | *[Enc] Packet Encapsulations:* ESP-IPv4-ICMP
...
*** Variables ***
| ${rsa_path}= | ${EXECDIR}/resources/test_data/ikev2_rsa
...
| | IKEV2 Setup | ${strict_policy} | ${ike} | ${esp} | ${mobike}
| | ... | ${key_exchange} | ${ike_lifetime} | ${lifetime} | ${PSK_pr_name}
...
| | ... | [Ver] Send and receive ESP packet between TG and VPP node.
| | IKEV2 Setup | ${strict_policy} | ${ike} | ${esp} | ${mobike}
| | ... | ${key_exchange} | ${ike_lifetime} | ${lifetime} | ${ID_IP_pr_name}
...
| | ... | [Ver] Send and receive ESP packet between TG and VPP node.
| | IKEV2 Setup | ${strict_policy} | ${ike} | ${esp} | ${mobike}
| | ... | ${key_exchange} | ${ike_lifetime} | ${lifetime} | ${ID_RFC_pr_name}
...
| | ... | [Ver] Send and receive ESP packet between TG and VPP node.
| | IKEV2 Setup | ${strict_policy} | ${ike} | ${esp} | ${mobike}
| | ... | ${key_exchange} | ${ike_lifetime} | ${lifetime} | ${ID_KEY_pr_name}
...
| | Copy RSA Files
| | IKEV2 Setup | ${strict_policy} | ${ike} | ${esp} | ${mobike}
| | ... | ${key_exchange} | ${ike_lifetime} | ${lifetime} | ${RSA_pr_name}
...
| | ... | ${RSA_vpp_key} | ${RSA_authby} | ${RSA_leftcert} | ${RSA_rightcert}
...
| | ... | ${right_id} | ${left_id} | ${cacert}= | ${secrets}= | ${vpp_key}=
| | ... | ${authby}= | ${leftcert}= | ${rightcert}=
...
| | Set Secrets Strongswan | ${tg_node} | ${default_secret}
| | Run Keyword If | '${secrets}' != '' | Run Keywords |
| | ... | Set Secrets Strongswan | ${tg_node} | ${secrets} |
| | ... | AND |
| | ... | Set Ikev2 Key | ${dut_node} | ${vpp_key}
...
| | ... | left_id=${left_id} | auto=start | cacert=${cacert} | authby=${authby}
| | ... | leftcert=${leftcert} | rightcert=${rightcert}
