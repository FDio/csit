...
| | [Documentation]
| | ... | [Top] TG-DUT1-DUT2-TG.
| | ... | [Enc] Eth-IPv6-LISPGPE-IPv4-ICMPv4 on DUT1-DUT2, Eth-IPv4-ICMPv4 on\
| | ... | TG-DUTn.
...
| | And IP addresses are set on interfaces
| | ... | ${dut1_node} | ${dut1_to_dut2} | ${dut1_to_dut2_ip4o6}
| | ... | ${dut_prefix4o6}
| | ... | ${dut1_node} | ${dut1_to_tg} | ${dut1_to_tg_ip4o6} | ${tg_prefix4o6}
| | ... | ${dut2_node} | ${dut2_to_dut1} | ${dut2_to_dut1_ip4o6}
| | ... | ${dut_prefix4o6}
| | ... | ${dut2_node} | ${dut2_to_tg} | ${dut2_to_tg_ip4o6} | ${tg_prefix4o6}
...
| | And Add Arp On Dut | ${dut2_node} | ${dut2_to_tg} | ${tg2_ip4o6}
| | ... | ${tg_to_dut2_mac}
| | And Add Arp On Dut | ${dut1_node} | ${dut1_to_dut2} | ${dut2_to_dut1_ip4o6}
| | ... | ${dut2_to_dut1_mac}
| | And Add Arp On Dut | ${dut2_node} | ${dut2_to_dut1} | ${dut1_to_dut2_ip4o6}
| | ... | ${dut1_to_dut2_mac}
...
| | ...
| | [Arguments] | ${fib_id}=0
| | Add IP Neighbor | ${dut1_node} | ${dut1_to_tg} | ${tg1_ip4o6}
| | ... | ${tg_to_dut1_mac} | ${fib_id}
| | Add IP Neighbor | ${dut2_node} | ${dut2_to_tg} | ${tg2_ip4o6}
| | ... | ${tg_to_dut2_mac} | ${fib_id}
| | Add IP Neighbor | ${dut1_node} | ${dut1_to_dut2} | ${dut2_to_dut1_ip4o6}
| | ... | ${dut2_to_dut1_mac}
| | Add IP Neighbor | ${dut2_node} | ${dut2_to_dut1} | ${dut1_to_dut2_ip4o6}
| | ... | ${dut1_to_dut2_mac}
...
| | VM for Vhost L2BD forwarding is setup | ${dut1_node} | ${sock1} | ${s