...
| ...
| Force Tags | 3_NODE_SINGLE_LINK_TOPO | VM_ENV | LISP | POKUS
| ...
...
| | Set Linux Interface IP | ${vm} | eth0 | ${vm1_vif1_ip4} | ${prefix4}
| | Set Linux Interface IP | ${vm} | eth1 | ${vm1_vif2_ip4} | ${prefix4}
| | Set Linux Interface Route | ${vm} | eth1 | ${6.0.2.0}/${prefix4}
| | Set Linux Interface Route | ${vm} | eth0 | ${6.0.1.0}/${prefix4}
| | Linux Enable Forwarding | ${vm}
#| | Dpdk Testpmd Start | ${vm} | eal_coremask=0x1
#| | ... | pmd_fwd_mode=mac
