...
| | And Add Arp On Dut | ${dut2_node} | ${dut2_to_tg} | ${tg2_ip4}
| | ... | ${tg_to_dut2_mac}
| | And Vpp Route Add | ${dut1_node} | 6.0.5.0 | ${prefix4} | ${vm1_vif1_ip4} | ${dut1_vif1}
| | And Vpp Route Add | ${dut1_node} | 6.0.5.0 | ${prefix4} | ${dut2_to_dut1_ip4} | ${dut1_to_dut2}
| | And Vpp Route Add | ${dut1_node} | 6.0.1.0 | ${prefix4} | ${vm1_vif2_ip4} | ${dut1_vif2}
| | And Vpp Route Add | ${dut1_node} | 6.0.1.0 | ${prefix4} | ${tg1_ip4} | ${dut1_to_tg}
| | And Vpp Route Add | ${dut2_node} | 6.0.5.0 | ${prefix4} | ${tg2_ip4} | ${dut2_to_tg}
| | And Vpp Route Add | ${dut2_node} | 6.0.1.0 | ${prefix4} | ${dut1_to_dut2_ip4} | ${dut2_to_dut1}
| | Then Send Packet And Check Headers
| | ... | ${tg_node} | ${tg1_ip4} | ${tg2_ip4}
| | ... | ${tg_to_dut1} | ${tg_to_dut1_mac} | ${dut1_to_tg_mac}
| | ... | ${tg_to_dut2} | ${dut2_to_tg_mac} | ${tg_to_dut2_mac}
