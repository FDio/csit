...
#| | ... | [Ref] RFC6830.
#| | ...
#| | [teardown] | Run keyword if test passed | Fail
#| | ...
#| | [Tags] | EXPECTED_FAILING | POKUS
#| | ...
#| | Given Path for 3-node testing is set
#| | ... | ${nodes['TG']} | ${nodes['DUT1']} | ${nodes['DUT2']} | ${nodes['TG']}
#| | And Interfaces in 3-node path are up
...
#| | ... | ${dut1_to_dut2_ip4_static_adjacency}
#| | ... | ${dut2_to_dut1_ip4_static_adjacency}
#| | ${dut1_lisp_idx}= | Get SW If Index | ${dut1_node} | lisp_gpe0
#| | Set Interface State | ${dut1_node} | ${dut1_lisp_idx} | up
#| | And IP addresses are set on interfaces
#| | ... | ${dut1_node} | ${dut1_to_dut2} | ${dut1_to_dut2_ip4} | ${prefix4}
#| | ... | ${dut1_node} | ${dut1_to_tg} | ${dut1_to_tg_ip4} | ${prefix4}
#| | ... | ${dut2_node} | ${dut2_to_dut1} | ${dut2_to_dut1_ip4} | ${prefix4}
...
#| | ... | TG-DUTn.
#| | ... | [Cfg] Configure IPv4 LISP static adjacencies on DUT1 and DUT2.
#| | ... | [Ver] Case: ip4-lispgpe-ip4 - virt2lisp
#| | ... | Make TG send ICMPv4 Echo Req between its interfaces across both\
#| | ... | DUTs and LISP GPE tunnel between them; verify IPv4 headers on\
#| | ... | received packets are correct.
#| | ... | [Ref] RFC6830.
...
#| | ... | ${dut1_to_dut2_ip4_static_adjacency}
#| | ... | ${dut2_to_dut1_ip4_static_adjacency}
#| | And Setup vhost interfaces on DUT1
#| | And Setup bridge domains on DUT1
#| | ${vm_node}= | Guest VM connected via vhost-user is setup
#| | ... | ${dut1_node} | ${sock1} | ${sock2} | DUT1_VM
#| | ... | ${dut1_vif1_mac} | ${dut1_vif2_mac}
#| | And Set test variable | ${vm_node}
#| | And IP addresses are set on interfaces
#| | ... | ${dut1_node} | ${dut1_to_dut2} | ${dut1_to_dut2_ip4} | ${prefix4}
#| | ... | ${dut1_node} | ${dut1_to_tg} | ${dut1_to_tg_ip4} | ${prefix4}
...
#| | And Add Arp On Dut | ${dut2_node} | ${dut2_to_tg} | ${tg2_ip4}
#| | ... | ${tg_to_dut2_mac}
#| | And Vpp Route Add | ${dut1_node} | ${dst_ip_range} | ${prefix4}
#| | ... | ${vm1_vif1_ip4} | ${dut1_vif1}
#| | And Vpp Route Add | ${dut1_node} | ${dst_ip_range} | ${prefix4}
#| | ... | ${dut2_to_dut1_ip4} | ${dut1_to_dut2}
#| | And Vpp Route Add | ${dut1_node} | ${src_ip_range} | ${prefix4}
#| | ... | ${vm1_vif2_ip4} | ${dut1_vif2}
#| | And Vpp Route Add | ${dut1_node} | ${src_ip_range} | ${prefix4}
#| | ... | ${tg1_ip4} | ${dut1_to_tg}
#| | And Vpp Route Add | ${dut2_node} | ${dst_ip_range} | ${prefix4}
#| | ... | ${tg2_ip4} | ${dut2_to_tg}
#| | And Vpp Route Add | ${dut2_node} | ${src_ip_range} | ${prefix4}
#| | ... | ${dut1_to_dut2_ip4} | ${dut2_to_dut1}
#| | Then Send Packet And Check Headers
#| | ... | ${tg_node} | ${tg1_ip4} | ${tg2_ip4}
#| | ... | ${tg_to_dut1} | ${tg_to_dut1_mac} | ${dut1_to_tg_mac}
#| | ... | ${tg_to_dut2} | ${dut2_to_tg_mac} | ${tg_to_dut2_mac}
...
#| | ... | ${dut2_node} | ${dut2_to_dut1} | ${dut2_to_dut1_ip4} | ${prefix4}
#| | ... | ${dut2_node} | ${dut2_to_tg} | ${dut2_to_tg_ip4} | ${prefix4}
#| | And Bridge domain on DUT node is created
#| | ... | ${dut1_node} | ${bid1} | learn=${TRUE}
#| | And Interface is added to bridge domain | ${dut1_node}
#| | ... | ${dut1_to_tg} | ${bid1} | 0
#| | And Interface is added to bridge domain | ${dut1_node}
#| | ... | ${dut1_vif1} | ${bid1} | 0
#| | And Setup VRF on DUT | ${dut1_node} | ${dut1_fib_table} | ${dut1_to_dut2}
#| | ... | ${dut2_to_dut1_ip4} | ${dut2_to_dut1_mac} | ${tg2_ip4} | ${dut1_vif2}
#| | ... | ${tg1_ip4} | ${tg_to_dut1_mac} | ${prefix4}
#| | Then Send Packet And Check Headers
#| | ... | ${tg_node} | ${tg1_ip4} | ${tg2_ip4}
#| | ... | ${tg_to_dut1} | ${tg_to_dut1_mac} | ${dut1_to_tg_mac}
...
| | And Interfaces in 3-node path are up
| | And IP addresses are set on interfaces
| | ... | ${dut1_node} | ${dut1_to_dut2} | ${dut1_to_dut2_ip4} | ${prefix6}
| | ... | ${dut1_node} | ${dut1_to_tg} | ${dut1_to_tg_ip4} | ${prefix6}
| | ... | ${dut2_node} | ${dut2_to_dut1} | ${dut2_to_dut1_ip4} | ${prefix6}
| | ... | ${dut2_node} | ${dut2_to_tg} | ${dut2_to_tg_ip4} | ${prefix6}
| | And Add Arp On Dut | ${dut1_node} | ${dut1_to_tg} | ${tg1_ip4}
| | ... | ${tg_to_dut1_mac}
| | And Add Arp On Dut | ${dut2_node} | ${dut2_to_tg} | ${tg2_ip4}
| | ... | ${tg_to_dut2_mac}
...
| TC05: DUT1 and DUT2 route IPv4 bidirectionally over LISP GPE tunnel using vhost interfaces and VRF is enabled
| | [Documentation]
| | ... | [Top] TG-DUT1-DUT2-TG.
| | ... | [Enc] Eth-IPv4-LISPGPE-IPv4-ICMPv4 on DUT1-DUT2, Eth-IPv4-ICMPv4 on\
| | ... | TG-DUTn.
...
| | [Documentation]
| | ... | Setup two vhost interfaces on DUT1.
| | ...
...
| Setup bridge domains on DUT1
| | [Documentation]
| | ... | Create two bridge domains and assign interfaces to them.
| | ...
...
| | ... | ${dut1_vif1} | ${bid1} | 0
| | Bridge domain on DUT node is created
| | ... | ${dut1_node} | ${bid2} | learn=${TRUE}
| | ${dut1_lisp_idx}= | Get SW If Index | ${dut1_node} | lisp_gpe0
| | Set Interface State | ${dut1_node} | ${dut1_lisp_idx} | up
| | Interface is added to bridge domain | ${dut1_node}
| | ... | ${dut1_vif2} | ${bid2} | 0
| | Interface is added to bridge domain | ${dut1_node}
| | ... | ${dut1_lisp_idx} | ${bid2} | 0

#| Guest VM connected via vhost-user is setup
#| | [Documentation]
#| | ... | Start QEMU guest with two vhost-user interfaces.
#| | ...
#| | ... | *Arguments:*
...
#| | ...
#| | ... | *Returns:*
#| | ... | - vm - VM which has been started. Type: dictionary
#| | ...
#| | ... | *Example:*
#| | ...
#| | ... | \| Guest VM connected via vhost-user is setup \
...
#| | Set Linux Interface Route | ${vm} | ${virt1} | ${dst_ip_range}/${prefix4}
#| | Set Linux Interface Route | ${vm} | ${virt2} | ${src_ip_range}/${prefix4}
...
#| | ...
#| | ... | *Arguments:*
#| | ... | - dut - DUT node to stop guest VM on. Type: dictionary
#| | ... | - vm - VM to be stopped. Type: dictionary
#| | ...
#| | ... | *Example:*
#| | ... | \| Stop QEMU \| ${dut1_node} \| ${vm_node} \|
#| | ...
#| | [Arguments] | ${dut} | ${vm}
#| | ...
#| | Run keyword | ${vm_name}.Qemu Set Node | ${dut}
#| | ${status} | ${value}= | Run Keyword And Ignore Error
#| | ... | ${vm_name}.Qemu System Status
