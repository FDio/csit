...
| | ... | [Top] TG-DUT1-VM1-DUT1-DUT2-VM2-DUT2-TG.
| | ... | [Enc] Eth-IPv4-LISPGPE-IPv4-ICMPv4 on DUT1-DUT2, Eth-IPv4-ICMPv4 on
| | ... | TG-DUTn.
| | ... | [Cfg] Configure IPv4 LISP static adjacencies on DUT1 and DUT2.
| | ... | [Ver] Make TG send ICMPv4 Echo Req between its interfaces across both
| | ... | DUTs and LISP GPE tunnel between them, the traffic is routed via vhost
| | ... | interfaces to and from VMs; verify IPv4 headers on received packets
| | ... | are correct.
| | ... | [Ref] RFC6830.
...
#| | And Setup VXLAN and BD on Dut | ${dut1_node} | ${dut1_vhost_ip_1} | ${dut1_vhost_ip_2}
#| | ... | ${vhost_if_11} | ${vhost_if_12}
#| | And Setup VXLAN and BD on Dut | ${dut2_node} | ${dut2_vhost_ip_1} | ${dut2_vhost_ip_2}
#| | ... | ${vhost_if_21} | ${vhost_if_22}
...
| | [Documentation]
| | ... | Setup Qemu with 2 vhost-user interfaces and 2 namespaces.
...
| | Set Linux Interface Ipaddr | ${vm} | ${vhost1} | ${ip1} | ${prefix4}
| | Set Linux Interface Ipaddr | ${vm} | ${vhost2} | ${ip2} | ${prefix4}
...
| | ... | \| @{vhosts} \|
| | ...
| | [Arguments] | ${dut_node} | ${src_ip} | ${dst_ip} | ${vhost1} | ${vhost2}
...
| | Interface is added to bridge domain
| | ... | ${dut_node} | ${vhost1} | ${bid_b} | 0
| | Interface is added to bridge domain
| | ... | ${dut_node} | ${vhost2} | ${bid_b} | 0
