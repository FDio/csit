...
| | And IP addresses are set on interfaces
| | ... | ${dut1_node} | ${vhost_if_11} | ${dut1_to_tg_ip4} | ${prefix4}
| | ... | ${dut1_node} | ${vhost_if_12} | ${dut1_to_dut2_ip4} | ${prefix4}
| | ... | ${dut2_node} | ${vhost_if_21} | ${dut2_to_dut1_ip4} | ${prefix4}
| | ... | ${dut2_node} | ${vhost_if_22} | ${dut2_to_tg_ip4} | ${prefix4}
...
| | And VPP IP Probe | ${dut1_node} | ${vhost_if_12} | ${dut2_to_dut1_ip4}
| | And VPP IP Probe | ${dut2_node} | ${vhost_if_21} | ${dut1_to_dut2_ip4}
| | And Add Arp On Dut | ${dut2_node} | ${vhost_if_22} | ${tg2_ip4}
| | ... | ${tg_to_dut2_mac}
| | And Add Arp On Dut | ${dut1_node} | ${vhost_if_11} | ${tg1_ip4}
| | ... | ${tg_to_dut1_mac}
| | When Set up LISP GPE topology
...
| | ... | ${dut1_node} | ${sock11} | ${sock12}
| | And VM for Vhost L2BD forwarding is setup
| | ... | ${dut2_node} | ${sock21} | ${sock22}
| | Then Send Packet And Check Headers
| | ... | ${tg_node} | ${tg1_ip4} | ${tg2_ip4}
| | ... | ${tg_to_dut1} | ${tg_to_dut1_mac} | ${vhost_if_11_mac}
| | ... | ${tg_to_dut2} | ${vhost_if_22_mac} | ${tg_to_dut2_mac}
| | And Send Packet And Check Headers
| | ... | ${tg_node} | ${tg2_ip4} | ${tg1_ip4}
| | ... | ${tg_to_dut2} | ${tg_to_dut2_mac} | ${vhost_if_22_mac}
| | ... | ${tg_to_dut1} | ${vhost_if_11_mac} | ${tg_to_dut1_mac}
...
| | ... | ${nodes['TG']} | ${nodes['DUT1']} | ${nodes['DUT2']} | ${nodes['TG']}
| | And Vhosts are set on DUTs in 3-node topology
| | When Setup VRF 1 on DUT 1 with vhost
| | And Setup VRF 1 on DUT 2 with vhost
| | And IP addresses are set on interfaces
| | ... | ${dut1_node} | ${vhost_if_11} | ${dut1_to_tg_ip4} | ${prefix4}
| | ... | ${dut1_node} | ${vhost_if_12} | ${dut1_to_dut2_ip4} | ${prefix4}
| | ... | ${dut2_node} | ${vhost_if_21} | ${dut2_to_dut1_ip4} | ${prefix4}
...
| Setup VRF 1 on DUT 1 with vhost
| | [Documentation]
| | ... | Set a FIB table on DUT1. DUT1-TG-IF1 and DUT1-DUT2-IF1 are assigned \
| | ... | to FIB table. IP addresses are subsequently set on interfaces, and ARP
| | ... | is set for neighbors. The last setting is route for each fib table.
...
| | Add fib table | ${dut1_node}
| | ... | ${tg2_ip4} | ${prefix4} | ${dut1_fib_table}
| | ... | via ${dut2_to_dut1_ip4} sw_if_index ${vhost_if_11} multipath
| | ...
| | Assign Interface To Fib Table
| | ... | ${dut1_node} | ${vhost_if_12} | ${dut1_fib_table}
| | Assign Interface To Fib Table
...
| | ... | ${dut2_to_dut1_ip4} | ${vhost_if_21_mac} | vrf=${dut1_fib_table}
| | ...
| | Vpp Route Add | ${dut1_node} | ${tg2_ip4} | ${prefix4}
| | ... | ${dut2_to_dut1_ip4} | ${vhost_if_12} | vrf=${dut1_fib_table}

| Setup VRF 1 on DUT 2 with vhost
| | [Documentation]
| | ... | Set a FIB table on DUT2. DUT2-TG-IF2 and DUT2-DUT1-IF2 are assigned \
| | ... | to FIB table. IP addresses are subsequently set on interfaces, and ARP
| | ... | is set for neighbors. The last setting is route for each fib table.
...
| | Add fib table | ${dut2_node}
| | ... | ${tg1_ip4} | ${prefix4} | ${dut2_fib_table}
| | ... | via ${dut2_to_dut1_ip4} sw_if_index ${vhost_if_21} multipath
| | ...
| | Assign Interface To Fib Table
| | ... | ${dut2_node} | ${vhost_if_21} | ${dut2_fib_table}
| | Assign Interface To Fib Table
| | ... | ${dut2_node} | ${vhost_if_22} | ${dut2_fib_table}
| | ...
| | Add Arp On Dut | ${dut2_node} | ${vhost_if_22}
| | ... | ${tg2_ip4} | ${tg_to_dut2_mac} | vrf=${dut2_fib_table}
| | Add Arp On Dut | ${dut2_node} | ${vhost_if_21}
| | ... | ${dut1_to_dut2_ip4} | ${vhost_if_12_mac} | vrf=${dut2_fib_table}
| | ...
| | Vpp Route Add | ${dut2_node} | ${tg1_ip4} | ${prefix4}
| | ... | ${dut1_to_dut2_ip4} | ${vhost_if_21} | vrf=${dut2_fib_table}
