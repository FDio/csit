...
| | Set Interface State | ${dut1_node} | ${dut1_vif1} | up | if_type=name
| | Set Interface State | ${dut1_node} | ${dut1_vif2} | up | if_type=name
...
| | Set Linux Interface Route | ${vm} | ${virt1} | 6.0.2.0/${prefix4}
