...
| | And VPP IP Probe | ${dut1_node} | ${dut1_to_dut2} | ${dut1_vhost_ip_1}
| | And VPP IP Probe | ${dut2_node} | ${dut2_to_dut1} | ${dut2_vhost_ip_1}
| | And VPP IP Probe | ${dut1_node} | ${dut1_to_dut2} | ${dut1_vhost_ip_2}
| | And VPP IP Probe | ${dut2_node} | ${dut2_to_dut1} | ${dut2_vhost_ip_2}
