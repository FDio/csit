...
| | Add Arp On Dut | ${dut1_node} | ${dut1_to_dut2}
| | ... | ${dut2_to_dut1} | ${dut2_to_dut1_mac} | vrf=${dut1_fib_table2}
| | ...
| | Vpp Route Add | ${dut1_node} | ${tg2_ip4} | ${prefix4}
| | ... | ${dut1_vhost_ip_1} | ${vhost_if_12} | vrf=${dut1_fib_table}
| | Vpp Route Add | ${dut1_node} | ${tg2_ip4} | ${prefix4}
| | ... | ${dut2_to_dut1_ip4} | ${dut1_to_dut2} | vrf=${dut1_fib_table2}
| | Vpp Route Add | ${dut1_node} | ${tg1_ip4} | ${prefix4}
| | ... | ${dut1_vhost_ip_2} | ${vhost_if_11} | vrf=${dut1_fib_table2}
...
| | ...
| | Add Arp On Dut | ${dut2_node} | ${dut2_to_dut1}
| | ... | ${dut1_to_dut2} | ${dut1_to_dut2_mac} | vrf=${dut2_fib_table}
...
| | ... | ${dut2_vhost_ip_1} | ${vhost_if_22} | vrf=${dut2_fib_table}
| | Vpp Route Add | ${dut2_node} | ${tg1_ip4} | ${prefix4}
| | ... | ${dut2_vhost_ip_2} | ${vhost_if_21} | vrf=${dut2_fib_table2}
| | Vpp Route Add | ${dut2_node} | ${tg1_ip4} | ${prefix4}
| | ... | ${dut2_to_dut1_ip4} | ${dut1_to_dut2} | vrf=${dut2_fib_table}
