...
| | Add IP Neighbor | ${dut1_node} | ${dut1_to_dut2} | ${dut1_to_dut2_ip6} | ${dut2_to_dut1_mac}
| | Add IP Neighbor | ${dut2_node} | ${dut2_to_dut1} | ${dut2_to_dut1_ip6} | ${dut1_to_dut2_mac}
| | Vpp Route Add | ${dut1_node} | ${tg2_ip6} | 64 | ${dut1_to_dut2_ip6} | ${dut1_to_dut2}
| | Vpp Route Add | ${dut2_node} | ${tg1_ip6} | 64 | ${dut2_to_dut1_ip6} | ${dut2_to_dut1}
...
#| | ... | ${auth_key} | ${dut1_spi} | ${dut2_spi} | ${dut1_to_dut2_ip6} | ${dut2_to_dut1_ip6}
#| | VPP Setup IPsec Manual Keyed Connection
#| | ... | ${dut2_node} | ${dut2_to_dut1} | ${encr_alg} | ${encr_key} | ${auth_alg}
#| | ... | ${auth_key} | ${dut2_spi} | ${dut1_spi} | ${dut2_to_dut1_ip6} | ${dut1_to_dut2_ip6}
