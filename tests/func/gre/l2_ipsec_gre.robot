...
| Documentation | *IPSecGRE test cases*
| ...
| ... | *[Top] Network Topologies:* TG=DUT1 2-node topology with two links\
| ... | between nodes; TG-DUT1-DUT2-TG 3-node circular topology with single\
| ... | links between nodes.
| ... | *[Enc] Packet Encapsulations:* Eth-IPv4-ESP-GRE-Eth-IPv4-ICMP
...
| | ... | [Ver] Packet is send from TG and then transfered from BD to\
...
| | ... | ${encr_alg} | ${encr_key} | ${auth_alg} | ${auth_key}
| | ${ipsec_gpe_idx}= | And Add Del IPSec GRE Interface | ${dut1_node}
| | ... | ${dut1_to_dut2_ip} | ${dut2_to_dut1_ip}
| | ... | ${l_sa_id} | ${r_sa_id} | state_up=${TRUE}
...
| | ${ipsec_gpe_idx}= | And Add Del IPSec GRE Interface | ${dut2_node}
| | ... | ${dut2_to_dut1_ip} | ${dut1_to_dut2_ip}
| | ... | ${r_sa_id} | ${l_sa_id} | state_up=${TRUE}
...
| | ... | configured for neighbors along with Bridge Domain.
| | ... | [Ver] Packet is sent from TG and then transfered from BD to\
...
| | ... | ${encr_alg} | ${encr_key} | ${auth_alg} | ${auth_key}
| | ${ipsec_gpe_idx}= | And Add Del IPSec GRE Interface | ${dut_node}
| | ... | ${dut1_to_dut2_ip} | ${dut2_to_dut1_ip}
| | ... | ${l_sa_id} | ${r_sa_id} | state_up=${TRUE}
