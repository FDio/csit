...
| ... | *[Ver] TG verification:* Test packets are sent from TG on the first link\
| ... | to DUT. Packet is received on TG on the second link from DUT1.
...
| ${neighbor_3_ip}= | 192.168.2.30
| ${neighbor_3_mac}= | 02:00:00:00:00:04
...
| | ... | [Ver] TG sends 100 IPv4 ICMP packets traffic on the first link to DUT.
| | ... | On second link to TG verify if traffic is divided to two paths.
