...
*** Test Cases ***
| VPP proxies valid DHCPv4 request to DHCPv4 server
| | [Documentation] |
| | ... | [Top] TG=DUT
...
| | ... | ${tg_to_dut_if2_mac}
| | DHCP Proxy Config | ${dut_node} | ${dhcp_server_ip} | ${dut_to_tg_if1_ip}
...
| VPP proxy ignores invalid DHCPv4 request
| | [Documentation] |
| | ... | [Top] TG=DUT
| | ... | [Cfg] On DUT setup DHCP proxy.
...
| | ... | ${tg_to_dut_if2_mac}
| | DHCP Proxy Config | ${dut_node} | ${dhcp_server_ip} | ${dut_to_tg_if1_ip}
| | Send DHCP DISCOVER | ${tg_node} | ${tg_to_dut_if1}
| | ... | ${tg_to_dut_if2} | 0.0.0.0 | 255.255.255.255
| | Send DHCP DISCOVER should fail | ${tg_node} | ${tg_to_dut_if1}
| | ... | ${tg_to_dut_if2} | 0.0.0.0 | 255.255.255.1
