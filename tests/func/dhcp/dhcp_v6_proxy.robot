...
*** Test Cases ***
| VPP proxies valid DHCPv6 request to DHCPv6 server
| | [Documentation] |
| | ... | [Top] TG=DUT \
...
| | And VPP Route Add | ${dut_node} | ff02::1:2 | 64 | ${NONE} | local
| | ... | ${FALSE} | ${NONE}
| | And VPP Route Add | ${dut_node} | 3ffe:62::1 | 64 | ${NONE} | local
| | ... | ${FALSE} | ${NONE}
...
| | Send DHCPv6 Messages | ${tg_node} | ${tg_to_dut_if1} | ${tg_to_dut_if2}
| | ... | ${dut_to_tg_if1_ip} | ${dhcp_server_ip} | ${tg_to_dut_if1_mac}
| | ... | ${tg_to_dut_if2_mac}
