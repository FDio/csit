...
*** Test Cases ***
| TC01: virtio2p-dot1q-l2bdbasemaclrn-eth-2vhost-1vm - ipv4
| | [Documentation]
| | ... | [Top] TG=DUT.
...
| | And VPP Vhost interfaces for L2BD forwarding are setup | ${dut_node}
| | ...                                                    | ${sock1}
| | ...                                                    | ${sock2}
| | And VM for Vhost L2BD forwarding is setup | ${dut_node} | ${sock1}
| | ...                                       | ${sock2}
| | And Interfaces are added to BD | ${dut_node} | ${bd_id1}
| | ...                            | ${vlan1_index} | ${vhost_if1}
| | And Interfaces are added to BD | ${dut_node} | ${bd_id2}
| | ...                            | ${vlan2_index} | ${vhost_if2}
...
| TC01: virtio2p-dot1q-l2bdbasemaclrn-eth-2vhost-1vm - ipv6
| | [Documentation]
| | ... | [Top] TG=DUT.
