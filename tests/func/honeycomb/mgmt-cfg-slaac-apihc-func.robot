...
| TC03: Honeycomb can configure SLAAC
| | [Documentation] | Checks if Honeycomb can congigure SLAAC after removing it.
...
| | And Honeycomb sets interface ipv6 address | ${node} | ${interface} 
| | ... | ${address} | ${prefix}
| | When Honeycomb configures SLAAC | ${node} | ${interface} | ${slaac_data_16}
| | Then SLAAC configuration from Honeycomb should be | ${node} | ${interface} 
| | ... | ${slaac_data_16}
...
| | And Honeycomb sets interface ipv6 address | ${node} | ${interface} 
| | ... | ${address} | ${prefix}
| | When Honeycomb configures SLAAC | ${node} | ${interface} | ${slaac_data_17}
| | Then SLAAC configuration from Honeycomb should be | ${node} | ${interface} 
| | ... | ${slaac_data_17}
...
| | And Honeycomb sets interface ipv6 address | ${node} | ${interface} 
| | ... | ${address} | ${prefix}
| | When Honeycomb configures SLAAC | ${node} | ${interface} | ${slaac_data_18}
| | Then SLAAC configuration from Honeycomb should be | ${node} | ${interface} 
| | ... | ${slaac_data_18}
