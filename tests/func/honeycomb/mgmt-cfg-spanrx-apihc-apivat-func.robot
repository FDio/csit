...
| TC04: Honeycomb can configure SPAN with two source interfaces
| | [Documentation] | Honeycomb configures SPAN on interface and verifies
| | ... | against VPP SPAN dump in state both.
| | ...
| | When Honeycomb Configures SPAN on interface
...
| | [Documentation] | Honeycomb configures SPAN on two interface and verifies
...
| | ... | ${node} | ${interface2}
| | When Honeycomb Configures SPAN on interface
| | ... | ${node} | ${interface1} | ${settings_4}
| | And Honeycomb Configures SPAN on interface
| | ... | ${node} | ${interface2} | ${settings_4}
| | Then Interface SPAN configuration from Honeycomb should be
| | ... | ${node} | ${interface1} | ${settings_4}
| | Then Interface SPAN configuration from Honeycomb should be
| | ... | ${node} | ${interface2} | ${settings_4}
...
| | ... | ${node} | ${interface1} | ${1} | ${settings_1}
| | Then sub-Interface SPAN configuration from Honeycomb should be
| | ... | ${node} | ${interface1} | ${1} | ${settings_1}
...
| | ... | ${node} | ${interface1} | ${1} | down | up
| | When Honeycomb Configures SPAN on sub-interface
| | ... | ${node} | ${interface1} | ${1} | ${settings_3}
| | Then sub-Interface SPAN configuration from Honeycomb should be
| | ... | ${node} | ${interface1} | ${1} | ${settings_3}

| TC11: Honeycomb can configure SPAN on two interfaces
| | [Documentation] | Honeycomb configures SPAN on sub-interface and verifies
| | ... | against VPP SPAN dump in state both.
| | ...
| | Given Sub-interface state from Honeycomb should be
| | ... | ${node} | ${interface1} | ${1} | down | up
| | When Honeycomb Configures SPAN on sub-interface
| | ... | ${node} | ${interface1} | ${1} | ${settings_2} | ${settings_4}
| | Then sub-Interface SPAN configuration from Honeycomb should be
| | ... | ${node} | ${interface1} | ${1} | ${settings_2} | ${settings_4}
...
| | Given Sub-interface state from Honeycomb should be
| | ... | ${node} | ${interface1} | ${1} | down | up
| | Given sub-Interface SPAN configuration from Honeycomb should be
| | ... | ${node} | ${interface1} | ${1} | ${settings_2} | ${settings_4}
| | When Honeycomb removes sub-interface SPAN configuration
| | ... | ${node} | ${interface1} | ${1}
| | Then sub-Interface SPAN configuration from Honeycomb should be empty
| | ... | ${node} | ${interface1} | ${1}
...
| | When Honeycomb Configures SPAN on sub-interface
| | ... | ${node} | ${interface1} | ${1} | ${settings_4}
| | And Honeycomb Configures SPAN on sub-interface
| | ... | ${node} | ${interface2} | ${1} | ${settings_4}
| | Then Sub-Interface SPAN configuration from Honeycomb should be
| | ... | ${node} | ${interface1} | ${1} | ${settings_4}
| | Then Sub-Interface SPAN configuration from Honeycomb should be
| | ... | ${node} | ${interface2} | ${1} | ${settings_4}
