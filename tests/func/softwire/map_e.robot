...
| | ...
#| | [Setup] | Set interfaces IP addresses and route
| | [Setup] | Run Keywords
| | ... | Setup all DUTs before test | AND
| | ... | Setup all TGs before traffic script | AND
| | ... | Set interfaces IP addresses and route
...
# | ipv4_pfx          | ipv6_pfx      | ipv6_src    | ea_bit_len | psid_offset | psid_len | ipv4_dst       | dst_port | expected_ipv6_dst                 |
# |===================|===============|=============|============|=============|==========|================|==========|===================================|
| | 20.0.0.0/8        | 2001::/16     | ${ipv6_src} | ${48}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:a9c9:db34::14a9:c9db:34      |
| | 20.169.0.0/16     | 2001::/16     | ${ipv6_src} | ${48}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:c9db:3400::14a9:c9db:34      |
| | 20.169.201.0/24   | 2001::/16     | ${ipv6_src} | ${48}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:db34::14a9:c9db:34           |
| | 20.169.201.219/32 | 2001::/16     | ${ipv6_src} | ${48}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:3400::14a9:c9db:34           |

| | 20.0.0.0/8        | 2001::/24     | ${ipv6_src} | ${40}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:a9:c9db:3400:0:14a9:c9db:34  |
| | 20.169.0.0/16     | 2001::/24     | ${ipv6_src} | ${40}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:c9:db34::14a9:c9db:34        |
| | 20.169.201.0/24   | 2001::/24     | ${ipv6_src} | ${40}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:db:3400::14a9:c9db:34        |
| | 20.169.201.219/32 | 2001::/24     | ${ipv6_src} | ${40}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:34::14a9:c9db:34             |
| | 20.169.0.0/16     | 2001::/16     | ${ipv6_src} | ${40}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:c9db:3400::14a9:c9db:34      |
| | 20.169.201.219/32 | 2001::/16     | ${ipv6_src} | ${40}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:3400::14a9:c9db:34           |

| | 20.0.0.0/8        | 2001:db8::/32 | ${ipv6_src} | ${32}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:db8:a9c9:db34:0:14a9:c9db:34 |
| | 20.169.0.0/16     | 2001:db8::/32 | ${ipv6_src} | ${32}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:db8:c9db:3400:0:14a9:c9db:34 |
| | 20.169.201.0/24   | 2001:db8::/32 | ${ipv6_src} | ${32}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:db8:db34::14a9:c9db:34       |
| | 20.169.201.219/32 | 2001:db8::/32 | ${ipv6_src} | ${32}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:db8:3400::14a9:c9db:34       |
| | 20.169.0.0/16     | 2001::/24     | ${ipv6_src} | ${32}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:c9:db34::14a9:c9db:34        |
| | 20.169.201.0/24   | 2001::/24     | ${ipv6_src} | ${32}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:db:3400::14a9:c9db:34        |
| | 20.169.0.0/16     | 2001::/16     | ${ipv6_src} | ${32}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:c9db:3400::14a9:c9db:34      |
| | 20.169.201.0/24   | 2001::/16     | ${ipv6_src} | ${32}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:db34::14a9:c9db:34           |

| | 20.160.0.0/12     | 2001:db8::/32 | ${ipv6_src} | ${25}      | ${6}        | ${5}     | 20.169.201.219 | ${1232}  | 2001:db8:9c9d:b300:0:14a9:c9db:6  |
| | 20.169.0.0/16     | 2001:db8::/32 | ${ipv6_src} | ${25}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:db8:c9db:3400:0:14a9:c9db:34 |
| | 20.169.201.0/24   | 2001:db8::/32 | ${ipv6_src} | ${25}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:db8:db34::14a9:c9db:34       |
| | 20.169.201.219/32 | 2001:db8::/32 | ${ipv6_src} | ${25}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:db8:3400::14a9:c9db:34       |

| | 20.169.192.0/20   | 2001:db8::/32 | ${ipv6_src} | ${17}      | ${6}        | ${5}     | 20.169.201.219 | ${1232}  | 2001:db8:9db3::14a9:c9db:6        |
| | 20.169.201.0/24   | 2001:db8::/32 | ${ipv6_src} | ${17}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:db8:db34::14a9:c9db:34       |
| | 20.169.201.219/32 | 2001:db8::/32 | ${ipv6_src} | ${17}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:db8:3400::14a9:c9db:34       |

| | 20.169.201.0/24   | 2001:db8::/32 | ${ipv6_src} | ${12}      | ${6}        | ${4}     | 20.169.201.219 | ${1232}  | 2001:db8:db30::14a9:c9db:3        |
| | 20.169.201.219/32 | 2001:db8::/32 | ${ipv6_src} | ${12}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  | 2001:db8:3400::14a9:c9db:34       |
...
# |===================|=========================|=============|============|=============|==========|================|==========|
| | 20.0.0.0/8        | 2001:db8:0012:3400::/56 | ${ipv6_src} | ${8}       | ${0}        | ${0}     | 20.169.201.219 | ${1232}  |
| | 20.169.201.208/28 | 2001:db8:0012:3400::/56 | ${ipv6_src} | ${8}       | ${5}        | ${4}     | 20.169.201.219 | ${3280}  |
| | 20.0.0.0/8        | 2001:db8:0012:3400::/64 | ${ipv6_src} | ${0}       | ${0}        | ${0}     | 20.169.201.219 | ${1232}  |
| | 20.169.201.219/32 | 2001:db8:0012:3400::/64 | ${ipv6_src} | ${0}       | ${0}        | ${0}     | 20.169.201.219 | ${1232}  |
...
# | ipv4_pfx          | ipv6_pfx                | ipv6_src    | ea_bit_len | psid_offset | psid_len | ipv4_dst       | dst_port |
# |===================|=========================|=============|============|=============|==========|================|==========|
| | 0.0.0.0/0         | 2001:db8:0000::/40      | ${ipv6_src} | ${8}       | ${0}        | ${0}     | 20.169.201.219 | ${1232}  |
| | 0.0.0.0/0         | 2001:db8:0000::/40      | ${ipv6_src} | ${16}      | ${0}        | ${0}     | 20.169.201.219 | ${1232}  |
| | 0.0.0.0/0         | 2001:db8::/32           | ${ipv6_src} | ${32}      | ${0}        | ${0}     | 20.169.201.219 | ${1232}  |
| | 0.0.0.0/0         | 2001::/16               | ${ipv6_src} | ${48}      | ${0}        | ${0}     | 20.169.201.219 | ${1232}  |
| | 0.0.0.0/0         | 2001::/16               | ${ipv6_src} | ${48}      | ${6}        | ${8}     | 20.169.201.219 | ${1232}  |
...
| | Vpp Route Add | ${dut_node} | 2001:: | 16 | ${dut_ip6_gw} | ${dut_to_tg_if2}
...
| | ... | 20.0.0.0/8 | 2001::/16 | ${ipv6_src} | ${48} | ${6} | ${8}
