...
# | ipv4_pfx | ipv6_pfx | ipv6_src | ea_bit_len | psid_offset | psid_len | ipv4_dst | dst_port | expected_ipv6_dst
#
| | 20.0.0.0/8      | 2001:db8::/32 | ${ipv6_src} | ${4}  | ${6} | ${8} | 20.169.201.219 | ${1232} |
| | 20.0.0.0/8      | 2001:db8::/32 | ${ipv6_src} | ${8}  | ${6} | ${8} | 20.169.201.219 | ${1232} |
| | 20.0.0.0/8      | 2001:db8::/32 | ${ipv6_src} | ${10} | ${6} | ${8} | 20.169.201.219 | ${1232} |
| | 20.0.0.0/8      | 2001:db8::/32 | ${ipv6_src} | ${16} | ${6} | ${8} | 20.169.201.219 | ${1232} |
| | 20.0.0.0/8      | 2001:db8::/32 | ${ipv6_src} | ${20} | ${6} | ${8} | 20.169.201.219 | ${1232} |
| | 20.0.0.0/8      | 2001:db8::/32 | ${ipv6_src} | ${23} | ${6} | ${8} | 20.169.201.219 | ${1232} |
| | 20.169.201.0/24 | 2001:db8::/32 | ${ipv6_src} | ${4}  | ${6} | ${8} | 20.169.201.219 | ${1232} |
| | 20.169.201.0/24 | 2001:db8::/32 | ${ipv6_src} | ${7}  | ${6} | ${8} | 20.169.201.219 | ${1232} |
