...
| | L2 Vlan Tag Rewrite | ${dut_node} | @{vhosts}[0] | push-1 | ${vlan_blue}
| | L2 Vlan Tag Rewrite | ${dut_node} | @{vhosts}[1] | push-1 | ${vlan_blue}
| | L2 Vlan Tag Rewrite | ${dut_node} | @{vhosts}[2] | push-1 | ${vlan_red}
| | L2 Vlan Tag Rewrite | ${dut_node} | @{vhosts}[3] | push-1 | ${vlan_red}
