...
| Test Teardown | Delete Kubernetes resource on all duts | ${nodes}
| ...
...
| ${s_limit} | ${10000000000}
# Kubernetes profile
| ${kubernetes_profile} | l2xc-1vs-1vnf
# Traffic profile:
...
| | ... | ${kubernetes_profile}/sfc.yaml | $$condition1$$=BLA
#| | Apply Kubernetes resource on all duts | ${nodes}
...
*** Test Cases ***
| tc01-64B-1t1c-eth-l2xcbase-eth-2memif-kubernetes-ndrdisc
| | [Documentation]
