...
| tc17-64B-4t4c-ethip4ipsecscale1ip4-ip4base-tunnels-aes-gcm-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel AES GCM in each direction, configured\
...
| tc18-64B-4t4c-ethip4ipsecscale1ip4-ip4base-tunnels-aes-gcm-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel AES GCM in each direction, configured\
...
| tc19-64B-4t4c-ethip4ipsecscale1000ip4-ip4base-tunnels-aes-gcm-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1000 IPsec tunnels AES GCM in each direction,\
...
| tc20-64B-4t4c-ethip4ipsecscale1000ip4-ip4base-tunnels-aes-gcm-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1000 IPsec tunnels AES GCM in each direction,\
| | ... | configured with 4 threads, 4 phy cores, 2 receive queue per NIC port.
| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 40GE\
