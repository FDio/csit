...
| tc03-1518B-1t1c-ethip4-ip4base-snat-1u-15p-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port. SNAT is configured between DUTs -\
| | ... | 1 user and 15 ports (sessions) per user.
...
| tc04-1518B-1t1c-ethip4-ip4base-snat-1u-15p-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port. SNAT is configured between DUTs -\
| | ... | 1 user and 15 ports (sessions) per user.
...
| tc05-1518B-1t1c-ethip4-ip4base-snat-1u-15p-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port. SNAT is configured between DUTs -\
| | ... | 1 user and 15 ports (sessions) per user.
...
| tc06-IMIX-1t1c-ethip4-ip4base-snat-1u-15p-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port. SNAT is configured between DUTs -\
| | ... | 1 user and 15 ports (sessions) per user.
