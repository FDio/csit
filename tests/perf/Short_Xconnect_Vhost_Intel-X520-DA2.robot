...
| TC03: Verify IMIX_v4_1 ref-NDR at 2x 138.58kpps - DUT L2XC-VHOST - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port. [Ver] Verify ref-NDR for IMIX_v4_1
| | ... | frame size using single trial throughput test.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | NDR
...
| TC06: Verify IMIX_v4_1 ref-NDR at 2x 138.58kpps - DUT L2XC-VHOST - 2thread 2core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC config with 2 threads, 2 phy cores, \
| | ... | 1 receive queue per NIC port. [Ver] Verify ref-NDR for IMIX_v4_1
| | ... | frame size using single trial throughput test.
...
| TC09: Verify IMIX_v4_1 ref-NDR at 2x 138.58kpps - DUT L2XC-VHOST - 4thread 4core 2rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC config with 4 threads, 4 phy cores, \
| | ... | 2 receive queues per NIC port. [Ver] Verify ref-NDR for IMIX_v4_1
| | ... | frame using single trial throughput test.
| | [Tags] | 4_THREAD_NOHTT_RXQUEUES_2 | MULTI_THREAD | NDR
| | ${framesize}= | Set Variable | IMIX_v4_1
| | ${duration}= | Set Variable | 10
| | ${rate}= | Set Variable | 0.1mpps
