...
| | framesize=${64} | rate=2.7mpps | wt=1 | rxq=1
...
| | ...
| | [Template] | Check PDR for L2XC with vhost and VM with dpdk-testpmd
| | framesize=${1518} | rate=738571pps | wt=1 | rxq=1
...
| | ...
| | [Template] | Check PDR for L2XC with vhost and VM with dpdk-testpmd
| | framesize=IMIX_v4_1 | rate=1.9mpps | wt=1 | rxq=1
...
| | ...
| | [Template] | Check PDR for L2XC with vhost and VM with dpdk-testpmd
| | framesize=${64} | rate=2.8mpps | wt=2 | rxq=1
...
| | ...
| | [Template] | Check PDR for L2XC with vhost and VM with dpdk-testpmd
| | framesize=IMIX_v4_1 | rate=3.2mpps | wt=2 | rxq=1
...
| | ...
| | [Template] | Check PDR for L2XC with vhost and VM with dpdk-testpmd
| | framesize=${64} | rate=7.7mpps | wt=4 | rxq=2
...
| | ...
| | [Template] | Check PDR for L2XC with vhost and VM with dpdk-testpmd
| | framesize=IMIX_v4_1 | rate=4.7mpps | wt=4 | rxq=2
