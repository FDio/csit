...
*** Test Cases ***
| tc01-64B-1t1c-ethip4ipsecscale1ip4-ip4base-ndrdisc
| | [Documentation]
...
| tc02-64B-1t1c-ethip4ipsecscale1000ip4-ip4base-ndrdisc
| | [Documentation]
...
| tc03-64B-1t1c-ethip4ipsecscale1ip4-ip4base-pdrdisc
| | [Documentation]
...
| tc04-64B-1t1c-ethip4ipsecscale1000ip4-ip4base-pdrdisc
| | [Documentation]
...
| tc05-1456B-1t1c-ethip4ipsecscale1ip4-ip4base-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel AES GCM in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| tc06-1456B-1t1c-ethip4ipsecscale1000ip4-ip4base-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1000 IPsec tunnels AES GCM in each direction,\
| | ... | configured with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find NDR for 1456 Byte frames\
...
| tc07-1456B-1t1c-ethip4ipsecscale1ip4-ip4base-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel CBC-SHA1 in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 10GE\
...
| tc08-1456B-1t1c-ethip4ipsecscale1000ip4-ip4base-pdrdisc
| | [Documentation]
...
| tc09-IMIX-1t1c-ethip4ipsecscale1ip4-ip4base-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel AES GCM in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| tc10-IMIX-1t1c-ethip4ipsecscale1000ip4-ip4base-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1000 IPsec tunnels AES GCM in each direction,\
| | ... | configured with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find NDR for IMIX_v4_1 frames\
...
| tc11-IMIX-1t1c-ethip4ipsecscale1ip4-ip4base-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel CBC-SHA1 in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| tc12-IMIX-1t1c-ethip4ipsecscale1000ip4-ip4base-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1000 IPsec tunnels CBC-SHA1 in each direction,\
| | ... | configured with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find PDR for IMIX_v4_1 frames using binary search start at 10GE\
