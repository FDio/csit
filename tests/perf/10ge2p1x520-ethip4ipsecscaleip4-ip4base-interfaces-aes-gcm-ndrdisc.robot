...
*** Test Cases ***
| tc00-64B-1t1c-ethip4ipsecSWscale1ip4-ip4base-interfaces-aes-gcm-ndrdisc
| | [Documentation]
...
| tc00-64B-1t1c-ethip4ipsecSWscale1ip4-ip4base-interfaces-aes-gcm-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel AES GCM in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| tc00-64B-1t1c-ethip4ipsecMODscale1ip4-ip4base-interfaces-aes-gcm-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel AES GCM in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find NDR for 64 Byte frames\
...
| | And Apply startup configuration on all VPP DUTs
| | And IPsec initialized in a 3-node circular topology
| | And IPsec Create Tunnel Interfaces
| | ... | ${dut1} | ${dut2} | ${dut1_if2_ip4} | ${dut2_if1_ip4} | ${n_tunnels}
| | ... | ${encr_alg} | ${encr_key} | ${auth_alg} | ${auth_key} | ${laddr_ip4}
| | ... | ${raddr_ip4} | ${addr_range}
| | Then Find NDR using binary search and pps | ${framesize}
...
| tc00-64B-1t1c-ethip4ipsecMODscale1ip4-ip4base-interfaces-aes-gcm-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel AES GCM in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 10GE\
...
| | And Apply startup configuration on all VPP DUTs
| | And IPsec initialized in a 3-node circular topology
| | And VPP Create Tunnel Interfaces
| | ... | ${dut1} | ${dut2} | ${dut1_if2_ip4} | ${dut2_if1_ip4} | ${n_tunnels}
| | ... | ${encr_alg} | ${encr_key} | ${auth_alg} | ${auth_key} | ${laddr_ip4}
| | ... | ${raddr_ip4} | ${addr_range}
| | Then Find PDR using binary search and pps | ${framesize}
