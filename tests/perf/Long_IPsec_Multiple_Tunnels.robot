...
| ...           | ${min_rate}pps | ${framesize} | 3-node-IPv4-dst-${n_tunnels}
| ...           | fail_on_loss=${False}
...
*** Test Cases ***
| TC01: 64B PDR binary search - IPsec 1 Tunnel CBC-SHA1 Performance Test - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 10GE\
| | ... | linerate, step 100kpps and loss tolerance of 16 packets
...
| | ...                     | ${dut1} | ${dut2} | ${dut1_if2}
| | ...                     | ${dut2_if1} | ${n_tunnels} | ${encr_alg}
| | ...                     | ${encr_key} | ${auth_alg} | ${auth_key}
| | ...                     | ${dut1_if2_ip4} | ${dut2_if1_ip4} | ${laddr_ip4}
...
| | ...                                       | ${min_rate} | ${max_rate}
| | ...                                       | ${threshold}
| | ...                                       | ${ipsec_pipeline} | frames

| TC02: 64B PDR binary search - IPsec 1000 CBC-SHA1 Tunnels Performance Test - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUTs run 1000 IPsec tunnels in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 10GE\
| | ... | linerate, step 100kpps and loss tolerance of 16 packets
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | PDR
...
| TC03: 64B NDR binary search - IPsec 1 Tunnel AES GCM Performance Test - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| TC04: 64B NDR binary search - IPsec 1000 Tunnels AES GCM Performance Test - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUTs run 1000 IPsec tunnels in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find NDR for 64 Byte frames\
...
| TC05: 1456B PDR binary search - IPsec 1 Tunnel CBC-SHA1 Performance Test - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 10GE\
...
| TC06: 1456B PDR binary search - IPsec 1000 Tunnels CBC-SHA1 Performance Test - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUTs run 1000 IPsec tunnel in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find PDR for 1456 Byte frames using binary search start at 10GE\
| | ... | linerate, step 100kpps and loss tolerance of 16 packets
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | PDR
| | ${n_tunnels}= | Set Variable | ${1000}
| | ${framesize}= | Set Variable | ${1456}
...
| TC07: 1456B NDR binary search - IPsec 1 Tunnel AES GCM Performance Test - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find NDR for 1456 Byte frames\
| | ... | using binary search start at 10GE linerate, step 100kpps.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | NDR
| | ${n_tunnels}= | Set Variable | ${1}
| | ${framesize}= | Set Variable | ${1456}
...
| TC08: 1456B NDR binary search - IPsec 1000 Tunnels AES GCM Performance Test - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUTs run 1000 IPsec tunnels in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find NDR for 1456 Byte frames\
...
| TC09: IMIX_v4_1 PDR binary search - IPsec 1 Tunnel CBC-SHA1 Performance Test - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| | ${min_rate}= | Set Variable | ${10000}
| | ${max_rate}= | Calculate pps | ${s_limit} | ${imix_size} + ${ipsec_overhead}
| | ${binary_min}= | Set Variable | ${min_rate}
| | ${binary_max}= | Set Variable | ${max_rate}
| | ${threshold}= | Set Variable | ${min_rate}
| | ${encr_alg}= | Crypto Alg AES CBC 128
...
| TC10: IMIX_v4_1 PDR binary search - IPsec 1000 Tunnels CBC-SHA1 Performance Test - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUTs run 1000 IPsec tunnels in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find PDR for IMIX_v4_1 frames using binary search start at 10GE\
...
| TC11: IMIX_v4_1 NDR binary search - IPsec 1 Tunnel AES GCM Performance Test - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| TC12: IMIX_v4_1 NDR binary search - IPsec 1000 Tunnels AES GCM Performance Test - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUTs run 1000 IPsec tunnels in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find NDR for IMIX_v4_1 frames\
