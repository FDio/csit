...
| | [Documentation]
| | ... | [Cfg] DUTs runs 1 IPsec tunnel in each direction, configured\
...
| TC02: 64B NDR binary search - IPsec 100 Tunnels Performance Test - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUTs runs 100 IPsec tunnels in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find NDR for 64 Byte frames\
| | ... | using binary search start at 10GE linerate, step 100kpps.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | NDR
...
| TC03: 64B NDR binary search - IPsec 10000 Tunnels Performance Test - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUTs runs 10000 IPsec tunnels in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find NDR for 64 Byte frames\
| | ... | using binary search start at 10GE linerate, step 100kpps.
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | NDR
