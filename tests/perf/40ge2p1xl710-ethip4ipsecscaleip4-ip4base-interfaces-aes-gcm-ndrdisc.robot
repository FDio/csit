...
| tc17-64B-4t4c-ethip4ipsecscale1ip4-ip4base-interfaces-aes-gcm-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel AES GCM in each direction, configured\
| | ... | with 4 thread, 4 phy core, 2 receive queue per NIC port.
| | ... | [Ver] Find NDR for 64 Byte frames\
| | ... | using binary search start at 40GE linerate, step 100kpps.
| | ...
...
| tc18-64B-4t4c-ethip4ipsecscale1ip4-ip4base-interfaces-aes-gcm-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel AES GCM in each direction, configured\
| | ... | with 4 threads, 4 phy core, 2 receive queue per NIC port.
| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 40GE\
| | ... | linerate, step 100kpps and loss tolerance of 0.5%.
| | ...
...
| tc19-64B-4t4c-ethip4ipsecscale1000ip4-ip4base-interfaces-aes-gcm-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1000 IPsec tunnels AES GCM in each direction,\
| | ... | configured with 4 threads, 4 phy cores, 2 receive queue per NIC port.
| | ... | [Ver] Find NDR for 64 Byte frames using binary search start at 40GE\
| | ... | at 40GE linerate, step 100kpps.
| | ...
| | [Tags] | 4T4C | MTHREAD | NDRDISC
| | ...
| | ${n_tunnels}= | Set Variable | ${1000}
...
| tc20-64B-4t4c-ethip4ipsecscale1000ip4-ip4base-interfaces-aes-gcm-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1000 IPsec tunnels AES GCM in each direction,\
| | ... | configured with 4 threads, 4 phy cores, 2 receive queue per NIC port.
| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 40GE\
