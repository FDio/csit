...
| TC02: Verify 1518B ref-NDR at 2x 0.1Mpps - DUT L2BD-VHOST - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 1 thread, 1 phy core, \
...
| TC03: Verify IMIX_v4_1 ref-NDR at 2x 0.1Mpps - DUT L2BD-VHOST - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 1 thread, 1 phy core, \
...
| TC04: Verify 64B ref-NDR at 2x 0.3Mpps - DUT L2BD-VHOST - 2thread 2core 1rxq
| | [Documentation]
...
| TC05: Verify 1518B ref-NDR at 2x 0.1Mpps - DUT L2BD-VHOST - 2thread 2core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 2 threads, 2 phy cores, \
| | ... | 1 receive queue per NIC port. [Ver] Verify ref-NDR for 1518 Byte
| | ... | frames using single trial throughput test.
...
| TC06: Verify IMIX_v4_1 ref-NDR at 2x 0.2Mpps - DUT L2BD-VHOST - 2thread 2core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 2 threads, 2 phy cores, \
| | ... | 1 receive queue per NIC port. [Ver] Verify ref-NDR for IMIX_v4_1
| | ... | frame size using single trial throughput test.
...
| TC07: Verify 64B ref-NDR at 2x 0.3Mpps - DUT L2BD-VHOST - 4thread 4core 2rxq
| | [Documentation]
...
| TC08: Verify 1518B ref-NDR at 2x 0.1Mpps - DUT L2BD-VHOST - 4thread 4core 2rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 4 threads, 4 phy cores, \
...
| TC09: Verify IMIX_v4_1 ref-NDR at 2x 0.2Mpps - DUT L2BD-VHOST - 4thread 4core 2rxq
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 4 threads, 4 phy cores, \
