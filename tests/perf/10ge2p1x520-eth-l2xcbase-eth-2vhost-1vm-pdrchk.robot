...
| | framesize=${64} | rate=3.1mpps | wt=1 | rxq=1
...
| | ...
| | [Template] | Check PDR for L2XC with vhost and VM with dpdk-testpmd
| | framesize=${1518} | rate=808200pps | wt=1 | rxq=1
...
| | ...
| | [Template] | Check PDR for L2XC with vhost and VM with dpdk-testpmd
| | framesize=${64} | rate=5.9mpps | wt=2 | rxq=1
...
| | ...
| | [Template] | Check PDR for L2XC with vhost and VM with dpdk-testpmd
| | framesize=${1518} | rate=1.4mpps | wt=2 | rxq=1
...
| | ...
| | [Template] | Check PDR for L2XC with vhost and VM with dpdk-testpmd
| | framesize=IMIX_v4_1 | rate=3.9mpps | wt=2 | rxq=1
...
| | ...
| | [Template] | Check PDR for L2XC with vhost and VM with dpdk-testpmd
| | framesize=IMIX_v4_1 | rate=6.0mpps | wt=4 | rxq=2
