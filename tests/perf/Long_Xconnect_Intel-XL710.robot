...
| ... | 3-node Performance Suite Setup with DUT's NIC model | L2 | Intel-XL710
| ... | AND | Set Suite Variable | ${s_24.5G}= | ${24500000000}
| ... | AND | Set Suite Variable | ${s_18.75Mpps}= | ${18750000000}
