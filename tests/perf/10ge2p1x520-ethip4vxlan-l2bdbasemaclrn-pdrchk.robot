...
| | ...
| | [Template] | Check PDR for L2BD forwarding with VXLAN over IPv4
| | framesize=${1518 + ${vxlan_overhead}} | rate=787153pps | wt=1 | rxq=1
...
| | ...
| | [Template] | Check PDR for L2BD forwarding with VXLAN over IPv4
| | framesize=${9000 + ${vxlan_overhead}} | rate=137816pps | wt=1 | rxq=1
...
| | ...
| | [Template] | Check PDR for L2BD forwarding with VXLAN over IPv4
| | framesize=${1518 + ${vxlan_overhead}} | rate=787153pps | wt=2 | rxq=1
...
| | ...
| | [Template] | Check PDR for L2BD forwarding with VXLAN over IPv4
| | framesize=${9000 + ${vxlan_overhead}} | rate=137816pps | wt=2 | rxq=1
...
| | ...
| | [Template] | Check PDR for L2BD forwarding with VXLAN over IPv4
| | framesize=${64 + ${vxlan_overhead}} | rate=8.4mpps | wt=4 | rxq=2
...
| | ...
| | [Template] | Check PDR for L2BD forwarding with VXLAN over IPv4
| | framesize=${1518 + ${vxlan_overhead}} | rate=787153pps | wt=4 | rxq=2
...
| | ...
| | [Template] | Check PDR for L2BD forwarding with VXLAN over IPv4
| | framesize=${9000 + ${vxlan_overhead}} | rate=137816pps | wt=4 | rxq=2
