...
*** Test Cases ***
| tc01-64B-1t1c-ethip4udp-ip4scale1000-udpdstscale15-snat-ndrdisc
| | [Documentation]
...
| tc02-64B-1t1c-ethip4udp-ip4scale1000-udpdstscale15-snat-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port. SNAT is configured between DUTs -\
| | ... | 1000 users and 15 ports (sessions) per user.
...
| tc03-1518B-1t1c-ethip4udp-ip4scale1000-udpdstscale15-snat-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port. SNAT is configured between DUTs -\
| | ... | 1000 users and 15 ports (sessions) per user.
...
| tc04-1518B-1t1c-ethip4udp-ip4scale1000-udpdstscale15-snat-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port. SNAT is configured between DUTs -\
| | ... | 1000 users and 15 ports (sessions) per user.
...
| tc05-IMIX-1t1c-ethip4udp-ip4scale1000-udpdstscale15-snat-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port. SNAT is configured between DUTs -\
| | ... | 1000 users and 15 ports (sessions) per user.
...
| tc06-IMIX-1t1c-ethip4udp-ip4scale1000-udpdstscale15-snat-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port. SNAT is configured between DUTs -\
| | ... | 1000 users and 15 ports (sessions) per user.
