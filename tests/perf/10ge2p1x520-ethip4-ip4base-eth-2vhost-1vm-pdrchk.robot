...
| | ...
| | [Template] | Check PDR for IPv4 routing with vhost and VM with dpdk-testpmd
| | framesize=${1518} | rate=717891pps | wt=1 | rxq=1
...
| | ...
| | [Template] | Check PDR for IPv4 routing with vhost and VM with dpdk-testpmd
| | framesize=${64} | rate=5.7mpps | wt=2 | rxq=1
...
| | ...
| | [Template] | Check PDR for IPv4 routing with vhost and VM with dpdk-testpmd
| | framesize=${1518} | rate=717891pps | wt=2 | rxq=1
...
| | ...
| | [Template] | Check PDR for IPv4 routing with vhost and VM with dpdk-testpmd
| | framesize=IMIX_v4_1 | rate=3.6mpps | wt=2 | rxq=1
...
| | ...
| | [Template] | Check PDR for IPv4 routing with vhost and VM with dpdk-testpmd
| | framesize=${64} | rate=7.8mpps | wt=4 | rxq=2
...
| | ...
| | [Template] | Check PDR for IPv4 routing with vhost and VM with dpdk-testpmd
| | framesize=${1518} | rate=717891pps | wt=4 | rxq=2
...
| | ...
| | [Template] | Check PDR for IPv4 routing with vhost and VM with dpdk-testpmd
| | framesize=IMIX_v4_1 | rate=5.3mpps | wt=4 | rxq=2
