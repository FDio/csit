...
| ... | interconnecting vhost-user interfaces using 3 cores pinned to cpus 5,6,\
| ... | 7 and 2048M memory. Testpmd is using socket-mem=1024M (512x2M\
| ... | hugepages), 3 cores (1 main core and 2 cores dedicated for io),\
| ... | forwarding mode is set to mac, rxq/txq=2048, burst=64. DUT1, DUT2 are\
...
| TC02: Verify 1518B ref-NDR at 2x 0.1Mpps - DUT IPv4-VHOST - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port.
...
| TC03: Verify IMIX_v4_1 ref-NDR at 2x 0.1Mpps - DUT IPv4-VHOST - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Verify ref-NDR for IMIX_v4_1 frame size using single trial\
| | ... | throughput test. IMIX_v4_1 = (28x64B;16x570B;4x1518B)
| | [Tags] | 1_THREAD_NOHTT_RXQUEUES_1 | SINGLE_THREAD | NDR
...
| TC04: Verify 64B ref-NDR at 2x 0.1Mpps - DUT IPv4-VHOST - 2thread 2core 1rxq
| | [Documentation]
...
| TC05: Verify 1518B ref-NDR at 2x 0.1Mpps - DUT IPv4-VHOST - 2thread 2core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 2 thread, 2 phy core,\
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Verify ref-NDR for 1518 Byte frames using single trial\
...
| TC06: Verify IMIX_v4_1 ref-NDR at 2x 0.1Mpps - DUT IPv4-VHOST - 2thread 2core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 2 thread, 2 phy core,\
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Verify ref-NDR for IMIX_v4_1 frame size using single trial\
...
| TC07: Verify 64B ref-NDR at 2x 0.1Mpps - DUT IPv4-VHOST - 4thread 4core 2rxq
| | [Documentation]
...
| TC08: Verify 1518B ref-NDR at 2x 0.1Mpps - DUT IPv4-VHOST - 4thread 4core 2rxq
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 4 thread, 4 phy core,\
| | ... | 2 receive queue per NIC port.
| | ... | [Ver] Verify ref-NDR for 1518 Byte frames using single trial\
...
| TC09: Verify IMIX_v4_1 ref-NDR at 2x 0.1Mpps - DUT IPv4-VHOST - 4thread 4core 2rxq
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 4 thread, 4 phy core,\
| | ... | 2 receive queue per NIC port.
| | ... | [Ver] Verify ref-NDR for IMIX_v4_1 frame size using single trial\
