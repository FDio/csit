...
| ... | AND | Create '1' LXC containers on all DUT nodes with '1' cpus | ${lxc}
| ... | AND | Install VPP on all LXC containers on all DUT nodes | ${lxc}
| Test Teardown | Run Keywords | Performance test teardown | ${min_rate}pps
| ... | ${framesize} | ${traffic_profile}
| ... | AND | Destroy all LXC containers on all DUT nodes
| ...
...
*** Keywords ***
| L2 Cross Connect with Memif NDR Binary Search
...
| L2 Cross Connect with Memif PDR Binary Search
| | [Arguments] | ${framesize} | ${min_rate} | ${wt} | ${rxq}
| | Set Test Variable | ${framesize}
| | Set Test Variable | ${min_rate}
| | ${max_rate}= | Calculate pps | ${s_limit} | ${framesize}
...
| | [Template] | L2 Cross Connect with Memif NDR Binary Search
