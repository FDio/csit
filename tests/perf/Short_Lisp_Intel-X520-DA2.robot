...
| TC02: Verify 1480B ref-NDR at 2x 828.91kpps - DUT IPv4 - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port.
...
| TC03: Verify 9000B ref-NDR at 2x 138.46kpps - DUT IPv4 - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port.
...
| TC05: Verify 1480B ref-NDR at 2x 828.91kpps - DUT IPv4 - 2thread 2core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 2 threads, 2 phy cores, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Verify ref-NDR for 1480 Byte frames using single trial
...
| TC06: Verify 9000B ref-NDR at 2x 138.46kpps - DUT IPv4 - 2thread 2core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 2 threads, 2 phy cores, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Verify ref-NDR for 9000 Byte frames using single trial
...
| TC08: Verify 1480B ref-NDR at 2x 828.91kpps - DUT IPv4 - 4thread 4core 2rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 4 threads, 4 phy cores, \
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Verify ref-NDR for 1480 Byte frames using single trial
...
| TC09: Verify 9000B ref-NDR at 2x 138.46kpps - DUT IPv4 - 4thread 4core 2rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 4 threads, 4 phy cores, \
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Verify ref-NDR for 9000 Byte frames using single trial
...
| TC11: Verify 1460B ref-NDR at 2x 828.91kpps - DUT IPv6 - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port.
...
| TC12: Verify 9000B ref-NDR at 2x 138.46kpps - DUT IPv6 - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Verify ref-NDR for 9000 Byte frames using single trial
...
| TC14: Verify 1460B ref-NDR at 2x 828.91kpps - DUT IPv6 - 2thread 2core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 2 threads, 2 phy cores, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Verify ref-NDR for 1460 Byte frames using single trial
...
| TC15: Verify 9000B ref-NDR at 2x 138.46kpps - DUT IPv6 - 2thread 2core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 2 threads, 2 phy cores, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Verify ref-NDR for 9000 Byte frames using single trial
...
| TC17: Verify 1460B ref-NDR at 2x 828.91kpps - DUT IPv6 - 4thread 4core 2rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 4 threads, 4 phy cores, \
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Verify ref-NDR for 1460 Byte frames using single trial
...
| TC18: Verify 9000B ref-NDR at 2x 138.46kpps - DUT IPv6 - 4thread 4core 2rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 4 threads, 4 phy cores, \
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Verify ref-NDR for 9000 Byte frames using single trial
...
| TC20: Verify 1460B ref-NDR at 2x 818.06kpps - DUT IPv4oIPv6 - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Verify ref-NDR for 1460 Byte frames using single trial
...
| TC21: Verify 9000B ref-NDR at 2x 137.85kpps - DUT IPv4oIPv6 - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Verify ref-NDR for 9000 Byte frames using single trial
...
| TC23: Verify 1460B ref-NDR at 2x 818.06kpps - DUT IPv4oIPv6 - 2thread 2core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 2 threads, 2 phy cores, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Verify ref-NDR for 1460 Byte frames using single trial
...
| TC24: Verify 9000B ref-NDR at 2x 137.85kpps - DUT IPv4oIPv6 - 2thread 2core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 2 threads, 2 phy cores, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Verify ref-NDR for 9000 Byte frames using single trial
...
| TC26: Verify 1460B ref-NDR at 2x 818.06kpps - DUT IPv4oIPv6 - 4thread 4core 2rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 4 threads, 4 phy cores, \
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Verify ref-NDR for 1460 Byte frames using single trial
...
| TC27: Verify 9000B ref-NDR at 2x 137.86kpps - DUT IPv4oIPv6 - 4thread 4core 2rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 4 threads, 4 phy cores, \
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Verify ref-NDR for 9000 Byte frames using single trial
...
| TC29: Verify 1460B ref-NDR at 2x 818.06kpps - DUT IPv6oIPv4 - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Verify ref-NDR for 1460 Byte frames using single trial
...
| TC30: Verify 9000B ref-NDR at 2x 137.85kpps - DUT IPv6oIPv4 - 1thread 1core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Verify ref-NDR for 9000 Byte frames using single trial
...
| TC32: Verify 1460B ref-NDR at 2x 818.06kpps - DUT IPv6oIPv4 - 2thread 2core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 2 threads, 2 phy cores, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Verify ref-NDR for 1460 Byte frames using single trial
...
| TC33: Verify 9000B ref-NDR at 2x 137.85kpps - DUT IPv6oIPv4 - 2thread 2core 1rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 2 threads, 2 phy cores, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Verify ref-NDR for 9000 Byte frames using single trial
...
| TC35: Verify 1460B ref-NDR at 2x 818.06Kpps - DUT IPv6oIPv4 - 4thread 4core 2rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 4 threads, 4 phy cores, \
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Verify ref-NDR for 1460 Byte frames using single trial
...
| TC36: Verify 9000B ref-NDR at 2x 137.85Kpps - DUT IPv6oIPv4 - 4thread 4core 2rxq
| | [Documentation]
| | ... | [Cfg] DUT runs LISP tunnel config with 4 threads, 4 phy cores, \
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Verify ref-NDR for 9000 Byte frames using single trial
