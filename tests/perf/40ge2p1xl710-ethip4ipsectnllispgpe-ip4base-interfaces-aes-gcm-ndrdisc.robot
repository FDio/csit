...
| ... | *[Cfg] DUT configuration:* DUT1 and DUT2 are configured with N
...
| ${raddr_ip4}= | 20.20.20.1
| ${laddr_ip4}= | 10.10.10.1
| ${addr_range}= | ${32}
| ${ipsec_overhead_gcm}= | ${54}

*** Test Cases ***
| tc01-64B-1t1c-ethip4ipsectnllispgpe-ip4base-interfaces-aes-gcm-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUTs IPv4 LISP static adjacencies on DUT1 and DUT2 with 1 IPsec\
| | ... | tunnel AES GCM in each direction, configured with 1 thread, 1 phy\
...
| | ... | ${dut1} | ${dut2} | ${dut1_to_dut2_ip4} | ${dut2_to_dut1_ip4}
| | ... | ${n_tunnels} | ${encr_alg} | ${encr_key} | ${auth_alg} | ${auth_key}
