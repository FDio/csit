...
*** Test Cases ***
| tc01-64B-1t1c-ethip4-ip4base-eth-2vhost-1vm-vring256-ndrdisc
| | [Documentation]
...
#| tc02-64B-1t1c-ethip4-ip4base-eth-2vhost-1vm-vring256-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy core,\
#| | ... | 1 receive queue per NIC port.
...
#
#| tc04-1518B-1t1c-ethip4-ip4base-eth-2vhost-1vm-vring256-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy core,\
#| | ... | 1 receive queue per NIC port.
...
#
#| tc05-IMIX-1t1c-ethip4-ip4base-eth-2vhost-1vm-vring256-ndrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy core,\
#| | ... | 1 receive queue per NIC port.
...
#
#| tc06-IMIX-1t1c-ethip4-ip4base-eth-2vhost-1vm-vring256-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy core,\
#| | ... | 1 receive queue per NIC port.
...
| tc07-64B-2t2c-ethip4-ip4base-eth-2vhost-1vm-vring256-ndrdisc
| | [Documentation]
...
#
#| tc08-64B-2t2c-ethip4-ip4base-eth-2vhost-1vm-vring256-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 2 threads, 2 phy cores,\
#| | ... | 1 receive queue per NIC port.
#| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 10GE\
...
#
#| tc09-1518B-2t2c-ethip4-ip4base-eth-2vhost-1vm-vring256-ndrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 2 threads, 2 phy cores,\
#| | ... | 1 receive queue per NIC port.
#| | ... | [Ver] Find NDR for 1518 Byte frames using binary search start at 10GE\
...
#
#| tc10-1518B-2t2c-ethip4-ip4base-eth-2vhost-1vm-vring256-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 2 threads, 2 phy cores,\
#| | ... | 1 receive queue per NIC port.
#| | ... | [Ver] Find PDR for 1518 Byte frames using binary search start at 10GE\
...
#
#| tc11-IMIX-2t2c-ethip4-ip4base-eth-2vhost-1vm-vring256-ndrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 2 threads, 2 phy cores,\
#| | ... | 1 receive queue per NIC port.
#| | ... | [Ver] Find NDR for IMIX_v4_1 framesize using binary search start at\
...
#
#| tc12-IMIX-2t2c-ethip4-ip4base-eth-2vhost-1vm-vring256-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 2 threads, 2 phy cores,\
#| | ... | 1 receive queue per NIC port.
#| | ... | [Ver] Find PDR for IMIX_v4_1 framesize using binary search start at\
...
#
#| tc13-64B-4t4c-ethip4-ip4base-eth-2vhost-1vm-vring256-ndrdisc
#| | [Documentation]
...
#
#| tc14-64B-4t4c-ethip4-ip4base-eth-2vhost-1vm-vring256-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 4 threads, 4 phy cores,\
#| | ... | 2 receive queues per NIC port.
#| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 10GE\
...
#
#| tc15-1518B-4t4c-ethip4-ip4base-eth-2vhost-1vm-vring256-ndrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 4 threads, 4 phy cores,\
#| | ... | 2 receive queues per NIC port.
#| | ... | [Ver] Find NDR for 1518 Byte frames using binary search start at 10GE\
...
#
#| tc16-1518B-4t4c-ethip4-ip4base-eth-2vhost-1vm-vring256-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 4 threads, 4 phy cores,\
#| | ... | 2 receive queues per NIC port.
#| | ... | [Ver] Find PDR for 1518 Byte frames using binary search start at 10GE\
...
#
#| tc17-IMIX-4t4c-ethip4-ip4base-eth-2vhost-1vm-vring256-ndrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 4 threads, 4 phy cores,\
#| | ... | 2 receive queues per NIC port.
#| | ... | [Ver] Find NDR for IMIX_v4_1 framesize using binary search start at\
...
#
#| tc18-IMIX-4t4c-ethip4-ip4base-eth-2vhost-1vm-vring256-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 4 threads, 4 phy cores,\
#| | ... | 2 receive queues per NIC port.
#| | ... | [Ver] Find PDR for IMIX_v4_1 framesize using binary search start at\
