...
| L2 bridge domain PDR check with jumbo frames
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Verify ref-PDR for 64 Byte frames using single trial\
...
| | ...
| | [Template] | L2 bridge domain PDR check
...
| | ...
| | [Template] | L2 bridge domain PDR check with jumbo frames
