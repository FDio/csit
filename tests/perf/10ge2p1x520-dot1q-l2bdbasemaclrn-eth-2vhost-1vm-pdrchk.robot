...
| | ...
| | [Template] | Check PDR for L2 bridge domain with vhost and VM with dpdk-testpmd
| | framesize=IMIX_v4_1 | rate=1.8pps | wt=1 | rxq=1
...
| | ...
| | [Template] | Check PDR for L2 bridge domain with vhost and VM with dpdk-testpmd
| | framesize=${64} | rate=2.4mpps | wt=2 | rxq=1
...
| | ...
| | [Template] | Check PDR for L2 bridge domain with vhost and VM with dpdk-testpmd
| | framesize=${1518} | rate=716053pps | wt=2 | rxq=1
...
| | ...
| | [Template] | Check PDR for L2 bridge domain with vhost and VM with dpdk-testpmd
| | framesize=IMIX_v4_1 | rate=1.8pps | wt=2 | rxq=1
...
| | ...
| | [Template] | Check PDR for L2 bridge domain with vhost and VM with dpdk-testpmd
| | framesize=${64} | rate=2.4mpps | wt=4 | rxq=2
...
| | ...
| | [Template] | Check PDR for L2 bridge domain with vhost and VM with dpdk-testpmd
| | framesize=${1518} | rate=716053pps | wt=4 | rxq=2
...
| | ...
| | [Template] | Check PDR for L2 bridge domain with vhost and VM with dpdk-testpmd
| | framesize=IMIX_v4_1 | rate=1.8pps | wt=4 | rxq=2
