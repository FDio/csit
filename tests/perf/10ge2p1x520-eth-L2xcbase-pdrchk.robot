...
| ... | NIC_Intel-X520-DA2 | ETH | L2XCFWD | BASE | L2XCBASE | THIS
| ...
...
*** Variables ***
| ${topology_type} | 3-node-xconnect

*** Keywords ***
| L2 xconnect PDR check
| | [Documentation]
...
| L2 xconnect PDR check with jumbo frames
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Verify ref-PDR for 64 Byte frames using single trial\
...
| | ...
| | [Template] | L2 xconnect PDR check
...
| | ...
| | [Template] | L2 xconnect PDR check with jumbo frames
...
| | ...
| | [Template] | L2 xconnect PDR check
| | framesize=${64} | rate=10.4mpps | wt=2 | rxq=2
...
| | ...
| | [Template] | L2 xconnect PDR check
| | framesize=${1815} | rate=812743pps | wt=2 | rxq=2
...
| | ...
| | [Template] | L2 xconnect PDR check with jumbo frames
| | framesize=${9000} | rate=138580pps | wt=2 | rxq=2
