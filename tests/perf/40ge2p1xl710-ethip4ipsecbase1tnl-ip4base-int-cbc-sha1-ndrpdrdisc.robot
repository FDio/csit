...
*** Test Cases ***
| tc01-64B-1t1c-ethip4ipsecbase1tnl-ip4base-int-cbc-sha1-ndrdisc
| | [Documentation]
...
| tc02-64B-1t1c-ethip4ipsecbase1tnl-ip4base-int-cbc-sha1-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel CBC-SHA1 in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| tc03-1518B-1t1c-ethip4ipsecbase1tnl-ip4base-int-cbc-sha1-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel CBC-SHA1 in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| tc04-1518B-1t1c-ethip4ipsecbase1tnl-ip4base-int-cbc-sha1-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel CBC-SHA1 in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| tc05-IMIX-1t1c-ethip4ipsecbase1tnl-ip4base-int-cbc-sha1-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel CBC-SHA1 in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| tc06-IMIX-1t1c-ethip4ipsecbase1tnl-ip4base-int-cbc-sha1-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel CBC-SHA1 in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| tc07-64B-2t2c-ethip4ipsecbase1tnl-ip4base-int-cbc-sha1-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel CBC-SHA1 in each direction, configured\
...
| tc08-64B-2t2c-ethip4ipsecbase1tnl-ip4base-int-cbc-sha1-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel CBC-SHA1 in each direction, configured\
| | ... | with 2 thread, 2 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 40GE\
