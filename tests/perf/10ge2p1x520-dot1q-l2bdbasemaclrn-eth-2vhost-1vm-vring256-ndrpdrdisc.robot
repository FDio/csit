...
*** Keywords ***
| L2 Bridge Domain with VLAN and VM Binary Search
| | [Arguments] | ${framesize} | ${min_rate} | ${wt} | ${rxq} | ${search_type}
| | ...
| | Set Test Variable | ${perf_qemu_qsz} | 256
| | Set Test Variable | ${framesize}
| | Set Test Variable | ${min_rate}
| | ${get_frame}= | Set Variable If
| | ... | "${framesize}" == "IMIX_v4_1" | ${avg_imix_framesize}
| | ... |  ${framesize + ${vlan_overhead}}
| | ${max_rate}= | Calculate pps | ${s_limit} | ${get_frame}
...
| | And Run Keyword If | ${get_frame} < ${1522} | Add No Multi Seg to all DUTs
...
*** Test Cases ***
| tc01-64B-1t1c-dot1q-l2bdbasemaclrn-eth-2vhost-1vm-vring256-ndrdisc
| | ... | framesize=${64} | min_rate=${10000} | wt=1 | rxq=1 | search_type=NDR
| | [Documentation]
...
| | ...
| | [Template] | L2 Bridge Domain with VLAN and VM Binary Search

| tc02-64B-1t1c-dot1q-l2bdbasemaclrn-eth-2vhost-1vm-vring256-pdrdisc
| | ... | framesize=${64} | min_rate=${10000} | wt=1 | rxq=1 | search_type=PDR
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port.
...
| tc03-1518B-1t1c-dot1q-l2bdbasemaclrn-eth-2vhost-1vm-vring256-ndrdisc
...
| tc04-1518B-1t1c-dot1q-l2bdbasemaclrn-eth-2vhost-1vm-vring256-pdrdisc
...
| tc05-IMIX-1t1c-dot1q-l2bdbasemaclrn-eth-2vhost-1vm-vring256-ndrdisc
| | ... | framesize=IMIX_v4_1 | min_rate=${10000} | wt=1 | rxq=1
| | ... | search_type=NDR
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port.
...
| tc06-IMIX-1t1c-dot1q-l2bdbasemaclrn-eth-2vhost-1vm-vring256-pdrdisc
| | ... | framesize=IMIX_v4_1 | min_rate=${10000} | wt=1 | rxq=1
| | ... | search_type=PDR
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy core,\
...
| tc07-64B-2t2c-dot1q-l2bdbasemaclrn-eth-2vhost-1vm-vring256-ndrdisc
| | ... | framesize=${64} | min_rate=${10000} | wt=2 | rxq=1 | search_type=NDR
| | [Documentation]
...
| tc08-64B-2t2c-dot1q-l2bdbasemaclrn-eth-2vhost-1vm-vring256-pdrdisc
| | ... | framesize=${64} | min_rate=${10000} | wt=2 | rxq=1 | search_type=PDR
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 2 threads, 2 phy cores,\
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 10GE\
...
| tc09-1518B-2t2c-dot1q-l2bdbasemaclrn-eth-2vhost-1vm-vring256-ndrdisc
...
| tc10-1518B-2t2c-dot1q-l2bdbasemaclrn-eth-2vhost-1vm-vring256-pdrdisc
...
| tc11-IMIX-2t2c-dot1q-l2bdbasemaclrn-eth-2vhost-1vm-vring256-ndrdisc
| | ... | framesize=IMIX_v4_1 | min_rate=${10000} | wt=2 | rxq=1
| | ... | search_type=NDR
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 2 threads, 2 phy cores,\
| | ... | 1 receive queue per NIC port.
...
| tc12-IMIX-2t2c-dot1q-l2bdbasemaclrn-eth-2vhost-1vm-vring256-pdrdisc
| | ... | framesize=IMIX_v4_1 | min_rate=${10000} | wt=2 | rxq=1
| | ... | search_type=PDR
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 2 threads, 2 phy cores,\
...
| tc13-64B-4t4c-dot1q-l2bdbasemaclrn-eth-2vhost-1vm-vring256-ndrdisc
| | ... | framesize=${64} | min_rate=${10000} | wt=4 | rxq=2 | search_type=NDR
| | [Documentation]
...
| tc14-64B-4t4c-dot1q-l2bdbasemaclrn-eth-2vhost-1vm-vring256-pdrdisc
| | ... | framesize=${64} | min_rate=${10000} | wt=4 | rxq=2 | search_type=PDR
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 4 threads, 4 phy cores,\
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 10GE\
...
| tc15-1518B-4t4c-dot1q-l2bdbasemaclrn-eth-2vhost-1vm-vring256-ndrdisc
...
| tc16-1518B-4t4c-dot1q-l2bdbasemaclrn-eth-2vhost-1vm-vring256-pdrdisc
...
| tc17-IMIX-4t4c-dot1q-l2bdbasemaclrn-eth-2vhost-1vm-vring256-ndrdisc
| | ... | framesize=IMIX_v4_1 | min_rate=${10000} | wt=4 | rxq=2
| | ... | search_type=NDR
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 4 threads, 4 phy cores,\
| | ... | 2 receive queues per NIC port.
...
| tc18-IMIX-4t4c-dot1q-l2bdbasemaclrn-eth-2vhost-1vm-vring256-pdrdisc
| | ... | framesize=IMIX_v4_1 | min_rate=${10000} | wt=4 | rxq=2
| | ... | search_type=PDR
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 4 threads, 4 phy cores,\
