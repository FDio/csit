...
| ...
| Suite Setup | Configure Honeycomb Netconf threads | ${node} | ${8}
| ...
| Force Tags | HC_PERF
| ...
| Documentation | *Base Netconf operational read test suite with eigth Netconf
| ... | threads.*
| ...
...
| | ... | with 10K requests generated in a single thread. Perform three cycles.
| | ${cycles}= | Set Variable | ${3}
| | ${threads}= | Set Variable | ${1}
| | ${entries}= | Set Variable | ${10000}
...
| | [Documentation]
| | ... | [Ver] Measure response time using single trial throughput test
| | ... | with 10K requests generated in two threads. Perform three cycles.
| | ${cycles}= | Set Variable | ${3}
| | ${threads}= | Set Variable | ${2}
| | ${entries}= | Set Variable | ${5000}
| | Run base operational read performance trial
| | ... | ${node} | ${cycles} | ${threads} | ${entries}
...
| | [Documentation]
| | ... | [Ver] Measure response time using single trial throughput test
| | ... | with 10K requests generated in four threads. Perform three cycles.
| | ${cycles}= | Set Variable | ${3}
| | ${threads}= | Set Variable | ${4}
| | ${entries}= | Set Variable | ${2500}
| | Run base operational read performance trial
| | ... | ${node} | ${cycles} | ${threads} | ${entries}
...
| | [Documentation]
| | ... | [Ver] Measure response time using single trial throughput test
| | ... | with 10K requests generated in eigth threads. Perform three cycles.
| | ${cycles}= | Set Variable | ${3}
| | ${threads}= | Set Variable | ${8}
| | ${entries}= | Set Variable | ${1250}
| | Run base operational read performance trial
| | ... | ${node} | ${cycles} | ${threads} | ${entries}
...
| | [Documentation]
| | ... | [Ver] Measure response time using single trial throughput test
| | ... | with 10K requests generated in sixteen threads. Perform three cycles.
| | ${cycles}= | Set Variable | ${3}
| | ${threads}= | Set Variable | ${16}
| | ${entries}= | Set Variable | ${625}
| | Run base operational read performance trial
| | ... | ${node} | ${cycles} | ${threads} | ${entries}
