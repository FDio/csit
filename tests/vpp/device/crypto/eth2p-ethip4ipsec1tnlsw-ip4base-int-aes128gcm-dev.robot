...
| ... | AES_128_CBC | AES | DRV_VFIO_PCI | MY_TEST
|
...
| ${raddr_ip4}= | 20.0.0.1
| ${laddr_ip4}= | 10.0.0.0
| ${tun_dut1_if2}= | 192.168.20.1
| ${tun_tg_if2}= |  192.168.20.2
| ${r_ip4}= | 20.0.0.1
| ${l_ip4}= | 10.0.0.1
| ${ip4_plen}= | ${24}
| ${addr_range}= | ${24}
...
| | And VPP IPsec Create Tunnel Interfaces on 2node 2v1
| | ... | ${nodes} | ${tun_dut1_if2} | ${tg_if2_ip4} | ${dut1_if2}
...
| | ... | ${dut_spi} | ${l_ip4} | ${r_ip4} | ${tg_if2_ip4} | ${tun_dut1_if2}
