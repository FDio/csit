...
| ... | *[Enc] Packet Encapsulations:* Eth-IPv6-ICMPv6 for L2 switching of IPv6.
...
| ... | on receive TG verifies packets for correctness and their IPv6 \
...
*** Test Cases ***
| tc01-78B-eth2p-ethicmpv6-l2xcbase-eth-2memif-1dcr-dev
| | [Tags] | 78B
