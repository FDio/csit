...
| | ... | interfaces with enbaled Generic Segmentation Offload. Both \
| | ... | interfaces are configured with IP addresses from the same network. \
| | ... | The VM is running VPP IPv4 forwarding to pass packet from one \
| | ... | vhost-user interface to the other one.
| |
| | ... | *Arguments:*
...
*** Test Cases ***
| 64B-ethip4-ip4base-eth-2vhostgso-1vm-dev
| | [Tags] | 64B
