...
| | ... | two L2BDs with MAC learning, each with vhost-user i/f with enbaled \
| | ... | Generic Segmentation Offload to local VM and i/f to TG; configure \
| | ... | VPP in VM to loop pkts back betwen its two virtio i/fs. [Ver] Make \
| | ... | TG verify IPv4 packets are switched thru DUT1 and VM in both \
| | ... | directions and are correct on receive.
| |
| | ... | *Arguments:*
...
*** Test Cases ***
| 64B-ethipv4-l2bdbasemaclrn-eth-2vhostgso-1vm-dev
| | [Tags] | 64B
