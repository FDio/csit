...
| ... | *[Enc] Packet Encapsulations:* Eth-IPv6-LISPGPE-IPv6-ICMPv6 on \
| ... |  DUT1-TG, Eth-IPv6-ICMPv6 on TG-DUTn for IPv6 routing over
| ... |  LISPoIPv6 tunnel.
...
| ... | their IPv6 src-addr, dst-addr and MAC addresses.\
...
*** Test Cases ***
| tc01-110B-ethip6lispgpe-ip6base-dev
| | [Tags] | 110B
