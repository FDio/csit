...
| ... | *[Enc] Packet Encapsulations:* Eth-IPv6-LISPGPE-IPv4-ICMPv4 on \
| ... |  DUT1-TG, Eth-IPv4-ICMPv4 on TG-DUTn for IPv6 routing over
| ... |  LISPoIPv6 tunnel.
| ... | *[Cfg] DUT configuration:* DUT1 and TG(if2) are configured with IPv6\
...
| ... | TG->DUT(if1); On receive TG(if2) verifies packets for correctness and\
| ... | their IPv4 src-addr, dst-addr and MAC addresses.\
...
*** Test Cases ***
| tc01-110B-ethip6lispgpe-ip4base-dev
| | [Tags] | 110B
