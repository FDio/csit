...
| ... | dst-addr and MAC addresses. Dump statistics used in performance tests.
...
| | ... | all packets are received. Run statistic commands.
| |
| | ... | *Arguments:*
...
| | And Check statistic commands

| Check statistic commands
| | ${results}= | Create List
