...
| ... | NIC_Virtual | ETH | L2BDMACLRN | BASE | ACL | ACL_STATEFUL 
| ... | IACL | MACIP_ACL_10
| ...
...
| ... | *[Enc] Packet Encapsulations:* Eth-IPv4-UDP on TG-DUT1 (if1) link.
...
| ${ip_step}= | ${1}
| ${src_mac_start}= | 08:00:27:0f:e0:4d
| ${src_mac_step}= | ${1000}
| ${src_mac_mask}= | 00:00:00:00:00:00
| ${tg_stream1_mac}= | 08:00:27:0f:e0:4d
| ${tg_stream2_mac}= | 08:00:27:61:f7:ad
...
| | And Initialize L2 bridge domain with MACIP ACLs on DUT1 in 2-node circular topology
