...
| | And Initialize IPv6 forwarding over SRv6 with endpoint to SR-unaware Service Function via 'dynamic_proxy' behaviour in circular topology
...
| | ... | ${out_sid1_1} | ${out_sid2_1} | decap=${False}
| | ... | ${out_sid1_2}=${None} | ${out_sid2_2}=${None}
