...
| | ... | one SR behaviour (function) - End - for other direction.
| |
| | ... | *Arguments:*
...
| |
| | @{dut1_dstsids}= | Create List | ${dut1_sid2}
| | @{dut2_dstsids}= | Create List | ${dut2_sid2}
| |
...
| | ... | ${DUT1_${int}2_mac}[0] | ${src_ip} | ${dst_ip} | ${dut1_bsid}
| | ... | ${dut1_sid1} | @{dut1_dstsids} | ${dut2_sid1} | @{dut2_dstsids}
