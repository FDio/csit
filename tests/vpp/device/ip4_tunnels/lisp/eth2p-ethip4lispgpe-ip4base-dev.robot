...
| ... | *[Enc] Packet Encapsulations:* Eth-IPv4-LISPGPE-IPv4-ICMPv4 on \
| ... |  DUT1-TG, Eth-IPv4-ICMPv4 on TG-DUTn for IPv4 routing over
| ... |  LISPoIPv4 tunnel.
| ... | *[Cfg] DUT configuration:* DUT1 and TG(if2) are configured with IPv4\
