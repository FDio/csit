...
| ...
| ... | *[Top] Network Topologies:* TG(if1)-DUT1-TG(if2) 2-node circular topology\
| ... | with single links between nodes.
| ... | *[Enc] Packet Encapsulations:* Eth-IPv4-LISP-IPv6-ICMPv6 on DUT1-TG(if2),\
...
*** Test Cases ***
| tc01-110B-ethip4lispgpe-ip6base-dev
| | [Tags] | 110B
