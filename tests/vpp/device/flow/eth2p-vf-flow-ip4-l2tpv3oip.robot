...
|
| Documentation | *IP4-L2TPV3OIP flow test cases*
| ...
| ... | *[Top] Network Topologies:* TG-DUT1 2-node topology with one link\
| ... | between nodes.
| ... | *[Enc] Packet Encapsulations:* Eth-IP4-L2TPV3OIP.
| ... | *[Cfg] DUT configuration:* DUT is configured with IP4-L2TPV3OIP flow.
...
*** Test Cases ***
| vf-flow-ip4-l2tpv3oip-action-redirect-to-queue
| | Initialize Flow Test Configuration
| | ${flow_index} = | Vpp Create IP4 L2tp Flow | ${dut1}
...
| vf-flow-ip4-l2tpv3oip-action-drop
| | Initialize Flow Test Configuration
| | ${flow_index} = | Vpp Create IP4 L2tp Flow | ${dut1}
| | ... | session_id=${session_id}
| | ... | action=drop
...
| vf-flow-ip4-l2tpv3oip-action-mark
| | Initialize Flow Test Configuration
| | ${flow_index} = | Vpp Create IP4 L2tp Flow | ${dut1}
| | ... | session_id=${session_id}
| | ... | action=mark | value=${7}
