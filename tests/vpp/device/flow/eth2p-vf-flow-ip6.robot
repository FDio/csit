...
*** Test Cases ***
| vf-flow-ip6-udp-action-redirect-to-queue
| | Initialize Flow Test Configuration
...
| vf-flow-ip6-tcp-action-redirect-to-queue
| | Initialize Flow Test Configuration
| | ${flow_index} = | Vpp Create Ip6 Flow | ${dut1}
