...
*** Test Cases ***
| vf-flow-ip4-udp-action-redirect-to-queue
| | Initialize Flow Test Configuration
...
| vf-flow-ip4-tcp-action-redirect-to-queue
| | Initialize Flow Test Configuration
| | ${flow_index} = | Vpp Create Ip4 Flow | ${dut1}
