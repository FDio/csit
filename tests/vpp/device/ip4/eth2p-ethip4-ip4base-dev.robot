...
| ... | *[Ver] TG verification:* TestICMPv4 Echo Request packets are sent in\
...
| | ...
| | ${hops}= | Set Variable | ${1}
| | ${tg_if1_ip4}= | Set Variable | 10.10.10.2
| | ${tg_if2_ip4}= | Set Variable | 20.20.20.2
| | ${dut1_if1_ip4}= | Set Variable | 10.10.10.1
| | ${dut1_if2_ip4}= | Set Variable | 20.20.20.1
| | ...
| | Given Configure path in 2-node circular topology
| | ... | ${nodes['TG']} | ${nodes['DUT1']} | ${nodes['TG']}
| | When Initialize IPv4 forwarding in circular topology
| | ... | ${tg_if1_ip4} | ${tg_if2_ip4} | ${dut1_if1_ip4} | ${dut1_if2_ip4}
| | Then Send IPv4 ping packet and verify headers | ${tg_node} | ${tg_if1}
| | ... | ${tg_node} | ${tg_if2} | ${tg_if1_ip4} | ${tg_if2_ip4}
...
| | Then Send IPv4 ping packet and verify headers | ${tg_node} | ${tg_if1}
| | ... | ${tg_node} | ${tg_if2} | ${remote_host1_ip4} | ${remote_host2_ip4}
