...
| ... | NIC_Virtual | ETH | IP4FWD | FEATURE | ACL_STATELESS | IACL_LIST 
| ... | DRV_VFIO_PCI
| ...
...
| | @{permit_list} = | Create List | 10.0.0.1/32 | 10.0.0.2/32 | 10.10.10.2/32
...
*** Test Cases ***
| tc01-64B-ethip4-ip4base-iacllistbase-dev
| | [Tags] | 64B
