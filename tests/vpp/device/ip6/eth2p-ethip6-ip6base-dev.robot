...
| | ...
| | ${hops}= | Set Variable | ${0}
| | ${tg_to_dut_if1_ip6}= | Set Variable | 2001:1::2
| | ${tg_to_dut_if2_ip6}= | Set Variable | 2001:2::2
| | ${dut_to_tg_if1_ip6}= | Set Variable | 2001:1::1
| | ${dut_to_tg_if2_ip6}= | Set Variable | 2001:2::1
| | ...
...
| | And Suppress ICMPv6 router advertisement message
...
| TC02: DUT replies to ICMPv6 Echo Req to its egress interface
| | [Documentation]
...
| TC03: DUT1 routes IPv6 packets between TG interfaces for locally connected IPv6 addresses
| | [Documentation]
...
| TC04: DUT1 routes IPv6 packets between TG interfaces for remote host IPv6 addresses
| | [Documentation]
| | ... | Make TG send ICMPv6 Echo Req between its interfaces across DUT1 for\
...
| | ${dut_to_tg_if1_ip6}= | Set Variable | 2001:1::1
| | ${dut_to_tg_if2_ip6}= | Set Variable | 2001:2::1
| | ${remote_host1_ip6}= | Set Variable | 3ffe:5f::1
| | ${remote_host2_ip6}= | Set Variable | 3ffe:5f::2
| | ${remote_host_ip6_prefix}= | Set Variable | 128
| | ...
| | Given Configure path in 2-node circular topology
| | ... | ${nodes['TG']} | ${nodes['DUT1']} | ${nodes['TG']}
| | And Initialize IPv6 forwarding in circular topology | ${tg_to_dut_if1_ip6}
