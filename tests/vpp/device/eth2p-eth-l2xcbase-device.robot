...
*** Test Cases ***
| TC01: DUT1 with L2XC switch ICMPv4 between two TG links
| | [Documentation]
| | ... | [Top] TG-DUT1-TG. [Enc] Eth-IPv4-ICMPv4.
| | ... | [Cfg] On DUT1 configure L2 cross-connect (L2XC), each with one\
| | ... | interface to TG and one Ethernet interface towards the DUT.
...
| TC02: DUT1 with L2XC switch ICMPv6 between two TG links
| | [Documentation]
