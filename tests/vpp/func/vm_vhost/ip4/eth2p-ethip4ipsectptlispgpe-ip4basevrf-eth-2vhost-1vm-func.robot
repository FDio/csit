...
| Variables | resources/test_data/lisp/ipsec_lispgpe/ipv4_ipsec_lispgpe_ipv4.py
| ...
...
| | ... | ${fib_table_1}
| | Assign Interface To Fib Table | ${dut1_node} | ${dut1_to_dut2}
| | ... | ${fib_table_2}
...
| | ... | gateway=${dut1_vhost1_ip4} | interface=${vhost1} | vrf=${fib_table_1}
| | Vpp Route Add | ${dut1_node} | ${dut1_to_tg_ip4} | ${prefix4}
| | ... | gateway=${dut1_vhost2_ip4} | interface=${vhost2} | vrf=${fib_table_2}
...
| | Set Test Variable | ${vhost1}
| | ${vhost2}= | Vpp Create Vhost User Interface | ${dut1_node} | ${sock2}
| | Set Test Variable | ${vhost2}
| | Set Interface State | ${dut1_node} | ${vhost1} | up
| | Set Interface State | ${dut1_node} | ${vhost2} | up
| | Assign Interface To Fib Table | ${dut1_node} | ${vhost1} | ${fib_table_1}
| | Assign Interface To Fib Table | ${dut1_node} | ${vhost2} | ${fib_table_2}
| | Set Interface Address | ${dut1_node} | ${vhost1} | ${dut1_vhost1_ip4}
| | ... | ${prefix4}
| | Set Interface Address | ${dut1_node} | ${vhost2} | ${dut1_vhost2_ip4}
| | ... | ${prefix4}
