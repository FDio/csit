...
| | Set VPP Interface Address | ${dut1_node} | ${dut1_to_dut2}
| | ... | ${dut1_to_dut2_ip4} | ${prefix4}
| | Set VPP Interface Address | ${dut1_node} | ${dut1_to_tg} | ${dut1_to_tg_ip4}
| | ... | ${prefix4}
| | Set VPP Interface Address | ${dut2_node} | ${dut2_to_dut1}
| | ... | ${dut2_to_dut1_ip4} | ${prefix4}
| | Set VPP Interface Address | ${dut2_node} | ${dut2_to_tg} | ${dut2_to_tg_ip4}
| | ... | ${prefix4}
...
| | Set VPP Interface Address | ${dut1_node} | ${vhost2} | 6.6.1.9
| | ... | ${prefix4}
