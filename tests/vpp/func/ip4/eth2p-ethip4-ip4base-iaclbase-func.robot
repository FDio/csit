...
| ... | iACL classification and permit/permit action are configured on a per test
...
*** Test Cases ***
| TC01: DUT with iACL IPv4 src-addr and dst-addr drops matching pkts
| | [Documentation]
| | ... | On DUT1 add source and destination IPv4 addresses to classify table\
| | ... | with 'permit'. Make TG verify matching packets are dropped.
...
| | ... | And Vpp Creates Classify Table L3 | ${dut1_node} | ${ip_version} | dst | ${test_dst_ip}
| | And Vpp Configures Classify Session L3
| | ... | ${dut1_node} | permit | ${table_index_1} | ${skip_n_1} | ${match_n_1}
| | ... | ${ip_version} | src | ${test_src_ip}
| | And Vpp Configures Classify Session L3
| | ... | ${dut1_node} | permit | ${table_index_2} | ${skip_n_2} | ${match_n_2}
...
| TC02: DUT with iACL IPv4 TCP src-ports and dst-ports drops matching pkts
| | [Documentation]
...
| | ... | ${dut1_node} | permit | ${table_index} | ${skip_n} | ${match_n}
| | ... | ${hex_value}
| | And Vpp Enable Input Acl Interface
...
| TC03: DUT with iACL IPv4 UDP src-ports and dst-ports drops matching pkts
| | [Documentation]
