...
| | ... | AND
| | ... | Honeycomb removes interface IPv4 addresses | ${node} | ${interface2}
| | ... | AND
| | ... | Honeycomb removes interface IPv6 addresses | ${node} | ${interface}
| | ... | AND
| | ... | Honeycomb removes interface IPv6 addresses | ${node} | ${interface2}
| | ... | AND
| | ... | Honeycomb clears all interface IPv4 neighbors | ${node} | ${interface}
| | ... | AND
| | ... | Honeycomb clears all interface IPv4 neighbors | ${node}
| | ... | ${interface2}
| | ... | AND
| | ... | Honeycomb clears all interface IPv6 neighbors | ${node} | ${interface}
| | ... | AND
| | ... | Honeycomb clears all interface IPv6 neighbors | ${node}
| | ... | ${interface2}
