...
| ... | Stop Honeycomb service on DUTs | ${dut2_node} | AND
| ... | Unconfigure IPv4 Management Interfaces | AND
| ... | Disable Honeycomb Feature | ${node} | BGP | AND
| ... | Disable Honeycomb Feature | ${dut2_node} | BGP
| ...
| Force Tags | HC_FUNC
| ...
...
| | ... | addresses on the link and create suite variables for traffic trests.
| | ...
