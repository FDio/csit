...
| | IKEV2 Setup And Send Packet | ${PSK} | ${STRONGSWAN_CONF_DEFAULT}
...
| | ... | [Ver] Send and receive ESP packet between TG and VPP node.
| | IKEV2 Setup And Send Packet | ${ID_IP} | ${STRONGSWAN_CONF_DEFAULT}
...
| | ... | Algorithms AES-CBC-128 and integrity algorithm SHA1-96 are used.
| | ... | [Ver] Send and receive ESP packet between TG and VPP node.
| | IKEV2 Setup And Send Packet | ${ID_RFC} | ${STRONGSWAN_CONF_DEFAULT}
...
| | ... | Algorithms AES-CBC-128 and integrity algorithm SHA1-96 are used.
| | ... | [Ver] Send and receive ESP packet between TG and VPP node.
| | IKEV2 Setup And Send Packet | ${ID_KEY} | ${STRONGSWAN_CONF_DEFAULT}
...
| | ... | [Ver] Send and receive ESP packet between TG and VPP node.
| | Copy RSA Files
| | IKEV2 Setup And Send Packet | ${RSA} | ${RSA_CONF}

*** Keywords ***
| IKEV2 Setup And Send Packet
...
| | Set Interface Address | ${dut_node} | port2 | 9.9.9.9 | 32
| | Set Ipsec Route | ${dut_node} | ${src_ip}/${prefix} | 9.9.9.9 | port2
