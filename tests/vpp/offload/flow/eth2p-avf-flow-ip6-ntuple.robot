...
| ... | NIC_Intel-E810CQ | ETH | FLOW | IP6_N_TUPLE | DRV_AVF
...
*** Test Cases ***
| avf-flow-ip6-ntuple-udp-action-redirect-to-queue
| | Initialize Flow Test Configuration
...
| avf-flow-ip6-ntuple-udp-action-drop
| | Initialize Flow Test Configuration
| | ${flow_index} = | Vpp Create Ip6 N Tuple Flow | ${dut1}
| | ... | ${src_ip} | ${dst_ip} | ${src_port} | ${dst_port}
...
| avf-flow-ip6-ntuple-udp-action-mark
| | Initialize Flow Test Configuration
| | ${flow_index} = | Vpp Create Ip6 N Tuple Flow | ${dut1}
| | ... | ${src_ip} | ${dst_ip} | ${src_port} | ${dst_port}
...
| avf-flow-ip6-ntuple-tcp-action-redirect-to-queue
| | Initialize Flow Test Configuration
| | ${flow_index} = | Vpp Create Ip6 N Tuple Flow | ${dut1}
| | ... | ${src_ip} | ${dst_ip} | ${src_port} | ${dst_port}
...
| avf-flow-ip6-ntuple-tcp-action-drop
| | Initialize Flow Test Configuration
| | ${flow_index} = | Vpp Create Ip6 N Tuple Flow | ${dut1}
| | ... | ${src_ip} | ${dst_ip} | ${src_port} | ${dst_port}
...
| avf-flow-ip6-ntuple-tcp-action-mark
| | Initialize Flow Test Configuration
| | ${flow_index} = | Vpp Create Ip6 N Tuple Flow | ${dut1}
| | ... | ${src_ip} | ${dst_ip} | ${src_port} | ${dst_port}
