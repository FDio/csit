...
|
| Force Tags | 2_NODE_SINGLE_LINK_TOPO | HW_ENV | SCAPY | ETH
| ... | FLOW | IP6_N_TUPLE | DRV_VFIO_PCI | RXQ_SIZE_0 | TXQ_SIZE_0
| ... | flow-ip6-ntuple
|
...
| | | ... | WITH NAME | ${dut}
| | | Run Keyword | ${dut}.Add dpdk dev parameter | ${dut1_if1_pci}
| | | ... | devargs | flow-mark-support=1
| | | Run Keyword | ${dut}.Add dpdk dev parameter | ${dut1_if2_pci}
| | | ... | devargs | flow-mark-support=1
| | END
...
*** Test Cases ***
| flow-ip6-ntuple-udp-action-to-queue
| | Initialize Flow Test Configuration
...
| | ... | ${tg} | ${TG_pf1}[0] | ${TG_pf1_mac}[0] | ${DUT1_${int}1_mac}[0]
| | ... | ${src_ip} | ${dst_ip} | ${src_port} | ${dst_port}
| | ... | flow_type=IP6_N_TUPLE | proto=UDP | value=${7}
...
| | ... | ${tg} | ${TG_pf1}[0] | ${TG_pf1_mac}[0] | ${DUT1_${int}1_mac}[0]
| | ... | ${src_ip} | ${dst_ip} | ${src_port} | ${dst_port}
| | ... | flow_type=IP6_N_TUPLE | proto=UDP | value=${0}
| | ... | traffic_script=send_flow_packet
| | ... | action=drop
| | Vpp Flow Disable | ${dut1} | ${DUT1_${int}1}[0] | ${flow_index}
| | Vpp Flow Del | ${dut1} | ${flow_index}
...
| | ... | ${tg} | ${TG_pf1}[0] | ${TG_pf1_mac}[0] | ${DUT1_${int}1_mac}[0]
| | ... | ${src_ip} | ${dst_ip} | ${src_port} | ${dst_port}
| | ... | flow_type=IP6_N_TUPLE | proto=UDP | value=${3}
| | ... | traffic_script=send_flow_packet
| | ... | action=mark
| | Vpp Flow Disable | ${dut1} | ${DUT1_${int}1}[0] | ${flow_index}
| | Vpp Flow Del | ${dut1} | ${flow_index}

| flow-ip6-ntuple-tcp-action-to-queue
| | Initialize Flow Test Configuration
| | ${flow_index} = | Vpp Create Ip6 N Tuple Flow | ${dut1}
| | ... | ${src_ip} | ${dst_ip} | ${src_port} | ${dst_port}
...
| | ... | ${tg} | ${TG_pf1}[0] | ${TG_pf1_mac}[0] | ${DUT1_${int}1_mac}[0]
| | ... | ${src_ip} | ${dst_ip} | ${src_port} | ${dst_port}
| | ... | flow_type=IP6_N_TUPLE | proto=TCP | value=${7}
| | ... | traffic_script=send_flow_packet
| | ... | action=redirect-to-queue
| | Vpp Flow Disable | ${dut1} | ${DUT1_${int}1}[0] | ${flow_index}
| | Vpp Flow Del | ${dut1} | ${flow_index}
...
| | ... | ${tg} | ${TG_pf1}[0] | ${TG_pf1_mac}[0] | ${DUT1_${int}1_mac}[0]
| | ... | ${src_ip} | ${dst_ip} | ${src_port} | ${dst_port}
| | ... | flow_type=IP6_N_TUPLE | proto=TCP | value=${0}
| | ... | traffic_script=send_flow_packet
| | ... | action=drop
| | Vpp Flow Disable | ${dut1} | ${DUT1_${int}1}[0] | ${flow_index}
| | Vpp Flow Del | ${dut1} | ${flow_index}
...
| | ... | ${tg} | ${TG_pf1}[0] | ${TG_pf1_mac}[0] | ${DUT1_${int}1_mac}[0]
| | ... | ${src_ip} | ${dst_ip} | ${src_port} | ${dst_port}
| | ... | flow_type=IP6_N_TUPLE | proto=TCP | value=${3}
| | ... | traffic_script=send_flow_packet
| | ... | action=mark
| | Vpp Flow Disable | ${dut1} | ${DUT1_${int}1}[0] | ${flow_index}
| | Vpp Flow Del | ${dut1} | ${flow_index}
