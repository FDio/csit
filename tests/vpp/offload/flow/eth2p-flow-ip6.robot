...
|
#| Library | resources.libraries.python.FlowCliUtil
|
| Force Tags | 2_NODE_SINGLE_LINK_TOPO | OFFLOADTEST | HW_ENV | SCAPY
| ... | NIC_Intel-E810CQ | ETH | FLOW | IP6 | DRV_VFIO_PCI
...
*** Test Cases ***
| flow-ip6-udp-action-redirect-to-queue
| | Initialize Flow Test Configuration
...
| flow-ip6-tcp-action-redirect-to-queue
| | Initialize Flow Test Configuration
| | ${flow_index} = | Vpp Create Ip6 Flow | ${dut1}
