...
| ... | NIC_Intel-E810CQ | ETH | FLOW | IP4 | DRV_VFIO_PCI
...
*** Test Cases ***
| flow-ip4-udp-action-redirect-to-queue
| | Initialize Flow Test Configuration
...
| flow-ip4-tcp-action-redirect-to-queue
| | Initialize Flow Test Configuration
| | ${flow_index} = | Vpp Create Ip4 Flow | ${dut1}
