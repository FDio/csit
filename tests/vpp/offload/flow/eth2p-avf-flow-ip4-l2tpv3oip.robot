...
| ... | NIC_Intel-E810CQ | ETH | FLOW | IP4_L2TPV3OIP | DRV_AVF
...
*** Test Cases ***
| avf-flow-ip4-l2tpv3oip-action-redirect-to-queue
| | Initialize Flow Test Configuration
...
| avf-flow-ip4-l2tpv3oip-action-drop
| | Initialize Flow Test Configuration
| | ${flow_index} = | Vpp Create IP4 L2tp Flow | ${dut1}
| | ... | session_id=${session_id}
| | ... | action=drop
...
| avf-flow-ip4-l2tpv3oip-action-mark
| | Initialize Flow Test Configuration
| | ${flow_index} = | Vpp Create IP4 L2tp Flow | ${dut1}
| | ... | session_id=${session_id}
| | ... | action=mark | value=${7}
