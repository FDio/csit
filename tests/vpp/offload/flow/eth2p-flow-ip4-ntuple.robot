...
| ... | ETH | FLOW | IP4_N_TUPLE | DRV_VFIO_PCI | RXQ_SIZE_0 | TXQ_SIZE_0
| ... | flow-ip4-ntuple
|
...
*** Test Cases ***
| flow-ip4-ntuple-udp-action-to-queue
| | Initialize Flow Test Configuration
...
| | ... | ${src_ip} | ${dst_ip} | ${src_port} | ${dst_port}
| | ... | flow_type=IP4_N_TUPLE | proto=UDP | value=${7}
...
| | ... | ${tg} | ${TG_pf1}[0] | ${TG_pf1_mac}[0] | ${DUT1_${int}1_mac}[0]
| | ... | ${src_ip} | ${dst_ip} | ${src_port} | ${dst_port}
| | ... | flow_type=IP4_N_TUPLE | proto=UDP | value=${0}
| | ... | traffic_script=send_flow_packet
| | ... | action=drop
| | Vpp Flow Disable | ${dut1} | ${DUT1_${int}1}[0] | ${flow_index}
| | Vpp Flow Del | ${dut1} | ${flow_index}
...
| flow-ip4-ntuple-tcp-action-to-queue
| | Initialize Flow Test Configuration
| | ${flow_index} = | Vpp Create Ip4 N Tuple Flow | ${dut1}
| | ... | ${src_ip} | ${dst_ip} | ${src_port} | ${dst_port}
...
| | ... | ${tg} | ${TG_pf1}[0] | ${TG_pf1_mac}[0] | ${DUT1_${int}1_mac}[0]
| | ... | ${src_ip} | ${dst_ip} | ${src_port} | ${dst_port}
| | ... | flow_type=IP4_N_TUPLE | proto=TCP | value=${7}
| | ... | traffic_script=send_flow_packet
| | ... | action=redirect-to-queue
| | Vpp Flow Disable | ${dut1} | ${DUT1_${int}1}[0] | ${flow_index}
| | Vpp Flow Del | ${dut1} | ${flow_index}
...
| | ... | ${tg} | ${TG_pf1}[0] | ${TG_pf1_mac}[0] | ${DUT1_${int}1_mac}[0]
| | ... | ${src_ip} | ${dst_ip} | ${src_port} | ${dst_port}
| | ... | flow_type=IP4_N_TUPLE | proto=TCP | value=${0}
| | ... | traffic_script=send_flow_packet
| | ... | action=drop
| | Vpp Flow Disable | ${dut1} | ${DUT1_${int}1}[0] | ${flow_index}
| | Vpp Flow Del | ${dut1} | ${flow_index}
