...
| ... | contains two L4 flow-groups (maglev use flow-group is only from TG to DUT,
| ... | 6 flows for flow-group) with all packets containing Ethernet header, IPv4
| ... | header with IP protocol=17 and static payload. MAC addresses are matching
