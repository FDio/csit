...
| ... | NF_DENSITY | PIPELINE | NF_VPPIP4 | 6R4C | 24DCR1T
...
| ${nf_nodes}= | ${4}
# Traffic profile:
| ${traffic_profile}= | trex-stl-ethip4-ip4src254-6c4n
# Container
...
*** Test Cases ***
| 64B-1c-eth-l2bd-6pl-12mif-24dcr1t-vppip4-ndrpdr
| | [Tags] | 64B | 1C
| | frame_size=${64} | phy_cores=${1}

| 64B-2c-eth-l2bd-6pl-12mif-24dcr1t-vppip4-ndrpdr
| | [Tags] | 64B | 2C
...
| 1518B-2c-eth-l2bd-6pl-12mif-24dcr1t-vppip4-ndrpdr
| | [Tags] | 1518B | 2C
...
| 9000B-2c-eth-l2bd-6pl-12mif-24dcr1t-vppip4-ndrpdr
| | [Tags] | 9000B | 2C
