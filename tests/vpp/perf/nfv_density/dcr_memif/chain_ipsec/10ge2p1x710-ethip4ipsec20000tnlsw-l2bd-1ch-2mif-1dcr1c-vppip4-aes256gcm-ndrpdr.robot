...
| ${nf_nodes}= | ${1}
# Traffic profile:
| ${traffic_profile}= | trex-sl-3n-ethip4-ip4dst${n_tunnels}-${nf_nodes}cnf
# Container
...
| Local Template
| | [Documentation]
| | ... | [Cfg] DUT1 runs IPSec tunneling AES_256_GCM config to ${nf_nodes}.
| | ... | containers.
...
| | ... | ${laddr_ip4} | ${raddr_ip4} | ${addr_range} | ${nf_nodes}
| | And Start containers for test
| | ... | nf_chains=${nf_nodes} | nf_nodes=${nf_nodes} | auto_scale=${False}
| | ... | pinning=${False}
