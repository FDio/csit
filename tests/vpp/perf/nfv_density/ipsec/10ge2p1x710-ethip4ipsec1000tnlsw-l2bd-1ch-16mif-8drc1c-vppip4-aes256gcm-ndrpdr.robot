...
| tc13-64B-8c-ethip4ipsec1000tnlsw-l2bd-1ch-16mif-8drc1c-vppip4-aes256gcm-ndrpdr
| | [Tags] | 64B | 8C
| | frame_size=${64} | phy_cores=${8}

| tc14-1518B-8c-ethip4ipsec1000tnlsw-l2bd-1ch-16mif-8drc1c-vppip4-aes256gcm-ndrpdr
| | [Tags] | 1518B | 8C
| | frame_size=${1518} | phy_cores=${8}

| tc15-IMIX-8c-ethip4ipsec1000tnlsw-l2bd-1ch-16mif-8drc1c-vppip4-aes256gcm-ndrpdr
| | [Tags] | IMIX | 8C
