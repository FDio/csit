...
| | Log To Console | ${bidirectional_throughput}
...
| | Log To Console | ${result.loss_count}
| | Log To Console | ${result.latency}
| | Log To Console | ${result.duration}
| | Log To Console | ${result.transmit_rate}
| | # Keeping commented out until autogen knows this new suite type.
