...
| ...
| Documentation | *HTTP goodput measurement.*
| ...
...
*** Variables ***
| ${nic_name}= | Intel-X710
| ${traffic_profile}= | wrk-sf-2n-ethip4tcphttp-1u1c50con-bw
...
*** Test Cases ***
| tc01-1c-ethip4tcphttp-bw-httpserver
| | [Tags] | 1C
| | phy_cores=${1}

| tc02-2c-ethip4tcphttp-bw-httpserver
| | [Tags] | 2C
| | phy_cores=${2}

| tc03-4c-ethip4tcphttp-bw-httpserver
| | [Tags] | 4C
| | phy_cores=${4}
