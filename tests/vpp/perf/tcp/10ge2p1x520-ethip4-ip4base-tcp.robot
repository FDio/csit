...
| | ...
| | Given Add '1' worker threads and '1' rxqueues in 2-node single-link circular topology
...
| | ...
| | Given Add '2' worker threads and '1' rxqueues in 2-node single-link circular topology
| | And Add PCI devices to DUTs in 2-node single link topology
| | And Apply startup configuration on all VPP DUTs
| | And Set up HTTP server on the VPP node | 192.168.10.2 | 24
| | Then Measure throughput | wrk-bw-1url-1core-50con
...
| | ...
| | Given Add '4' worker threads and '2' rxqueues in 2-node single-link circular topology
| | And Add PCI devices to DUTs in 2-node single link topology
| | And Apply startup configuration on all VPP DUTs
| | And Set up HTTP server on the VPP node | 192.168.10.2 | 24
| | Then Measure throughput | wrk-bw-1url-1core-50con
