...
| | traffic_profile=wrk-sf-2n-ethip4tcphttp-4u4c50con-cps | wt=1 | rxq=1
| | ... | test_type=cps
...
| | ...
| | [Template] | Measure throughput or rps or cps
| | traffic_profile=wrk-sf-2n-ethip4tcphttp-4u4c50con-cps | wt=2 | rxq=2
| | ... | test_type=cps
...
| | ...
| | [Template] | Measure throughput or rps or cps
| | traffic_profile=wrk-sf-2n-ethip4tcphttp-4u4c50con-cps | wt=4 | rxq=4
| | ... | test_type=cps
