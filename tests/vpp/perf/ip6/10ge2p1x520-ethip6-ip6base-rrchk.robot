...
*** Test Cases ***
| tc01-78B-1t1c-ethip6-ip6base-rrchk
| | [Documentation]
...
| tc02-1518B-1t1c-ethip6-ip6base-rrchk
| | [Documentation]
| | ... | [Cfg] DUT runs IPv6 routing config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port.
...
| tc03-9000B-1t1c-ethip6-ip6base-rrchk
| | [Documentation]
| | ... | [Cfg] DUT runs IPv6 routing config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port.
...
| tc04-78B-2t2c-ethip6-ip6base-rrchk
| | [Documentation]
...
| tc05-1518B-2t2c-ethip6-ip6base-rrchk
| | [Documentation]
| | ... | [Cfg] DUT runs IPv6 routing config with 2 threads, 2 phy cores, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Measure raw results for 1518B frames using single\
...
| tc06-9000B-2t2c-ethip6-ip6base-rrchk
| | [Documentation]
| | ... | [Cfg] DUT runs IPv6 routing config with 2 threads, 2 phy cores, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Measure raw results for 9000B frames using single\
...
| tc07-78B-4t4c-ethip6-ip6base-rrchk
| | [Documentation]
...
| tc08-1518B-4t4c-ethip6-ip6base-rrchk
| | [Documentation]
| | ... | [Cfg] DUT runs IPv6 routing config with 4 threads, 4 phy cores, \
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Measure raw results for 1518B frames using single\
...
| tc09-9000B-4t4c-ethip6-ip6base-rrchk
| | [Documentation]
| | ... | [Cfg] DUT runs IPv6 routing config with 4 threads, 4 phy cores, \
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Measure raw results for 9000B frames using single\
