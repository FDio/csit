...
| | ... | - acl_type - FIXME.
| | ...
| | [Arguments] | ${framesize} | ${phy_cores} | ${acl_type}=${EMPTY}
| | ... | ${rxq}=${None}
| | ...
...
*** Test Cases ***
| tc01-64B-2c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-ndrpdr
| | [Tags] | 64B | 2C
| | framesize=${64} | phy_cores=${2}

| tc02-150B-2c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-ndrpdr
| | [Tags] | 150B | 2C
| | framesize=${150} | phy_cores=${2}

| tc03-200B-2c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-ndrpdr
| | [Tags] | 200B | 2C
| | framesize=${200} | phy_cores=${2}

| tc04-IMIX-2c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-ndrpdr
| | [Tags] | IMIX | 2C
| | framesize=IMIX_v4_1 | phy_cores=${2}

| tc05-64B-2c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-acl-ndrpdr
| | [Tags] | 64B | 2C | ACL_PERMIT
| | framesize=${64} | phy_cores=${2} | acl_type=permit

| tc06-150B-2c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-acl-ndrpdr
| | [Tags] | 150B | 2C | ACL_PERMIT
| | framesize=${150} | phy_cores=${2} | acl_type=permit

| tc07-200B-2c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-acl-ndrpdr
| | [Tags] | 200B | 2C | ACL_PERMIT
| | framesize=${200} | phy_cores=${2} | acl_type=permit

| tc08-IMIX-2c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-acl-ndrpdr
| | [Tags] | IMIX | 2C | ACL_PERMIT
| | framesize=IMIX_v4_1 | phy_cores=${2} | acl_type=permit

| tc09-64B-2c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-aclreflect-ndrpdr
| | [Tags] | 64B | 2C | ACL_PERMIT_REFLECT
| | framesize=${64} | phy_cores=${2} | acl_type=permit+reflect

| tc10-150B-2c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-aclreflect-ndrpdr
| | [Tags] | 150B | 2C | ACL_PERMIT_REFLECT
| | framesize=${150} | phy_cores=${2} | acl_type=permit+reflect

| tc11-200B-2c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-aclreflect-ndrpdr
| | [Tags] | 200B | 2C | ACL_PERMIT_REFLECT
| | framesize=${200} | phy_cores=${2} | acl_type=permit+reflect

| tc12-IMIX-2c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-aclreflect-ndrpdr
| | [Tags] | IMIX | 2C | ACL_PERMIT_REFLECT
| | framesize=IMIX_v4_1 | phy_cores=${2} | acl_type=permit+reflect
