...
| | Given Add '2' worker threads and '2' rxqueues in 2-node single-link circular topology
| | Add PCI devices to DUTs in 2-node single link topology
| | And Add no multi seg to all DUTs
| | And Apply startup configuration on all VPP DUTs
| | When Initialize L2 bridge domains with Vhost-User and VXLANoIPv4 in 2-node circular topology
