...
| | ...
| | [Arguments] | ${dut} | ${dut_if} | ${acl_apply_type} | ${acl_action} | @{subnets}
...
| | ... | ${dut1_bd_id1} | ${dut1_bd_id2} | ${dut2_bd_id1} | ${sock1} | ${sock2}
| | @{permit_list}= | Create List | 10.0.0.1/32 | 10.0.0.2/32
| | Configure ACLs on a single interface | ${dut1} | ${dut1_if2} | input | permit | @{permit_list}
...
*** Settings ***
| Test Template | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL

*** Test Cases ***   num_of_threads | rxq | pkt_framesize | search_type
| tc01-64B-1t1c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-acl-ndrdisc
| | ...             | 2             | 2   | ${64}         | NDR
| tc02-64B-1t1c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-acl-pdrdisc
| | ...             | 2             | 2   | ${64}         | PDR
| tc03-150B-1t1c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-acl-ndrdisc
| | ...             | 2             | 2   | ${150}        | NDR
| tc04-150B-1t1c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-acl-pdrdisc
| | ...             | 2             | 2   | ${150}        | PDR
| tc05-200B-1t1c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-acl-ndrdisc
| | ...             | 2             | 2   | ${200}        | NDR
| tc06-200B-1t1c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-acl-pdrdisc
| | ...             | 2             | 2   | ${200}        | PDR
| tc07-IMIX-1t1c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-acl-ndrdisc
| | ...             | 2             | 2   | IMIX_v4_1     | NDR
| tc08-IMIX-1t1c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-acl-pdrdisc
| | ...             | 2             | 2   | IMIX_v4_1     | PDR
