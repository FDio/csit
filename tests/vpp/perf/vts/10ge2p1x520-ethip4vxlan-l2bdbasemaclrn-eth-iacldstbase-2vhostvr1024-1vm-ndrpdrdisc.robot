...
| | [Tags] | 64B | 2C | STHREAD | NDRDISC | ACL_PERMIT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${64} | search_type=NDR
| | ... | acl_type=permit
...
| | [Tags] | 64B | 2C | STHREAD | PDRDISC | ACL_PERMIT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${64} | search_type=PDR
| | ... | acl_type=permit
...
| | [Tags] | 150B | 2C | STHREAD | NDRDISC | ACL_PERMIT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${150} | search_type=NDR
| | ... | acl_type=permit
...
| | [Tags] | 150B | 2C | STHREAD | PDRDISC | ACL_PERMIT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${150} | search_type=PDR
| | ... | acl_type=permit
...
| | [Tags] | 200B | 2C | STHREAD | NDRDISC | ACL_PERMIT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${200} | search_type=NDR
| | ... | acl_type=permit
...
| | [Tags] | 200B | 2C | STHREAD | PDRDISC | ACL_PERMIT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${200} | search_type=PDR
| | ... | acl_type=permit
...
| | [Tags] | IMIX | 2C | STHREAD | NDRDISC | ACL_PERMIT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=IMIX_v4_1 | search_type=NDR
| | ... | acl_type=permit
...
| | [Tags] | IMIX | 2C | STHREAD | PDRDISC | ACL_PERMIT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=IMIX_v4_1 | search_type=PDR
| | ... | acl_type=permit
...
| | [Tags] | 64B | 2C | STHREAD | NDRDISC | ACL_PERMIT_REFLECT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${64} | search_type=NDR
...
| | [Tags] | 64B | 2C | STHREAD | PDRDISC | ACL_PERMIT_REFLECT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${64} | search_type=PDR
| | ... | acl_type=permit+reflect
...
| | [Tags] | 150B | 2C | STHREAD | NDRDISC | ACL_PERMIT_REFLECT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${150} | search_type=NDR
| | ... | acl_type=permit+reflect
...
| | [Tags] | 150B | 2C | STHREAD | PDRDISC | ACL_PERMIT_REFLECT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${150} | search_type=PDR
| | ... | acl_type=permit+reflect
...
| | [Tags] | 200B | 2C | STHREAD | NDRDISC | ACL_PERMIT_REFLECT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${200} | search_type=NDR
| | ... | acl_type=permit+reflect
...
| | [Tags] | 200B | 2C | STHREAD | PDRDISC | ACL_PERMIT_REFLECT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${200} | search_type=PDR
| | ... | acl_type=permit+reflect
...
| | [Tags] | IMIX | 2C | STHREAD | NDRDISC | ACL_PERMIT_REFLECT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=IMIX_v4_1 | search_type=NDR
| | ... | acl_type=permit+reflect
...
| | [Tags] | IMIX | 2C | STHREAD | PDRDISC | ACL_PERMIT_REFLECT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=IMIX_v4_1 | search_type=PDR
| | ... | acl_type=permit+reflect
