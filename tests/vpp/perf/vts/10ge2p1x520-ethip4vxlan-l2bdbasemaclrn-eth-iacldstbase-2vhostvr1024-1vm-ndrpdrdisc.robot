...
# Traffic profile:
| ${traffic_profile} | trex-sl-2n-ethip4-vxlansrc253
| ${min_rate}= | ${10000}
...
| | ... | 172.16.0.1 | 16 | 172.26.0.1 | 16 | 172.16.0.2 | 172.26.0.2 | ${dut1_vxlans} | ${dut2_vxlans}
| | ... | 172.17.0.0 | 16 | 172.27.0.0 | 16
| | @{permit_list}= | Create List | 10.0.0.1/32 | 10.0.0.2/32
| | Run Keyword If | '${acl_type}' != '${EMPTY}'
| | ... | Configure ACLs on a single interface | ${dut1} | ${dut1_if2} | input | ${acl_type} | @{permit_list}
...
*** Test Cases ***   num_of_threads | rxq | pkt_framesize | search_type | ... | acl_type

*** Test Cases ***
| tc01-64B-1t1c-ethip4vxlan-l2bdbasemaclrn-eth-2vhost-1vm-ndrdisc
| | [Tags] | VHOST | VXLAN | 64B | 2T2C | STHREAD | NDRDISC
| | ...
...
| | [Tags] | VHOST | VXLAN | IMIX | 2T2C | STHREAD | PDRDISC
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
...
| | [Tags] | VHOST | VXLAN | 64B | 2T2C | STHREAD | NDRDISC | ACL_PERMIT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${64} | search_type=NDR
| | ... | acl_type=permit
...
| | [Tags] | VHOST | VXLAN | 64B | 2T2C | STHREAD | PDRDISC | ACL_PERMIT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${64} | search_type=PDR
| | ... | acl_type=permit
...
| | [Tags] | VHOST | VXLAN | 150B | 2T2C | STHREAD | NDRDISC | ACL_PERMIT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${150} | search_type=NDR
| | ... | acl_type=permit
...
| | [Tags] | VHOST | VXLAN | 150B | 2T2C | STHREAD | PDRDISC | ACL_PERMIT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${150} | search_type=PDR
| | ... | acl_type=permit
...
| | [Tags] | VHOST | VXLAN | 200B | 2T2C | STHREAD | NDRDISC | ACL_PERMIT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${200} | search_type=NDR
| | ... | acl_type=permit
...
| | [Tags] | VHOST | VXLAN | 200B | 2T2C | STHREAD | PDRDISC | ACL_PERMIT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${200} | search_type=PDR
| | ... | acl_type=permit
...
| | [Tags] | VHOST | VXLAN | IMIX | 2T2C | STHREAD | NDRDISC | ACL_PERMIT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=IMIX_v4_1 | search_type=NDR
| | ... | acl_type=permit
...
| | [Tags] | VHOST | VXLAN | IMIX | 2T2C | STHREAD | PDRDISC | ACL_PERMIT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=IMIX_v4_1 | search_type=PDR
| | ... | acl_type=permit
...
| | [Tags] | VHOST | VXLAN | 64B | 2T2C | STHREAD | NDRDISC | ACL_PERMIT_REFLECT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${64} | search_type=NDR
...
| | [Tags] | VHOST | VXLAN | 64B | 2T2C | STHREAD | PDRDISC | ACL_PERMIT_REFLECT
| | ...
| | [Template] | Discover NDR or PDR for IPv4 forwarding with VHOST/VXLAN and ACL
| | num_of_threads=2 | rxq=2 | pkt_framesize=${64} | search_type=PDR
| | ... | acl_type=permit+reflect
