...
| ... | ethip4tcp-sfdptcp-ip4base-h1024-p63-s64512-cps
|
...
*** Test Cases ***
| 64B-1c-ethip4tcp-sfdptcp-ip4base-h1024-p63-s64512-cps-ndrpdr
| | [Tags] | 64B | 1C
| | frame_size=${64} | phy_cores=${1}

| 64B-2c-ethip4tcp-sfdptcp-ip4base-h1024-p63-s64512-cps-ndrpdr
| | [Tags] | 64B | 2C
| | frame_size=${64} | phy_cores=${2}

| 64B-4c-ethip4tcp-sfdptcp-ip4base-h1024-p63-s64512-cps-ndrpdr
| | [Tags] | 64B | 4C
