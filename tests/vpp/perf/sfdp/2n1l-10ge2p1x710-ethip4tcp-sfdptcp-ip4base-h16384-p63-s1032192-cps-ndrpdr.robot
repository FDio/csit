...
| ... | ethip4tcp-sfdptcp-ip4base-h16384-p63-s1032192-cps
|
...
*** Test Cases ***
| 64B-1c-ethip4tcp-sfdptcp-ip4base-h16384-p63-s1032192-cps-ndrpdr
| | [Tags] | 64B | 1C
| | frame_size=${64} | phy_cores=${1}

| 64B-2c-ethip4tcp-sfdptcp-ip4base-h16384-p63-s1032192-cps-ndrpdr
| | [Tags] | 64B | 2C
| | frame_size=${64} | phy_cores=${2}

| 64B-4c-ethip4tcp-sfdptcp-ip4base-h16384-p63-s1032192-cps-ndrpdr
| | [Tags] | 64B | 4C
