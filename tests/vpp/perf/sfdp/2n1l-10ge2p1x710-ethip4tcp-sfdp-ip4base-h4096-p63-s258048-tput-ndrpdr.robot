...
| ... | ethip4tcp-sfdp-ip4base-h4096-p63-s258048-tput
|
...
*** Test Cases ***
| 100B-1c-ethip4tcp-sfdp-ip4base-h4096-p63-s258048-tput-ndrpdr
| | [Tags] | 100B | 1C
| | frame_size=${100} | phy_cores=${1}

| 100B-2c-ethip4tcp-sfdp-ip4base-h4096-p63-s258048-tput-ndrpdr
| | [Tags] | 100B | 2C
| | frame_size=${100} | phy_cores=${2}

| 100B-4c-ethip4tcp-sfdp-ip4base-h4096-p63-s258048-tput-ndrpdr
| | [Tags] | 100B | 4C
| | frame_size=${100} | phy_cores=${4}

| 1518B-1c-ethip4tcp-sfdp-ip4base-h4096-p63-s258048-tput-ndrpdr
| | [Tags] | 1518B | 1C
| | frame_size=${1518} | phy_cores=${1}

| 1518B-2c-ethip4tcp-sfdp-ip4base-h4096-p63-s258048-tput-ndrpdr
| | [Tags] | 1518B | 2C
| | frame_size=${1518} | phy_cores=${2}

| 1518B-4c-ethip4tcp-sfdp-ip4base-h4096-p63-s258048-tput-ndrpdr
| | [Tags] | 1518B | 4C
| | frame_size=${1518} | phy_cores=${4}

| 9000B-1c-ethip4tcp-sfdp-ip4base-h4096-p63-s258048-tput-ndrpdr
| | [Tags] | 9000B | 1C
| | frame_size=${9000} | phy_cores=${1}

| 9000B-2c-ethip4tcp-sfdp-ip4base-h4096-p63-s258048-tput-ndrpdr
| | [Tags] | 9000B | 2C
| | frame_size=${9000} | phy_cores=${2}

| 9000B-4c-ethip4tcp-sfdp-ip4base-h4096-p63-s258048-tput-ndrpdr
| | [Tags] | 9000B | 4C
