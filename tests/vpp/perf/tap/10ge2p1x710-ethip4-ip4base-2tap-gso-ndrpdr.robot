...
| | ... | ${nodes['DUT1']}
| | ... | if1_pci=${DUT1_${int}1_pci}[0]
| | ... | if2_pci=${DUT1_${int}2_pci}[0]
...
| | And Add Default Route To Namespace
| | ... | ${nodes['DUT1']}
| | ... | namespace=${iperf_client_interface}_namespace
| | ... | default_route=${iperf_client_bind}
| | ${iperf3_pid} = | iPerf Client Start Remote Exec
| | ... | ${nodes['DUT1']}
| | ... | duration=1.0
| | ... | rate=100000
| | ... | frame_size=64000
...
| | ... | namespace=${iperf_client_interface}_namespace
| | And iPerf Client Stop Remote Exec
| | ... | ${nodes['DUT1']}
| | ... | pids=${iperf3_pid}
