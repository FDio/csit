...
| ... | IP4FWD | IPSEC | IPSECHW | ASYNC | IPSECINT | NIC_Intel-X710 | TNL_2
...
*** Test Cases ***
| 64B-1c-ethip4ipsec2tnlswasync-scheduler-ip4base-int-aes256gcm-ndrpdr
| | [Tags] | 64B | 1C
...
| 1518B-1c-ethip4ipsec2tnlswasync-scheduler-ip4base-int-aes256gcm-ndrpdr
| | [Tags] | 1518B | 1C
...
| 9000B-1c-ethip4ipsec2tnlswasync-scheduler-ip4base-int-aes256gcm-ndrpdr
| | [Tags] | 9000B | 1C
...
| IMIX-1c-ethip4ipsec2tnlswasync-scheduler-ip4base-int-aes256gcm-ndrpdr
| | [Tags] | IMIX | 1C
