...
| ... | RXQ_SIZE_0 | TXQ_SIZE_0 | TNL_1000
| ... | ethip4ipsec1000tnlswasync-scheduler-ip4base-int-aes256gcm-udir
|
...
*** Test Cases ***
| 1518B-2c-ethip4ipsec1000tnlswasync-scheduler-ip4base-int-aes256gcm-udir-ndrpdr
| | [Tags] | 1518B | 2C
| | frame_size=${1518} | phy_cores=${2}

| 1518B-3c-ethip4ipsec1000tnlswasync-scheduler-ip4base-int-aes256gcm-udir-ndrpdr
| | [Tags] | 1518B | 3C
| | frame_size=${1518} | phy_cores=${3}

| 1518B-4c-ethip4ipsec1000tnlswasync-scheduler-ip4base-int-aes256gcm-udir-ndrpdr
| | [Tags] | 1518B | 4C
