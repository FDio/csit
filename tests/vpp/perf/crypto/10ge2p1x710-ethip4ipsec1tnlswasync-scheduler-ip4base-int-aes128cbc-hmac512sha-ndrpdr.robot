...
*** Test Cases ***
| 64B-1c-1c-ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha-ndrpdr
| | [Tags] | 64B | 1C_1C
| | frame_size=${64} | phy_cores=${2}

| 64B-1c-2c-ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha-ndrpdr
| | [Tags] | 64B | 1C_2C
| | frame_size=${64} | phy_cores=${3}

| 64B-1c-3c-ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha-ndrpdr
| | [Tags] | 64B | 1C_3C
| | frame_size=${64} | phy_cores=${4}

| 1518B-1c-1c-ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha-ndrpdr
| | [Tags] | 1518B | 1C_1C
| | frame_size=${1518} | phy_cores=${2}

| 1518B-1c-2c-ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha-ndrpdr
| | [Tags] | 1518B | 1C_2C
| | frame_size=${1518} | phy_cores=${3}

| 1518B-1c-3c-ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha-ndrpdr
| | [Tags] | 1518B | 1C_3C
| | frame_size=${1518} | phy_cores=${4}

| 9000B-1c-1c-ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha-ndrpdr
| | [Tags] | 9000B | 1C_1C
| | frame_size=${9000} | phy_cores=${2}

| 9000B-1c-2c-ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha-ndrpdr
| | [Tags] | 9000B | 1C_2C
| | frame_size=${9000} | phy_cores=${3}

| 9000B-1c-3c-ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha-ndrpdr
| | [Tags] | 9000B | 1C_3C
| | frame_size=${9000} | phy_cores=${4}

| IMIX-1c-1c-ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha-ndrpdr
| | [Tags] | IMIX | 1C_1C
| | frame_size=IMIX_v4_1 | phy_cores=${2}

| IMIX-1c-2c-ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha-ndrpdr
| | [Tags] | IMIX | 1C_2C
| | frame_size=IMIX_v4_1 | phy_cores=${3}

| IMIX-1c-3c-ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha-ndrpdr
| | [Tags] | IMIX | 1C_3C
