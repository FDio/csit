...
*** Test Cases ***
| tc01-64B-1c-ethip4ipsec40tnlsw-ip4base-int-aes256gcm-ndrpdr
| | [Tags] | 64B | 1C
| | frame_size=${64} | phy_cores=${1}

| tc02-64B-2c-ethip4ipsec40tnlsw-ip4base-int-aes256gcm-ndrpdr
| | [Tags] | 64B | 2C
...
| tc05-1518B-2c-ethip4ipsec40tnlsw-ip4base-int-aes256gcm-ndrpdr
| | [Tags] | 1518B | 2C
...
| tc08-9000B-2c-ethip4ipsec40tnlsw-ip4base-int-aes256gcm-ndrpdr
| | [Tags] | 9000B | 2C
...
| tc11-IMIX-2c-ethip4ipsec40tnlsw-ip4base-int-aes256gcm-ndrpdr
| | [Tags] | IMIX | 2C
