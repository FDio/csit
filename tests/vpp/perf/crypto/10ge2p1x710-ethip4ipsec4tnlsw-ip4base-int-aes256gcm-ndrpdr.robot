...
| tc13-64B-6c-ethip4ipsec4tnlsw-ip4base-int-aes256gcm-ndrpdr
| | [Tags] | 64B | 6C
| | frame_size=${64} | phy_cores=${6}

| tc14-64B-8c-ethip4ipsec4tnlsw-ip4base-int-aes256gcm-ndrpdr
| | [Tags] | 64B | 8C
| | frame_size=${64} | phy_cores=${8}

| tc15-IMIX-6c-ethip4ipsec4tnlsw-ip4base-int-aes256gcm-ndrpdr
| | [Tags] | 64B | 6C
| | frame_size=IMIX_v4_1 | phy_cores=${6}

| tc16-IMIX-8c-ethip4ipsec4tnlsw-ip4base-int-aes256gcm-ndrpdr
| | [Tags] | 64B | 8C
