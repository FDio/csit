...
| | [Documentation]
| | ... | [Cfg] DUT runs IPSec tunneling config with ${wt} thread(s), ${wt}\
...
| tc03-9000B-1t1c-ethip4ipsecbasetnl-ip4base-int-aes-gcm-mrr
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel AES GCM in each direction, configured\
| | ... | with 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| tc07-9000B-2t2c-ethip4ipsecbasetnl-ip4base-int-aes-gcm-mrr
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel AES GCM in each direction, configured\
| | ... | with 2 threads, 2 phy cores, 1 receive queue per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for 9000B frames using single\
...
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel AES GCM in each direction, configured\
| | ... | with 4 threads, 4 phy cores, 1 receive queue per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for 64B frames using single trial\
| | ... | throughput test.
| | [Tags] | 64B | 4T4C | MTHREAD
| | ...
| | [Template] | Check RR for IPv4 routing with IPSec HW cryptodev
| | framesize=${64} | wt=4 | rxq=1
...
| | ...
| | [Template] | Check RR for IPv4 routing with IPSec HW cryptodev
| | framesize=${1518} | wt=4 | rxq=1

| tc11-9000B-4t4c-ethip4ipsecbasetnl-ip4base-int-aes-gcm-mrr
| | [Documentation]
| | ... | [Cfg] DUTs run 1 IPsec tunnel AES GCM in each direction, configured\
| | ... | with 4 threads, 4 phy cores, 1 receive queue per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for 9000B frames using single\
...
| | ...
| | [Template] | Check RR for IPv4 routing with IPSec HW cryptodev
| | framesize=IMIX_v4_1 | wt=4 | rxq=1
