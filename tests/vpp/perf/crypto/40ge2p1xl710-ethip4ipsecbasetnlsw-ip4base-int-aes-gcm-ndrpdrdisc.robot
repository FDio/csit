...
| | ${max_rate}= | Run Keyword If | ${get_framesize} == ${64}
| | ... | Set Variable | ${s_18.75Mpps}
| | ... | ELSE
| | ... | Calculate pps | ${s_24.5G} | ${get_framesize} + ${ipsec_overhead_gcm}
...
| | And Add DPDK Uio Driver on all DUTs | igb_uio
