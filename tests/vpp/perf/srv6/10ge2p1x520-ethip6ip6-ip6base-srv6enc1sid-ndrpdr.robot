...
| | ${get_framesize} = | Get Frame Size | ${framesize} | ${srv6_overhead_nosrh}
...
| tc07-IMIX-1c-ethip6ip6-ip6base-srv6enc1sid-ndrpdr
| | [Tags] | IMIX | 1C
| | framesize=IMIX_v4_1 | phy_cores=${1}

| tc08-IMIX-2c-ethip6ip6-ip6base-srv6enc1sid-ndrpdr
| | [Tags] | IMIX | 2C
| | framesize=IMIX_v4_1 | phy_cores=${2}

| tc09-IMIX-4c-ethip6ip6-ip6base-srv6enc1sid-ndrpdr
| | [Tags] | IMIX | 4C
