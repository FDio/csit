...
*** Test Cases ***
| tc01-78B-1t1c-ethip6srhip6-ip6base-srv6chain-dproxy-ndrdisc
| | [Documentation]
...
| tc02-78B-1t1c-ethip6srhip6-ip6base-srv6chain-dproxy-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
| | ... | 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| tc03-78B-2t2c-ethip6srhip6-ip6base-srv6chain-dproxy-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
...
| tc04-78B-2t2c-ethip6srhip6-ip6base-srv6chain-dproxy-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
| | ... | 2 threads, 2 phy cores, 1 receive queue per NIC port.
| | ... | [Ver] Find PDR for 78 Byte frames using binary search start at 10GE\
...
| tc05-78B-4t4c-ethip6srhip6-ip6base-srv6chain-dproxy-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
...
| tc06-78B-4t4c-ethip6srhip6-ip6base-srv6chain-dproxy-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
| | ... | 4 threads, 4 phy cores, 2 receive queues per NIC port.
| | ... | [Ver] Find PDR for 78 Byte frames using binary search start at 10GE\
...
| tc07-1518B-1t1c-ethip6srhip6-ip6base-srv6chain-dproxy-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
| | ... | 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| tc08-1518B-1t1c-ethip6srhip6-ip6base-srv6chain-dproxy-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
| | ... | 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| tc09-1518B-2t2c-ethip6srhip6-ip6base-srv6chain-dproxy-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
| | ... | 2 threads, 2 phy cores, 1 receive queue per NIC port.
| | ... | [Ver] Find NDR for 1518 Byte frames using binary search start at 10GE\
...
| tc10-1518B-2t2c-ethip6srhip6-ip6base-srv6chain-dproxy-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
| | ... | 2 threads, 2 phy cores, 1 receive queue per NIC port.
| | ... | [Ver] Find PDR for 1518 Byte frames using binary search start at 10GE\
...
| tc11-1518B-4t4c-ethip6srhip6-ip6base-srv6chain-dproxy-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
| | ... | 4 threads, 4 phy cores, 2 receive queues per NIC port.
| | ... | [Ver] Find NDR for 1518 Byte frames using binary search start at 10GE\
...
| tc12-1518B-4t4c-ethip6srhip6-ip6base-srv6chain-dproxy-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
| | ... | 4 threads, 4 phy cores, 2 receive queues per NIC port.
| | ... | [Ver] Find PDR for 1518 Byte frames using binary search start at 10GE\
