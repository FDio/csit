...
| ...
| Documentation | *RFC2544: Packet throughput Segment routing over IPv6\
| ... | dataplane test cases*
| ...
| ... | *[Top] Network Topologies:* TG-DUT1-DUT2-TG 3-node circular topology\
| ... | with single links between nodes.
| ... | *[Enc] Packet Encapsulations:* Eth-IPv6-IPv6-UDP on DUT1-DUT2,\
| ... | Eth-IPv6-UDP on TG-DUTn for IPv6 routing over SRv6.
| ...
| ... | upravit dokumentaciu
| ...
...
*** Test Cases ***
| tc01-78B-1t1c-ethip6ip6-ip6base-srv6enc2sids-nodecaps-ndrdisc
| | [Documentation]
...
| | wt=1 | rxq=1 | framesize=${78} | min_rate=${100000} | search_type=NDR
#
#| tc02-78B-1t1c-ethip6ip6-ip6base-srv6enc2sids-nodecaps-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
#| | ... | 1 thread, 1 phy core, 1 receive queue per NIC port.
...
#| | ...
#| | [Template] | Discover NDR or PDR for IPv6 routing over SRv6
#| | wt=1 | rxq=1 | framesize=${78} | min_rate=${100000} | search_type=PDR
#
#| tc03-78B-2t2c-ethip6ip6-ip6base-srv6enc2sids-nodecaps-ndrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
...
#| | ...
#| | [Template] | Discover NDR or PDR for IPv6 routing over SRv6
#| | wt=2 | rxq=1 | framesize=${78} | min_rate=${100000} | search_type=NDR
#
#| tc04-78B-2t2c-ethip6ip6-ip6base-srv6enc2sids-nodecaps-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
#| | ... | 2 threads, 2 phy cores, 1 receive queue per NIC port.
#| | ... | [Ver] Find PDR for 78 Byte frames using binary search start at 10GE\
...
#| | ...
#| | [Template] | Discover NDR or PDR for IPv6 routing over SRv6
#| | wt=2 | rxq=1 | framesize=${78} | min_rate=${100000} | search_type=PDR
#
#| tc05-78B-4t4c-ethip6ip6-ip6base-srv6enc2sids-nodecaps-ndrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
...
#| | ...
#| | [Template] | Discover NDR or PDR for IPv6 routing over SRv6
#| | wt=4 | rxq=2 | framesize=${78} | min_rate=${100000} | search_type=NDR
#
#| tc06-78B-4t4c-ethip6ip6-ip6base-srv6enc2sids-nodecaps-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
#| | ... | 4 threads, 4 phy cores, 2 receive queues per NIC port.
#| | ... | [Ver] Find PDR for 78 Byte frames using binary search start at 10GE\
...
#| | ...
#| | [Template] | Discover NDR or PDR for IPv6 routing over SRv6
#| | wt=4 | rxq=2 | framesize=${78} | min_rate=${100000} | search_type=PDR
#
#| tc07-1518B-1t1c-ethip6ip6-ip6base-srv6enc2sids-nodecaps-ndrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
#| | ... | 1 thread, 1 phy core, 1 receive queue per NIC port.
...
#
#| tc08-1518B-1t1c-ethip6ip6-ip6base-srv6enc2sids-nodecaps-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
#| | ... | 1 thread, 1 phy core, 1 receive queue per NIC port.
...
#
#| tc09-1518B-2t2c-ethip6ip6-ip6base-srv6enc2sids-nodecaps-ndrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
#| | ... | 2 threads, 2 phy cores, 1 receive queue per NIC port.
#| | ... | [Ver] Find NDR for 1518 Byte frames using binary search start at 10GE\
...
#
#| tc10-1518B-2t2c-ethip6ip6-ip6base-srv6enc2sids-nodecaps-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
#| | ... | 2 threads, 2 phy cores, 1 receive queue per NIC port.
#| | ... | [Ver] Find PDR for 1518 Byte frames using binary search start at 10GE\
...
#
#| tc11-1518B-4t4c-ethip6ip6-ip6base-srv6enc2sids-nodecaps-ndrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
#| | ... | 4 threads, 4 phy cores, 2 receive queues per NIC port.
#| | ... | [Ver] Find NDR for 1518 Byte frames using binary search start at 10GE\
...
#
#| tc12-1518B-4t4c-ethip6ip6-ip6base-srv6enc2sids-nodecaps-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over SRv6 routing config with\
#| | ... | 4 threads, 4 phy cores, 2 receive queues per NIC port.
#| | ... | [Ver] Find PDR for 1518 Byte frames using binary search start at 10GE\
