...
| ${prefix}= | ${64}
| ${srv6_overhead_nosrh}= | ${40}  # outer IPv6 header: 40B
| ${srv6_overhead_2sids}= | ${80}  # outer IPv6 header + SRH with 2 SIDs: 40+40B
# Traffic profile:
...
| | When Initialize IPv6 forwarding over SRv6 with encapsulation in 3-node circular topology
...
*** Test Cases ***
| tc01-64B-1t1c-ethip6ip6udp-ip6base-srv6enc-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs IPv6 over STv6 routing config with\
...
#| tc02-64B-1t1c-ethip6ip6udp-ip6base-srv6enc-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over STv6 routing config with\
#| | ... | 1 thread, 1 phy core, 1 receive queue per NIC port.
...
#
#| tc03-64B-2t2c-ethip6ip6udp-ip6base-srv6enc-ndrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over STv6 routing config with\
...
#
#| tc04-64B-2t2c-ethip6ip6udp-ip6base-srv6enc-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over STv6 routing config with\
#| | ... | 2 threads, 2 phy cores, 1 receive queue per NIC port.
#| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 10GE\
...
#
#| tc05-64B-4t4c-ethip6ip6udp-ip6base-srv6enc-ndrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over STv6 routing config with\
...
#
#| tc06-64B-4t4c-ethip6ip6udp-ip6base-srv6enc-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over STv6 routing config with\
#| | ... | 4 threads, 4 phy cores, 2 receive queues per NIC port.
#| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 10GE\
