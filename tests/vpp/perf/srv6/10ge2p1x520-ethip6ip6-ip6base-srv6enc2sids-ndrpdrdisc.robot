...
*** Test Cases ***
| tc01-64B-1t1c-ethip6ip6-ip6base-srv6enc2sids-ndrdisc
| | [Documentation]
...
#| tc02-64B-1t1c-ethip6ip6-ip6base-srv6enc2sids-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over STv6 routing config with\
#| | ... | 1 thread, 1 phy core, 1 receive queue per NIC port.
...
#
#| tc03-64B-2t2c-ethip6ip6-ip6base-srv6enc2sids-ndrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over STv6 routing config with\
...
#
#| tc04-64B-2t2c-ethip6ip6-ip6base-srv6enc2sids-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over STv6 routing config with\
#| | ... | 2 threads, 2 phy cores, 1 receive queue per NIC port.
#| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 10GE\
...
#
#| tc05-64B-4t4c-ethip6ip6-ip6base-srv6enc2sids-ndrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over STv6 routing config with\
...
#
#| tc06-64B-4t4c-ethip6ip6-ip6base-srv6enc2sids-pdrdisc
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv6 over STv6 routing config with\
#| | ... | 4 threads, 4 phy cores, 2 receive queues per NIC port.
#| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 10GE\
