...
testcase = Testcase(r'''
| ${tc_num}-${frame_lower}-${cores_str}c-ethip6ip6-ip6base-srv6enc1sid-ndrdisc
...
with open("10ge2p1x520-ethip6ip6-ip6base-srv6enc1sid-ndrpdr.robot", "w") as file_out:
    file_out.write(prolog)
    file_out.write(testcase.generate(1, 78, 1))
    file_out.write(testcase.generate(2, 78, 2))
    file_out.write(testcase.generate(3, 78, 4))
    file_out.write(testcase.generate(4, 1518, 1))
    file_out.write(testcase.generate(5, 1518, 2))
    file_out.write(testcase.generate(6, 1518, 4))
