...
| ... | TCP | NIC_Intel-X710 | DRV_VFIO_PCI | IPERF3_LDPRELOAD | NSIM
|
...
*** Test Cases ***
| tc01-IMIX-1c-eth-ip4tcp-nsim-ldpreload-iperf3-bps
| | [Tags] | 1C | 1CLIENT | 1STREAM
| | phy_cores=${1} | clients=${1} | streams=${1} | bytes=1G |

| tc02-IMIX-1c-eth-ip4tcp-nsim-ldpreload-iperf3-bps
| | [Tags] | 1C | 1CLIENT | 10STREAM
| | phy_cores=${1} | clients=${1} | streams=${10} | bytes=10G |

| tc03-IMIX-2c-eth-ip4tcp-nsim-ldpreload-iperf3-bps
| | [Tags] | 2C | 1CLIENT | 10STREAM
| | phy_cores=${2} | clients=${1} | streams=${10} | bytes=10G |

| tc04-IMIX-4c-eth-ip4tcp-nsim-ldpreload-iperf3-bps
