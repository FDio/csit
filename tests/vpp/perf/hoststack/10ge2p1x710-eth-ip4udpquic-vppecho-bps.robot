...
*** Test Cases ***
| tc01-IMIX-0c-eth-ip4udpquic-vppecho-bps
| | [Tags] | 0C | 1CLIENT | 1STREAM
| | phy_cores=${0} | clients=${1} | streams=${1} | bytes=100M

| tc02-IMIX-0c-eth-ip4udpquic-vppecho-bps
| | [Tags] | 0C | 1CLIENT | 10STREAM
| | phy_cores=${0} | clients=${1} | streams=${10} | bytes=100M

| tc03-IMIX-0c-eth-ip4udpquic-vppecho-bps
| | [Tags] | 0C | 10CLIENT | 1STREAM
| | phy_cores=${0} | clients=${10} | streams=${1} | bytes=100M

| tc04-IMIX-0c-eth-ip4udpquic-vppecho-bps
| | [Tags] | 0C | 10CLIENT | 10STREAM
| | phy_cores=${0} | clients=${10} | streams=${10} | bytes=100M
