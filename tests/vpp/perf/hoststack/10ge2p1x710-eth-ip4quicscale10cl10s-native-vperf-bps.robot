...
| ... | eth-ip4quicscale10cl10s-native-vperf
|
...
|
| Documentation | **Vperf client -> Vperf server QUIC goodput (10 clients, 10 streams, native crypto).**
| ... |
...
*** Test Cases ***
| 1280B-1c-eth-ip4quicscale10cl10s-native-vperf-bps
| | [Tags] | 1C
| | phy_cores=${1}
