...
| ... | NIC_Intel-X710 | DRV_VFIO_PCI | UDP | QUIC | NSIM | VPPECHO
| ... | HOSTSTACK | eth-ip4udpquic-nsim-vppecho
|
...
*** Test Cases ***
| tc01-IMIX-1c-eth-ip4udpquic-nsim-vppecho-bps
| | [Tags] | 1C | 1CLIENT | 1STREAM
| | phy_cores=${1} | clients=${1} | streams=${1} | bytes=100M

| tc02-IMIX-1c-eth-ip4udpquic-nsim-vppecho-bps
| | [Tags] | 1C | 1CLIENT | 10STREAM
| | phy_cores=${1} | clients=${1} | streams=${10} | bytes=100M

| tc03-IMIX-1c-eth-ip4udpquic-nsim-vppecho-bps
| | [Tags] | 1C | 10CLIENT | 1STREAM
| | phy_cores=${1} | clients=${10} | streams=${1} | bytes=100M

| tc04-IMIX-1c-eth-ip4udpquic-nsim-vppecho-bps
