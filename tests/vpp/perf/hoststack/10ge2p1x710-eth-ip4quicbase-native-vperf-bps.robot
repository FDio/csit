...
| ... | 1CLIENT | 1STREAM | HOSTSTACK | 1280B | eth-ip4quicbase-native-vperf
|
...
|
| Documentation | **Vperf client -> Vperf server QUIC goodput (vpp/openssl crypto).**
| ... |
...
*** Test Cases ***
| 1280B-1c-eth-ip4quicbase-openssl-vperf-bps
| | [Tags] | 1C
| | phy_cores=${1}
