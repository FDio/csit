...
| 8192B-1c-eth-ip4tcphttp-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 8192B | 1C
| | frame_size=${8192} | phy_cores=${1}

| 8192B-2c-eth-ip4tcphttp-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 8192B | 2C
| | frame_size=${8192} | phy_cores=${2}
