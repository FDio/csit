...
| ... | LDPRELOAD | IPERF3 | 1CLIENT | 8STREAM | 1460B
| ... | eth-ip4tcp-hfc-scenarios-ldpreload-1cl8s
|
...
| ${frame_size}= | ${1518}
| ${crypto_type}= | ${None}
| ${client_ldpreload}= | ${True}
| ${server_ldpreload}= | ${True}
| ${streams} | ${8}
...
*** Test Cases ***
| 1460B-1c-eth-ip4tcp-hfc-scenarios-ldpreload-1cl8s-bps
