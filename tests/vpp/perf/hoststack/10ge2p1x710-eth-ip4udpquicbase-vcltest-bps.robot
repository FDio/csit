...
| ... | 1CLIENT | 1STREAM | HOSTSTACK | 1280B | eth-ip4udpquicbase-vcltest
|
...
|
| Documentation | **VCL Test client -> VCL Test server QUIC goodput.**
| ... |
...
*** Test Cases ***
| 1280B-1c-eth-ip4udpquicbase-vcltest-bps
| | [Tags] | 1C
| | phy_cores=${1}
