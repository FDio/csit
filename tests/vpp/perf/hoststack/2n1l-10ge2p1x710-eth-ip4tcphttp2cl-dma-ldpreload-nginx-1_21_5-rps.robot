...
| ... | TCP_RPS | DMA
| ... | eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5
|
...
*** Test Cases ***
| 0B-2c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 0B | 2C
| | frame_size=${0} | vpp_cores=${1} | nginx_cores=${1}

| 0B-3c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 0B | 3C
| | frame_size=${0} | vpp_cores=${1} | nginx_cores=${2}

| 0B-4c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 0B | 4C
| | frame_size=${0} | vpp_cores=${1} | nginx_cores=${3}

| 64B-2c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 64B | 2C
| | frame_size=${64} | vpp_cores=${1} | nginx_cores=${1}

| 64B-3c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 64B | 3C
| | frame_size=${64} | vpp_cores=${1} | nginx_cores=${2}

| 64B-4c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 64B | 4C
| | frame_size=${64} | vpp_cores=${1} | nginx_cores=${3}

| 1KB-2c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 1KB | 2C
| | frame_size=1KB | vpp_cores=${1} | nginx_cores=${1}

| 1KB-3c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 1KB | 3C
| | frame_size=1KB | vpp_cores=${1} | nginx_cores=${2}

| 1KB-4c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 1KB | 4C
| | frame_size=1KB | vpp_cores=${1} | nginx_cores=${3}

| 2KB-2c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 2KB | 2C
| | frame_size=2KB | vpp_cores=${1} | nginx_cores=${1}

| 2KB-3c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 2KB | 3C
| | frame_size=2KB | vpp_cores=${1} | nginx_cores=${2}

| 2KB-4c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 2KB | 4C
| | frame_size=2KB | vpp_cores=${1} | nginx_cores=${3}

| 4KB-2c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 4KB | 2C
| | frame_size=4KB | vpp_cores=${1} | nginx_cores=${1}

| 4KB-3c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 4KB | 3C
| | frame_size=4KB | vpp_cores=${1} | nginx_cores=${2}

| 4KB-4c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 4KB | 4C
| | frame_size=4KB | vpp_cores=${1} | nginx_cores=${3}

| 8KB-2c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 8KB | 2C
| | frame_size=8KB | vpp_cores=${1} | nginx_cores=${1}

| 8KB-3c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 8KB | 3C
| | frame_size=8KB | vpp_cores=${1} | nginx_cores=${2}

| 8KB-4c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 8KB | 4C
| | frame_size=8KB | vpp_cores=${1} | nginx_cores=${3}

| 16KB-2c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 16KB | 2C
| | frame_size=16KB | vpp_cores=${1} | nginx_cores=${1}

| 16KB-3c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 16KB | 3C
| | frame_size=16KB | vpp_cores=${1} | nginx_cores=${2}

| 16KB-4c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 16KB | 4C
| | frame_size=16KB | vpp_cores=${1} | nginx_cores=${3}

| 32KB-2c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 32KB | 2C
| | frame_size=32KB | vpp_cores=${1} | nginx_cores=${1}

| 32KB-3c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 32KB | 3C
| | frame_size=32KB | vpp_cores=${1} | nginx_cores=${2}

| 32KB-4c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 32KB | 4C
| | frame_size=32KB | vpp_cores=${1} | nginx_cores=${3}

| 64KB-2c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 64KB | 2C
| | frame_size=64KB | vpp_cores=${1} | nginx_cores=${1}

| 64KB-3c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 64KB | 3C
| | frame_size=64KB | vpp_cores=${1} | nginx_cores=${2}

| 64KB-4c-eth-ip4tcphttp2cl-dma-ldpreload-nginx-1_21_5-rps
| | [Tags] | 64KB | 4C
