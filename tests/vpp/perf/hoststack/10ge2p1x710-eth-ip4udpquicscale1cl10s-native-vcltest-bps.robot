...
| ... | eth-ip4udpquicscale1cl10s-native-vcltest
|
...
|
| Documentation | **VCL Test client -> VCL Test server QUIC goodput (1 client, 10 streams, native crypto).**
| ... |
...
*** Test Cases ***
| 1280B-1c-eth-ip4udpquicscale1cl10s-native-vcltest-bps
| | [Tags] | 1C
| | phy_cores=${1}
