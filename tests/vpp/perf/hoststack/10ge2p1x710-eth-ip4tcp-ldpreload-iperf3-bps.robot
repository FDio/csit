...
| | phy_cores=${1} | clients=${1} | streams=${1} | bytes=40G

| tc02-9000B-1c-eth-ip4tcp-ldpreload-iperf3-bps
| | [Tags] | 1C | 1CLIENT | 10STREAM
| | phy_cores=${1} | clients=${1} | streams=${10} | bytes=100G

| tc03-9000B-2c-eth-ip4tcp-ldpreload-iperf3-bps
| | [Tags] | 2C | 1CLIENT | 10STREAM
| | phy_cores=${2} | clients=${1} | streams=${10} | bytes=10G

| tc04-9000B-4c-eth-ip4tcp-ldpreload-iperf3-bps
