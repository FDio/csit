...
| Test Teardown | Tear down test | vhost
|
...
| | ... | node=DUT1 | nf_nodes=${2} | vnf=iperf3
| | ... | validate=${False}
| | Set Test Variable | ${iperf_client_affinity} | 1-${thr_count_int}
| | Set Test Variable | ${iperf_server_affinity} | 1-${thr_count_int}
| | And Start iPerf Server
| | ... | ${nodes['${iperf_server_node}']} | affinity=${iperf_server_affinity}
| | Traffic should pass with maximum rate on iPerf3

*** Test Cases ***
| 128KB-1c-ethip4-ip4base-2vhost-gso-mrr
| | [Tags] | 128KB | 1C | THIS
| | frame_size=${128000} | phy_cores=${1}

| 128KB-2c-ethip4-ip4base-2vhost-gso-mrr
| | [Tags] | 128KB | 2C
| | frame_size=${128000} | phy_cores=${2}

| 128KB-4c-ethip4-ip4base-2vhost-gso-mrr
| | [Tags] | 128KB | 4C
