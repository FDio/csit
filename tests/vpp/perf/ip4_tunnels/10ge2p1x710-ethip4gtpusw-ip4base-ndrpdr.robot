...
| | # 667 is 639 at reass level out of 1516
| | # 533 implies 532+532+512 (=1576)
| | # 526 implies 524+524+524+24 (=1596)
| | # 778 implies 772+772+32 (=1576)
| | And VPP Set Interface MTU and bring up | ${nodes['DUT1']} | ${dut1_if2} | ${788}
