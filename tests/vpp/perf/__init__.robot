...
| | ... | - stat_runtime - Statistics actions including non-main trials.
| | ... | - stat_pre_trial - Statistics actions before main trials.
| | ... | - stat_post_trial - Statistics actions after main trials.
