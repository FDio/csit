...
# See the License for the s10ge2p1x710-ethip4-ip4scale2m-rdn-ndrpdr.robotpecific language governing permissions and
...
# Traffic profile:10ge2p1x710-ethip4-ip4scale2m-rdn-ndrpdr.robot
...
| | ...
| | ... | *Arguments:*10ge2p1x710-ethip4-ip4scale2m-rdn-ndrpdr.robot
...
| | And Set Max Rate And Jumbo And Handle Multi Seg10ge2p1x710-ethip4-ip4scale2m-rdn-ndrpdr.robot
| | And Apply startup configuration on all VPP DUTs
| | When Initialize layer driver | ${nic_driver}
| | And Initialize IPv4 forwarding with scaling in circular topology10ge2p1x710-ethip4-ip4scale2m-rdn-ndrpdr.robot
| | ... | ${rts_per_flow}10ge2p1x710-ethip4-ip4scale2m-rdn-ndrpdr.robot
