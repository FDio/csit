...
| | And Initialize IPv4 forwarding in circular topology | 192.168.0.1 | 20.0.0.0
| | Set Test Variable | \${max_rate} | ${1032192}
| | Pcap Trace On | ${dut1} | rx | ${2000000} | ${DUT1_${int}1}[0] | dut1_if1_ip4_rx_1c_16384u_1s_1032192cps.pcap
