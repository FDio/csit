...
| ${overhead}= | ${0}
# Traffic profile
| ${traffic_profile}= | trex-stl-ethip4-ethip4
...
| &{traffic_profile_params}=
| ... | p1_src_ip_start=10.10.10.2 | p1_src_ip_count=253
| ... | p1_dst_ip_start=20.20.20.2 | p1_dst_ip_count=1
| ... | p2_src_ip_start=20.20.20.2 | p2_src_ip_count=253
| ... | p2_dst_ip_start=10.10.10.2 | p2_dst_ip_count=1
