...
| | ... | [Ver] Measure raw rate for ${framesize} frames using single trial\
...
| | ... | ${max_rate} | ${framesize} | ${traffic_profile}
...
| | ... | [Ver] Measure raw rate for 64B frames using single trial\
| | ... | throughput test at line rate.
...
| | ... | [Cfg] DUT runs IPv4 routing config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Measure raw rate for 1518B frames using single trial\
| | ... | throughput test at line rate.
...
| | ... | [Cfg] DUT runs IPv4 routing config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Measure raw rate for 9000B frames using single trial\
| | ... | throughput test at line rate.
