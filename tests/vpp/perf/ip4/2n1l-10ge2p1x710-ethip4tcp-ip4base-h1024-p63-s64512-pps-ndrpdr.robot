...
| IMIX-1c-ethip4tcp-ip4base-h1024-p63-s64512-pps-ndrpdr
| | [Tags] | IMIX | 1C
| | frame_size=IMIX_v4_1 | phy_cores=${1}

| IMIX-2c-ethip4tcp-ip4base-h1024-p63-s64512-pps-ndrpdr
| | [Tags] | IMIX | 2C
| | frame_size=IMIX_v4_1 | phy_cores=${2}

| IMIX-4c-ethip4tcp-ip4base-h1024-p63-s64512-pps-ndrpdr
| | [Tags] | IMIX | 4C
