...
*** Test Cases ***
| 133B-1c-ethip4udp-nat44ed-h1024-p63-s64512-pps-ndrpdr
| | [Tags] | 133B | 1C
| | frame_size=${133} | phy_cores=${1}

| 134B-1c-ethip4udp-nat44ed-h1024-p63-s64512-pps-ndrpdr
| | [Tags] | 134B | 1C
| | frame_size=${134} | phy_cores=${1}

| 133B-2c-ethip4udp-nat44ed-h1024-p63-s64512-pps-ndrpdr
| | [Tags] | 133B | 2C
| | frame_size=${133} | phy_cores=${2}

| 134B-2c-ethip4udp-nat44ed-h1024-p63-s64512-pps-ndrpdr
| | [Tags] | 134B | 2C
| | frame_size=${134} | phy_cores=${2}

| 133B-4c-ethip4udp-nat44ed-h1024-p63-s64512-pps-ndrpdr
| | [Tags] | 133B | 4C
| | frame_size=${133} | phy_cores=${4}

| 134B-4c-ethip4udp-nat44ed-h1024-p63-s64512-pps-ndrpdr
| | [Tags] | 134B | 4C
