...
*** Test Cases ***
| tc01-64B-1t1c-ethip4-ip4base-iacl1-stateless-flows100-ndrdisc
| | ...
...
| tc02-64B-1t1c-ethip4-ip4base-iacl1-stateless-flows100-pdrdisc
...
#| tc03-64B-1t1c-ethip4-ip4base-iacl10-stateless-flows100-ndrdisc
#| | [Tags] | 1T1C | STHREAD | NDRDISC | FEATURE | ACL | SRC_USER_100
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
#| | ... | 1 thread, 1 phy core, 1 receive queue per NIC port.
...
#| | ... | min_rate=${10000} | search_type=NDR
#
#| tc04-64B-1t1c-ethip4-ip4base-iacl10-stateless-flows100-pdrdisc
#| | [Tags] | 1T1C | STHREAD | PDRDISC | FEATURE | ACL | SRC_USER_100
#| | ... | SKIP_PATCH
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
...
#| | ... | min_rate=${10000} | search_type=PDR
#
#| tc05-64B-1t1c-ethip4-ip4base-iacl50-stateless-flows100-ndrdisc
#| | [Tags] | 1T1C | STHREAD | NDRDISC | FEATURE | ACL | SRC_USER_100
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
#| | ... | 1 thread, 1 phy core, 1 receive queue per NIC port.
...
#| | ... | min_rate=${10000} | search_type=NDR
#
#| tc06-64B-1t1c-ethip4-ip4base-iacl50-stateless-flows100-pdrdisc
#| | [Tags] | 1T1C | STHREAD | PDRDISC | FEATURE | ACL | SRC_USER_100
#| | ... | SKIP_PATCH
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
...
#| | ... | min_rate=${10000} | search_type=PDR
#
#| tc07-64B-1t1c-ethip4-ip4base-iacl1-stateless-flows10k-ndrdisc
...
#| | ... | min_rate=${10000} | search_type=NDR
#
#| tc08-64B-1t1c-ethip4-ip4base-iacl1-stateless-flows10k-pdrdisc
...
#| | ... | min_rate=${10000} | search_type=PDR
#
#| tc09-64B-1t1c-ethip4-ip4base-iacl10-stateless-flows10k-ndrdisc
#| | [Tags] | 1T1C | STHREAD | NDRDISC | FEATURE | ACL | SRC_USER_10
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
#| | ... | 1 thread, 1 phy core, 1 receive queue per NIC port.
...
#| | ... | min_rate=${10000} | search_type=NDR
#
#| tc10-64B-1t1c-ethip4-ip4base-iacl10-stateless-flows10k-pdrdisc
#| | [Tags] | 1T1C | STHREAD | PDRDISC | FEATURE | ACL | SRC_USER_10
#| | ... | SKIP_PATCH
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
...
#| | ... | min_rate=${10000} | search_type=PDR
#
#| tc13-64B-1t1c-ethip4-ip4base-iacl1-stateless-flows100k-ndrdisc
#| | [Tags] | 1T1C | STHREAD | NDRDISC | FEATURE | ACL | SRC_USER_100
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
#| | ... | 1 thread, 1 phy core, 1 receive queue per NIC port.
...
#| | ... | min_rate=${10000} | search_type=NDR
#
#| tc14-64B-1t1c-ethip4-ip4base-iacl1-stateless-flows100k-pdrdisc
#| | [Tags] | 1T1C | STHREAD | PDRDISC | FEATURE | ACL | SRC_USER_100
#| | ... | SKIP_PATCH
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
...
#| | ... | min_rate=${10000} | search_type=PDR
#
#| tc15-64B-1t1c-ethip4-ip4base-iacl10-stateless-flows100k-ndrdisc
#| | [Tags] | 1T1C | STHREAD | NDRDISC | FEATURE | ACL | SRC_USER_100
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
#| | ... | 1 thread, 1 phy core, 1 receive queue per NIC port.
...
#| | ... | min_rate=${10000} | search_type=NDR
#
#| tc16-64B-1t1c-ethip4-ip4base-iacl10-stateless-flows100k-pdrdisc
#| | [Tags] | 1T1C | STHREAD | PDRDISC | FEATURE | ACL | SRC_USER_100
#| | ... | SKIP_PATCH
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
...
#| | ... | min_rate=${10000} | search_type=PDR
#
#| tc19-64B-2t2c-ethip4-ip4base-iacl1-stateless-flows100-ndrdisc
#| | ...
...
#| | ... | min_rate=${10000} | search_type=NDR
#
#| tc20-64B-2t2c-ethip4-ip4base-iacl1-stateless-flows100-pdrdisc
...
#| | ... | min_rate=${10000} | search_type=PDR
#
#| tc21-64B-2t2c-ethip4-ip4base-iacl10-stateless-flows100-ndrdisc
#| | ...
#| | [Tags] | 2T2C | MTHREAD | NDRDISC | FEATURE | ACL | SRC_USER_100
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
...
#| | ... | min_rate=${10000} | search_type=NDR
#
#| tc22-64B-2t2c-ethip4-ip4base-iacl10-stateless-flows100-pdrdisc
#| | [Tags] | 2T2C | MTHREAD | PDRDISC | FEATURE | ACL | SRC_USER_100
#| | ... | SKIP_PATCH
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
...
#| | ... | min_rate=${10000} | search_type=PDR
#
#| tc23-64B-2t2c-ethip4-ip4base-iacl50-stateless-flows100-ndrdisc
#| | ...
#| | [Tags] | 2T2C | MTHREAD | NDRDISC | FEATURE | ACL | SRC_USER_100
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
...
#| | ... | min_rate=${10000} | search_type=NDR
#
#| tc24-64B-2t2c-ethip4-ip4base-iacl50-stateless-flows100-pdrdisc
#| | [Tags] | 2T2C | MTHREAD | PDRDISC | FEATURE | ACL | SRC_USER_100
#| | ... | SKIP_PATCH
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
...
#| | ... | min_rate=${10000} | search_type=PDR
#
#| tc25-64B-2t2c-ethip4-ip4base-iacl1-stateless-flows10k-ndrdisc
#| | ...
...
#| | ... | min_rate=${10000} | search_type=NDR
#
#| tc26-64B-2t2c-ethip4-ip4base-iacl1-stateless-flows10k-pdrdisc
...
#| | ... | min_rate=${10000} | search_type=PDR
#
#| tc27-64B-2t2c-ethip4-ip4base-iacl10-stateless-flows10k-ndrdisc
#| | ...
#| | [Tags] | 2T2C | MTHREAD | NDRDISC | FEATURE | ACL | SRC_USER_10
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
...
#| | ... | min_rate=${10000} | search_type=NDR
#
#| tc28-64B-2t2c-ethip4-ip4base-iacl10-stateless-flows10k-pdrdisc
#| | [Tags] | 2T2C | MTHREAD | PDRDISC | FEATURE | ACL | SRC_USER_10
#| | ... | SKIP_PATCH
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
...
#| | ... | min_rate=${10000} | search_type=PDR
#
#| tc31-64B-2t2c-ethip4-ip4base-iacl1-stateless-flows100k-ndrdisc
#| | ...
#| | [Tags] | 2T2C | MTHREAD | NDRDISC | FEATURE | ACL | SRC_USER_100
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
...
#| | ... | min_rate=${10000} | search_type=NDR
#
#| tc32-64B-2t2c-ethip4-ip4base-iacl1-stateless-flows100k-pdrdisc
#| | [Tags] | 2T2C | MTHREAD | PDRDISC | FEATURE | ACL | SRC_USER_100
#| | ... | SKIP_PATCH
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
...
#| | ... | min_rate=${10000} | search_type=PDR
#
#| tc33-64B-2t2c-ethip4-ip4base-iacl10-stateless-flows100k-ndrdisc
#| | ...
#| | [Tags] | 2T2C | MTHREAD | NDRDISC | FEATURE | ACL | SRC_USER_100
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
...
#| | ... | min_rate=${10000} | search_type=NDR
#
#| tc34-64B-2t2c-ethip4-ip4base-iacl10-stateless-flows100k-pdrdisc
#| | [Tags] | 2T2C | MTHREAD | PDRDISC | FEATURE | ACL | SRC_USER_100
#| | ... | SKIP_PATCH
#| | [Documentation]
#| | ... | [Cfg] DUT runs IPv4 routing config with ACL with\
