...
| ... | NIC_Intel-X520-DA2 | DOT1Q | L2BDMACLRN | BASE | TEST
| ...
...
| | ... |  ${framesize}
| | ${max_rate}= | Calculate pps | ${s_limit} | ${get_framesize + ${vlan_overhead}}
...
| | When Initialize L2 bridge domains with VLAN in a 3-node circular topology
