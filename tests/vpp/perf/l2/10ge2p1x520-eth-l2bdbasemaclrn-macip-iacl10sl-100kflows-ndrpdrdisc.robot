...
*** Test Cases ***
| tc01-64B-1t1c-eth-l2bdbasemaclrn-macip-iacl10-stateless-flows100k-ndrdisc
| | [Documentation]
...
| tc02-64B-1t1c-eth-l2bdbasemaclrn-macip-iacl10-stateless-flows100k-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with MACIP ACL with\
| | ... | 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| tc03-64B-2t2c-eth-l2bdbasemaclrn-macip-iacl10-stateless-flows100k-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with MACIP ACL with\
...
| tc04-64B-2t2c-eth-l2bdbasemaclrn-macip-iacl10-stateless-flows100k-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with MACIP ACL with\
| | ... | 2 threads, 2 phy cores, 1 receive queue per NIC port.
| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 10GE\
...
| tc05-64B-4t4c-eth-l2bdbasemaclrn-macip-iacl10-stateless-flows100k-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with MACIP ACL with\
...
| tc06-64B-4t4c-eth-l2bdbasemaclrn-macip-iacl10-stateless-flows100k-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with MACIP ACL with\
| | ... | 4 threads, 4 phy cores, 2 receive queues per NIC port.
| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 10GE\
