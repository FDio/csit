...
| ${trex_if1_mac}= | ca:fe:00:00:00:00
| ${trex_if2_mac}= | fa:ce:00:00:00:00
| ${trex_mac_mask}= | ff:ff:ff:fe:00:00
...
| | ${traffic_profile}= | Set Variable | trex-sl-3n-ethip4-macsrc100kip4src100k
