...
| ... | L2 | Intel-X520-DA2
| ... | AND | Create ETCD container on all DUTs
| ... | AND | Start all 'ETCD' containers
| ... | AND | Create Kafka container on all DUTs
| ... | AND | Start all 'Kafka' containers
| ... | AND | Create VNF containers on all DUTs | Docker
| ... | ubuntu | ${container_cpus} | ${container_count}
#| ... | AND | Create VNF containers on all DUTs | LXC
#| ... | -d ubuntu -r xenial -a amd64 | ${container_cpus} | ${container_count}
| ... | AND | Start all 'VNF' containers
| ... | AND | Install VPP in all 'VNF' containers
| ... | AND | Configure VPP in all 'VNF' containers
| ...
