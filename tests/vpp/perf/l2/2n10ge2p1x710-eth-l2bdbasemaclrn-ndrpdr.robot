...
| ...
| Test Template | Discover NDRPDR for l2bdbasemaclrn
| ...
...
*** Keywords ***
| Discover NDRPDR for l2bdbasemaclrn
| | [Documentation]
| | ... | [Cfg] DUT runs L2 switching config with ${wt} thread(s), ${wt}\
| | ... | phy core(s), ${rxq} receive queue(s) per NIC port.
| | ... | [Ver] Find NDR and PDR for ${framesize} frames using binary search start at\
...
| | ... | [Ver] Find NDR and PDR for 64 Byte frames using\
| | ... | optimized binary search start at 10GE linerate.
| | ...
