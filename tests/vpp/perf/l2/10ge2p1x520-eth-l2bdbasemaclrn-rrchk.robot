...
| ...
| Force Tags | 3_NODE_SINGLE_LINK_TOPO | PERFTEST | HW_ENV | RRCHK
...
| ... | *[Ver] TG verification:* In Raw results checks TG sends traffic
...
| | ... | [Ver] Measure raw results for ${framesize} frames using single trial\
| | ... | throughput test at line rate.
| | ...
...
*** Test Cases ***
| tc01-64B-1t1c-eth-l2bdbasemaclrn-rrchk
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Measure raw results for 64B frames using single trial\
| | ... | throughput test at line rate.
...
| tc02-1518B-1t1c-eth-l2bdbasemaclrn-rrchk
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Measure raw results for 1518B frames using single\
| | ... | trial throughput test at line rate.
| | [Tags] | 1518B | 1T1C | STHREAD
| | ...
| | [Template] | Check RR for l2bdbasemaclrn
| | framesize=${1518} | wt=1 | rxq=1

| tc03-9000B-1t1c-eth-l2bdbasemaclrn-rrchk
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Measure raw results for 9000B frames using single\
| | ... | trial throughput test at line rate.
...
| tc04-64B-2t2c-eth-l2bdbasemaclrn-rrchk
| | [Documentation]
...
| tc05-1518B-2t2c-eth-l2bdbasemaclrn-rrchk
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 2 threads, 2 phy cores, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Measure raw results for 1518B frames using single\
...
| tc06-9000B-2t2c-eth-l2bdbasemaclrn-rrchk
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 2 threads, 2 phy cores, \
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Measure raw results for 9000B frames using single\
...
| tc07-64B-4t4c-eth-l2bdbasemaclrn-rrchk
| | [Documentation]
...
| tc08-1518B-4t4c-eth-l2bdbasemaclrn-rrchk
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 4 threads, 4 phy cores, \
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Measure raw results for 1518B frames using single\
...
| tc09-9000B-4t4c-eth-l2bdbasemaclrn-rrchk
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD config with 4 threads, 4 phy cores, \
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Measure raw results for 9000B frames using single\
