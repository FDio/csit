...
| tc03-64B-1t1c-eth-l2bdbasemaclrn-iacl10-stateful-flows100-ndrdisc
| | [Tags] | 1T1C | STHREAD | NDRDISC | FEATURE | ACL | SRC_USER_100
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
| | ... | 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| tc04-64B-1t1c-eth-l2bdbasemaclrn-iacl10-stateful-flows100-pdrdisc
| | [Tags] | 1T1C | STHREAD | PDRDISC | FEATURE | ACL | SRC_USER_100
| | ... | SKIP_PATCH
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
...
| tc05-64B-1t1c-eth-l2bdbasemaclrn-iacl50-stateful-flows100-ndrdisc
| | [Tags] | 1T1C | STHREAD | NDRDISC | FEATURE | ACL | SRC_USER_100
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
| | ... | 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| tc06-64B-1t1c-eth-l2bdbasemaclrn-iacl50-stateful-flows100-pdrdisc
| | [Tags] | 1T1C | STHREAD | PDRDISC | FEATURE | ACL | SRC_USER_100
| | ... | SKIP_PATCH
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
...
| tc07-64B-1t1c-eth-l2bdbasemaclrn-iacl1-stateful-flows10k-ndrdisc
...
| tc08-64B-1t1c-eth-l2bdbasemaclrn-iacl1-stateful-flows10k-pdrdisc
...
| tc09-64B-1t1c-eth-l2bdbasemaclrn-iacl10-stateful-flows10k-ndrdisc
| | [Tags] | 1T1C | STHREAD | NDRDISC | FEATURE | ACL | SRC_USER_10
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
| | ... | 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| tc10-64B-1t1c-eth-l2bdbasemaclrn-iacl10-stateful-flows10k-pdrdisc
| | [Tags] | 1T1C | STHREAD | PDRDISC | FEATURE | ACL | SRC_USER_10
| | ... | SKIP_PATCH
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
...
| tc13-64B-1t1c-eth-l2bdbasemaclrn-iacl1-stateful-flows100k-ndrdisc
| | [Tags] | 1T1C | STHREAD | NDRDISC | FEATURE | ACL | SRC_USER_100
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
| | ... | 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| tc14-64B-1t1c-eth-l2bdbasemaclrn-iacl1-stateful-flows100k-pdrdisc
| | [Tags] | 1T1C | STHREAD | PDRDISC | FEATURE | ACL | SRC_USER_100
| | ... | SKIP_PATCH
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
...
| tc15-64B-1t1c-eth-l2bdbasemaclrn-iacl10-stateful-flows100k-ndrdisc
| | [Tags] | 1T1C | STHREAD | NDRDISC | FEATURE | ACL | SRC_USER_100
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
| | ... | 1 thread, 1 phy core, 1 receive queue per NIC port.
...
| tc16-64B-1t1c-eth-l2bdbasemaclrn-iacl10-stateful-flows100k-pdrdisc
| | [Tags] | 1T1C | STHREAD | PDRDISC | FEATURE | ACL | SRC_USER_100
| | ... | SKIP_PATCH
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
...
| tc19-64B-2t2c-eth-l2bdbasemaclrn-iacl1-stateful-flows100-ndrdisc
| | ...
...
| tc20-64B-2t2c-eth-l2bdbasemaclrn-iacl1-stateful-flows100-pdrdisc
...
| tc21-64B-2t2c-eth-l2bdbasemaclrn-iacl10-stateful-flows100-ndrdisc
| | ...
| | [Tags] | 2T2C | MTHREAD | NDRDISC | FEATURE | ACL | SRC_USER_100
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
...
| tc22-64B-2t2c-eth-l2bdbasemaclrn-iacl10-stateful-flows100-pdrdisc
| | [Tags] | 2T2C | MTHREAD | PDRDISC | FEATURE | ACL | SRC_USER_100
| | ... | SKIP_PATCH
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
...
| tc23-64B-2t2c-eth-l2bdbasemaclrn-iacl50-stateful-flows100-ndrdisc
| | ...
| | [Tags] | 2T2C | MTHREAD | NDRDISC | FEATURE | ACL | SRC_USER_100
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
...
| tc24-64B-2t2c-eth-l2bdbasemaclrn-iacl50-stateful-flows100-pdrdisc
| | [Tags] | 2T2C | MTHREAD | PDRDISC | FEATURE | ACL | SRC_USER_100
| | ... | SKIP_PATCH
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
...
| tc25-64B-2t2c-eth-l2bdbasemaclrn-iacl1-stateful-flows10k-ndrdisc
| | ...
...
| tc26-64B-2t2c-eth-l2bdbasemaclrn-iacl1-stateful-flows10k-pdrdisc
...
| tc27-64B-2t2c-eth-l2bdbasemaclrn-iacl10-stateful-flows10k-ndrdisc
| | ...
| | [Tags] | 2T2C | MTHREAD | NDRDISC | FEATURE | ACL | SRC_USER_10
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
...
| tc28-64B-2t2c-eth-l2bdbasemaclrn-iacl10-stateful-flows10k-pdrdisc
| | [Tags] | 2T2C | MTHREAD | PDRDISC | FEATURE | ACL | SRC_USER_10
| | ... | SKIP_PATCH
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
...
| tc31-64B-2t2c-eth-l2bdbasemaclrn-iacl1-stateful-flows100k-ndrdisc
| | ...
| | [Tags] | 2T2C | MTHREAD | NDRDISC | FEATURE | ACL | SRC_USER_100
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
...
| tc32-64B-2t2c-eth-l2bdbasemaclrn-iacl1-stateful-flows100k-pdrdisc
| | [Tags] | 2T2C | MTHREAD | PDRDISC | FEATURE | ACL | SRC_USER_100
| | ... | SKIP_PATCH
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
...
| tc33-64B-2t2c-eth-l2bdbasemaclrn-iacl10-stateful-flows100k-ndrdisc
| | ...
| | [Tags] | 2T2C | MTHREAD | NDRDISC | FEATURE | ACL | SRC_USER_100
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
...
| tc34-64B-2t2c-eth-l2bdbasemaclrn-iacl10-stateful-flows100k-pdrdisc
| | [Tags] | 2T2C | MTHREAD | PDRDISC | FEATURE | ACL | SRC_USER_100
| | ... | SKIP_PATCH
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with ACL with\
