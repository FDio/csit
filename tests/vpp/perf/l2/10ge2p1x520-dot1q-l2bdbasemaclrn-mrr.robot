...
*** Keywords ***
| Check RR for L2 Bridge Domain with VLAN
...
| | ...
| | [Template] | Check RR for L2 Bridge Domain with VLAN
| | wt=1 | rxq=1 | framesize=${64}

| tc02-1518B-1t1c-dot1q-l2bdbasemaclrn-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port.
...
| tc03-9000B-1t1c-dot1q-l2bdbasemaclrn-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port.
...
| tc04-IMIX-1t1c-dot1q-l2bdbasemaclrn-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port.
...
| tc05-64B-2t2c-dot1q-l2bdbasemaclrn-ndrdisc
| | [Documentation]
...
| tc06-1518B-2t2c-dot1q-l2bdbasemaclrn-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 2 threads, 2 phy cores,\
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for 1518B frames using single trial\
...
| tc07-9000B-2t2c-dot1q-l2bdbasemaclrn-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 2 threads, 2 phy cores,\
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for 9000B frames using single trial\
...
| tc08-IMIX-2t2c-dot1q-l2bdbasemaclrn-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 2 threads, 2 phy cores,\
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for IMIX_v4_1 frames using single trial\
...
| tc09-64B-4t4c-dot1q-l2bdbasemaclrn-ndrdisc
| | [Documentation]
...
| tc10-1518B-4t4c-dot1q-l2bdbasemaclrn-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 4 threads, 4 phy cores,\
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for 1518B frames using single trial\
...
| tc11-9000B-4t4c-dot1q-l2bdbasemaclrn-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 4 threads, 4 phy cores,\
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for 9000B frames using single trial\
...
| tc12-IMIX-4t4c-dot1q-l2bdbasemaclrn-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 4 threads, 4 phy cores,\
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for IMIX_v4_1 frames using single trial\
