...
*** Variables ***
| @{plugins_to_enable}= | avf_plugin.so | gbp_plugin.so
| ${osi_layer}= | L3
| ${nic_name}= | Intel-X710
| ${overhead}= | ${4}
# Traffic profile:
...
| | | ${dut_lo1}= | VPP Create Loopback | ${dut}
| | | Set Interface State | ${dut1} | ${dut_lo1} | up
| | | Add Fib Table | ${dut} | ${1}
...
| | | ... | ${dut} | ${dut_lo1} | 10.10.10.1 | 24
| | | GBP Subnet Add Del
| | | ... | ${dut} | 10.10.10.0 | 24 | bd_id=${1} | sclass=${100}
| | | GBP Ext Itf Add Del
| | | ... | ${dut} | ${dut_lo1} | bd_id=${1} | rd_id=${1}
| | | GBP Endpoint Add
| | | ... | ${dut} | ${${dut_str}_dot1q_${id}_1} | 10.10.10.2
| | | ... | ${${dut_str}_if1_mac} | sclass=${100}
| | | GBP Endpoint Add
| | | ... | ${dut} | ${${dut_str}_dot1q_${id}_1} | 10.10.10.3
| | | ... | ${${dut_str}_if2_mac} | sclass=${100}
| | | VPP Route Add
| | | ... | ${dut} | 20.20.20.0 | 24 | gateway=10.10.10.2 | interface=${dut_lo1}
| | | VPP Route Add
| | | ... | ${dut} | 30.30.30.0 | 24 | gateway=10.10.10.3 | interface=${dut_lo1}
| | | GBP Subnet Add Del
| | | ... | ${dut} | 20.20.20.0 | 24 | bd_id=${1} | sclass=${200}
| | | GBP Subnet Add Del
| | | ... | ${dut} | 30.30.30.0 | 24 | bd_id=${1} | sclass=${300}
| | | Add Replace Acl Multi Entries
| | | ... | ${dut} | rules="ipv4 permit src 0.0.0.0/0 dst 0.0.0.0/0 proto 61"
