...
| ...
| Test Template | Find NDRPDR for l2bdbasemaclrn
| ...
...
| ... | and MAC learning enabled. DUT1 tested with 2p25GE NIC
| ... | XXV710 by Intel.
...
*** Keywords ***
| Find NDRPDR for l2bdbasemaclrn
| | [Documentation]
| | ... | [Cfg] DUT runs L2 switching config with, ${wt} phy core(s),\
...
| | ... | [Cfg] DUT runs L2BD switching config with with\
| | ... | 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find PDR for 1518 Byte frames using binary search start at\
| | ... | linerate, step 50kpps, LT=0.5%.
| | ...
...
| | ... | [Cfg] DUT runs L2BD switching config with with\
| | ... | 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find NDR for 9000 Byte frames using binary search start at\
...
| | ... | [Cfg] DUT runs L2BD switching config with with\
| | ... | 1 phy core, 1 receive queue per NIC port.
| | ... | [Ver] Find PDR for 9000 Byte frames using binary search start at\
