...
*** Test Cases ***
| tc01-64B-1t1c-eth-l2bdbasemaclrn-eth-2vhostvr1024-1vm-ndrdisc-10
| | [Documentation]
...
| | [Tags] | 64B | 1T1C | STHREAD | NDRDISC | THAT
| | ${perf_trial_duration}= | Set Variable | ${10}
...
| tc02-64B-1t1c-eth-l2bdbasemaclrn-eth-2vhostvr1024-1vm-pdrdisc-10
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy core, \
...
| tc03-64B-1t1c-eth-l2bdbasemaclrn-eth-2vhostvr1024-1vm-ndrdisc-30
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port. [Ver] Find NDR for 64 Byte frames \
| | ... | using binary search start at 10GE linerate, step 10kpps.
| | [Tags] | 64B | 1T1C | STHREAD | NDRDISC | THAT
| | ${perf_trial_duration}= | Set Variable | ${30}
| | Set Test Variable | ${perf_trial_duration}
| | ${framesize}= | Set Variable | ${64}
| | ${min_rate}= | Set Variable | ${10000}
| | ${max_rate}= | Calculate pps | ${s_limit} | ${framesize}
...
| tc04-64B-1t1c-eth-l2bdbasemaclrn-eth-2vhostvr1024-1vm-pdrdisc-30
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port. [Ver] Find PDR for 64 Byte frames \
| | ... | using binary search start at 10GE linerate, step 10kpps, LT=0.5%.
...
| tc05-64B-1t1c-eth-l2bdbasemaclrn-eth-2vhostvr1024-1vm-ndrdisc-60
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port. [Ver] Find NDR for 64 Byte frames \
| | ... | using binary search start at 10GE linerate, step 10kpps.
| | [Tags] | 64B | 1T1C | STHREAD | NDRDISC | THAT
| | ${perf_trial_duration}= | Set Variable | ${60}
| | Set Test Variable | ${perf_trial_duration}
| | ${framesize}= | Set Variable | ${64}
| | ${min_rate}= | Set Variable | ${10000}
| | ${max_rate}= | Calculate pps | ${s_limit} | ${framesize}
...
| tc06-64B-1t1c-eth-l2bdbasemaclrn-eth-2vhostvr1024-1vm-pdrdisc-60
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port. [Ver] Find PDR for 64 Byte frames \
| | ... | using binary search start at 10GE linerate, step 10kpps, LT=0.5%.
