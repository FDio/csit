...
| ... | NIC_Intel-XL710 | DOT1Q | L2XCFWD | BASE | VHOST | 1VM
...
| | ${max_rate}= | Calculate pps | ${s_24.5G} | ${get_framesize + ${vlan_overhead}}
...
*** Test Cases ***
| tc01-64B-1t1c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
...
| tc02-1518B-1t1c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 1 thread, 1 phy\
| | ... | core, 1 receive queue per NIC port.
...
| tc03-9000B-1t1c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 1 thread, 1 phy\
| | ... | core, 1 receive queue per NIC port.
...
| tc04-IMIX-1t1c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 1 thread, 1 phy\
| | ... | core, 1 receive queue per NIC port.
...
| tc05-64B-2t2c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
...
| | ... | trial throughput test.
| | ...
| | [Tags] | 64B | 2T2C | MTHREAD | TEST
| | ...
| | [Template] | Check RR for 1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm
| | framesize=${64} | wt=2 | rxq=16

| tc06-1518B-2t2c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 2 threads, 2 phy\
| | ... | cores, 1 receive queue per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for 1518B frames using single\
| | ... | trial throughput test.
| | ...
| | [Tags] | 1518B | 2T2C | MTHREAD | TEST
| | ...
| | [Template] | Check RR for 1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm
| | framesize=${1518} | wt=2 | rxq=8

| tc07-9000B-2t2c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 2 threads, 2 phy\
| | ... | cores, 1 receive queue per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for 9000B frames using single\
...
| tc08-IMIX-2t2c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 2 threads, 2 phy\
| | ... | cores, 1 receive queue per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for IMIX_v4_1 frames using single\
...
| tc09-64B-4t4c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
...
| | ... | trial throughput test.
| | ...
| | [Tags] | 64B | 4T4C | MTHREAD | TEST
| | ...
| | [Template] | Check RR for 1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm
| | framesize=${64} | wt=4 | rxq=8

| tc10-1518B-4t4c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 4 threads, 4 phy\
| | ... | cores, 2 receive queues per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for 1518B frames using single\
| | ... | trial throughput test.
| | ...
| | [Tags] | 1518B | 4T4C | MTHREAD | TEST
| | ...
| | [Template] | Check RR for 1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm
| | framesize=${1518} | wt=4 | rxq=16

| tc11-9000B-4t4c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 4 threads, 4 phy\
| | ... | cores, 2 receive queues per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for 9000B frames using single\
...
| tc12-IMIX-4t4c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 4 threads, 4 phy\
| | ... | cores, 2 receive queues per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for IMIX_v4_1 frames using single\
