...
*** Test Cases ***
| tc01-64B-1t1c-1lbvpp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
...
| tc02-1518B-1t1c-1lbvpp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy\
| | ... | core, 1 receive queue per NIC port.
...
| tc03-9000B-1t1c-1lbvpp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy\
| | ... | core, 1 receive queue per NIC port.
...
| tc04-IMIX-1t1c-1lbvpp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy\
| | ... | core, 1 receive queue per NIC port.
...
| tc05-64B-2t2c-1lbvpp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
...
| tc06-1518B-2t2c-1lbvpp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 2 threads, 2 phy\
| | ... | cores, 1 receive queue per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for 1518B frames using single\
...
| | ...
| | [Template] | Check RR for 1lbvpp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm
| | framesize=${1518} | wt=2 | rxq=16

| tc07-9000B-2t2c-1lbvpp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 2 threads, 2 phy\
| | ... | cores, 1 receive queue per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for 9000B frames using single\
...
| | ...
| | [Template] | Check RR for 1lbvpp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm
| | framesize=${9000} | wt=2 | rxq=16

| tc08-IMIX-2t2c-1lbvpp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 2 threads, 2 phy\
| | ... | cores, 1 receive queue per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for IMIX_v4_1 frames using single\
...
| | ...
| | [Template] | Check RR for 1lbvpp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm
| | framesize=IMIX_v4_1 | wt=2 | rxq=16

| tc09-64B-4t4c-1lbvpp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
...
| | ...
| | [Template] | Check RR for 1lbvpp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm
| | framesize=${64} | wt=4 | rxq=16

| tc10-1518B-4t4c-1lbvpp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 4 threads, 4 phy\
| | ... | cores, 2 receive queues per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for 1518B frames using single\
...
| tc11-9000B-4t4c-1lbvpp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 4 threads, 4 phy\
| | ... | cores, 2 receive queues per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for 9000B frames using single\
...
| | ...
| | [Template] | Check RR for 1lbvpp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm
| | framesize=${9000} | wt=4 | rxq=16

| tc12-IMIX-4t4c-1lbvpp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 4 threads, 4 phy\
| | ... | cores, 2 receive queues per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for IMIX_v4_1 frames using single\
...
| | ...
| | [Template] | Check RR for 1lbvpp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm
| | framesize=IMIX_v4_1 | wt=4 | rxq=16
