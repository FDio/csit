...
| | ...
| | Given Add worker threads and rxqueues to all DUTs | ${phy_cores} | ${rxq} | double_dut_link=${TRUE}
| | And Add PCI devices to all DUTs with double link between DUTs
...
| | ... | ${tag_rewrite} | ${bond_mode} | ${lb_mode} | double_dut_link=${TRUE}
