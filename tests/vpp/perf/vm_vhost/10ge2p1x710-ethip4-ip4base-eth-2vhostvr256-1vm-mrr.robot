...
| | When Initialize IPv4 forwarding with vhost for '1' VMs in 3-node circular topology
| | Set Test Variable | ${jumbo}
| | And Configure '1' guest VMs with dpdk-testpmd-mac connected via vhost-user in 3-node circular topology
