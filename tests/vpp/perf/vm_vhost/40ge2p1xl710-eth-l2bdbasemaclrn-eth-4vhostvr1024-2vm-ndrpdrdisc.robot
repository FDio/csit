...
| | When Initialize L2 bridge domains with Vhost-User for '2' VMs in 3-node circular topology
| | And Configure '2' guest VMs with dpdk-testpmd connected via vhost-user in 3-node circular topology
| | ${results} = | Send traffic on tg |  1 | ${rate} | ${framesize} | ${traffic_profile} | warmup_time=0
| | ${results} = | Send traffic on tg |  2 | ${rate} | ${framesize} | ${traffic_profile} | warmup_time=0
| | ${results} = | Send traffic on tg |  4 | ${rate} | ${framesize} | ${traffic_profile} | warmup_time=0
| | ${results} = | Send traffic on tg |  8 | ${rate} | ${framesize} | ${traffic_profile} | warmup_time=0
| | ${results} = | Send traffic on tg | 16 | ${rate} | ${framesize} | ${traffic_profile} | warmup_time=0
| | ${results} = | Send traffic on tg | 32 | ${rate} | ${framesize} | ${traffic_profile} | warmup_time=0
| | ${results} = | Send traffic on tg | 64 | ${rate} | ${framesize} | ${traffic_profile} | warmup_time=0
