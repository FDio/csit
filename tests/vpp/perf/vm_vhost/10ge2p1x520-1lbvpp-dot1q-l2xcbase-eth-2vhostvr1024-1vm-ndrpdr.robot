...
| ... | link bonding on link between DUT1 and DUT2 and L2 cross- connect. Qemu
| ... | Guest is connected to VPP via vhost-user interfaces. Guest is running
| ... | DPDK testpmd interconnecting vhost-user interfaces using 5 cores
| ... | pinned to cpus 5-9 and 2048M memory. Testpmd is using socket-mem=1024M
| ... | (512x2M hugepages), 5 cores (1 main core and 4 cores dedicated for io),
...
*** Test Cases ***
| tc01-64B-1t1c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-ndrdisc
| | [Documentation]
...
| tc02-64B-1t1c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port.
...
| tc03-1518B-1t1c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port.
...
| tc04-1518B-1t1c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port.
...
| tc05-9000B-1t1c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port.
...
| tc06-9000B-1t1c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port.
...
| tc07-IMIX-1t1c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port.
...
| tc08-IMIX-1t1c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 1 thread, 1 phy core,\
| | ... | 1 receive queue per NIC port.
...
| tc09-64B-2t2c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-ndrdisc
| | [Documentation]
...
| tc10-64B-2t2c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 2 threads, 2 phy cores,\
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 10GE\
...
| tc11-1518B-2t2c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 2 threads, 2 phy cores,\
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Find NDR for 1518 Byte frames using binary search start at 10GE\
...
| tc12-1518B-2t2c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 2 threads, 2 phy cores,\
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Find PDR for 1518 Byte frames using binary search start at 10GE\
...
| tc13-9000B-2t2c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 2 threads, 2 phy cores,\
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Find NDR for 9000 Byte frames using binary search start at 10GE\
...
| tc14-9000B-2t2c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 2 threads, 2 phy cores,\
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Find PDR for 9000 Byte frames using binary search start at 10GE\
...
| tc15-IMIX-2t2c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 2 threads, 2 phy cores,\
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Find NDR for IMIX_v4_1 framesize using binary search start at\
...
| tc16-IMIX-2t2c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 2 threads, 2 phy cores,\
| | ... | 1 receive queue per NIC port.
| | ... | [Ver] Find PDR for IMIX_v4_1 framesize using binary search start at\
...
| tc17-64B-4t4c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-ndrdisc
| | [Documentation]
...
| tc18-64B-4t4c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 4 threads, 4 phy cores,\
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Find PDR for 64 Byte frames using binary search start at 10GE\
...
| tc19-1518B-4t4c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 4 threads, 4 phy cores,\
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Find NDR for 1518 Byte frames using binary search start at 10GE\
...
| tc20-1518B-4t4c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 4 threads, 4 phy cores,\
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Find PDR for 1518 Byte frames using binary search start at 10GE\
...
| tc21-9000B-4t4c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 4 threads, 4 phy cores,\
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Find NDR for 9000 Byte frames using binary search start at 10GE\
...
| tc22-9000B-4t4c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 4 threads, 4 phy cores,\
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Find PDR for 9000 Byte frames using binary search start at 10GE\
...
| tc23-IMIX-4t4c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 4 threads, 4 phy cores,\
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Find NDR for IMIX_v4_1 framesize using binary search start at\
...
| tc24-IMIX-4t4c-1lbvpp-dot1q-l2xcbase-eth-2vhostvr1024-1vm-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2XC switching config with 4 threads, 4 phy cores,\
| | ... | 2 receive queues per NIC port.
| | ... | [Ver] Find PDR for IMIX_v4_1 framesize using binary search start at\
