...
*** Keywords ***
| Check RR for eth-ip4base-eth-2vhostvr1024-1vm
| | [Documentation]
...
*** Test Cases ***
| tc01-64B-1t1c-eth-ip4base-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
...
| | ...
| | [Template] | Check RR for eth-ip4base-eth-2vhostvr1024-1vm-mrr
| | framesize=${64} | wt=1 | rxq=1

| tc02-1518B-1t1c-eth-ip4base-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 1 thread, 1 phy\
| | ... | core, 1 receive queue per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for ${framesize} frames using single\
...
| tc03-IMIX-1t1c-eth-ip4base-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 1 thread, 1 phy\
| | ... | core, 1 receive queue per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for ${framesize} frames using single\
...
| tc04-64B-2t2c-eth-ip4base-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
...
| tc05-1518B-2t2c-eth-ip4base-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 2 threads, 2 phy\
| | ... | cores, 1 receive queue per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for ${framesize} frames using single\
...
| tc06-IMIX-2t2c-eth-ip4base-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 2 threads, 2 phy\
| | ... | cores, 1 receive queue per NIC port.
| | ... | [Ver] Measure MaxReceivedRate for ${framesize} frames using single\
...
| tc07-64B-4t4c-eth-ip4base-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
...
| tc08-1518B-4t4c-eth-ip4base-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 4 threads, 4 phy\
| | ... | cores, 2 receive queues per NIC port.
...
| tc09-IMIX-4t4c-eth-ip4base-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
| | ... | [Cfg] DUT runs IPv4 routing config with 4 threads, 4 phy\
| | ... | cores, 2 receive queues per NIC port.
