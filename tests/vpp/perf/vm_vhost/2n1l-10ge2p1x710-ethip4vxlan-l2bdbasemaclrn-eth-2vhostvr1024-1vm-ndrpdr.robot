...
| ${nf_nodes}= | ${1}
# Traffic profile:
| ${traffic_profile}= | trex-sl-2n3n-ethip4vxlan_ip4src${nf_chains}dst${nf_chains}udpsrcrnd
...
| | ... | nf_chains=${nf_chains} | nf_nodes=${nf_nodes} | underlay=vxlanoipv4
