...
| | ...
| | [Template] | Find NDRPDR for eth-l2bdbasemaclrn-eth-2vhostvr1024-1vm
...
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy core, \
| | ... | 1 receive queue per NIC port. [Ver] Find NDR for IMIX_v4_1 frames \
| | ... | using optimized search start at 10GE linerate.
...
| | ... | 2 receive queue per NIC port. [Ver] Find NDR for 64 Byte frames \
| | ... | using optimized search start at 10GE linerate.
| | ...
...
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 4 thread, 4 phy core, \
| | ... | 2 receive queue per NIC port. [Ver] Find NDR for 1518 Byte frames \
| | ... | using optimized search start at 10GE linerate.
| | ...
...
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 4 thread, 4 phy core, \
| | ... | 2 receive queue per NIC port. [Ver] Find NDR for 9000 Byte frames \
| | ... | using optimized search start at 10GE linerate.
| | ...
...
| | [Documentation]
| | ... | [Cfg] DUT runs L2BD switching config with 4 thread, 4 phy core, \
| | ... | 2 receive queue per NIC port. [Ver] Find NDR for IMIX_v4_1 frames \
| | ... | using optimized search start at 10GE linerate.
| | ... | IMIX_v4_1 = (28x64B; 16x570B; 4x1518B)
| | ...
