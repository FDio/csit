...
*** Variables ***
| ${dut1_eth_bond_if1}= | BondEthernet0
| ${dut2_eth_bond_if1}= | BondEthernet0
| ${perf_qemu_qsz}= | 1024
| ${subid}= | 10
| ${tag_rewrite}= | pop-1
# Socket names
...
*** Keywords ***
| Check RR for 1lblacp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm
| | [Documentation]
...
| | And Add DPDK bonded Etheret interfaces to DUTs in 3-node single link topology
| | And Run Keyword If | ${get_framesize} < ${1522}
| | ... | Add no multi seg to all DUTs
| | And Apply startup configuration on all VPP DUTs
| | And Add DPDK bonded etheret interfaces to topolgy file in 3-node single link topology
| | Then VPP shows interfaces on all DUTs
...
*** Test Cases ***
| tc01-64B-1t1c-1lblacp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
| | [Documentation]
...
| | ...
| | [Template] | Check RR for 1lblacp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm
| | framesize=${64} | wt=1 | rxq=1
#
#| tc02-1518B-1t1c-1lblacp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy\
#| | ... | core, 1 receive queue per NIC port.
...
#
#| tc03-9000B-1t1c-1lblacp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy\
#| | ... | core, 1 receive queue per NIC port.
...
#
#| tc04-IMIX-1t1c-1lblacp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 1 thread, 1 phy\
#| | ... | core, 1 receive queue per NIC port.
...
#
#| tc05-64B-2t2c-1lblacp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
#| | [Documentation]
...
#
#| tc06-1518B-2t2c-1lblacp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 2 threads, 2 phy\
#| | ... | cores, 1 receive queue per NIC port.
#| | ... | [Ver] Measure MaxReceivedRate for 1518B frames using single\
...
#
#| tc07-9000B-2t2c-1lblacp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 2 threads, 2 phy\
#| | ... | cores, 1 receive queue per NIC port.
#| | ... | [Ver] Measure MaxReceivedRate for 9000B frames using single\
...
#
#| tc08-IMIX-2t2c-1lblacp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 2 threads, 2 phy\
#| | ... | cores, 1 receive queue per NIC port.
#| | ... | [Ver] Measure MaxReceivedRate for IMIX_v4_1 frames using single\
...
#
#| tc09-64B-4t4c-1lblacp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
#| | [Documentation]
...
#
#| tc10-1518B-4t4c-1lblacp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 4 threads, 4 phy\
#| | ... | cores, 2 receive queues per NIC port.
#| | ... | [Ver] Measure MaxReceivedRate for 1518B frames using single\
...
#
#| tc11-9000B-4t4c-1lblacp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 4 threads, 4 phy\
#| | ... | cores, 2 receive queues per NIC port.
#| | ... | [Ver] Measure MaxReceivedRate for 9000B frames using single\
...
#
#| tc12-IMIX-4t4c-1lblacp-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr
#| | [Documentation]
#| | ... | [Cfg] DUT runs L2BD switching config with 4 threads, 4 phy\
#| | ... | cores, 2 receive queues per NIC port.
#| | ... | [Ver] Measure MaxReceivedRate for IMIX_v4_1 frames using single\
