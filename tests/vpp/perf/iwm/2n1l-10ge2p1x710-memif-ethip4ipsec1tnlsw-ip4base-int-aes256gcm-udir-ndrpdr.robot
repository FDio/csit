...
| ... | IP4FWD | IPSEC | IPSECSW | IPSECINT | NIC_Intel-X710 | TNL_1
| ... | SCHEDULER | AES_256_GCM | AES | DRV_VFIO_PCI
| ... | RXQ_SIZE_0 | TXQ_SIZE_0
| ... | memif-ethip4ipsec1tnlsw-ip4base-int-aes256gcm-udir
|
...
*** Test Cases ***
| 1518B-1c-memif-ethip4ipsec1tnlsw-ip4base-int-aes256gcm-udir-ndrpdr
| | [Tags] | 1518B | 1C
| | frame_size=${1518} | phy_cores=${1}

| 1518B-2c-memif-ethip4ipsec1tnlsw-ip4base-int-aes256gcm-udir-ndrpdr
| | [Tags] | 1518B | 2C
| | frame_size=${1518} | phy_cores=${2}

| 1518B-3c-memif-ethip4ipsec1tnlsw-ip4base-int-aes256gcm-udir-ndrpdr
| | [Tags] | 1518B | 3C
| | frame_size=${1518} | phy_cores=${3}

| 1518B-4c-memif-ethip4ipsec1tnlsw-ip4base-int-aes256gcm-udir-ndrpdr
| | [Tags] | 1518B | 4C
