...
| ... | memif-ethip4ipsec16tnlsw-ip4base-int-aes256gcm
|
...
*** Test Cases ***
| 1518B-1c-memif-ethip4ipsec16tnlsw-ip4base-int-aes256gcm-ndrpdr
| | [Tags] | 1518B | 1C
| | frame_size=${1518} | phy_cores=${1}

| 1518B-2c-memif-ethip4ipsec16tnlsw-ip4base-int-aes256gcm-ndrpdr
| | [Tags] | 1518B | 2C
| | frame_size=${1518} | phy_cores=${2}

| 1518B-3c-memif-ethip4ipsec16tnlsw-ip4base-int-aes256gcm-ndrpdr
| | [Tags] | 1518B | 3C
| | frame_size=${1518} | phy_cores=${3}

| 1518B-4c-memif-ethip4ipsec16tnlsw-ip4base-int-aes256gcm-ndrpdr
| | [Tags] | 1518B | 4C
