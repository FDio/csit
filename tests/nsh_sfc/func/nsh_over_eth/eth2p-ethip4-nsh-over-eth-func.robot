...
| ... | if the packet match the NSH SFC rules, the NSH plugin will
| ... | swap the NSH protocol, then encapsulate with the
| ... | Ethernet protocol. DUT will loopback the packet to the TG.
| ... | The TG will capture this Ethernet+NSH encapsulate packet and
| ... | check the packet field is correct.

*** Test Cases ***
| TC01: NSH Over Ethernet functional test with 152B frame size
| | [Documentation]
| | ... | Make TG send 152 Bytes Ethernet+NSH packet to DUT ingress interface.\
...
| | [Documentation]
| | ... | Make TG send 256 Bytes Ethernet+NSH packet to DUT ingress interface.\
| | ... | Make TG verify SFC NSH Over Ethernet functional is correct.
...
| | [Documentation]
| | ... | Make TG send 512 Bytes Ethernet+NSH packet to DUT ingress interface.\
| | ... | Make TG verify SFC NSH Over Ethernet functional is correct.
...
| | [Documentation]
| | ... | Make TG send 1024 Bytes Ethernet+NSH packet to DUT ingress interface.\
| | ... | Make TG verify SFC NSH Over Ethernet functional is correct.
...
| | [Documentation]
| | ... | Make TG send 1280 Bytes Ethernet+NSH packet to DUT ingress interface.\
| | ... | Make TG verify SFC NSH Over Ethernet functional is correct.
...
| | [Documentation]
| | ... | Make TG send 1518 Bytes Ethernet+NSH packet to DUT ingress interface.\
| | ... | Make TG verify SFC NSH Over Ethernet functional is correct.
