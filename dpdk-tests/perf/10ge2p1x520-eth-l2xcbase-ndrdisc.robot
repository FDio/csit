...
| tc01-64B-1t1c-eth-l2xcbase-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2 frame forwarding config with 1 thread, 1 phy core,\
...
| tc01-1518B-1t1c-eth-l2xcbase-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2 frame forwarding config with 1 thread, 1 phy core,\
...
| tc01-1518B-1t1c-eth-l2xcbase-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2 frame forwarding config with 1 thread, 1 phy core,\
...
| tc01-9000B-1t1c-eth-l2xcbase-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2 frame forwarding config with 1 thread, 1 phy core,\
...
| tc01-9000B-1t1c-eth-l2xcbase-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2 frame forwarding config with 1 thread, 1 phy core,\
...
| tc01-64B-2t2c-eth-l2xcbase-ndrdisc
| | [Documentation]
...
| tc01-64B-2t2c-eth-l2xcbase-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2 frame forwarding config with 2 threads, 2 phy\
...
| tc01-1518B-2t2c-eth-l2xcbase-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2 frame forwarding config with 2 threads, 2 phy\
...
| tc01-1518B-2t2c-eth-l2xcbase-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2 frame forwarding config with 2 threads, 2 phy\
...
| tc01-9000B-2t2c-eth-l2xcbase-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2 frame forwarding config with 2 threads, 2 phy\
...
| tc01-9000B-2t2c-eth-l2xcbase-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2 frame forwarding config with 2 threads, 2 phy\
...
| tc01-64B-4t4c-eth-l2xcbase-ndrdisc
| | [Documentation]
...
| tc01-64B-4t4c-eth-l2xcbase-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2 frame forwarding config with 4 threads, 4 phy\
...
| tc01-1518B-4t4c-eth-l2xcbase-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2 frame forwarding config with 4 threads, 4 phy\
...
| tc01-1518B-4t4c-eth-l2xcbase-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2 frame forwarding config with 4 threads, 4 phy\
...
| tc01-9000B-4t4c-eth-l2xcbase-ndrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2 frame forwarding config with 4 threads, 4 phy\
...
| tc01-9000B-4t4c-eth-l2xcbase-pdrdisc
| | [Documentation]
| | ... | [Cfg] DUT runs L2 frame forwarding config with 4 threads, 4 phy\
