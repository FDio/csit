...
def topology_lookup(topology_paths, topo_dir):
    ...
    for topology_name in ret_topologies:
        try:
            ...
            print('Unable to verify topology, schema error: {}'.format(ex),
                  file=sys.stderr)
        except KeyError as ex:
            print('Unable to verify topology, key error: {}'.format(ex),
                  file=sys.stderr)
        except Exception as ex:
            print('Unable to verify topology, {}'.format(ex), file=sys.stderr)
