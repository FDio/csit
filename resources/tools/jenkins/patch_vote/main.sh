...
#source "$script_dir/prepare-build-parent.sh"
#source "$tools_dir/vpp_build/build_vpp_ubuntu_amd64.sh"
#
source "$script_dir/download_builds.sh"
#
source "$script_dir/prepare-test-new.sh"
source "$tools_dir/run_tests/vpp-csit-verify-perf.sh"
source "$script_dir/prepare-test-parent.sh"
source "$tools_dir/run_tests/vpp-csit-verify-perf.sh"
