...
class ClientAppTests(unittest.TestCase):
    ...
    def test_coverage_tab_keeps_phase_one_placeholder(self):
        fake_client = FakeMCPClient()
        app = create_app(client_factory=FakeMCPContextFactory([fake_client]))
        ...
        self.assertEqual(fake_client.calls, [("datasets", {})])
    ...
    def test_static_assets_are_served_separately(self):
        ...
        self.assertIn('href="/static/dashboard.css?v=13"', page.text)
        self.assertIn('src="/static/dashboard.js?v=13"', page.text)
