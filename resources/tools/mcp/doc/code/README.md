...
- [`mcp-server`](../../mcp-server/) loads and analyzes FD.io CSIT data, exposes
  27 read-only MCP tools, and serves operational HTTP routes.
...
| [APIs](api.md) | 27 MCP tools, resources, server routes, client routes, pagination, and errors. |
...
4. [`mcp_tools.py`](../../mcp-server/dashboard/mcp_tools.py)
5. Dataset-specific modules under
