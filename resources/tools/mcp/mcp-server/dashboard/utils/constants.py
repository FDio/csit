...
class Constants:
    ...
    # Bounded retries for transient S3 streaming and connection failures.
    S3_READ_MAX_ATTEMPTS = get_int_from_env("S3_READ_MAX_ATTEMPTS", 3)
    S3_READ_RETRY_BASE_SECONDS = get_int_from_env(
        "S3_READ_RETRY_BASE_SECONDS", 2
    )
