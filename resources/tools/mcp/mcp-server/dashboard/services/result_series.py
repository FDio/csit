...
def series_id_for_dimensions(
        dimensions: dict[str, str],
        logical_type: str
    ) -> str:
    """Return the stable identifier shared by result and telemetry queries."""
...
def dataframe_records(data: pd.DataFrame) -> Iterator[dict[str, Any]]:
    """Yield row dictionaries without materializing a full list of Python objects."""
