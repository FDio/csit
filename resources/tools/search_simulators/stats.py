...
def stat(s):
    ...
    for x in np.arange(0, numberOfRows):
        result = s.narrow_down_ndr_and_pdr(min_rate=20000, max_rate=37000000, packet_loss_ratio=0.005)
...
print(f"basic binary search, width 20000, 10s final duration, single loss measurer")
...
print(f"optimized search, 30s final duration, single loss measurer")
