...
print "relative wednesday search, 30s final duration, two phase provider"
from WednesdaySearchAlgorithm import WednesdaySearchAlgorithm as my_search
s = my_search(rate_provider=p)
stat(s)

print "relative optimized search, 30s final duration, two phase provider"
from OptimizedSearchAlgorithm import OptimizedSearchAlgorithm as my_search
s = my_search(rate_provider=p)
stat(s)
