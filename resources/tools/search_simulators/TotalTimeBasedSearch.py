...
class TotalTimeBasedSearch(AbstractSearchAlgorithm):
    ...
    def ndrpdr(self, state, duration):
        ...
        while 1:
            ...
            if state.time_bank >= duration and max_relative_width > 0.0:
                ...
                if ndr_relative_width >= pdr_relative_width:
                    ...
                    logging.info("ndr section predicted", prediction_from_rr)
                    ...
                    logging.info("pdr section predicted", prediction_from_rr)
                    new_tr = min(max(prediction_from_rr,
