...
class TwoPhaseRateProvider(AbstractRateProvider):
    ...
    def __init__(self, first_phase_duration=0.002, first_rr_lo=3333333.0, first_rr_hi=4000000.0,
                 second_rr_lo=4100000.0, second_rr_hi=4150000.0, shiftness=5.0, sensitivity=0.02):
