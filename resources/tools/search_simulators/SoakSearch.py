...
class SoakSearch(object):
    ...
    def search(self, min_rate, max_rate):
        ...
        while 1:
            ...
            print "DEBUG lps", lps
            average, stdev = self.compute(trial_result_list, max_rate, lps)
    ...
    @staticmethod
    def lfit(load, mrr_1, mrr_2, koeff):
        """FIXME."""
        loga_1 = math.log(load) - mrr_1 / load
        loga_2 = math.log(load) - mrr_2 / load
        lc_1 = math.log(koeff)
        lc_2 = math.log(1.0 - koeff)
        loga = log_plus(loga_1 + lc_1, loga_2 + lc_2)
        return loga
