...
tuple_list = [
    (7445476.0, 151887638, 0, 10.2, 4375),
    (14880952.0, 309523655, 107798018, 10.4, 6535),
#    (9698348.90253, 205604902, 624210, 10.6, 9230),
    (9698348.902527198, 205604902, 624210, 10.6, 9230),
#    (9668901.53293, 208848178, 10, 10.8, 11740),
    (9668901.53292789, 208848178, 10, 10.8, 11740),
#    (9474451.30305, 208437838, 76589, 11.0, 11198),
    (9474451.303047102, 208437838, 76589, 11.0, 11198),
#    (11013.2328974, 246699, 0, 11.2, 11252),
    (11013.232897403359, 246699, 0, 11.2, 11252),
#    (9056169.76375, 206480582, 0, 11.4, 11239),
    (9056169.763752399, 206480582, 0, 11.4, 11239),
#    (11013.2328974, 255509, 0, 11.6, 11151),
    (11013.232897403359, 255509, 0, 11.6, 11151),
#    (9056172.70908, 213725588, 0, 11.8, 10381),
    (9056172.70907914, 213725588, 0, 11.8, 10381),
#    (11013.2328974, 264318, 0, 12.0, 10916),
    (11013.232897403359, 264318, 0, 12.0, 10916),
#    (9056175.42363, 220970590, 0, 12.2, 10965),
    (9056175.423628056, 220970590, 0, 12.2, 10965),
]
...
for count, (rate, tx, lx, duration, samples) in enumerate(tuple_list):
    if count in range(12):
        result = s.measure_and_compute(20.0, 1e6, trial_result_list, 29761904, list_integrator_data[count], samples)
