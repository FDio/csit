...
result = s.narrow_down_intervals(minimum_transmit_rate=1000000, maximum_transmit_rate=30000000, packet_loss_ratios=[0.0, 0.005])

#print "result repr:", repr(result)
print "result string:", str(result)
print "RW:", "NDR", result[0].rel_tr_width, "PDR", result[1].rel_tr_width
