...
class PdrNdrResult(object):
    ...
    def __init__(self, pdr_interval, ndr_interval):
    ...
    def __str__(self):
        ...
        return "PDR=" + str(self.pdr_interval) + ",NDR=" + str(self.ndr_interval)

    def __repr__(self):
        """Return string evaluable as a constructor call."""
        return "PdrNdrResult(pdr_interval=" + repr(self.pdr_interval) + \
               ",ndr_interval=" + repr(self.ndr_interval) + ")"
