...
class ExecutionChecker(ResultVisitor):
    ...
    def __init__(self, metadata, mapping):
        ...
        # TODO: remove logging.info("Mapping:\n{}".format(self._mapping))
    ...
    def start_test(self, test):
        ...
        if "tests.vpp.perf.ip4.10ge2p1x520-ethip4udp" in longname_orig:
            logging.info("longname_orig:\n{}".format(longname_orig))
            logging.info("longname:\n{}".format(longname))

        if "tc01-64B-1t1c-ethip4udp-ip4base-iacl50-stateful-flows10k-mrr" in longname_orig:
            logging.info("longname_orig:\n{}".format(longname_orig))
            logging.info("longname:\n{}".format(longname))
