    ...
    def download_and_parse_data(self, repeat=1):
        ...
        logging.info("DATA:\n{}".format(
            self._input_data["csit-vpp-perf-verify-master-3n-hsw"]["45"][
                ...
                "10ge2p1x520-1lbdpdk-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr."
                "64b-1t1c-1lbdpdk-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-mrr"]))
        logging.info("DATA:\n{}".format(
            self._input_data["csit-vpp-perf-verify-master-3n-hsw"]["45"][
                "tests"][
                "tests.vpp.perf.vm vhost."
        ...
        logging.info("DATA:\n{}".format(
            self._input_data["csit-vpp-perf-verify-master-3n-hsw"]["45"][
                ...
                "tests.vpp.perf.vm vhost."
                "10ge2p1x520-1lbdpdk-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-ndrpdr."
                "64b-1t1c-1lbdpdk-dot1q-l2bdbasemaclrn-eth-2vhostvr1024-1vm-ndrpdr"]["result"]))
        logging.info("DATA:\n{}".format(
            self._input_data["csit-vpp-perf-verify-master-3n-hsw"]["45"][
                "tests"][
                "tests.vpp.perf.vm vhost."
