...
class InputData(object):
    ...
    def download_and_parse_data(self, repeat=1):
        ...
        logging.info("Done.")
        logging.warn(repr(self._input_data["csit-vpp-perf-verify-master"]["122"]["tests"]["tests.vpp.perf.ip4.40ge2p1xl710-ethip4-ip4base-ndrpdrdisc.tc01-64b-1t1c-ethip4-ip4base-ndrdisc"]["throughput"]))
        logging.warn(repr(self._input_data["csit-vpp-perf-verify-master"]["122"]["tests"]["tests.vpp.perf.ip4.40ge2p1xl710-ethip4-ip4base-mrr.tc01-64b-1t1c-ethip4-ip4base-mrr"]["result"]))
