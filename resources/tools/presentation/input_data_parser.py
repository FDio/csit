...
class ExecutionChecker(ResultVisitor):
    ...
    def _get_data_from_perf_test_msg(self, msg):
        ...
        try:
            return (
                f"NDR Lower: {data[u'ndr_low']:.2f}M{data[u'ndr_low_unit']}, "
                f"{data[u'ndr_low_b']:.2f}{data[u'ndr_low_b_unit']}\n"
                # f"NDR Upper: {data[u'ndr_up']:.2f}M{data[u'ndr_up_unit']}, "
                ...
                f"PDR Lower: {data[u'pdr_low']:.2f}M{data[u'pdr_low_unit']}, "
                f"{data[u'pdr_low_b']:.2f}{data[u'pdr_low_b_unit']}\n"
                # f"PDR Upper: {data[u'pdr_up']:.2f}M{data[u'pdr_up_unit']}, "
