...
class ExecutionChecker(ResultVisitor):
    ...
    def _get_data_from_perf_test_msg(self, msg):
        ...
        try:
            return (
                f"NDR Lower: {data[u'ndr_low']}{data[u'ndr_low_unit']}, "
                f"{data[u'ndr_low_b']}{data[u'ndr_low_b_unit']}\n"
                f"NDR Upper: {data[u'ndr_up']}{data[u'ndr_up_unit']}, "
                f"{data[u'ndr_up_b']}{data[u'ndr_up_b_unit']}\n"
                f"NDR Latency W-E: {_process_lat(data[u'ndr_lat_1'])}\n"
                f"NDR Latency E-W: {_process_lat(data[u'ndr_lat_2'])}\n"
                f"PDR Lower: {data[u'pdr_low']}{data[u'pdr_low_unit']}, "
                f"{data[u'pdr_low_b']}{data[u'pdr_low_b_unit']}\n"
                f"PDR Upper: {data[u'pdr_up']}{data[u'pdr_up_unit']}, "
                f"{data[u'pdr_up_b']}{data[u'pdr_up_b_unit']}\n"
