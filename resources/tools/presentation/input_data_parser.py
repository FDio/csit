        ...
        for job, builds in self._cfg.builds.items():
            for build in builds:
                ...
                logging.info("ru_maxrss = {0}".format(
                    resource.getrusage(resource.RUSAGE_BOTH).ru_maxrss))
                logging.info("ru_ixrss = {0}".format(
                    resource.getrusage(resource.RUSAGE_BOTH).ru_ixrss))
                logging.info("ru_idrss = {0}".format(
                    resource.getrusage(resource.RUSAGE_BOTH).ru_idrss))
                logging.info("ru_isrss = {0}".format(
                    resource.getrusage(resource.RUSAGE_BOTH).ru_isrss))
                logging.info("ru_nswap = {0}".format(
                    resource.getrusage(resource.RUSAGE_BOTH).ru_nswap))
