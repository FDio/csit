...
def file_test_results(file_spec, input_data):
    ...
    _generrate_file_test_results(file_spec, input_data, False)
...
def file_merged_test_results(file_spec, input_data):
    ...
    :type input_data: InputData
    """
    _generrate_file_test_results(file_spec, input_data, True)


def _generrate_file_test_results(file_spec, input_data, merge):
    ...
    :param file_spec: File to generate.
    :param input_data: Data to process.
    :param merge: If True, the input data are merged from more than one
        job/build.
    :type file_spec: pandas.Series
    :type input_data: InputData
    :type merge: bool
