...
def file_details_split(file_spec, input_data, frmt=u"rst"):
    ...
    for chapter_l1 in order_1:
        ...
        chapter_l1_file_name = f"{join(fileset_file_name, chapter_l1)}.rst"
        with open(chapter_l1_file_name, u"w") as file_handler:
        ...
        for chapter_l2 in order_2:
            ...
            for chapter_l3 in order_3:
                ...
                if not content_l3:
                    continue
                print(chapter_l3)
                with open(chapter_l1_file_name, u"a") as file_handler:
                    file_handler.write(
                        f"    ../{u'/'.join(content_l3.split(u'/')[-2:])}\n"
                    )
    return
