...
class Alerting():
    ...
    def _generate_email_body(self, alert):
        ...
        for idx, test_set in enumerate(alert.get(u"include", [])):
            ...
            try:
                with open(file_name, u'r') as txt_file:
                    ...
                    with open(f"{out_dir}/trending-regressions.txt", u'a+') as \
                            reg_file:
            ...
            try:
                with open(file_name, u'r') as txt_file:
                    file_content = txt_file.read()
                    with open(f"{out_dir}/trending-progressions.txt", u'a+') \
                            as pro_file:
        ...
        file_name = f"{out_dir}/{config[u'output-file']}"
