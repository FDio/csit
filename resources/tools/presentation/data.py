...
class ExecutionChecker(ResultVisitor):
    ...
    def __init__(self, **metadata):
        ...
        self._lookup_kw = "Vpp Show Version Verbose"
    ...
    def start_test(self, test):
        ...
        if test.status == "PASS" and "NDRPDRDISC" in tags:
            ...
            self._data["tests"][test.longname.lower()] = test_result
    ...
    def visit_setup_kw(self, keyword):
    ...
    def start_setup_kw(self, keyword):
        ...
        :returns: Nothing.
        """
        if keyword.name.count("Vpp Show Version Verbose") \
                and not self._version:
            keyword.messages.visit(self)

    def end_setup_kw(self, keyword):
        """Called when keyword ends. Default implementation does nothing.
