...
def prepare_static_content(static_config):
    """Prepare the static content which is stored in the git.

    :param static_config: Specification of the static content.
    :type static_config: dict
    """

    src = static_config["src-path"]
    dst = static_config["dst-path"]
