...
def plot_service_density_heatmap(plot, input_data):
    ...
    # Colorscales:
    my_green = [[z_min, 'rgb(230, 255, 230)'], [z_max, 'rgb(0, 128, 0)']]
    my_red = [[z_min, 'rgb(255, 214, 204)'], [z_max, 'rgb(230, 46, 0)']]
    my_blue = [[z_min, 'rgb(204, 204, 255)'], [z_max, 'rgb(0, 0, 230)']]
    my_grey = [[z_min, 'rgb(230, 230, 230)'], [z_max, 'rgb(153, 153, 153)']]
