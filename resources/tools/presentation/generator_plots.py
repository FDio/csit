...
def plot_latency_hdrhistogram_bar_name(plot, input_data):
                    ...
                    try:
                        ...
                        for item in decoded.get_recorded_iterator():
                            ...
                            hovertext.append(
                                ...
                                "Latency: {lat}uSec<br>"
                                "Probability: {prob:.2f}%<br>"
                                "Percentile: {percentile:.2f}".format(
                                    test=name,
                                    direction=direction,
                        ...
                        marker_color[xaxis.index(
                            decoded.get_value_at_percentile(50.0))] = "red"
                        marker_color[xaxis.index(
                            decoded.get_value_at_percentile(90.0))] = "red"
                        marker_color[xaxis.index(
                            decoded.get_value_at_percentile(95.0))] = "red"
                        histograms.append(
                            plgo.Bar(
                                x=xaxis,
                                y=yaxis,
    ...
    layout["annotations"][2]["y"] = 1.06 - 0.008 * len(tests)
    layout["annotations"][3]["y"] = 1.06 - 0.008 * len(tests)
