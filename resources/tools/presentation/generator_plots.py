...
def plot_service_density_heatmap(plot, input_data):
    ...
    fig = ff.create_annotated_heatmap(x=nodes,
                                      y=chains,
                                      z=data,
                                      colorbar=dict(
    ...
    annotations.append(dict(
        ...
        xanchor="center",
        yanchor="middle",
        text="<b>Number of Network Functions in a Chain</b>",
        font=dict(
            size=16,
        ),
        align="center",
    ...
    annotations.append(dict(
        ...
        xanchor="center",
        yanchor="middle",
        text="<b>Number of Chains of Network Functions</b>",
        font=dict(
            size=16,
        ),
        align="center",
    ...
    if layout.get("title", None):
            layout["title"] = "<b>Packet Throughput:</b> {0}<br> ". \
                format(layout["title"])
    layout["annotations"] = annotations
    ...
    try:
        # Create plot
        plpl = plgo.Figure(data=fig, layout=layout)
