...
def plot_service_density_heatmap(plot, input_data):
    ...
    # Colorscales:
    my_green = [[0.0, 'rgb(255, 255, 255)'],
                [z_min/z_max, 'rgb(230, 255, 230)'],
                [1.0, 'rgb(0, 128, 0)']]
    my_red = [[0.0, 'rgb(255, 255, 255)'],
              [z_min/z_max, 'rgb(255, 214, 204)'],
              [1.0, 'rgb(230, 46, 0)']]
    my_blue = [[0.0, 'rgb(255, 255, 255)'],
               [z_min/z_max, 'rgb(204, 204, 255)'],
               [1.0, 'rgb(0, 0, 230)']]
    my_grey = [[0.0, 'rgb(255, 255, 255)'],
               [z_min/z_max, 'rgb(230, 230, 230)'],
               [1.0, 'rgb(153, 153, 153)']]
    ...
    updatemenus = list([
        dict(
            ...
            buttons=list([
                dict(
                    args=[{"colorscale": [my_green, ], "reversescale": True}],
                    label="Green",
                    method="update"
                ),
                dict(
                    args=[{"colorscale": [my_red, ], "reversescale": True}],
                    label="Red",
                    method="update"
                ),
                dict(
                    args=[{"colorscale": [my_blue, ], "reversescale": True}],
                    label="Blue",
                    method="update"
                ),
                dict(
                    args=[{"colorscale": [my_grey, ], "reversescale": True}],
                    label="Grey",
                    method="update"
                )
            ])
