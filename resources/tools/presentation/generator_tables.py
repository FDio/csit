                ...
                try:
                    ...
                    if table["include-tests"] == "MRR":
                        ...
                        if tst_data["type"] == "PDR":
                            ...
                            tbl_dict[tst_name]["ref-data"].append(
                                tst_data["throughput"]["PDR"]["LOWER"].avg)
                        ...
                        if tst_data["type"] == "NDR":
                            ...
                            tbl_dict[tst_name]["ref-data"].append(
                                tst_data["throughput"]["NDR"]["LOWER"].avg)
                    else:
                        continue
                except TypeError:
                ...
                try:
                    ...
                    if table["include-tests"] == "MRR":
                        ...
                        if tst_data["type"] == "PDR":
                            ...
                            tbl_dict[tst_name]["cmp-data"].append(
                                tst_data["throughput"]["PDR"]["LOWER"].avg)
                    elif table["include-tests"] == "NDR":
                        if tst_data["type"] == "NDR":
                            tbl_dict[tst_name]["cmp-data"]. \
                    ...
                    for tst_name, tst_data in data[job][str(build)].iteritems():
                        ...
                        try:
                            ...
                            if table["include-tests"] == "MRR":
                                ...
                                if tst_data["type"] == "PDR":
                                    tbl_dict[tst_name]["history"][
                                        item["title"]].\
                                        append(tst_data["throughput"]["value"])
                                elif tst_data["type"] == "NDRPDR":
                                    tbl_dict[tst_name]["history"][item[
