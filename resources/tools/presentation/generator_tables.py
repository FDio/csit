...
def table_comparison(table, input_data):
        ...
        for itm in line[1:]:
            if itm is None:
                ...
                row.append(
                    ...
                    f"{chr(177)}{round(float(itm[u'stdev']) / 1e6, 1)}".
                        replace(u"nan", u"NaN")
                )
    ...
    legend += (
        ...
        f"Second part of the result following '{chr(177)}' is a standard "
        u"deviation [Mpps].\n"
        u"First part of Diff is a relative change of mean values [%].\n"
        f"Second part of Diff following '{chr(177)}' is a standard deviation "
