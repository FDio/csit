...
def table_performance_trending_dashboard_html(table, input_data):
    ...
    try:
        ...
        logger.warn("The input file is not defined.")
        return
    except csv.Error as err:
        logger.warn("Not possible to process the file '{0}'.\n{1}".
    ...
    try:
        ...
        logger.warn("The output file is not defined.")
        return
