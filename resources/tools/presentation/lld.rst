...
The model of presentation and analytics layer (PAL) consists of four sub-layers,
from bottom to top:

 - sL1 - Data - input data to be processed:

   - Static content - .rst text files, .svg static figures, other (TBD) stored
     in CSIT git repository.
