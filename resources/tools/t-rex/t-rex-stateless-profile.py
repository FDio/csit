...
def simple_burst(profile_file, framesize, rate, duration, latency,
                 warmup_time, async_start=False, ifaces_reordered=False):
    ...
    try:
        ...
        port_0, port_1 = (0, 1) if ifaces_reordered else (1, 0)
        ...
        if warmup_time > 0:
            ...
            client.start(ports=[port_0, port_1], mult=rate, duration=warmup_time)

            # Block until done:
            client.wait_on_traffic(ports=[port_0, port_1], timeout=warmup_time+30)
