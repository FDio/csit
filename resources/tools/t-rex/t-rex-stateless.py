...
def create_streams(traffic_options, frame_size=64):
    ...
    print("p1_src_udp_port: {}".format(int(p1_src_udp_port)))
    print("p1_src_udp_port: {}".format(int(p1_src_udp_port) +
                                       int(nr_of_ports) - 1))
    print("p2_dst_start_ip: {}".format(p2_dst_start_ip))
    print("p2_dst_start_ip: {}".format(p2_dst_start_ip))
    print("p2_dst_udp_port: {}".format(int(p2_dst_udp_port)))
    print("p2_dst_udp_port: {}".format(int(p2_dst_udp_port) +
                                       int(nr_of_ports) - 1))
    print("#" * 80)
    if nr_of_ports > 1:
        vm1 = STLScVmRaw([
            ...
            STLVmTupleGen(ip_min=p1_src_start_ip,
                          ...
                          port_min=int(p1_src_udp_port),
                          port_max=int(p1_src_udp_port) + int(nr_of_ports) - 1,
                          name="tuple"),
        ...
        vm2 = STLScVmRaw([
            ...
            STLVmTupleGen(ip_min=p2_dst_start_ip,
                          ...
                          port_min=int(p2_dst_udp_port),
                          port_max=int(p2_dst_udp_port) + int(nr_of_ports) - 1,
                          name="tuple"),
            # write ip to packet IP.src
