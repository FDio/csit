...
process_dataframe(u"ndrpdr", path_list).toDF().show(truncate=DBG_TRUNCATE)
process_dataframe(u"soak", path_list).toDF().show(truncate=DBG_TRUNCATE)
process_dataframe(u"mrr", path_list).toDF().show(truncate=DBG_TRUNCATE)
