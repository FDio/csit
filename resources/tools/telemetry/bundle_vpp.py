...
class BundleVpp:
    ...
    def attach(self, duration):
        ...
        try:
            ...
            getLogger("console_err").error(u"Could not connect to VPP!")
            sys.exit(1)
    ...
    def detach(self):
        ...
        try:
            ...
            getLogger("console_err").error(u"Could not disconnect from VPP!")
            sys.exit(2)
    ...
    def fetch_data(self):
        ...
        for command in self.api_command_list:
            try:
                ...
                getLogger("console_err").error(f"Failed when executing command:"
    ...
    def process_data(self):
        ...
        for command in zip(self.api_command_list, self.api_replies_list):
            ...
            try:
                ...
                getLogger("console_err").error(f"Failed when processing "
