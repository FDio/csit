...
class Value:
    ...
    def get(self):
        """
        Get a specific value under mutex.
...
class Metric(object):
    ...
    def __init__(self, name, documentation, typ):
        """
        Initialize class and do basic sanitization.
    ...
    def add_sample(self, name, labels, value, timestamp=time()):
        ...
        :param timestamp: Timestamp. Default to be when added.
        :type name: str
        :type lables: tuple
        :type value: int or float
...
class MetricBase:
    ...
    def validate_name(self, name, namespace, subsystem):
        """
...
class Counter(MetricBase):
    ...
    def _metric_init(self):
        """
        Initialize counter value and time it was created.
        """
        self._value = Value()
        self._created = time()
...
class Info(MetricBase):
    ...
    def _child_samples(self):
        ...
        """
        with self._lock:
            return ((u"_info", self._value, 1.0,),)
