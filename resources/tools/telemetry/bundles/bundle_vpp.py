    ...
    def show_interface(self, reply):
        ...
        for line in reply.splitlines():
            ...
            if fullmatch(M_INT_BEGIN, line):
                ...
                snke = ifc[u"counter"].replace(" ", "_").replace("-", "_")
                item[u"name"] = snke
                item[u"value"] = ifc[u"count"]
            if fullmatch(M_INT_CONT, line):
                ifc_cont = fullmatch(M_INT_CONT, line).groupdict()
                snke = ifc_cont[u"counter"].replace(" ", "_").replace("-", "_")
                item[u"name"] = snke
                item[u"value"] = ifc_cont[u"count"]
