...
def configure_traffic_item(ixnet, name, src_ep, dst_ep, frame_size,
    ...
    #### TODO: FIND API FOR 4-byte checksum
    #### print ixnet.getAttribute(ixnet.getRoot() + '/traffic/latency', '-latency')
