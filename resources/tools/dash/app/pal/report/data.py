...
def read_ndrpdr():
    ...
    return create_dataframe_from_parquet(
        path=f"s3://{S3_DOCS_BUCKET}/csit/parquet/trending",
        partition_filter=lambda_f,
        columns=["job", "build", "dut_type", "dut_version", "hosts", "tg_type",
            "tg_version", "start_time", "passed", "test_id", "test_name_long",
            "test_name_short", "version",
            "result_pdr_upper_rate_unit", "result_pdr_upper_rate_value",
