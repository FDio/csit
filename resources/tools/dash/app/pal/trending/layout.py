...
class Layout:
    ...
    def callbacks(self, app):
        ...
        def _process_list(store_sel, list_sel, phy, area, test, cores,
            ...
            if not (btn_add or btn_display or btn_remove or start_date or end_date):
                raise PreventUpdate
            ...
            if trigger_id == "btn-ctrl-add":
                ...
                fig, style = _update_graph(store_sel, start_date, end_date)
        ...
        def _update_graph(sel, start, end):
            ...
            start = datetime(
                 ...
                 int(end[0:4]), int(end[5:7]), int(end[8:10])
            )
            data = read_data()
            style={
                "vertical-align": "top",
