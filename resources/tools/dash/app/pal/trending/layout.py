...
class Layout:
    ...
    def callbacks(self, app):
        ...
        @app.callback(
            ...
            Output("container-selected-tests", "children"),  # User selection
            ...
            State("container-selected-tests", "children"),  # User selection
            Input("btn-ctrl-add", "n_clicks"),
        )
        def _print_user_selection(store_sel, phy, area, test, core, framesize,
                testtype, container_sel, n_clicks):
            """
            """
            ...
            return store_sel, container_sel, None, None, None
        ...
        def _remove_from_selected(store_sel, container_sel, n_clicks):
            return store_sel, container_sel
        ...
        def _update_graph(store_sel, n_clicks):
            """
            """
