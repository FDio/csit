...
from resources.libraries.python.jumpavg.BitCountingClassifier import (
    AvgStdevStats, BitCountingClassifier, BitCountingGroupList)
...
for test_index in range(num_tests):
    ...
    parent_stats = AvgStdevStats.for_runs(parent_results)
    current_stats = AvgStdevStats.for_runs(current_results)
    parent_group_list = BitCountingGroupList(max_value=max_value)\
    ...
    classified_list = classifier.classify([parent_values, current_values])
