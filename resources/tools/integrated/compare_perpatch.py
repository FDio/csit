...
for test_index in range(num_tests):
    ...
    parent_stats = jumpavg.AvgStdevStats.for_runs(parent_results)
    current_stats = jumpavg.AvgStdevStats.for_runs(current_results)
    parent_group_list = jumpavg.BitCountingGroupList(max_value=max_value)\
