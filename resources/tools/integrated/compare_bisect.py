...
def main() -> int:
    ...
    :rtype: int
    """
    early_results, early_avg = read_from_dir(u"csit_early")
    late_results, late_avg = read_from_dir(u"csit_late")
    mid_results, mid_avg = read_from_dir(u"csit_mid")
    ...
    if double_bits <= single_bits:
        ...
        if rel_diff_to_early > rel_diff_to_late:
            print(u"The mid results are considered late.")
            ...
            print(u"The mid results are considered early.")
            print(u"Preferring relative difference of averages:")
