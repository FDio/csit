...
try:
    checker.report_initial_conflicts(report_missing=False)
    # TODO: Enable report_missing once https://gerrit.fd.io/r/20726
    # is in stable vpp version.
    ...
    sys.stderr.write(
        ...
        "ither this Change and/or its ancestors were editing .api files,\n"
        "or your chain is not rebased upon the recent enough VPP codebase.\n"
        "\n"
        "Please rebase and recheck, and if that fails ask CSIT project\n"
        "or a new oper branch supporting the changes.\n"
        "\n"
        "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n"
    )
    sys.exit(1)
