...
def main():
    ...
    table_header = '<tr><th>Name</th><th>Documentation</th>'+\
                   '<th>Status</th><th>Message</th><tr/>'
    table_data = parse_tests(args)
    html = '<html><body><table border=1>{}{}</table></body></html>'.format(
