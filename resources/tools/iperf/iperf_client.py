...
def simple_burst(args):
    ...
    if args.rate and not args.frame_size:
        # Linux default for TCP MSS matches 1518 frame size.
    ...
    if args.rate:
        ...
        length = None if args.rate * 0.1 * mss >= 128 * 1024 else mss
    ...
    for i in range(args.instances):
        # TODO: Construct command on Robot machine usinf OptionString.
        cmd_list = ["exec", "sudo"]
        if args.namespace:
