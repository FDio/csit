...
def simple_burst(
        namespace=None, host=None, bind=None, udp=False, affinity=None,
        duration=1, frame_size=64, rate=1000, warmup_time=0.0,
        async_start=False, traffic_directions=1, instances=1):
