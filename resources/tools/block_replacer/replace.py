...
A bash colution created by combining these two:
    https://unix.stackexchange.com/a/181215
    https://stackoverflow.com/a/23849180
does not seem to work if the blocks contin complicated characters.
"""
...
'''
    ...
    parser.add_argument(
        ...
        help=u"Paths to file where the replacement should be mage."
    )
...
def do_it(args):
    ...
    :type args: namedtuple with "before", "after" and "target" fields.
    """
