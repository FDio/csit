...
do_ssh "cat - >> /etc/apt/sources.list" <<_EOF
# For a custom qemu build
deb http://ppa.launchpad.net/syseleven-platform/virtualization/ubuntu xenial main
deb-src http://ppa.launchpad.net/syseleven-platform/virtualization/ubuntu xenial main
_EOF
fi
