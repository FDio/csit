...
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_performance_results/vpp_performance_results_l2.rst \
    --formatting rst --start 3 --level 2 \
    --regex ".+(eth|dot1q|dot1ad)-(l2xcbase|l2bdbasemaclrn)-ndr" \
    --title "L2 Ethernet Switching"
# IPv4 Routed-Forwarding
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_performance_results/vpp_performance_results_ipv4.rst \
    --formatting rst --start 3 --level 2 \
    --regex ".+ethip4-ip4[a-z0-9]+-[a-z-]*ndr" \
    --title "IPv4 Routed-Forwarding"
# IPv6 Routed-Forwarding
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_performance_results/vpp_performance_results_ipv6.rst \
    --formatting rst --start 3 --level 2 \
    --regex ".+ethip6-ip6[a-z0-9]+-[a-z-]*ndr" \
    --title "IPv6 Routed-Forwarding"
# IPv4 Overlay Tunnels
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_performance_results/vpp_performance_results_ipv4o.rst \
    --formatting rst --start 3 --level 2 \
    --regex ".+ethip4[a-z0-9]+-[a-z0-9]*-ndr" \
    --title "IPv4 Overlay Tunnels"
# IPv6 Overlay Tunnels
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_performance_results/vpp_performance_results_ipv6o.rst \
    --formatting rst --start 3 --level 2 \
    --regex ".+ethip6[a-z0-9]+-[a-z0-9]*-ndr" \
    --title "IPv6 Overlay Tunnels"
# VM Vhost Connections
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_performance_results/vpp_performance_results_vhost.rst \
    --formatting rst --start 3 --level 2 \
    --regex ".+vhost.*" \
    --title "VM Vhost Connections"

#JEN_JOB='csit-vpp-perf-1704-long'
#JEN_BUILD=(2 4 5 6)
#
#for i in "${JEN_BUILD[@]}"; do
#    curl -fs ${JEN_URL}/${JEN_JOB}/${i}/artifact/${JEN_FILE_PERF} \
...
rm -f ${DTR_SOURCE_DIR}/vpp_performance_results/*.json
...
#python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
#    --output ${DTR_SOURCE_DIR}/testpmd_performance_results/testpmd_performance_results.rst \
#    --formatting rst --start 3 --level 2

rm -f ${DTR_SOURCE_DIR}/testpmd_performance_results/*.json
...
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_functional_results/vpp_functional_results_cop.rst \
    --formatting rst --start 4 --level 2 \
    --regex ".+cop(blk|wh).*" \
    --title "Cop Address Security"
# DHCP Client and proxy
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_functional_results/vpp_functional_results_dhcp.rst \
    --formatting rst --start 4 --level 2 \
    --regex ".+dhcp.*" \
    --title "DHCP - Client and Proxy"
# GRE Overlay Tunnels
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_functional_results/vpp_functional_results_gre.rst \
    --formatting rst --start 4 --level 2 \
    --regex ".+ethip4gre.*" \
    --title "GRE Overlay Tunnels"
# iACL Security
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_functional_results/vpp_functional_results_iacl.rst \
    --formatting rst --start 4 --level 2 \
    --regex ".+iacl.*" \
    --title "iACL Security"
# IPSec - Tunnels and Transport
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_functional_results/vpp_functional_results_ipsec.rst \
    --formatting rst --start 4 --level 2 \
    --regex ".+ipsec(tnl|tpt)+-.*" \
    --title "IPSec - Tunnels and Transport"
# IPv4 Routed-Forwarding
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_functional_results/vpp_functional_results_ipv4.rst \
    --formatting rst --start 4 --level 2 \
    --regex ".+ethip4-ip4base-(func|ip4ecmp\-func|ip4proxyarp\-func|ip4arp\-func)+" \
    --title "IPv4 Routed-Forwarding"
# IPv6 Routed-Forwarding
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_functional_results/vpp_functional_results_ipv6.rst \
    --formatting rst --start 4 --level 2 \
...
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_functional_results/vpp_functional_results_l2xc.rst \
    --formatting rst --start 4 --level 2 \
    --regex ".*eth-l2xcbase-(eth|func).*" \
    --title "L2XC Ethernet Switching"
# LISP Overlay Tunnels
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_functional_results/vpp_functional_results_lisp.rst \
    --formatting rst --start 4 --level 2 \
    --regex ".+lisp.*" \
    --title "LISP Overlay Tunnels"
# QoS Policer Metering
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_functional_results/vpp_functional_results_policer.rst \
    --formatting rst --start 4 --level 2 \
    --regex ".+ipolicemark.*" \
    --title "QoS Policer Metering"
# RPF Source Security
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_functional_results/vpp_functional_results_rpf.rst \
    --formatting rst --start 4 --level 2 \
    --regex ".+rpf.*" \
    --title "RPF Source Security"
# Softwire Tunnels
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_functional_results/vpp_functional_results_softwire.rst \
    --formatting rst --start 4 --level 2 \
    --regex ".+swire.*" \
    --title "Softwire Tunnels"
# Tap Interface
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_functional_results/vpp_functional_results_tap.rst \
    --formatting rst --start 4 --level 2 \
    --regex ".+tap.*" \
    --title "Tap Interface"
# Telemetry - IPFIX and SPAN
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_functional_results/vpp_functional_results_telemetry.rst \
    --formatting rst --start 4 --level 2 \
    --regex ".+(ipfix|spanrx).*" \
    --title "Telemetry - IPFIX and SPAN"
# VLAN Tag Translation
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_functional_results/vpp_functional_results_vlan.rst \
    --formatting rst --start 4 --level 2 \
    --regex ".+(dot1q\-|dot1ad\-).*" \
    --title "VLAN Tag Translation"
# VRF Routed-Forwarding
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_functional_results/vpp_functional_results_vrf.rst \
    --formatting rst --start 4 --level 2 \
    --regex ".+ethip(4|6)+-ip(4|6)+basevrf.*" \
    --title "VRF Routed-Forwarding"
# VXLAN Overlay Tunnels
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml \
    --output ${DTR_SOURCE_DIR}/vpp_functional_results/vpp_functional_results_vxlan.rst \
    --formatting rst --start 4 --level 2 \
    --regex ".+(ip4vxlan|ip6vxlan).*" \
    --title "VXLAN Overlay Tunnels"

rm -f ${DTR_SOURCE_DIR}/vpp_functional_results/*.json
...
# unzip ${STATIC_DIR_ARCH}/${JEN_JOB}-${JEN_BUILD}.zip -d ${WORKING_DIR}/
# python run_robot_data.py \
#    -i ${WORKING_DIR}/archive/output.xml \
#    --output ${DTR_SOURCE_DIR}/honeycomb_functional_results/honeycomb_functional_results.rst \
#    --formatting rst --start 3 --level 2
rm -f ${DTR_SOURCE_DIR}/honeycomb_functional_results/*.json
...
python run_plot.py --input ${STATIC_DIR_VPP} --output ${STATIC_DIR_VPP}/64B-1t1c-vhost-ndrdisc --title "64B-1t1c-.*vhost.*-ndrdisc" --xpath '//*[@framesize="64B" and contains(@tags,"NDRDISC") and contains(@tags,"1T1C") and contains(@tags,"VHOST")]'
python run_plot.py --input ${STATIC_DIR_VPP} --output ${STATIC_DIR_VPP}/64B-2t2c-vhost-ndrdisc --title "64B-2t2c-.*vhost.*-ndrdisc" --xpath '//*[@framesize="64B" and contains(@tags,"NDRDISC") and contains(@tags,"2T2C") and contains(@tags,"VHOST")]'

python run_plot.py --input ${STATIC_DIR_VPP} --output ${STATIC_DIR_VPP}/64B-1t1c-ipsechw-ndrdisc --title "64B-1t1c-.*ipsec.*-ndrdisc" --xpath '//*[@framesize="64B" and not(contains(@tags, "VHOST")) and contains(@tags, "IP4FWD") and contains(@tags, "NDRDISC") and contains(@tags, "1T1C") and contains(@tags, "IPSECHW") and (contains(@tags, "IPSECTRAN") or contains(@tags, "IPSECTUN"))]'
python run_plot.py --input ${STATIC_DIR_VPP} --output ${STATIC_DIR_VPP}/64B-2t2c-ipsechw-ndrdisc --title "64B-2t2c-.*ipsec.*-ndrdisc" --xpath '//*[@framesize="64B" and not(contains(@tags, "VHOST")) and contains(@tags, "IP4FWD") and contains(@tags, "NDRDISC") and contains(@tags, "2T2C") and contains(@tags, "IPSECHW") and (contains(@tags, "IPSECTRAN") or contains(@tags, "IPSECTUN"))]'
...
python run_plot.py --input ${STATIC_DIR_VPP} --output ${STATIC_DIR_VPP}/64B-1t1c-vhost-pdrdisc --title "64B-1t1c-.*vhost.*-pdrdisc" --xpath '//*[@framesize="64B" and contains(@tags,"PDRDISC") and contains(@tags,"1T1C") and not(contains(@tags,"NDRDISC")) and contains(@tags,"VHOST")]'
python run_plot.py --input ${STATIC_DIR_VPP} --output ${STATIC_DIR_VPP}/64B-2t2c-vhost-pdrdisc --title "64B-2t2c-.*vhost.*-pdrdisc" --xpath '//*[@framesize="64B" and contains(@tags,"PDRDISC") and contains(@tags,"2T2C") and not(contains(@tags,"NDRDISC")) and contains(@tags,"VHOST")]'

python run_plot.py --input ${STATIC_DIR_VPP} --output ${STATIC_DIR_VPP}/64B-1t1c-ipsechw-pdrdisc --title "64B-1t1c-.*ipsec.*-pdrdisc" --xpath '//*[@framesize="64B" and not(contains(@tags, "VHOST")) and contains(@tags, "IP4FWD") and contains(@tags, "PDRDISC") and not(contains(@tags,"NDRDISC")) and contains(@tags, "1T1C") and contains(@tags, "IPSECHW") and (contains(@tags, "IPSECTRAN") or contains(@tags, "IPSECTUN"))]'
python run_plot.py --input ${STATIC_DIR_VPP} --output ${STATIC_DIR_VPP}/64B-2t2c-ipsechw-pdrdisc --title "64B-2t2c-.*ipsec.*-pdrdisc" --xpath '//*[@framesize="64B" and not(contains(@tags, "VHOST")) and contains(@tags, "IP4FWD") and contains(@tags, "PDRDISC") and not(contains(@tags,"NDRDISC")) and contains(@tags, "2T2C") and contains(@tags, "IPSECHW") and (contains(@tags, "IPSECTRAN") or contains(@tags, "IPSECTUN"))]'
...
python run_plot.py --input ${STATIC_DIR_VPP} --output ${STATIC_DIR_VPP}/64B-1t1c-ipsechw-ndrdisc-lat50 --title "64B-1t1c-.*ipsec.*-ndrdisc" --xpath '//*[@framesize="64B" and not(contains(@tags, "VHOST")) and contains(@tags, "IP4FWD") and contains(@tags, "NDRDISC") and contains(@tags, "1T1C") and contains(@tags, "IPSECHW") and (contains(@tags, "IPSECTRAN") or contains(@tags, "IPSECTUN"))]' --latency lat_50
python run_plot.py --input ${STATIC_DIR_VPP} --output ${STATIC_DIR_VPP}/64B-2t2c-ipsechw-ndrdisc-lat50 --title "64B-2t2c-.*ipsec.*-ndrdisc" --xpath '//*[@framesize="64B" and not(contains(@tags, "VHOST")) and contains(@tags, "IP4FWD") and contains(@tags, "NDRDISC") and contains(@tags, "2T2C") and contains(@tags, "IPSECHW") and (contains(@tags, "IPSECTRAN") or contains(@tags, "IPSECTUN"))]' --latency lat_50
