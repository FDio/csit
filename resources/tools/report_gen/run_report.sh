...
PERF_JENKINS_BUILD=(1)
PERF_JENKINS_FILE='output_perf_data.xml'

for i in ${PERF_JENKINS_BUILD[@]}; do
    wget -q ${JENKINS_URL}${PERF_JENKINS_JOB}/${i}${JENKINS_DIR}${PERF_JENKINS_FILE} -O ${STATIC_DIR}/${PERF_JENKINS_JOB}-${PERF_JENKINS_BUILD}.xml
done
...
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/64B-2t2c-l2-ndrdisc --title "64B-1t1c-*l2[bdbase|xcbase]*-ndrdisc" --xpath '//*[@framesize="64B" and contains(@tags,"BASE") and contains(@tags,"NDRDISC") and contains(@tags,"2T2C") and (contains(@tags,"L2BDMACSTAT") or contains(@tags,"L2BDMACLRN") or contains(@tags,"L2XCFWD")) and not(contains(@tags,"VHOST"))]' --lower 0 --upper 26000000
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/64B-4t4c-l2-ndrdisc --title "64B-1t1c-*l2[bdbase|xcbase]*-ndrdisc" --xpath '//*[@framesize="64B" and contains(@tags,"BASE") and contains(@tags,"NDRDISC") and contains(@tags,"4T4C") and (contains(@tags,"L2BDMACSTAT") or contains(@tags,"L2BDMACLRN") or contains(@tags,"L2XCFWD")) and not(contains(@tags,"VHOST"))]' --lower 0 --upper 36000000
...
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/64B-2t2c-ethip4-ip4-ndrdisc --title "64B-2t2c-ethip4-ip4*-ndrdisc" --xpath '//*[@framesize="64B" and (contains(@tags,"BASE") or contains(@tags,"SCALE") or contains(@tags,"FEATURE")) and contains(@tags,"NDRDISC") and contains(@tags,"2T2C") and contains(@tags,"IP4FWD") and not(contains(@tags,"VHOST"))]' --lower 0 --upper 24000000
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/64B-4t4c-ethip4-ip4-ndrdisc --title "64B-4t4c-ethip4-ip4*-ndrdisc" --xpath '//*[@framesize="64B" and (contains(@tags,"BASE") or contains(@tags,"SCALE") or contains(@tags,"FEATURE")) and contains(@tags,"NDRDISC") and contains(@tags,"4T4C") and contains(@tags,"IP4FWD") and not(contains(@tags,"VHOST"))]' --lower 0 --upper 32000000
...
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/78B-2t2c-ethip6-ip6-ndrdisc --title "78B-2t2c-ethip6-ip6*-ndrdisc" --xpath '//*[@framesize="78B" and (contains(@tags,"BASE") or contains(@tags,"SCALE") or contains(@tags,"FEATURE")) and contains(@tags,"NDRDISC") and contains(@tags,"2T2C") and contains(@tags,"IP6FWD") and not(contains(@tags,"VHOST"))]' --lower 5000000 --upper 20000000
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/78B-4t4c-ethip6-ip6-ndrdisc --title "78B-4t4c-ethip6-ip6*-ndrdisc" --xpath '//*[@framesize="78B" and (contains(@tags,"BASE") or contains(@tags,"SCALE") or contains(@tags,"FEATURE")) and contains(@tags,"NDRDISC") and contains(@tags,"4T4C") and contains(@tags,"IP6FWD") and not(contains(@tags,"VHOST"))]' --lower 14000000 --upper 30000000
...
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/64B-2t2c-l2-pdrdisc --title "64B-1t1c-*l2[bdbase|xcbase]*-pdrdisc" --xpath '//*[@framesize="64B" and contains(@tags,"BASE") and contains(@tags,"PDRDISC") and contains(@tags,"2T2C") and (contains(@tags,"L2BDMACSTAT") or contains(@tags,"L2BDMACLRN") or contains(@tags,"L2XCFWD")) and not(contains(@tags,"VHOST"))]' --lower 0 --upper 26000000
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/64B-4t4c-l2-pdrdisc --title "64B-1t1c-*l2[bdbase|xcbase]*-pdrdisc" --xpath '//*[@framesize="64B" and contains(@tags,"BASE") and contains(@tags,"PDRDISC") and contains(@tags,"4T4C") and (contains(@tags,"L2BDMACSTAT") or contains(@tags,"L2BDMACLRN") or contains(@tags,"L2XCFWD")) and not(contains(@tags,"VHOST"))]' --lower 0 --upper 36000000
...
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/64B-2t2c-ethip4-ip4-pdrdisc --title "64B-2t2c-ethip4-ip4*-pdrdisc" --xpath '//*[@framesize="64B" and (contains(@tags,"BASE") or contains(@tags,"SCALE") or contains(@tags,"FEATURE")) and contains(@tags,"PDRDISC") and contains(@tags,"2T2C") and contains(@tags,"IP4FWD") and not(contains(@tags,"VHOST"))]'
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/64B-4t4c-ethip4-ip4-pdrdisc --title "64B-4t4c-ethip4-ip4*-pdrdisc" --xpath '//*[@framesize="64B" and (contains(@tags,"BASE") or contains(@tags,"SCALE") or contains(@tags,"FEATURE")) and contains(@tags,"PDRDISC") and contains(@tags,"4T4C") and contains(@tags,"IP4FWD") and not(contains(@tags,"VHOST"))]'
...
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/64B-1t1c-l2-ndrdisc-lat --title "64B-1t1c-*l2[bdbase|xcbase]*-ndrdisc-lat" --xpath '//*[@framesize="64B" and contains(@tags,"BASE") and contains(@tags,"NDRDISC") and contains(@tags,"1T1C") and (contains(@tags,"L2BDMACSTAT") or contains(@tags,"L2BDMACLRN") or contains(@tags,"L2XCFWD")) and not(contains(@tags,"VHOST"))]' --latency lat_50
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/64B-2t2c-l2-ndrdisc-lat --title "64B-1t1c-*l2[bdbase|xcbase]*-ndrdisc-lat" --xpath '//*[@framesize="64B" and contains(@tags,"BASE") and contains(@tags,"NDRDISC") and contains(@tags,"2T2C") and (contains(@tags,"L2BDMACSTAT") or contains(@tags,"L2BDMACLRN") or contains(@tags,"L2XCFWD")) and not(contains(@tags,"VHOST"))]' --latency lat_50
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/64B-4t4c-l2-ndrdisc-lat --title "64B-1t1c-*l2[bdbase|xcbase]*-ndrdisc-lat" --xpath '//*[@framesize="64B" and contains(@tags,"BASE") and contains(@tags,"NDRDISC") and contains(@tags,"4T4C") and (contains(@tags,"L2BDMACSTAT") or contains(@tags,"L2BDMACLRN") or contains(@tags,"L2XCFWD")) and not(contains(@tags,"VHOST"))]' --latency lat_50
...
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/64B-1t1c-ethip4-ndrdisc-lat --title "64B-1t1c-ethip4*-ndrdisc-lat" --xpath '//*[@framesize="64B" and contains(@tags,"ENCAP") and contains(@tags,"NDRDISC") and contains(@tags,"1T1C") and (contains(@tags,"VXLAN") or contains(@tags,"VXLANGPE") or contains(@tags,"LISP") or contains(@tags,"LISPGPE") or contains(@tags,"GRE")) and not(contains(@tags,"VHOST"))]' --latency lat_50
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/64B-2t2c-ethip4-ndrdisc-lat --title "64B-2t2c-ethip4*-ndrdisc-lat" --xpath '//*[@framesize="64B" and contains(@tags,"ENCAP") and contains(@tags,"NDRDISC") and contains(@tags,"2T2C") and (contains(@tags,"VXLAN") or contains(@tags,"VXLANGPE") or contains(@tags,"LISP") or contains(@tags,"LISPGPE") or contains(@tags,"GRE")) and not(contains(@tags,"VHOST"))]' --latency lat_50
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/64B-4t4c-ethip4-ndrdisc-lat --title "64B-4t4c-ethip4*-ndrdisc-lat" --xpath '//*[@framesize="64B" and contains(@tags,"ENCAP") and contains(@tags,"NDRDISC") and contains(@tags,"4T4C") and (contains(@tags,"VXLAN") or contains(@tags,"VXLANGPE") or contains(@tags,"LISP") or contains(@tags,"LISPGPE") or contains(@tags,"GRE")) and not(contains(@tags,"VHOST"))]' --latency lat_50

python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/78B-1t1c-ethip6-ndrdisc-lat --title "78B-1t1c-ethip6*-ndrdisc-lat" --xpath '//*[@framesize="78B" and contains(@tags,"ENCAP") and contains(@tags,"NDRDISC") and contains(@tags,"1T1C") and (contains(@tags,"VXLAN") or contains(@tags,"VXLANGPE") or contains(@tags,"LISP") or contains(@tags,"LISPGPE") or contains(@tags,"GRE")) and not(contains(@tags,"VHOST"))]' --latency lat_50
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/78B-2t2c-ethip6-ndrdisc-lat --title "78B-2t2c-ethip6*-ndrdisc-lat" --xpath '//*[@framesize="78B" and contains(@tags,"ENCAP") and contains(@tags,"NDRDISC") and contains(@tags,"2T2C") and (contains(@tags,"VXLAN") or contains(@tags,"VXLANGPE") or contains(@tags,"LISP") or contains(@tags,"LISPGPE") or contains(@tags,"GRE")) and not(contains(@tags,"VHOST"))]' --latency lat_50
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/78B-4t4c-ethip6-ndrdisc-lat --title "78B-4t4c-ethip6*-ndrdisc-lat" --xpath '//*[@framesize="78B" and contains(@tags,"ENCAP") and contains(@tags,"NDRDISC") and contains(@tags,"4T4C") and (contains(@tags,"VXLAN") or contains(@tags,"VXLANGPE") or contains(@tags,"LISP") or contains(@tags,"LISPGPE") or contains(@tags,"GRE")) and not(contains(@tags,"VHOST"))]' --latency lat_50

python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/64B-1t1c-vhost-ndrdisc-lat --title "64B-1t1c-*vhost*-ndrdisc-lat" --xpath '//*[@framesize="64B" and contains(@tags,"NDRDISC") and contains(@tags,"1T1C") and contains(@tags,"VHOST")]' --latency lat_50
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/64B-2t2c-vhost-ndrdisc-lat --title "64B-2t2c-*vhost*-ndrdisc-lat" --xpath '//*[@framesize="64B" and contains(@tags,"NDRDISC") and contains(@tags,"2T2C") and contains(@tags,"VHOST")]' --latency lat_50
python run_plot.py --input ${STATIC_DIR} --output ${BUILD_DIR}/_static/64B-4t4c-vhost-ndrdisc-lat --title "64B-4t4c-*vhost*-ndrdisc-lat" --xpath '//*[@framesize="64B" and contains(@tags,"NDRDISC") and contains(@tags,"4T4C") and contains(@tags,"VHOST")]' --latency lat_50
...
#for i in ${PERF_JENKINS_BUILD[@]}; do
#    wget -q ${JENKINS_URL}${PERF_JENKINS_JOB}/${i}${JENKINS_DIR}${JENKINS_FILE} -O ${STATIC_DIR}/${PERF_JENKINS_JOB}-${PERF_JENKINS_BUILD}.zip
#done
...
#    wget -q ${JENKINS_URL}${FUNC_JENKINS_JOB}/${i}${JENKINS_DIR}${JENKINS_FILE} -O ${STATIC_DIR}/${FUNC_JENKINS_JOB}-${FUNC_JENKINS_BUILD}.zip
#done
