...
sudo apt-get -y install libxml2 libxml2-dev libxslt-dev build-essential zlib1g-dev unzip
...
rm ${DTR_SOURCE_DIR}/vpp_performance_results/*.json
...
rm ${DTR_SOURCE_DIR}/testpmd_performance_results/*.json
...
# DELETE ME
#cp ./csit-vpp-functional-1704-ubuntu1604-virl-8.zip ${STATIC_DIR_ARCH}/${JEN_JOB}-${i}.zip

unzip ${STATIC_DIR_ARCH}/${JEN_JOB}-${i}.zip -d ${WORKING_DIR}/
python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml --output ${DTR_SOURCE_DIR}/vpp_functional_results/vpp_functional_results_cop.rst --formatting rst --start 4 --level 2
rm ${DTR_SOURCE_DIR}/vpp_functional_results/*.json
...
# unzip ${STATIC_DIR_ARCH}/${JEN_JOB}-${i}.zip -d ${WORKING_DIR}/
# python run_robot_data.py -i ${WORKING_DIR}/archive/output.xml --output ${DTR_SOURCE_DIR}/honeycomb_functional_results/honeycomb_functional_results.rst --formatting rst --start 3 --level 2
rm ${DTR_SOURCE_DIR}/honeycomb_functional_results/*.json
