...
def main():
    ...
    if xdata and ydata:
        ...
        for suite in ydata:
            if args.latency:
                y_extract = []
                _ = [y_extract.extend([l, l]) for l in ydata[suite][1::2][1].split('/')]
                traces.append(plgo.Box(
                    x=['SUT1-to-SUT2', 'SUT1-to-SUT2', 'SUT1-to-SUT2',
                       'SUT1-to-SUT2', 'SUT1-to-SUT2', 'SUT1-to-SUT2',
                       'SUT2-to-SUT1', 'SUT2-to-SUT1', 'SUT2-to-SUT1',
                       'SUT2-to-SUT1', 'SUT2-to-SUT1', 'SUT2-to-SUT1'],
                    y=y_extract,
                    name=suite.lower(),
                    boxmean=False,
        ...
        layout = plgo.Layout(
            ...
            yaxis=dict(
                ...
                showticklabels=True,
                tickcolor='rgb(238, 238, 238)',
                title='uSec [min/avg/max]' if args.latency\
