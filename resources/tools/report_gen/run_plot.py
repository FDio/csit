        ...
        if sel:
            try:
                ydata_lat = combine_dicts(ydata_lat, dict((elem.attrib['name'],\
                    ('/'.join(str(i)*6), elem.attrib[args.latency])) for elem in sel))
            except KeyError:
...
#            print suite + ' :: ' + str(ydata[suite][1::2]) + ' :: ' + str(ydata[suite][0::2])
#        traces = [
#        {
#            'y': [0.2, 0.6, 1.0, 0.2, 0.6, 1.0, 0.1, 0.5, 0.3, 0.1, 0.5, 0.3],
