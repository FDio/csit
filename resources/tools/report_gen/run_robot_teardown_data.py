...
"""
Script extracts interested data (name, documentation, VAT command history or
table from Show Runtime command) from robot framework output file (output.xml)
and prints in specified format (wiki, html, rst) to defined output
file.
    ...
    [
        {
            ...
            "table": [
                ["TC name", "TC doc", "VAT history or show runtime"],
                ["TC name", "TC doc", "VAT history or show runtime"],
                ... other test cases ...
                ["Name", "Documentation", "VAT command history or
