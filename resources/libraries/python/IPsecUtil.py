...
class CryptoAlg(Enum):
    ...
    AES_CBC_128 = ('aes-cbc-128', 16)
    AES_CBC_192 = ('aes-cbc-128', 24)
    AES_CBC_256 = ('aes-cbc-256', 32)

    def __init__(self, alg_name, key_len):
...
class IntegAlg(Enum):
    """Integrity algorithm."""
    SHA1_96 = ('sha1-96', 20)
    SHA_256_128 = ('sha-256-128', 32)
    SHA_384_192 = ('sha-384-192', 48)
    SHA_512_256 = ('sha-512-256', 64)
