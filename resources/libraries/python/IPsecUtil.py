        ...
        if int(n_entries) > 10:
            ...
            with open(tmp_filename, 'w') as tmp_file:
                for i in range(n_entries):
                    ...
                    tunnel = (
                        f"tunnel-src {src_addr + i * addr_incr} "
                        f"tunnel-dst {dst_addr + i * addr_incr}"
                        if tunnel_src and tunnel_dst else u""
                    )
                    conf = (
                        f"exec ipsec sa add {sad_id + i} esp spi {spi + i} "
        ...
        if int(n_tunnels) > 10:
            ...
            with open(tmp_filename, 'w') as tmp_file:
                ...
                for i in range(n_tunnels):
                    conf = (
                        f"exec set interface ip address {if_name} "
        ...
        if int(n_entries) > 10:
            ...
            with open(tmp_filename, 'w') as tmp_file:
                for i in range(n_entries):
                    ...
                    tunnel = (
                        f"exec ipsec policy add spd {spd_id} "
            ...
            with open(tmp_fn1, 'w') as tmp_f1, open(tmp_fn2, 'w') as tmp_f2:
                ...
                for i in range(n_tunnels):
                    ...
                    if integ_alg:
                        ...
                        integ = (
                            f"integ_alg {integ_alg.alg_name} "
