...
class IPsecUtil(object):
    ...
    def vpp_ipsec_create_tunnel_interfaces(
        ...
        with PapiExecutor(nodes['DUT1']) as papi_exec_1, \
            ...
            args2_1 = dict(
                is_add=1,
                local_ip=IPUtil.create_ip_address_object(if1_ip),
                remote_ip=IPUtil.create_ip_address_object(if2_ip),
                local_spi=0,
                remote_spi=0,
            ...
            args2_2 = dict(
                ...
                remote_ip=IPUtil.create_ip_address_object(if1_ip),
                local_spi=0,
                remote_spi=0,
                crypto_alg=crypto_alg.alg_int_repr,
                local_crypto_key_len=0,
            ...
            err_msg = 'Failed to add IPsec tunnel interfaces on host {host}'.\
                format(host=nodes['DUT1']['host'])
            err_msg_2 = 'Failed to add IPsec tunnel interfaces on host {host}'.\
            ...
            for i in xrange(0, n_tunnels):
                ...
                args2_1['local_ip']['un'] = IPUtil.union_addr(
                    if1_ip + i * addr_incr)
                ...
                args2_2['remote_ip']['un'] = IPUtil.union_addr(
                    if1_ip + i * addr_incr)
