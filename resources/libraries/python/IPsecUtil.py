...
class IPsecUtil(object):
    ...
    def vpp_ipsec_create_tunnel_interfaces_in_containers(
        ...
        dut1_scripts = IPsecUtil._create_ipsec_script_files('DUT1',
                                                            n_instances)
        dut2_scripts = IPsecUtil._create_ipsec_script_files('DUT2',
                                                            n_instances)
        ...
        IPsecUtil._close_and_copy_ipsec_script_files('DUT1', nodes,
                                                     n_instances,
                                                     dut1_scripts)
        IPsecUtil._close_and_copy_ipsec_script_files('DUT2', nodes,
                                                     n_instances,
                                                     dut2_scripts)
