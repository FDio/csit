...
class IPsecUtil:
    ...
    def vpp_ipsec_create_tunnel_interfaces(
        ...
        at least for the first tunnel. That explains the current return tuple.
        In general, we could return all the generated keys,
        but that would needlessly spam the performance scale test log.
        TODO: Add an argument so callers can tweak how many keys they want?
        ...
        :type raddr_range: int
        :type existing_tunnels: int
        :returns: First ckey, first ikey, spi_1, spi_2.
