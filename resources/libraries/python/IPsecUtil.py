...
class IPsecUtil(object):
    ...
    def vpp_ipsec_create_tunnel_interfaces(
        ...
        with PapiExecutor(nodes['DUT1']) as papi_exec:
            ...
            for i in xrange(0, n_tunnels):
                ...
                args2['local_ip']['un'] = IPUtil.union_addr(
                    if1_ip + i * addr_incr)
        ...
        with PapiExecutor(nodes['DUT2']) as papi_exec:
            ...
            for i in xrange(0, n_tunnels):
                ...
                args2['remote_ip']['un'] = IPUtil.union_addr(
                    if1_ip + i * addr_incr)
                args2['local_crypto_key_len'] = len(ckeys[i])
                args2['local_crypto_key'] = ckeys[i]
                args2['remote_crypto_key_len'] = len(ckeys[i])
