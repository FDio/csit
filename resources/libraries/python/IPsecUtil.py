...
class IPsecUtil:
    ...
    def vpp_ipsec_set_ip_route(
            ...
            raddr_range, input_interface=None, dst_mac=None):
        ...
        if int(n_tunnels) > 10:
            ...
            with open(tmp_filename, 'w') as tmp_file:
                ...
                if input_interface:
                    input_if_name = Topology.get_interface_name(
                        node, input_interface)
                for i in range(n_tunnels):
                    ...
                    if input_interface:
                        conf = f"{conf}exec set ip neighbor " \
                               f"{input_if_name} " \
    ...
    def vpp_ipsec_add_multiple_tunnels(
        ...
        IPsecUtil.vpp_ipsec_set_ip_route(
            ...
            interface1, raddr_range, input_interface_dir1, rmac)
