...
class IPsecUtil:
    ...
    def vpp_ipsec_create_spds_with_rules_nth_match(
        ...
        if no_match_rule_amount > 0:
            ...
            IPsecUtil.vpp_ipsec_add_spd_entries(
                ...
                inbound=False, laddr_range=no_match_src_addr_range,
        ...
        IPsecUtil.vpp_ipsec_show_spd(node, spd_id_dir1)
        IPsecUtil.vpp_ipsec_show_spd(node, spd_id_dir2)
    ...
    @staticmethod
    def vpp_ipsec_show_spd(node, spd_id):
        """Run "show ipsec spd" debug CLI command.

        :param node: Node to run command on.
        :param spd_id: SPD id to show.
        :type node: dict
        :type spd_id: int
        """
        PapiSocketExecutor.run_cli_cmd(node, f"show ipsec spd {spd_id}")
