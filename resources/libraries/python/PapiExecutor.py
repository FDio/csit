...
def dictize(obj):
    ...
    If the object is not a namedtuple, it will be returned without change.
    If it is a namedtuple, its _asdict is returned,
    ...
    """
    if not isinstance(obj, collections.namedtuple):
        return obj
    ret = obj._asdict
