...
class PapiSocketExecutor:
    ...
    def get_replies(
        ...
        """
        return self._execute(err_msg=err_msg, fast_send=fast_send, fast_receive=fast_receive)
...
#                logger.trace(f"sent {second_sent.hex()}")
                ...
                send_template = BytesTemplate.from_two_messages(first_sent, second_sent)
