...
class Disconnector:
    ...
    This could be a class method of PapiSocketExecutor. But Robot calls methods
    on instances, and it would be weird fo give node argument for constructor
    in import. Also, as we have a class of the same name as the module,
