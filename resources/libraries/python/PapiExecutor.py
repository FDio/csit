        ...
        if process_reply:
            ...
            for data in json_data:
                try:
                    ...
                    # FIXME: Ignore broken response and continue with processing
                    # the rest, or stop the processing and raise RuntimeError?
                    continue
    ...
    def _process_api_data(api_d):
        ...
        for api in api_d:
            try:
                ...
                # FIXME: Ignore broken request and continue with processing the
                # rest, or stop the processing and raise RuntimeError?
                continue
