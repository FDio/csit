...
class PapiSocketExecutor(object):
    ...
    def _execute(self):
        ...
        try:
            ...
            # Remove after VPP becomes more resilient.
            ...
            # Previous test might have left SSH tunnel open to socket
            # of no longer existing process. We need to delete the local socket
            # to enable creating a new tunnel.
            output = subprocess.check_output(
                ["rm", "-vf", self._local_socket_path], stderr=subprocess.STDOUT)
            logger.debug(output)
