...
__all__ = [
    ...
    u"disconnect_all_papi_connections",
]
...
def disconnect_all_papi_connections():
    ...
    This could be a class method, but Robot calls methods on instances
    and it would be weird fo give node argument for constructor in import.
