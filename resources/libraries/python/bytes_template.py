...
class BytesTemplate:
    ...
    def from_two_messages(cls, first, second):
        ...
        The second violating pattern is IP addresses incrementing
        by multiple of 256, typically jumping over /24 ranges.
        This happens to work if the previous field was static.
        But if the previous field was 
