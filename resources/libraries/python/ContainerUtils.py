...
class ContainerEngine:
    ...
    def _fire_pre_vpp_teardown(self):
        """Execute any teardown actions derived objects need before VPP ends."""
    ...
    def verify_vppctl(self, retries=120, retry_wait=1):
        ...
        for _ in range(retries + 1):
            try:
                # Execute puts the comand into single quotes,
    ...
    def verify_vpp_papi(self, retries=120, retry_wait=1):
        ...
        They are garbage-collected via _fire_pre_vpp_teardown.
