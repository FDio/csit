...
class ContainerManager:
    ...
    def cat_log_in_all_containers(self):
        """Cat log in all containers."""
        for container in self.containers:
            self.engine.container = self.containers[container]
            self.engine.cat_log()
...
class ContainerEngine:
    ...
    def cat_log(self, filepath=u"/tmp/vppd.log"):
        """Execute cat in container."""
        try:
            self.execute(f"cat {filepath}")
        except RuntimeError:
            pass
