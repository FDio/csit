        ...
        if chain_topology == 'chain':
            for i, container in enumerate(self.containers):
                ...
                self.engine.create_vpp_exec_config(
                    ...
                    mid1=mid1, mid2=mid2, sid1=sid1, sid2=sid2, dir=guest_dir,
                    socket1='memif-{c_name}-{sid}'.
                            format(c_name=c_name, sid=sid1),
                    socket2='memif-{c_name}-{sid}'.
                            format(c_name=c_name, sid=sid2))
            ...
            for i, container in enumerate(self.containers):
                ...
                self.engine.create_vpp_exec_config(
                    container_vat_template,
                    mid1=mid1, sid1=sid1, if_name=if_name, dir=guest_dir,
                    socket1='memif-{c_name}-{sid}'.
                            format(c_name=c_name, sid=sid1))
