...
class ContainerManager:
    ...
    def _configure_vpp_chain_ipsec(self, **kwargs):
        ...
        if dut == u"DUT1":
            local_ip = f"{local_ip_base}.{nf_instance + 100}"
            ...
            local_ip = f"{local_ip_base}.{nf_instance}"
        ...
        mac1_5 = 1 + (16 * mac_offset)
        mac2_5 = 2 + (16 * mac_offset)
        mac_6 = nf_instance - 1
        self.engine.create_vpp_exec_config(
            ...
            sid1=u"1",
            sid2=u"2",
            mac1=f"02:02:00:00:{mac1_5:02X}:{mac6:02X}",
            mac2=f"02:02:00:00:{mac2_5:02X}:{mac6:02X}",
