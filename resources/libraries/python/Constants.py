...
def get_pessimistic_bool_from_env(env_var_names, default_value):
...
def get_optimistic_bool_from_env(env_var_names, default_value):
    """Attempt to read bool from environment variable, return that or default.
...
class Constants(object):
    ...
    CRC_MISMATCH_FAILS_TEST = get_optimistic_bool_from_env(
        ("CRC_MISMATCH_FAILS", "CRC_MISMATCH_FAILS_TEST"), True)
