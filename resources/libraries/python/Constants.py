...
class Constants:
    ...
    # This constant [s] allows longer wait,
    # without affecting approximate duration.
    PERF_TRIAL_STL_DELAY = get_float_form_env(u"PERF_TRIAL_STL_DELAY", 0.0)

    # ASTF may need a different delay value.
    PERF_TRIAL_ASTF_DELAY = get_float_form_env(u"PERF_TRIAL_ASTF_DELAY", 0.1115)
