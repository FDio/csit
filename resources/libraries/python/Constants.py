...
class Constants:
    ...
    # ASTF needs two delays.
    PERF_TRIAL_ASTF_SEND_DELAY = get_float_from_env(
#        u"PERF_TRIAL_ASTF_SEND_DELAY", 0.1
        u"PERF_TRIAL_ASTF_SEND_DELAY", 0.0
    )
    PERF_TRIAL_ASTF_RECEIVE_DELAY = get_float_from_env(
#        u"PERF_TRIAL_ASTF_RECEIVE_DELAY", 0.1115
        u"PERF_TRIAL_ASTF_RECEIVE_DELAY", 0.1095
    )
