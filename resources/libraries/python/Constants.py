...
| ... | at which a prescribed small fraction of packets would be lost. After set time,\\
| ... | the serarch stops and the algorithm reports its current estimate.\\''',
    }

    PERF_TYPE_TO_TEMPLATE_DOC_VER = {
        "mrr": '''[Ver] Measure MaxReceivedRate for ${frame_size}B frames using burst\\
| | ... | trials throughput test.\\''',
