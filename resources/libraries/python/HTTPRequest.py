...
class HTTPRequest(object):
    ...
    def _http_request(method, node, path, enable_logging=True, **kwargs):
        ...
        try:
            ...
            rsp = requests.request(method, url, auth=auth, **kwargs)
    ...
    def get(node, path, headers=None, timeout=10, enable_logging=True):
        ...
        :rtype: tuple
        """
        return HTTPRequest._http_request('GET',
                                         node,
                                         path,
    ...
    def put(node, path, headers=None, payload=None, timeout=10):
        ...
        :rtype: tuple
        """
        return HTTPRequest._http_request('PUT',
                                         node,
                                         path,
                                         headers=headers,
                                         data=payload,
    ...
    def post(node, path, headers=None, payload=None, json=None, timeout=10):
        ...
        :rtype: tuple
        """
        return HTTPRequest._http_request('POST',
                                         node,
                                         path,
                                         headers=headers,
                                         data=payload,
    ...
    def delete(node, path, timeout=10):
        ...
        :rtype: tuple
        """
        return HTTPRequest._http_request('DELETE',
                                         node,
                                         path,
                                         timeout=timeout)
