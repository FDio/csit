...
class DUTSetup:
    ...
    def check_huge_page(
        ...
        :param hugesize: HugePage size in KB. Defaulting CSIT to 2MB pages.
        ...
        if ((mem_size * 1024) / hugesize) > huge_available:
            ...
            if allocate:
                ...
                exec_cmd_no_error(
                    ...
                    msg=f"Increase map count failed on {node[u'host']}!"
                )
                ...
                exec_cmd_no_error(
                    ...
                    msg=f"Mount huge pages failed on {node[u'host']}!"
                )
