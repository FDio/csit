    ...
    def vpp_show_lisp_map_resolver(node):
        ...
        for details in dump.reply[0]["api_reply"]:
            ...
            if details["lisp_map_resolver_details"]["is_ipv6"] == 0:
                addr = str(IPv4Address(details["lisp_map_resolver_details"]["ip_address"][0:4]))
            elif details["lisp_map_resolver_details"]["is_ipv6"] == 1:
                addr = str(IPv6Address(details["lisp_map_resolver_details"]["ip_address"]))
...
# TODO: remove
        ...
        for details in dump.reply[0]["api_reply"]:
            ...
            if details["lisp_map_server_details"]["is_ipv6"] == 0:
                addr = str(IPv4Address(details["lisp_map_server_details"]["ip_address"][0:4]))
            elif details["lisp_map_server_details"]["is_ipv6"] == 1:
                addr = str(IPv6Address(details["lisp_map_server_details"]["ip_address"]))
...
# VAT is returning ipv6 address instead of ipv4
