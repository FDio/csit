...
class LispUtil():
    ...
    def lisp_locator_set_should_be_equal(self, locator_set1, locator_set2):
        """Fail if the lisp values are not equal.
    ...
    @staticmethod
    def generate_lisp_locator_set_test_values(node, locator_set_number):
    ...
    @staticmethod
    def generate_lisp_locator_set_reset_test_values(node, locator_set_number):
        """Generate a list of lisp locator_set we want set to VPP and
        then check if is set correct.
    ...
    @staticmethod
    def generate_lisp_local_eid_test_value(ipv4_num, ipv6_num):
    ...
    @staticmethod
    def generate_lisp_map_resolver(ipv4_num, ipv6_num):
