...
DPDK_SCRIPT = "./scripts/dpdk-devbind.py"
...
class VppPCIUtil(object):
    ...
    @staticmethod
    def _create_device_list(ssh, device_string):
        """
        ...
        for i in range(len(ids)):
            ...
            device['numa_node'] = stdout.rstrip('\n')
            ...
            pci_interfaces = stdout.rstrip('\n').split()
            device['interfaces'] = pci_interfaces
    ...
    def get_all_devices(self):
        ...
        self._dpdk_devices = self._create_device_list(ssh, using_dpdk)
        ...
        self._kernel_devices = self._create_device_list(ssh, using_kernel)
        ...
        self._other_devices = self._create_device_list(ssh, other)
        ...
        self._crypto_dpdk_devices = self._create_device_list(ssh,
                                                             crypto_using_dpdk)
        ...
        self._crypto_other_devices = self._create_device_list(ssh,
                                                              crypto_other)
