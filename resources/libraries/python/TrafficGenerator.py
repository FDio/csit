...
class OptimizedTrexSearch(object):
    ...
    def perform_optimized_trex_ndrpdr_search(self, frame_size, fail_rate, line_rate, traffic_type,
                                             final_relative_width=0.005, final_duration=30.0,
        ...
        algorithm = DropRateSearch.OptimizedSearchAlgorithm(rate_provider, float(final_duration),
                                                            float(final_relative_width), float(duration_coefficient))
