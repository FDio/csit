...
__all__ = ['TrafficGenerator', 'TGDropRateSearchImpl', 'TrexRateProvider', 'perform_optimized_ndr_pdr_search']
...
class TrexRateProvider(DropRateSearch.AbstractRateProvider):
    ...
    def measure(self, duration, transmit_rate):
        ...
        return DropRateSearch.ReceiveRateMeasurement(duration, transmit_rate, rx, dx)


def perform_optimized_ndr_pdr_search(frame_size, fail_rate, line_rate, traffic_type, allowed_drop_fraction):
    """Create Trex provide, initialize optimized search, find intervals and return them."""
    rate_provider = TrexRateProvider(frame_size, traffic_type)
    algorithm = DropRateSearch.OptimizedSearchAlgorithm()
