...
class TrafficGenerator(AbstractMeasurer):
    ...
    def send_traffic_on_tg(
        ...
        In case of CSIT-1901 symptom (detection only if not in async mode),
        retry once, fail if retry is also buggy
    ...
    def measure(self, intended_duration, intended_load):
        ...
        In case of CSIT-1901 symptom, retry once,
        fail if retry is also buggy to avoid exporting invalid json data.
