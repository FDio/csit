...
class TrafficGenerator(AbstractMeasurer):
    ...
    def trex_stl_start_remote_exec(
            ...
            latency=True, warmup_time=5.0, directions=2, tx_port=0,
            rx_port=1):
        ...
        :param directions: Traffic is bi- (2) or uni- (1) directional.
            Default: 2
    ...
    def send_traffic_on_tg(
            ...
            async_call=False, latency=True, directions=2, tx_port=0,
            rx_port=1):
        ...
        if subtype == NodeSubTypeTG.TREX:
            self.trex_stl_start_remote_exec(
                ...
                latency, warmup_time, directions, tx_port, rx_port)
    ...
    def measure(self, duration, transmit_rate):
        ...
        unit_rate_int = transmit_rate / float(self.directions)
...
class OptimizedSearch(object):
    ...
    def perform_optimized_ndrpdr_search(
            ...
            timeout=720.0, doublings=1, directions=2):
        ...
        tg_instance.set_rate_provider_defaults(
            frame_size, traffic_profile, directions=directions)
