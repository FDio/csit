...
class TrafficGenerator(AbstractMeasurer):
    ...
    def trex_stl_start_remote_exec(
        ...
        Ports are used as given for unidirectional traffic.
        For bidirectional traffic, ports are chosen based on _ifaces_reordered.
        ...
        :param tx_port: Traffic generator transmit port. Default: 0
        :param rx_port: Traffic generator receive port. Default: 1
        :type duration: float
        :type rate: str
        :type framesize: str
        :type traffic_type: str
        ...
        p_0, p_1 = tx_port, rx_port
        if not unidirection:
            p_0, p_1 = (p_1, p_0) if self._ifaces_reordered else (p_0, p_1)
        command = (
