...
class TrafficGenerator(AbstractMeasurer):
    ...
    def trex_astf_start_remote_exec(
            ...
            rx_port=1, n_transactions=0, delays=0.0, stretch_tolerance=1.3):
    ...
    def measure(self, duration, transmit_rate):
        ...
        self.send_traffic_on_tg(
            ...
            n_transactions=self.n_transactions, delays=self.delays,
...
class OptimizedSearch:
    ...
    def perform_optimized_ndrpdr_search(
        ...
        tg_instance.set_rate_provider_defaults(
            ...
            resetter=resetter, n_transactions=n_transactions, delays=delays,
    ...
    def perform_soak_search(
            ...
            traffic_directions=2, latency=True, resetter=None, n_transactions=0,
