...
class TrafficGenerator(AbstractMeasurer):
    ...
    def trex_stl_start_remote_exec(
        ...
        p0, p1 = tx_port, rx_port
        if not unidirection:
            p0, p1 = (1, 0) if self._ifaces_reordered else (0, 1)
        command = (
