...
class TrafficGenerator(AbstractMeasurer):
    ...
    def measure(self, intended_duration, intended_load):
        ...
        TelemetryUtil.run_telemetry_on_all_duts(nodes, profile="vppctl_clear_stats.yaml", export=False)
        ...
        TelemetryUtil.run_telemetry_on_all_duts(nodes, profile="vppctl_show_stats.yaml", export=False)
