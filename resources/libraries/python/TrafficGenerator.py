...
class OptimizedTrexSearch(object):
    ...
    def perform_optimized_trex_ndrpdr_search(self, frame_size, fail_rate, line_rate, traffic_type,
                                             ...
                                             allowed_drop_fraction=0.005, intermediate_phases=2, initial_trial_duration=1.0):
        ...
        algorithm = DropRateSearch.OptimizedSearchAlgorithm(rate_provider, float(final_trial_duration),
                                                            float(final_relative_width), int(intermediate_phases),
                                                            float(initial_trial_duration))
