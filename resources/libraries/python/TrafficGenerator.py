...
class TrafficGenerator(AbstractMeasurer):
    ...
    def _startup_trex(self, osi_layer):
        ...
        for _ in range(0, 3):
            ...
            cmd = f"sh -c '{Constants.REMOTE_FW_DIR}/GPL/tools/trex/"
    ...
    def trex_stl_stop_remote_exec(self, node):
        ...
        stdout, _ = exec_cmd_no_error(
            node, f"sh -c '{Constants.REMOTE_FW_DIR}/GPL/tools/trex/"
    ...
    def trex_stl_start_remote_exec(
        ...
        command = f"sh -c \"" \
            f"{Constants.REMOTE_FW_DIR}/GPL/tools/trex/" \
            f"trex_stateless_profile.py" \
            f" --profile {Constants.REMOTE_FW_DIR}/GPL/" \
