...
class TrafficGenerator(AbstractMeasurer):
    ...
    def get_measurement_results(self, duration=None, transmit_rate=None):
        ...
        :param duration: Measurement duration [s] if known beforehand.
            For explicitly stopped measurement is is estimated.
    ...
    def measure(self, duration, transmit_rate):
        ...
        return self.get_measurement_results(duration, transmit_rate)
