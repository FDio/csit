...
@unique
class SearchDirection(Enum): # pylint: disable=too-few-public-methods
...
@unique
class SearchResults(Enum): # pylint: disable=too-few-public-methods
...
@unique
class RateType(Enum): # pylint: disable=too-few-public-methods
    """Type of rate units."""
...
@unique
class LossAcceptanceType(Enum): # pylint: disable=too-few-public-methods
...
@unique
class SearchResultType(Enum): # pylint: disable=too-few-public-methods
...
class DropRateSearch(object):
    ...
    def _set_search_rate_type(self, rate_type):
        ...
        if rate_type not in RateType:
            raise ValueError("rate_type unknown: {}".format(rate_type))
        else:
