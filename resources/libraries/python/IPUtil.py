...
class NetworkIncrement(ObjIncrement):
    ...
    For other uses, it may be easier to use constant prefix length
    and increment only the address part using address_increment.
    """
...
def address_increment(initial_address, prefix_length):
    ...
    if NetworkIncrement formatting is less fitting.
