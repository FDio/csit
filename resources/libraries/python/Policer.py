...
class Policer(object):
    ...
    def policer_set_configuration(self, is_add=1):
        ...
        args_in = dict(
            ...
            conform_action_type=self._conform_action,
            conform_dscp=self._conform_dscp,
            exceed_action_type=self._exceed_action,
            exceed_dscp=self._exceed_dscp,
            violate_action_type=self._violate_action,
            violate_dscp=self._violate_dscp,
