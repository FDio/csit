...
def export_hoststack_iperf3_fail_result(output):
    ...
    result_node[u"output"] = dict(success=False, output_text=output)
...
def export_hoststack_vpp_echo_fail_result(output):
    ...
    output_list.append(dict(success=False, output_text=output))
...
def export_hoststack_iperf3_pass_result(output):
    ...
    result_node = get_export_data()[u"result"]
    result_node[u"type"] = u"hoststack_iperf3"
    result_node[u"output"] = dict(success=True, parsed_output=output)
...
def export_hoststack_vpp_echo_pass_result(output):
    ...
    output_list.append(dict(success=True, parsed_output=parsed_output))
