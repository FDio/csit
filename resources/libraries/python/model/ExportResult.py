...
def export_dut_version(dut_type, version):
    """Export the arguments as dut type and version.

    :param dut_type: DUT type, e.g. VPP or DPDK.
    :param version: DUT version as determined by the caller.
    :type dut_type: str
    :type version: str
    """
    data = get_export_data()
    data[u"dut_type"] = str(dut_type)
    data[u"dut_version"] = str(version)
