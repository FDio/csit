...
def export_sut_version(sut_type, version):
    """Export the arguments as sut type and version.

    :param sut_type: SUT type, e.g. VPP or DPDK.
    :param version: SUT version as determined by the caller.
    :type sut_type: str
    :type version: str
    """
    data = get_export_data()
    data[u"sut"] = dict(type=str(sut_type), version=str(version))
