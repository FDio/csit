...
class ExportJson():
    ...
    def export_pending_data(self):
        ...
        If not valid, do not reset, so caller may attempt again as failed test.
    ...
    def finalize_test_export_once(self):
        ...
        # The rest works on multiple calls.
    ...
    def process_passed(self):
        ...
        In case the test status is not PASS, we delete test result,
