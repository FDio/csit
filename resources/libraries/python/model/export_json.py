...
from resources.libraries.python.model.util import now
...
class export_json():
    ...
    def __init__(self, suite_name, log_dir):
        ...
        :type log_dir: str
        """
        logger.debug(u"export_json is imported now")
    ...
    def flush_test(self, test_name, test_status, test_tags):
        """Write serialized data to file based on test name.

        :param test_name: Test case name as detected by Robot.
        :param test_status: PASS or FAIL as detected by Robot.
        :param test_tags: Final state of test tags  as detected by Robot.
        :type test_name: str
        :type test_status: str
        :type test_tags: Iterable[str]
        """
        ...
        execution_node[u"stop_time"] = now()
