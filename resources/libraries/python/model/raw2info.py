...
def _create_suite_info_file(teardown_info_path):
    ...
    suite_data = dict(
        ...
        # Move fields not specific to just setup.
        suite_name=setup_data.pop(u"suite_name"),
        suite_id=setup_data.pop(u"suite_id"),
        suite_documentation=setup_data.pop(u"suite_documentation"),
    )
    ...
    # We moved some fields outouf setup, so rewrite setup info file content.
    dump_into(setup_data, setup_info_path, overwrite=True)
