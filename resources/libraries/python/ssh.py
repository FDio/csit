...
class SSH(object):
    ...
    def exec_command(self, cmd, timeout=240):
    ...
    def exec_command_sudo(self, cmd, cmd_input=None, timeout=240):
    ...
    def interactive_terminal_open(self, time_out=240):
    ...
    def scp(self, local_path, remote_path):
        ...
        scp = SCPClient(self._ssh.get_transport(), socket_timeout=240)
        start = time()
