...
class PerfUtil:
    ...
    def perf_stat(node, cpu_list=None, duration=1):
        ...
        exec_cmd(node, 'perf stat -e "cpu/event=0x28,umask=0x07,name=CORE_POWER.LVL0_TURBO_LICENSE/" -e "cpu/event=0x28,umask=0x18,name=CORE_POWER.LVL1_TURBO_LICENSE/" -e "cpu/event=0x28,umask=0x20,name=CORE_POWER.LVL2_TURBO_LICENSE/" -C 1 -I 1000 -- sleep 2',
            sudo=True)
