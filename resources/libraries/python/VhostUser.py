...
class VhostUser:
    ...
    def vhost_user_affinity(node, pf_key, skip_cnt=0):
        ...
        :type skip_cnt: int
        """
        exec_cmd(node, "grep . /proc/*/comm")
        exec_cmd(node, "ip netns exec tap0_namespace grep . /proc/*/comm")
        exec_cmd(node, "ip netns exec tap0_namespace grep -h vhost /proc/*/comm")
        exec_cmd(node, "ip netns exec tap0_namespace grep -h vhost /proc/*/comm | uniq | xargs pidof")
