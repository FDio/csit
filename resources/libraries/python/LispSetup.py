...
class LispGpeIface(object):
    ...
    def vpp_lisp_gpe_iface_up(node):
        ...
        with VatTerminal(node) as vat:
            vat.vat_terminal_exec_cmd_from_template('lisp_gpe_iface.vat',
                                                    state='up')
...
class  LispMapResolver(object):
    ...
    def vpp_add_mal_resolver(node, map_resolver_ip):
        ...
        with VatTerminal(node) as vat:
            vat.vat_terminal_exec_cmd_from_template('add_lisp_map_resolver.vat',
    ...
    def vpp_del_mal_resolver(node, map_resolver_ip):
        ...
        with VatTerminal(node) as vat:
            vat.vat_terminal_exec_cmd_from_template('del_lisp_map_resolver.vat',
                                                    address=map_resolver_ip)
...
class  LispLocalEid(object):
    ...
    def vpp_add_lisp_local_eid(node, locator_set_name, address, prefix_len):
        ...
        with VatTerminal(node) as vat:
            vat.vat_terminal_exec_cmd_from_template('add_lisp_local_eid.vat',
                                                    eid_address=address,
    ...
    def vpp_del_lisp_local_eid(node, locator_set_name, address, prefix_len):
        ...
        with VatTerminal(node) as vat:
            vat.vat_terminal_exec_cmd_from_template('del_lisp_local_eid.vat',
                                                    eid_address=address,
                                                    eid_prefix=prefix_len,
                                                    locator_name=locator_set_name)
...
class  LispLocator(object):
    ...
    def vpp_add_lisp_locator(node, locator_name, sw_if_index, priority, weight):
        ...
        with VatTerminal(node) as vat:
            vat.vat_terminal_exec_cmd_from_template('add_lisp_locator.vat',
    ...
    def vpp_del_lisp_locator(node, locator_name, sw_if_index, priority, weight):
        ...
        with VatTerminal(node) as vat:
            vat.vat_terminal_exec_cmd_from_template('del_lisp_locator.vat',
                                                    lisp_name=locator_name,
                                                    sw_if_index=sw_if_index,
                                                    priority=priority,
                                                    weight=weight)
...
class LispLocatoSet(object):
    ...
    def vpp_add_lisp_locator_set(node, name):
        ...
        with VatTerminal(node) as vat:
            vat.vat_terminal_exec_cmd_from_template('add_lisp_locator_set.vat',
                                                    lisp_name=name)
    ...
    def vpp_del_lisp_locator_set(node, name):
        ...
        with VatTerminal(node) as vat:
            vat.vat_terminal_exec_cmd_from_template('del_lisp_locator_set.vat',
                                                    lisp_name=name)
...
class LispSetup(object):
    ...
    @staticmethod
    def  node_set_lisp_locator_set(node, locator_sets):
    ...
    @staticmethod
    def  node_unset_lisp_locator_set(node, locator_sets):
    ...
    @staticmethod
    def node_set_lisp_eid_table(node, eid_table):
    ...
    @staticmethod
    def node_unset_lisp_eid_table(node, eid_table):
    ...
    @staticmethod
    def node_set_lisp_map_resolver(node, map_resolver):
    ...
    @staticmethod
    def node_unset_lisp_map_resolver(node, map_resolver):
    ...
    @staticmethod
    def node_lisp_gpe_interface_up(node):
    ...
    @staticmethod
    def node_lisp_gpe_interface_down(node):
        """Set lisp gpe interface up on VPP node in topology
