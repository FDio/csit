# Copyright (c) 2016-2021 Cisco and/or its affiliates.
...
class LispEid:
    ...
    def create_eid(eid, prefix_len):
        ...
        :type eid: str
        :type prefix_len: int
        :returns: Eid object suitable for PAPI command arguments.
        :rtype: dict
        """
        eid_addr = dict(
...
class LispRemoteLocator:
    ...
    def create_rloc(ip_addr, priority=0, weight=0):
        ...
        :type priority: int
        :type weight: int
        :returns: Remote locator object suitable for PAPI command arguments.
        :rtype: list of single dict
        """
        return [
            dict(
                priority=priority,
