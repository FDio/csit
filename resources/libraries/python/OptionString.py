...
class OptionString(object):
    ...
    def add_two_or_zero_if(self, parameter, value, condition):
    ...
    def add_equals_if(self, parameter, value, condition):
        """Add parameter=value to the list of parts if condition.
    ...
    def add_two_or_zero_from_dict(self, parameter, key, mapping, default=""):
        ...
        return self.add_two_or_zero(parameter, value)
    ...
    def add_two_or_zero_if_from_dict(
        ...
        """
        condition = mapping.get(key, default)
        return self.add_two_or_zero_if(parameter, value, condition)

    def add_equals_from_dict(self, parameter, key, mapping, default=""):
        """If key is in dict add parameter=value to options.
