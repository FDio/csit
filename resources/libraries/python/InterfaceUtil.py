        ...
        def process_vxlan_dump(vxlan_dump):
            if vxlan_dump['is_ipv6']:
                vxlan_dump['src_address'] = \
                    inet_pton(AF_INET6, vxlan_dump['src_address'])
                vxlan_dump['dst_address'] = \
                    inet_pton(AF_INET6, vxlan_dump['dst_address'])
            else:
                vxlan_dump['src_address'] = \
                    inet_pton(AF_INET, vxlan_dump['src_address'][0:4])
                vxlan_dump['dst_address'] = \
                    inet_pton(AF_INET, vxlan_dump['dst_address'][0:4])
            return vxlan_dump
