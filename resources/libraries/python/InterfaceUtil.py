...
class InterfaceUtil:
    ...
    def vxlan_dump(node, interface=None):
        ...
        def process_vxlan_dump(vxlan_dump):
            ...
            :rtype: object
            """
            vxlan_dump.src_address = str(vxlan_dump.src_address)
            vxlan_dump.dst_address = str(vxlan_dump.dst_address)
            return vxlan_dump
    ...
    def vxlan_gpe_dump(node, interface_name=None):
        ...
        def process_vxlan_gpe_dump(vxlan_dump):
            ...
            if vxlan_dump.is_ipv6:
                vxlan_dump.local = ip_address(vxlan_dump.local)
                vxlan_dump.remote = ip_address(vxlan_dump.remote)
            else:
                vxlan_dump.local = ip_address(vxlan_dump.local[0:4])
                vxlan_dump.remote = ip_address(vxlan_dump.remote[0:4])
            return vxlan_dump
