...
from resources.libraries.python.jumbo.Jumbo import MTU_JUMBO, jumbo_enabled
...
class InterfaceUtil:
    ...
    @staticmethod
    def set_interface_mtu(node, pf_pcis, mtu=MTU_JUMBO):
    ...
    def vpp_create_rdma_interface(
        ...
        args = dict(
            ...
            no_multi_seg=not jumbo_enabled(),
            max_pktlen=0,
