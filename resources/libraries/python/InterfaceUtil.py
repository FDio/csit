...
class InterfaceUtil:
    ...
    @staticmethod
    def set_interface_mtu(node, pf_pcis, mtu=Constants.EXPERIMENTAL_MTU):
    ...
    @staticmethod
    def vpp_set_interface_mtu(node, interface, mtu=Constants.EXPERIMENTAL_MTU):
    ...
    @staticmethod
    def vpp_set_interfaces_mtu_on_node(node, mtu=Constants.EXPERIMENTAL_MTU):
    ...
    @staticmethod
    def vpp_set_interfaces_mtu_on_all_duts(nodes, mtu=Constants.EXPERIMENTAL_MTU):
