...
class InterfaceUtil(object):
    ...
    def update_vpp_interface_data_on_node(node):
        ...
        api, and pairing known information from topology (mac address/pci
        address of interface) to state from VPP.
        ...
        for ifc in interface_list:
            if_dict = dict()
            for if_data_k, if_data_v in ifc.items():
                if_dict[if_data_k] = if_data_v
            interface_dict[ifc['l2_address']] = if_dict
