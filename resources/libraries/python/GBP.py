...
class GBP(object):
    ...
    def gbp_route_domain_add(node, rd_id=1, is_ipv6=False):
        ...
        args_in = dict(
            rd = dict (
                ...
                ip4_uu_sw_if_index = 0,
                ip6_uu_sw_if_index = 0
            )
        )
    ...
    def gbp_bridge_domain_add(node, bvi_sw_if_index, bd_id=1, rd_id=1):
        ...
        args_in = dict(
            bd = dict(
                ...
                uu_fwd_sw_if_index = 0,
                bm_flood_sw_if_index = 0,
                bd_id = bd_id,
                rd_id = rd_id
            )
        )
    ...
    def gbp_endpoint_add(node, sw_if_index, ip_addr, mac_addr, sclass=100):
        ...
        ips = list(IPUtil.create_ip_address_object(
    ...
    @staticmethod
    def gbp_contract_add_del(
        node, address, address_length, rd_id=1, sclass=100):
        """Add GBP contract.
