...
class SpyingSocket:
    ...
    def __init__(
            self, under_socket, capture=False, sent=b""):
        ...
        as vpp_instance.transport.q.get(True, timeout) retrieves raw data
        already nicely packaged into messages.
        ...
        """Whether sent data should be captured."""
        self.sent = sent
    ...
    def __eq__(self, other):
        ...
        This aso handles situations where under_socket is swapped back.
