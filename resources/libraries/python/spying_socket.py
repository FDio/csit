...
class SpyingSocket:
    ...
    def __init__(
            self, under_socket, capture_send=False, capture_receive=False,
            sent=b"", received=b""):
        ...
        :param capture_send: Whether the data sent should be remembered.
        :param capture_receive: Whether the data received should be remembered.
        :param sent: Last captured binary message sent.
        :param received: Last captured binary message received.
        :type under_socket: socket.socket or compatible (can be SpyingSocket)
        :type capture_send: bool
        :type capture_received: bool
        :type sent: bytes
        :type received: bytes
        """
        ...
        self.capture_send = capture_send
        self.capture_receive = capture_receive
        self.sent = sent
    ...
    def recv_into(self, buffer, nbytes=0):
        ...
        :rtype: int
        """
        ret = self.under_socket.recv_into(buffer, nbytes)
        if self.capture_receive:
