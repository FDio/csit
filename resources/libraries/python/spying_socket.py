...
class SpyingSocket:
    ...
    def __init__(self, under_socket, sent=b"", received=b""):
        ...
        """Buffere of data received. Appended on each chunk."""
    ...
    def flush_remembered(self):
        """Return and clean sent and received.

        :returns: Sent and received since last flush.
        :rtype: (bytes, bytes)
        """
        # TODO: Currently, only spying on sent is used.
        # Do not spy on received here, or use the received in the caller.
        sent, received = self.sent, self.received
        self.sent, self.received = b"", b""
