...
from resources.libraries.python.TLDK.gen_pcap import gen_ipv4_checksum_pcap
from resources.libraries.python.TLDK.gen_pcap import gen_ipv6_checksum_pcap
from resources.libraries.python.TLDK.gen_pcap import gen_ipv4_fragment_pcap
from resources.libraries.python.TLDK.gen_pcap import gen_ipv6_fragment_pcap
from resources.libraries.python.TLDK.gen_pcap import gen_ipv4_assemble_pcap
from resources.libraries.python.TLDK.gen_pcap import create_packet
...
def create_env_directory_at_node(node):
    ...
    (ret_code, stdout, stderr) = ssh.exec_command(
        'cd {0} && rm -rf env && virtualenv --system-site-packages --never-download env && '
