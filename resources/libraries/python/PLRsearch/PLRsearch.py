...
class PLRsearch:
    ...
    def measure_and_compute(
        ...
        # Preparation phase.
        dimension = 2
        logging.trace(u"dimension set")
        stretch_focus_tracker, erf_focus_tracker = focus_trackers
        logging.trace(u"trackers unpacked")
