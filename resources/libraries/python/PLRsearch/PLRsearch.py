...
#            stop_computing("erf", erf_pipe))
        ...
        stretch_var = math.exp(stretch_value_tracker.log_variance)
        erf_var = 0.0 # math.exp(erf_value_tracker.log_variance)
        ...
        upp, low = math.exp(avg_log - stdev_log), math.exp(avg_log + stdev_log)
        avg = (low + upp) / 2
        stdev = avg - low
