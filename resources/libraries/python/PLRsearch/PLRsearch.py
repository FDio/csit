...
class PLRsearch(object):
    ...
    FIXME: Those method names should start with underscore then.
    """
    ...
    def search(self, min_rate, max_rate):
        ...
        as their results tend to make the critical estimate worse.
...
#            self.lfit_erf, erf_focus_tracker)
        ...
        def stop_computing(name, pipe):
            ...
            logging.info("Logs from worker %(name)s:", name=name)
