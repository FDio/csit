...
class PLRsearch(object):
    ...
    def search(self, min_rate, max_rate):
        ...
        message += " integrator_data %(data)r"
    ...
    def find_critical_rate(trace, lfit_func, log_lps_target, mrr, spread):
        ...
        :rtype: float
        """
        trace("Finding critical rate for log_lps_target", log_lps_target)
    ...
    def measure_and_compute(
            ...
            max_rate, integrator_data, max_samples=None):
        ...
        logging.debug(
            ...
            + "max_rate %(mr)r, integrator_data %(data)r, max_samples %(ms)r",
            {"self": self, "dur": trial_duration, "tr": transmit_rate,
             "trl": trial_result_list, "mr": max_rate, "data": integrator_data,
             "ms": max_samples})
        # Preparation phase.
        dimension = 2
        ...
        def start_computing(fitting_function, bias_avg, bias_cov):
            ...
            boss_pipe_end.send(
                (dimension, dilled_function, bias_avg, bias_cov, max_samples))
