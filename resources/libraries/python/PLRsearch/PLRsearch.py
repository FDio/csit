...
class PLRsearch:
    ...
    def measure_and_compute(
        ...
        # Preparation phase.
        dimension = 2
        logger.trace(u"dimension set")
        stretch_focus_tracker, erf_focus_tracker = focus_trackers
        logger.trace(u"trackers unpacked")
