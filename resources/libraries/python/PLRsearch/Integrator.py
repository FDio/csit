...
def estimate_nd(communication_pipe, scale_coeff=8.0, trace_enabled=False):
    ...
    There are workaround in place that allow old or default focus tracker
    to be updated reasonable even when initial samples
    of new iteration have way different weights.
