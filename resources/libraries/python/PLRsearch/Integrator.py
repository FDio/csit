...
#        print "param_sampled_cov", repr(param_sampled_cov)
    ...
    logger.debug("integrator used " + str(samples) + " samples")
    logger.debug(
    ...
    logger.debug("top_weight_param[0] " + repr(top_weight_param[0]))
    ...
    communication_pipe.send(
        (value_avg, value_stdev, param_focus_avg, param_focus_cov))
