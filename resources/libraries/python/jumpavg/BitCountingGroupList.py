...
class BitCountingGroupList(object):
    ...
    def __str__(self):
        ...
        :rtype: str
        """
        return "group_list={gl} bits={bits}".format(
            gl=self.group_list, bits=self.bits)
    ...
    def __repr__(self):
        ...
        """
        return (
            "BitCountingGroupList(group_list={gl!r},bits_except_last={b!r},"
            "max_value={mv!r})".format(
                gl=self.group_list, b=self.bits_except_last,
                mv=self.max_value))
    ...
    def bits(self):
        ...
        if not self.group_list:
            return 0.0
        # TODO: Is it woth wo cache the overall result?
