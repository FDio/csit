...
class AvgStdevStats:
    ...
    def __str__(self):
        ...
        :rtype: str
        """
        return "size={size} avg={avg} stdev={stdev}".format(size=self.size, avg=self.avg, stdev=self.stdev)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return "AvgStdevStats(size={size!r},avg={avg!r},stdev={stdev!r})".format(size=self.size, avg=self.avg, stdev=self.stdev)
