...
=======
        return "stats={stats} bits={bits}".format(stats=self.stats, bits=self.cached_bits)
>>>>>>> Bisect script on alternative history
...
=======
            "BitCountingGroup(run_list={rl!r},stats={s!r}"
            ",bits={cb!r},max_value={mv!r}"
            ",prev_avg={pa!r},comment={c!r})"
