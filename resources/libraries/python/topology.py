...
class Topology(object):
    ...
    def add_new_port(node, ptype):
        """Add new port to the node from the topology
    ...
    def get_interface_by_name(self, node, vhost_socket):
        ...
        :param : Interface name (string form).
        ...
        for node_data in nodes_info.values():
            ...
            for if_key, if_val \
                ...
                if if_val['link'] == link_name:
                    return node_data, node_data['interfaces'][if_key]
