...
class Classify(object):
    ...
    @staticmethod
    def classify_add_table(node, ip_version, direction):
        """Create classify table.

        :param node: Node to create classify table.
    ...
    @staticmethod
    def classify_session(node, acl_method, table_index, skip_n, match_n,
                         ip_version, direction, address):
        """Configuration of classify session.

        :param node: Node to setup classify session.
