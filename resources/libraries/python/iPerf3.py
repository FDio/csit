...
class iPerf3:
    ...
    def iperf_client_start_remote_exec(
            ...
            traffic_directions=1, namespace=None):
        ...
        :type namespace: str
        :raises RuntimeError: In case of iPerf3 driver issue.
        """
        ...
        cmd_options = OptionString(prefix=u"--")
        cmd_options.add_with_value(u"port_netns", f"{namespace!r}")
        cmd_options.add_with_value(u"duration", f"{duration!r}")
        cmd_options.add_with_value(u"frame_size", frame_size)
        cmd_options.add_with_value(u"rate", f"{rate!r}")
        cmd_options.add_with_value(u"warmup_time", f"{warmup_time!r}")
        ...
        stdout, _ = exec_cmd_no_error(
            node, cmd, timeout=int(duration) + 60,
