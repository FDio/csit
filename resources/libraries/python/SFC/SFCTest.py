...
class SFCTest(object):
    ...
    @staticmethod
    def configure_and_start_SFC_functional_test(dut_node, dut_port,
                                                adj_mac, testtype):
        """
        ...
        :param testtype: which SFC functional test.
        :type dut_node: dict
        :type dut_port: str
        :type adj_mac: str
        :type testtype: str
    ...
    def start_the_tcpdump_on_the_node(from_node, from_port, filter_ip):
        ...
        cmd = 'cd {0}/nsh_sfc_tests/sfc_scripts/ && sudo ./start_tcpdump.sh ' \
              '{1} {2}'.format(con.REMOTE_FW_DIR, from_port, filter_ip)
