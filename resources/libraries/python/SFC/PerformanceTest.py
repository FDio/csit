...
"""
This module implements functionality which configures and starts
...
class PerformanceTest(object):
    ...
    def Start_performance_test_on_DUT(dut_node, dut_if1, dut_if2,
        if1_adj_mac, if2_adj_mac, test_type, dut_type):
        ...
        :param test_type: The SFC performance test type.
                         (Classifier, Proxy Inbound, Proxy Outbound, SFF).
        :param dut_type: The DUT type. (DUT1, DUT2)
        :type dut_node: dict
        :type dut_if1: str
        :type dut_if2: str
        ...
        cmd = 'cd {0}/tests/nsh_sfc/sfc_scripts/ && sudo ./{1} {2} ' \
              '{3} {4} {5} {6}'.format(con.REMOTE_FW_DIR, exec_shell, vpp_intf1_name,
                               vpp_intf2_name, if1_adj_mac, if2_adj_mac, dut_type)
