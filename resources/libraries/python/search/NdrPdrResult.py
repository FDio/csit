...
class NdrPdrResult(object):
    ...
    def width_in_goals(self, relative_width_goal):
        ...
        """
        return ("ndr "
                + str(self.ndr_interval.width_in_goals(relative_width_goal))
                + "; pdr "
                + str(self.pdr_interval.width_in_goals(relative_width_goal)))

    def __str__(self):
        """Return string as tuple of named values."""
        return ("NDR=" + str(self.ndr_interval)
                + ";PDR=" + str(self.pdr_interval))
