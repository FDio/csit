...
class Tap(object):
    ...
    def tap_dump(node, name=None):
        ...
        def process_tap_dump(tap_dump):
            ...
            :rtype: dict
            """
            tap_dump[u'dev_name'] = tap_dump[u'dev_name'].rstrip(u'\x00')
            tap_dump[u'host_if_name'] = tap_dump[u'host_if_name'].rstrip(u'\x00')
            tap_dump[u'host_namespace'] = \
                tap_dump[u'host_namespace'].rstrip(u'\x00')
            tap_dump[u'host_mac_addr'] = \
                L2Util.bin_to_mac(tap_dump[u'host_mac_addr'])
        ...
        for dump in details:
            ...
            elif dump.get(u'host_if_name').rstrip(u'\x00') == name:
