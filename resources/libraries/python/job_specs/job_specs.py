...
clear; ./job_specs.py --specification ../../../job_specs/job_specifications.yaml --job csit-vpp-perf-report-iterative-rls-2n-icx --test-type mrr --test-group ip4-base --output-dir ./out --output-file spec
clear; ./job_specs.py --specification ../../../job_specs/job_specifications.yaml --job csit-vpp-perf-report-iterative-rls-2n-icx --test-type mrr --output-dir ./out --output-file spec
...
if __name__ == "__main__":
    ...
    try: 
        ...
        logging.debug(f"The directory {output_dir} exists, it will be reused.")
    except OSError as err:
        logging.error(f"The directory {output_dir} can not be created.\n{err}")
        sys.exit(1)
