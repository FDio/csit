...
clear; ./job_specs.py --specification ../../../job_specs/job_specifications.yaml --job csit-vpp-perf-report-iterative-rls-2n-icx --testtype mrr
"""
...
def generate_job_spec(spec: dict, job: str, testtype: str=str()) -> int:
    """
    """
    if job not in spec:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--testgroup", required=False, type=str, default=str(),
        help=""
    )
    parser.add_argument(
        "--testtype", required=False, type=str, default=str(),
        help=""
    )
