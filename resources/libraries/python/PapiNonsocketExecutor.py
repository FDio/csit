...
__all__ = [u"PapiNonsocketExecutor"]


class PapiNonsocketExecutor:
    ...
    with PapiNonsocketExecutor(node) as papi_exec:
    ...
    Note: In this case, when PapiNonsocketExecutor method 'add' is used:
    - its parameter 'csit_papi_command' is used only to keep information
      ...
      is "stats".
    - the second parameter must be 'path' as it is used by PapiNonsocketExecutor
      method 'add'.
    """
