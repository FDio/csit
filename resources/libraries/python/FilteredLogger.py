...
class FilteredLogger(object):
    ...
    def __init__(self, logger_module, min_level="INFO"):
        ...
        self.logger_module.trace("FilteredLogger init {m!r} {l!r} {n!r}".format(
            m=logger_module, l=min_level, n=self.min_level_num))
    ...
    def write(self, message, farg=None, level="INFO"):
        ...
        :type level: str
        """
        self.logger_module.trace(
            "FilteredLogger.write called with {m!r} {f!r} {l!r} {n!r}".format(
                m=message, f=farg, l=level, n=_LEVELS[level.upper()]))
