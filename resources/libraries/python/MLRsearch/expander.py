...
class TargetedExpander:
    ...
    def expand(self, bump_current: bool = True) -> None:
        ...
        :param bump_current: False if called from limit or post init.
        :type bump_current: bool
        """
    ...
    def get_width(self) -> DiscreteWidth:
        ...
        :returns: The width to use, see CurrentWidth.
        :rtype: DiscreteWidth
        """
    ...
    def limit(self, last_width: DiscreteWidth) -> None:
        ...
        :param last_width: As applied by other strategy, larger of two halves.
