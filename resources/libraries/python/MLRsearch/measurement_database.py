...
class MeasurementDatabase:
    ...
    def get_valid_bounds(
        self, criterion, min_duration, trial_duration
        ...
        trial_duration = min(trial_duration, min_duration)
        logger.debug(f"gvb corrected trial duration {trial_duration}")
        ...
        for load_stat in self.load_to_stat.values():
            ...
            if load_stat.intended_duration < trial_duration:
