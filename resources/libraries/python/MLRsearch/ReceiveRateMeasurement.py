...
class ReceiveRateMeasurement:
    ...
    def __lt__(self, other):
        ...
        Types are not compared, so comparisons with subclasses
        may give surprising results.
        Primary quantities are compared.
        ...
        Other quantities are compared as they appear in constructor arguments,
        as for MLRsearch the first two should be enough to decide.
        ...
        if self.duration < other.duration:
            return True
        if self.transmit_count < other.transmit_count:
            return True
        if self.loss_count < other.loss_count:
            return True
        if self.approximated_duration < other.approximated_duration:
            return True
        if self.partial_transmit_count < other.partial_transmit_count:
            return True
        if self.effective_loss_ratio < other.effective_loss_ratio:
            return True
        return False
