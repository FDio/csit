...
class TargetSpec:
    ...
    loss_ratio: float
    """Target loss ratio. Equal and directly analogous to loss ratio goal,
    ...
    but can be coarser for non-final targets."""
    ...
    For non-final targets, this is shorter than goal min_duration_sum."""
