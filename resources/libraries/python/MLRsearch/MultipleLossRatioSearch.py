...
class MultipleLossRatioSearch:
    ...
    def _select_for_ratio(self, ratio):
        ...
        if cur_lo1 is None:
            ...
            new_tr = self._extend_down(cur_hi1, cur_hi2, pre_hi)
            self.debug(
        ...
        extended_tr = self._extend_down(cur_hi1, cur_hi2, pre_hi)
    ...
    def _extend_down(self, cur_hi1, cur_hi2, pre_hi):
    ...
    def _bisect(self, lower_bound, upper_bound):
        ...
        if width <= state.width_goal:
            ...
            return None
        new_tr = half_step_up(lower_bound.target_tr, width)
        return new_tr
