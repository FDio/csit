...
class MeasurementResult:
    ...
    to reach its transmit count. To signal irregular situations like this,
    ...
    to the few that prven useful in practice.
    ...
    """Trial measurement target duration [s]."""
    intended_load: float
    ...
    """Number of packets actually transmitted, (transactions started)."""
    loss_count: int = None
    ...
    def __post_init__(self):
        ...
        # TODO: Tell caller which counts need to be non-None?
        if self.forwarding_count is None:
            self.forwarding_count = int(self.offered_count) - int(self.loss_count)
        else:
    ...
    def loss_ratio(self) -> float:
        ...
        in irregular situations, thus guiding search algorithms
        towards lower loads where there should be less irregularities.
        The zero default is there to prevent search algorithm from
        getting stuck on too low load.
        """
