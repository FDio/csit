...
when the class fields do yet exist, and the decorated function
...
=======
otherwise the intended logic breaks down in the current implementation.
>>>>>>> ee1eeda62 (WiP: MLRsearch simulator for v7)
"""
...
class DataclassProperty(property):
    ...
    def __init__(
        self,
        fget: Optional[Callable[[Self], Value]] = None,
        fset: Optional[Callable[[Self, Value], None]] = None,
        fdel: Optional[Callable[[Self], None]] = None,
