...
class Candidate:
    ...
    As each selector is asked by the controller whether
    its nominated load is done being measured, reference to selector
    ...
    def __lt__(self, other: Candidate) -> bool:
        ...
        Self load is less than other when both loads are None.
    ...
    def done(self) -> bool:
        """Return whether the selector is done measuring at the nominated load.

        :returns: False if the same load should be measured again.
        :rtype: bool
        """
