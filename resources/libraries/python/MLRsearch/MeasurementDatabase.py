...
class MeasurementDatabase:
    ...
    def add(self, measurement):
        """Add a measurement. Duration has to math the set one.
    ...
    def get_bounds(self, ratio):
        ...
        """
        cur_lo1, cur_hi1, pre_lo1, pre_hi1, cur_lo2, cur_hi2 = [None] * 6
        ...
        if duration is not None:
            data = self.data_for_duration[duration]
            pre_lo1, pre_hi1, _, _ = data.get_valid_bounds(ratio)
        return cur_lo1, cur_hi1, pre_lo1, pre_hi1, cur_lo2, cur_hi2
