...
class Pep3140Dict(dict):
    ...
    Python implemented dict str method whch shows both keys and values
    in their repr form. This class shows them in their str form.
    """
...
=======
        :returns: Shorter but probably unparsable string description.
