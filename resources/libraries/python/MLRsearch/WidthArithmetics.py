...
"""Module defining utility functions for manipulating interval widths."""
...
def quadruple_step_down(relative_width, current_bound):
    ...
    :rtype: float
    """
    double_width = double_relative_width(relative_width)
    quadruple_width = double_relative_width(double_width)
    return step_down(quadruple_width, current_bound)
...
def quadruple_step_up(relative_width, current_bound):
    ...
    """
    double_width = double_relative_width(relative_width)
    quadruplee_width = double_relative_width(doublee_width)
    return step_up(quadruple_width, current_bound)
