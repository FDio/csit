...
"""Module defining CurrentWidth class."""
...
class CurrentWidth:
    ...
    That is why all selector instances refer to a single instance of this.

    The two methods are not really worth creating a new class,
    but the main reason is having a name for type hints
    that distinguish this from various other "with" and "current" values.
    """
    ...
    @staticmethod
    def from_loads(load0: DiscreteLoad, load1: DiscreteLoad) -> CurrentWidth:
        ...
        :rtype: CurrentWidth
        """
        return CurrentWidth(load1 - load0)
