...
class SelectionInfo:
    ...
    The default value is always the falsy one, as that is the Pythonic way.
    """

    load: Optional[DiscreteLoad] = None
    """Selected load. None means no measurements needed at this phase."""
    halve: bool = False
    ...
    Generally, only candidates from external search need this,
    as bisects already avoid bounds and re-measurements _need_
    to happen at exactly the same load."""
