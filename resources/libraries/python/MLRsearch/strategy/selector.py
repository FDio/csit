...
class CandidateSelector:
    ...
    def nomination_iterator(self) -> Iterator[LoadCandidate]:
        ...
        while 1:
            ...
            # Abuse rounding to convert to pure DiscreteLoad.
            self.initial_lower_load = self.bounds.clo.rounded_down()
            self.initial_upper_load = self.bounds.chi.rounded_down()
            self._update_bounds()
            self._recreate_strategies()
