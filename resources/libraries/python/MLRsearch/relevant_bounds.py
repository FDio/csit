...
class RelevantBounds:
    ...
    def from_database(
        ...
        """
        plo1, phi1, clo1, chi1, clo2, chi2 = [None] * 6
        if previous_duration is not None:
            plo1, phi1, _, _ = database.get_valid_bounds(
                criterion, previous_duration, subtrial_duration
            )
        clo1, chi1, clo2, chi2 = database.get_valid_bounds(
            criterion, current_duration, subtrial_duration, phi=phi1
        )
