...
class LoadRounding(BaseLoadRounding):
    """BaseLoadRounding with additional discrete_goals field.

    As this uses DiscreteWidth and DiscreteWidth uses BaseLoadRounding,
    this needs to be a separate class to avoid circular dependencies.
    """

    discrete_goals: List[DiscreteWidth] = field(init=False, repr=False)
    """Discrete form of int_goals."""

    def __post_init__(self) -> None:
        """Do parent postinit and populate discrete goals.
