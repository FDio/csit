...
class DiscreteLoad:
    ...
    def int_conver(rounding: LoadRounding) -> Callable[[int], DiscreteLoad]:
        """Return a factory that turns int loads into discrete load.
        ...
        def factory_int(int_load: int) -> DiscreteLoad:
            """Use rounding and this int to create discrete load.
    ...
    def float_conver(rounding: LoadRounding) -> Callable[[float], DiscreteLoad]:
        """Return a factory that turns float loads into discrete load.
        ...
        def factory_float(float_load: float) -> DiscreteLoad:
            """Use rounding and this float to create discrete load.
    ...
    def __sub__(
        ...
        :param offset: Value to subtract from int load.
        :type offset: Union[DiscreteWidth, DiscreteLoad]
    ...
    def __div__(self, coefficient: float) -> DiscreteLoad:
