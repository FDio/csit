...
class TargetScaling:
    ...
    goal_to_target: Dict[SearchGoal, TargetSpec] = field(repr=False, init=False)
    ...
    def __post_init__(self) -> None:
        ...
        for goal in self.goals:
            ...
            # Final target.
            width = DiscreteWidth(
                rounding=self.rounding, float_width=goal.relative_width,
            ).rounded_down()
            duration_sum = goal.min_duration_sum
            target = TargetSpec(
            ...
            self.goal_to_target[goal] = linked_targets[-1]
