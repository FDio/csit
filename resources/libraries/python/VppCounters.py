    ...
    def vpp_show_runtime(node, log_zeros=False):
        ...
        if sockets:
            for socket in sockets.values():
                ...
                table.align["Nr of Vectors"] = u"r"
                table.align["Nr of Packets"] = u"r"
                table.align["Suspends"] = u"r"
                table.align["Cycles per Packet"] = u"r"
                table.align["Average Vector Size"] = u"r"
