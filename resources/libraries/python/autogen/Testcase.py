...
class Testcase(object):
    ...
    def __init__(self, template):
        """Construct instance by storing template string.

        :param template: Template string to generate test case code with.
            ...
            - frame_lower - Framesize in lowercase, example: "74b".
            - frame_num - Framesize as a number, example: "${74}".
            - frame_upper - Framesize in upper case, example: "74B".
            - tc_num - Start of testcase name, example: "tc04".
        """
        self.template = Template(template)

    def generate(self, num, framesize, cores):
        ...
        :param cores: Number of cores to use. Example: 2.
        :type num: int
        ...
        try:
            ...
            subst_dict = {
                "frame_lower": "%db" % fs,
                "frame_num": "${%d}" % fs,  # Avoiding .format with curlies.
                "frame_upper": "%dB" % fs
            }
        except ValueError:  # IMIX string.
            subst_dict = {
                "frame_lower": "imix",
