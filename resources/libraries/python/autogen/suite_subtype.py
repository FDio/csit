...
import resources.libraries.python.autogen.kwargs
import resources.libraries.python.autogen.test_case
...
SuiteSubtypeTuple = namedtuple(u"SuiteSubtypeTuple", u" ".join(fields))
...
class SuiteSubtype(Enum):
    ...
    STATELESS_PERF = SuiteSubtypeTuple(
        ...
        testcase_factory=test_case.default,
    ...
    HTTP_PERF = SuiteSubtypeTuple(
        ...
        testcase_factory=test_case.tcp,
    ...
    IPERF3_MRR = SuiteSubtypeTuple(
        ...
        testcase_factory=test_case.iperf3,
    ...
    def from_filename(filename):
        ...
        if filename.endswith(u"-ndrpdr.robot"):
            if u"scheduler" in filename:
                return SCHEDULER_PERF
            return STATELESS_PERF
