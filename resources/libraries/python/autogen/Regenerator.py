...
def add_default_testcase(testcase, iface, suite_id, file_out, num, **kwargs):
    """Add default testcase to file.
...
def add_tcp_testcase(testcase, file_out, num, **kwargs):
    """Add TCP testcase to file.
...
def add_tcp_testcases(testcase, file_out, tc_kwargs_list):
    ...
    num = 1
    for tc_kwargs in tc_kwargs_list:
        num = add_tcp_testcase(testcase, file_out, num, **tc_kwargs)
