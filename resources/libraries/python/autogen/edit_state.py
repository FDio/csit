...
class EditState:
    ...
    def get_iface_and_suite_ids(self):
        ...
        """
        dash_split = self.filename.split(u"-", 1)
    ...
    def check_suite_tag_and_add_suite_id(self, suite_ids):
        """Verify suite tag occurres once in prolog, add suite ID to list.

        Fail if the suite ID is already in the list.
