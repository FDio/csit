...
class NATUtil:
    ...
    @staticmethod
    def compute_max_sessions(sessions):
        """Compute maximum number of sessions for NAT44 as a power of two.

        :param sessions: Required number of NAT44 sessions.
        :type sessions: int
        :returns: Maximum number of sessions.
        :rtype: int
        """
        rest, mult = modf(log2(int(sessions)/10))
