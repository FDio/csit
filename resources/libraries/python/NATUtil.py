...
class NATUtil:
    ...
    def get_nat44_sessions_number(node, proto):
        ...
        The 2202 output reports most of tcp sessions as timed-out,
        but the previous CSIT logic tolerated that,
        so this implementation also counts 2202 timed-out sessions
        as active.
