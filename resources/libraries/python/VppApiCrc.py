...
class VppApiCrcChecker(object):
    ...
    def _register_all(self):
        ...
        # TODO: Rework to read from files?

        # Collection with Centos build available,
        # but without https://gerrit.fd.io/r/c/vpp/+/20997
        ...
        # Collection with https://gerrit.fd.io/r/c/vpp/+/20997
        # but without Centos build available,
        self._register_collection(
