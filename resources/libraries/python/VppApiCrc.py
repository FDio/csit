    ...
    def _register_all(self):
        ...
        self._register_collection(
            "19.08-rc0~663-g692b9498e", {
                ...
                "classify_add_del_session": "0x85fd79f4",
                "classify_add_del_table": "0x9bd794ae",
                "cli_inband": "0xb1ad59b3",  # device setup
                "cli_inband_reply": "0x6d3c80a4",  # device setup
                "create_loopback": "0x3b54129c",
                "create_vhost_user_if": "0xbd230b87",
                "create_vlan_subif": "0x70cadeda",
                "create_subif": "0x86cfe408",
                "gre_tunnel_add_del": "0x04199f47",
                "hw_interface_set_mtu": "0x132da1e7",
                "input_acl_set_interface": "0xe09537b0",
                "ip_address_dump": "0x6b7bcd0a",
                "ip_probe_neighbor": "0x2736142d",
                "ip_route_add_del": "0x83e086ce",
                "ip_source_check_interface_add_del": "0x0a60152a",
                "ip_table_add_del": "0xe5d378f2",
                "ip_neighbor_add_del": "0x7a68a3c4",
                ...
                "show_version": "0x51077d14",  # device setup
                "show_version_reply": "0xb9bcf6df",  # device setup
                "show_threads": "0x51077d14",
                "sw_interface_add_del_address": "0x7b583179",
                "sw_interface_dump": "0x052753c5",  # device setup
                "sw_interface_details": "0xe4ee7eb6",  # device setup
                "sw_interface_ip6nd_ra_config": "0xc3f02daa",
                "sw_interface_rx_placement_dump": "0x529cb13f",  # perf
                "sw_interface_set_flags": "0x555485f5",  # device
                "sw_interface_set_flags_reply": "0xe8d4e804",  # device
                "sw_interface_set_l2_bridge": "0x5579f809",
                "sw_interface_set_l2_xconnect": "0x95de3988",
                "sw_interface_set_rx_placement": "0x4ef4377d",  # perf teardown?
