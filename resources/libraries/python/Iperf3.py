...
class Iperf3:
    ...
    def start_iperf_server(
        ...
        cmd = IPerf3Server.iperf3_cmdline(
            bind=bind, bind_gw=bind_gw, bind_mask=bind_mask,
            interface=interface, namespace=namespace, port=port,
            affinity=affinity)
        exec_cmd_no_error(
    ...
    def iperf_client_start_remote_exec(
        ...
        cmd = IPerf3Client.iperf3_cmdline(
            duration=duration, rate=rate, frame_size=frame_size,
            async_call=async_call, warmup_time=warmup_time,
            traffic_directions=1, namespace=namespace, udp=udp,
            bind=bind, affinity=self._c_affinity)
...
class IPerf3Server:
    ...
    @staticmethod
    def iperf3_cmdline(
            bind, bind_gw, bind_mask, interface, namespace=None, port=5201,
            affinity=None):
...
class IPerf3Client:
    ...
    @staticmethod
    def iperf3_cmdline(
            duration, rate=None, frame_size=None, async_call=False,
            warmup_time=5.0, traffic_directions=1, namespace=None, udp=False,
            bind=None, affinity=None):
        """Get iPerf3 client driver command line.
        ...
        :param namespace: Namespace to execute iPerf3 client on.
        :param udp: UDP traffic.
        :param bind: iPerf3 server IP address.
        :param affinity: iPerf3 server affinity.
        :type duration: float
        :type rate: str
        :type frame_size: str
        ...
        :type bind: str
        :type affinity: str
        :returns: iPerf3 client driver command line.
        :rtype: str
        """
        if not isinstance(duration, (float, int)):
            duration = float(duration)
        ...
        cmd_options = OptionString(prefix=u"--")
        cmd_options.add_with_value(u"bind", bind)
        ...
        cmd_options.add_with_value_if(u"frame_size", frame_size, frame_size)
        cmd_options.add_with_value_if(u"port_netns", namespace, namespace)
        cmd_options.add_with_value_if(u"rate", rate, rate)
        cmd_options.add_with_value_if(u"affinity", affinity, affinity)
