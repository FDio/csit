...
class Iperf3:
    ...
    def initialize_iperf_server(
            node, if1, if2, interface, bind, bind_gw, bind_mask,
        ...
        exec_cmd_no_error(
            ...
            f"EOF'", sudo=True, message=u"iPerf3 config generation!"
        )
        ...
        exec_cmd_no_error(
            ...
            f"sudo xargs -n 1 taskset -pc {s_affinity},{c_affinity}"
        )
    ...
    def iperf_client_start_remote_exec(
            node, duration, rate, frame_size, async_call=False, warmup_time=0,
