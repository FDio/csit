...
class IPerf3Client:
    ...
    def iperf3_cmdline(**kwargs):
        ...
        # Send bi- (2) or uni- (1) directional traffic. Currently only
        # uni- directional traffic is supported.
        cmd_options.add_with_value_from_dict(
        ...
        cmd_options.add_with_value_if_from_dict(
            u"frame_size", None, u"frame_size", kwargs, False)

        # Namespace to execute iPerf3 client on.
        cmd_options.add_with_value_if_from_dict(
            u"port_netns", None, u"namespace", kwargs, False)

        # Traffic rate expressed with units.
        cmd_options.add_with_value_if_from_dict(
            u"rate", None, u"rate", kwargs, False)

        # Set the CPU affinity, if possible.
        cmd_options.add_with_value_if_from_dict(
            u"affinity", None, u"affinity", kwargs, False)
