...
class SoakSearch(object):
    ...
    def __init__(self, measurer, tdpt, plr_target, initial_count=0, timeout=60.0):
        ...
        """Target average number of lost packets per ofered packet."""
...
#        zeros = 0
        ...
        while 1:
            ...
            self.lps_target = transmit_rate * self.plr_target
