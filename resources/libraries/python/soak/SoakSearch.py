...
class SoakSearch(object):
    ...
    def __init__(self, measurer, tdpt, lps_target, timeout, trim_period=4):
...
#                return average, stdev
            ...
            if trial_count % self.trim_period == 0:
                trial_result_list.sort(key=lambda item: item.target_tr)
