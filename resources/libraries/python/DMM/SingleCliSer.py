...
class SingleCliSer(object):
    ...
    @staticmethod
    def archive_dmm_logs(node):
        """Copy dmm log file from DUT node to VIRL for archiving.
        ...
        cmd = "cp /tmp/DMM-testing/tests/dmm/dmm_scripts/log_install_dmm.txt /scratch/"
