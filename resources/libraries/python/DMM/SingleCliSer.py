...
class SingleCliSer(object):
    ...
    @staticmethod
    def exec_the_base_vs_epoll_test(dut1_node, dut2_node, dut1_to_dut2_if_name,
                                    dut2_to_dut1_if_name):
    ...
    @staticmethod
    def exec_the_base_lwip_test(dut1_node, dut2_node, dut1_to_dut2_if_name,
                                dut2_to_dut1_if_name):
        """Test DMM with LWIP.
