...
class CpuUtils(object):
    ...
    def cpu_slice_of_list_for_nf(node, cpu_node, nf_chains=1, nf_nodes=1,
        ...
        :param nf_chain: Chain number.
        :param nf_node: Node number.
        :param vs_dtc: Amount of Dataplane threads of vswitch.
        :param nf_dtc: Amount of Dataplane threads per NF.
        ...
        # FIXME: Workaround as we are using physical core as main unit, we must
