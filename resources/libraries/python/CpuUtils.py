...
class CpuUtils:
    ...
    def get_affinity_iperf(
        ...
        :param pf_key: TG 1st interface. None to disable NUMA location awareness.
    ...
    def get_affinity_vhost(
        ...
        :param node: Topology node.
        :param pf_key: Topology interface. None to disable NUMA location awareness.
        ...
        :type skip_cnt: int
        :type cpu_cnt: int
        :returns: List of CPUs allocated to vhost.
        :rtype: str
        """
        if pf_key:
            cpu_node = Topology.get_interface_numa_node(node, pf_key)
