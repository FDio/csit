...
class L2Util(object):
    ...
    @staticmethod
    def l2_tag_rewrite(node, interface, tag_rewrite_method, push_dot1q_disable=False, tag1_id=None, tag2_id=None):
        ...
        :param push_dot1q_disable: Disable to push dot1q tag instead of dot1ad.
        :param tag1_id: Optional tag1 ID for VLAN.
        :param tag2_id: Optional tag2 ID for VLAN.
        :type node: dict
        :type interface: str or int
        :type tag_rewrite_method : str
        :type push_dot1q_disable : bool
        :type tag1_id: int
        :type tag2_id: int
        """
        if push_dot1q_disable is True:
            push_dot1q = ''
        else:
