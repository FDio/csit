...
class VppConfigGenerator(object):
    ...
    def apply_config(self, node, waittime=5, retries=12):
        ...
        vppconfig = VPP_CONFIG_TEMPLATE.format(cpuconfig=cpuconfig,
            pciconfig=pciconfig, socketmemconfig=socketmemconfig,
            heapsizeconfig=heapsizeconfig, rxqueuesconfig=rxqueuesconfig,
            txqueuesconfig=txqueuesconfig, nomultiseg = nomultiseg,
