...
class QemuManager:
    ...
    def _c_csr_ethip4ipsec40tnl_nat44ed_s64512(self, **kwargs):
        """Instantiate one VM with ethip4ipsec40tnl_nat44ed_s64512 configuration.
    ...
    def _c_vpp_2vfpt_ethip4ipsec40tnl_nat44ed_s64512(self, **kwargs):
        """Instantiate one VM with vpp_2vfpt_ethip4ipsec40tnl_nat44ed_s64512
        configuration.
