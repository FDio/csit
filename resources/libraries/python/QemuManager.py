...
class QemuManager:
    ...
    def _c_csr_ip4base(self, **kwargs):
        """Instantiate one VM with csr_ip4base configuration.
        ...
        self.machines[name].add_drive(
            drive_file=f"/var/lib/vm/{kwargs['vnf']}.qcow2",
    ...
    def _c_csr_ip4scale2k(self, **kwargs):
        """Instantiate one VM with csr_ip4scale2k configuration.

        :param kwargs: Named parameters.
        :type kwargs: dict
        """
        self._c_csr_ip4base(**kwargs)

    def _c_csr_ip4scale20k(self, **kwargs):
        """Instantiate one VM with csr_ip4scale20k configuration.
    ...
    def _c_csr_ip4scale200k(self, **kwargs):
        """Instantiate one VM with csr_ip4scale200k configuration.
    ...
    def _c_csr_ethip4ipsec1tnl(self, **kwargs):
        """Instantiate one VM with csr_ethip4ipsec1tnl configuration.
    ...
    def _c_csr_ethip4ipsec40tnl(self, **kwargs):
        """Instantiate one VM with csr_ethip4ipsec40tnl configuration.
    ...
    def _c_vpp_2vfpt_ip4base(self, **kwargs):
        """Instantiate one VM with vpp_2vfpt_ip4base configuration.
        ...
        if u"DUT1" in name:
            self.machines[name].configure_kernelvm_vnf(
                ip1=u"1.1.1.1/30",
                ip2=u"10.10.10.1/24",
                route1=u"20.20.20.0/24",
                routeif1=u"avf-0/0/3/0",
                nexthop1=u"1.1.1.2",
                arpmac1=u"3c:fd:fe:d1:5c:d8",
                arpip1=u"10.10.10.2",
                arpif1=u"avf-0/0/4/0",
                queues=kwargs[u"queues"],
                jumbo_frames=kwargs[u"jumbo"]
            )
        else:
            self.machines[name].configure_kernelvm_vnf(
                ip1=u"20.20.20.1/24",
                ip2=u"1.1.1.2/30",
                route1=u"10.10.10.0/24",
                routeif1=u"avf-0/0/4/0",
                nexthop1=u"1.1.1.1",
                arpmac1=u"3c:fd:fe:d1:5c:d9",
                arpip1=u"20.20.20.2",
                arpif1=u"avf-0/0/3/0",
                queues=kwargs[u"queues"],
                jumbo_frames=kwargs[u"jumbo"]
            )
        self.machines[name].add_vfio_pci_if(
    ...
    def _c_vpp_2vfpt_ip4scale2k(self, **kwargs):
        """Instantiate one VM with vpp_2vfpt_ip4scale2k configuration.
        ...
        if u"DUT1" in name:
            self.machines[name].configure_kernelvm_vnf(
                ip1=u"2.2.2.1/30",
                ip2=u"1.1.1.2/30",
                route1=u"20.0.0.0/32",
                routeif1=u"avf-0/0/3/0",
                nexthop1=u"2.2.2.2",
                route2=u"10.0.0.0/32",
                routeif2=u"avf-0/0/4/0",
                nexthop2=u"1.1.1.1",
                arpmac1=u"3c:fd:fe:d1:5c:d8",
                arpip1=u"1.1.1.1",
                arpif1=u"avf-0/0/4/0",
            ...
            self.machines[name].configure_kernelvm_vnf(
                ip1=u"3.3.3.2/30",
                ip2=u"2.2.2.2/30",
                route1=u"10.0.0.0/32",
                routeif1=u"avf-0/0/4/0",
                nexthop1=u"2.2.2.1",
                route2=u"20.0.0.0/32",
                routeif2=u"avf-0/0/3/0",
                nexthop2=u"3.3.3.1",
                arpmac1=u"3c:fd:fe:d1:5c:d9",
                arpip1=u"3.3.3.1",
                arpif1=u"avf-0/0/3/0",
    ...
    def _c_vpp_2vfpt_ip4scale20k(self, **kwargs):
        """Instantiate one VM with vpp_2vfpt_ip4scale20k configuration.
    ...
    def _c_vpp_2vfpt_ip4scale200k(self, **kwargs):
        """Instantiate one VM with vpp_2vfpt_ip4scale200k configuration.
    ...
    def _c_vpp_2vfpt_ethip4ipsec1tnl(self, **kwargs):
        """Instantiate one VM with vpp_2vfpt_ethip4ipsec1tnl configuration.
        ...
        if u"DUT1" in name:
            self.machines[name].configure_kernelvm_vnf(
                ...
                ipsec=\
                    ...
                    u"set interface unnumbered ipip0 use avf-0/0/3/0 \n" \
                    u"set interface state ipip0 up \n" \
                    u"ip route add 20.0.0.0/32 via ipip0 \n",
                queues=kwargs[u"queues"],
                jumbo_frames=kwargs[u"jumbo"]
            )
        else:
            self.machines[name].configure_kernelvm_vnf(
                ...
                ipsec=\
                    ...
                    u"ip route add 100.0.0.1/8 via 200.0.0.1 avf-0/0/4/0 \n" \
                    u"set interface unnumbered ipip0 use avf-0/0/4/0 \n" \
                    u"set interface state ipip0 up \n" \
                    u"ip route add 10.0.0.0/32 via ipip0 \n",
                queues=kwargs[u"queues"],
                jumbo_frames=kwargs[u"jumbo"]
            )
        self.machines[name].add_vfio_pci_if(
    ...
    def _c_vpp_2vfpt_ethip4ipsec40tnl(self, **kwargs):
        """Instantiate one VM with vpp_2vfpt_ethip4ipsec40tnl configuration.
        ...
        if u"DUT1" in name:
            self.machines[name].configure_kernelvm_vnf(
                ...
                ipsec=\
                    ...
                    u"set interface unnumbered ipip1 use avf-0/0/3/0 \n"
                    u"set interface state ipip1 up \n"
                    u"ip route add 20.0.0.1/32 via ipip1 \n"
                    ...
                    u"set interface unnumbered ipip2 use avf-0/0/3/0 \n"
                    u"set interface state ipip2 up \n"
                    u"ip route add 20.0.0.2/32 via ipip2 \n"
                    ...
                    u"set interface unnumbered ipip3 use avf-0/0/3/0 \n"
                    u"set interface state ipip3 up \n"
                    u"ip route add 20.0.0.3/32 via ipip3 \n"
                    ...
                    u"set interface unnumbered ipip4 use avf-0/0/3/0 \n"
                    u"set interface state ipip4 up \n"
                    u"ip route add 20.0.0.4/32 via ipip4 \n"
                    ...
                    u"set interface unnumbered ipip5 use avf-0/0/3/0 \n"
                    u"set interface state ipip5 up \n"
                    u"ip route add 20.0.0.5/32 via ipip5 \n"
                    ...
                    u"set interface unnumbered ipip6 use avf-0/0/3/0 \n"
                    u"set interface state ipip6 up \n"
                    u"ip route add 20.0.0.6/32 via ipip6 \n"
                    ...
                    u"set interface unnumbered ipip7 use avf-0/0/3/0 \n"
                    u"set interface state ipip7 up \n"
                    u"ip route add 20.0.0.7/32 via ipip7 \n"
                    ...
                    u"set interface unnumbered ipip8 use avf-0/0/3/0 \n"
                    u"set interface state ipip8 up \n"
                    u"ip route add 20.0.0.8/32 via ipip8 \n"
                    ...
                    u"set interface unnumbered ipip9 use avf-0/0/3/0 \n"
                    u"set interface state ipip9 up \n"
                    u"ip route add 20.0.0.9/32 via ipip9 \n"
                    ...
                    u"set interface unnumbered ipip10 use avf-0/0/3/0 \n"
                    u"set interface state ipip10 up \n"
                    u"ip route add 20.0.0.10/32 via ipip10 \n"
                    ...
                    u"set interface unnumbered ipip11 use avf-0/0/3/0 \n"
                    u"set interface state ipip11 up \n"
                    u"ip route add 20.0.0.11/32 via ipip11 \n"
                    ...
                    u"set interface unnumbered ipip12 use avf-0/0/3/0 \n"
                    u"set interface state ipip12 up \n"
                    u"ip route add 20.0.0.12/32 via ipip12 \n"
                    ...
                    u"set interface unnumbered ipip13 use avf-0/0/3/0 \n"
                    u"set interface state ipip13 up \n"
                    u"ip route add 20.0.0.13/32 via ipip13 \n"
                    ...
                    u"set interface unnumbered ipip14 use avf-0/0/3/0 \n"
                    u"set interface state ipip14 up \n"
                    u"ip route add 20.0.0.14/32 via ipip14 \n"
                    ...
                    u"set interface unnumbered ipip15 use avf-0/0/3/0 \n"
                    u"set interface state ipip15 up \n"
                    u"ip route add 20.0.0.15/32 via ipip15 \n"
                    ...
                    u"set interface unnumbered ipip16 use avf-0/0/3/0 \n"
                    u"set interface state ipip16 up \n"
                    u"ip route add 20.0.0.16/32 via ipip16 \n"
                    ...
                    u"set interface unnumbered ipip17 use avf-0/0/3/0 \n"
                    u"set interface state ipip17 up \n"
                    u"ip route add 20.0.0.17/32 via ipip17 \n"
                    ...
                    u"set interface unnumbered ipip18 use avf-0/0/3/0 \n"
                    u"set interface state ipip18 up \n"
                    u"ip route add 20.0.0.18/32 via ipip18 \n"
                    ...
                    u"set interface unnumbered ipip19 use avf-0/0/3/0 \n"
                    u"set interface state ipip19 up \n"
                    u"ip route add 20.0.0.19/32 via ipip19 \n"
                    ...
                    u"set interface unnumbered ipip20 use avf-0/0/3/0 \n"
                    u"set interface state ipip20 up \n"
                    u"ip route add 20.0.0.20/32 via ipip20 \n"
                    ...
                    u"set interface unnumbered ipip21 use avf-0/0/3/0 \n"
                    u"set interface state ipip21 up \n"
                    u"ip route add 20.0.0.21/32 via ipip21 \n"
                    ...
                    u"set interface unnumbered ipip22 use avf-0/0/3/0 \n"
                    u"set interface state ipip22 up \n"
                    u"ip route add 20.0.0.22/32 via ipip22 \n"
                    ...
                    u"set interface unnumbered ipip23 use avf-0/0/3/0 \n"
                    u"set interface state ipip23 up \n"
                    u"ip route add 20.0.0.23/32 via ipip23 \n"
                    ...
                    u"set interface unnumbered ipip24 use avf-0/0/3/0 \n"
                    u"set interface state ipip24 up \n"
                    u"ip route add 20.0.0.24/32 via ipip24 \n"
                    ...
                    u"set interface unnumbered ipip25 use avf-0/0/3/0 \n"
                    u"set interface state ipip25 up \n"
                    u"ip route add 20.0.0.25/32 via ipip25 \n"
                    ...
                    u"set interface unnumbered ipip26 use avf-0/0/3/0 \n"
                    u"set interface state ipip26 up \n"
                    u"ip route add 20.0.0.26/32 via ipip26 \n"
                    ...
                    u"set interface unnumbered ipip27 use avf-0/0/3/0 \n"
                    u"set interface state ipip27 up \n"
                    u"ip route add 20.0.0.27/32 via ipip27 \n"
                    ...
                    u"set interface unnumbered ipip28 use avf-0/0/3/0 \n"
                    u"set interface state ipip28 up \n"
                    u"ip route add 20.0.0.28/32 via ipip28 \n"
                    ...
                    u"set interface unnumbered ipip29 use avf-0/0/3/0 \n"
                    u"set interface state ipip29 up \n"
                    u"ip route add 20.0.0.29/32 via ipip29 \n"
                    ...
                    u"set interface unnumbered ipip30 use avf-0/0/3/0 \n"
                    u"set interface state ipip30 up \n"
                    u"ip route add 20.0.0.30/32 via ipip30 \n"
                    ...
                    u"set interface unnumbered ipip31 use avf-0/0/3/0 \n"
                    u"set interface state ipip31 up \n"
                    u"ip route add 20.0.0.31/32 via ipip31 \n"
                    ...
                    u"set interface unnumbered ipip32 use avf-0/0/3/0 \n"
                    u"set interface state ipip32 up \n"
                    u"ip route add 20.0.0.32/32 via ipip32 \n"
                    ...
                    u"set interface unnumbered ipip33 use avf-0/0/3/0 \n"
                    u"set interface state ipip33 up \n"
                    u"ip route add 20.0.0.33/32 via ipip33 \n"
                    ...
                    u"set interface unnumbered ipip34 use avf-0/0/3/0 \n"
                    u"set interface state ipip34 up \n"
                    u"ip route add 20.0.0.34/32 via ipip34 \n"
                    ...
                    u"set interface unnumbered ipip35 use avf-0/0/3/0 \n"
                    u"set interface state ipip35 up \n"
                    u"ip route add 20.0.0.35/32 via ipip35 \n"
                    ...
                    u"set interface unnumbered ipip36 use avf-0/0/3/0 \n"
                    u"set interface state ipip36 up \n"
                    u"ip route add 20.0.0.36/32 via ipip36 \n"
                    ...
                    u"set interface unnumbered ipip37 use avf-0/0/3/0 \n"
                    u"set interface state ipip37 up \n"
                    u"ip route add 20.0.0.37/32 via ipip37 \n"
                    ...
                    u"set interface unnumbered ipip38 use avf-0/0/3/0 \n"
                    u"set interface state ipip38 up \n"
                    u"ip route add 20.0.0.38/32 via ipip38 \n"
                    ...
                    u"set interface unnumbered ipip39 use avf-0/0/3/0 \n"
                    u"set interface state ipip39 up \n"
                    u"ip route add 20.0.0.39/32 via ipip39 \n",
                queues=kwargs[u"queues"],
                jumbo_frames=kwargs[u"jumbo"]
            )
        else:
            self.machines[name].configure_kernelvm_vnf(
                ...
                ipsec=\
                    u"create ipsec tunnel local-spi 20000 remote-spi 10000 crypto-alg aes-gcm-128 local-crypto-key 4f484443536343634b614f4452437747 remote-crypto-key 4f484443536343634b614f4452437747 local-ip 200.0.0.2 remote-ip 100.0.0.1 instance 0 salt 0x0 \n"
                    u"ip route add 100.0.0.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip0 use avf-0/0/4/0 \n"
                    u"set interface state ipip0 up \n"
                    u"ip route add 10.0.0.0/32 via ipip0 \n"
                    ...
                    u"ip route add 100.0.1.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip1 use avf-0/0/4/0 \n"
                    u"set interface state ipip1 up \n"
                    u"ip route add 10.0.0.1/32 via ipip1 \n"
                    ...
                    u"ip route add 100.0.2.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip2 use avf-0/0/4/0 \n"
                    u"set interface state ipip2 up \n"
                    u"ip route add 10.0.0.2/32 via ipip2 \n"
                    ...
                    u"ip route add 100.0.3.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip3 use avf-0/0/4/0 \n"
                    u"set interface state ipip3 up \n"
                    u"ip route add 10.0.0.3/32 via ipip3 \n"
                    ...
                    u"ip route add 100.0.4.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip4 use avf-0/0/4/0 \n"
                    u"set interface state ipip4 up \n"
                    u"ip route add 10.0.0.4/32 via ipip4 \n"
                    ...
                    u"ip route add 100.0.5.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip5 use avf-0/0/4/0 \n"
                    u"set interface state ipip5 up \n"
                    u"ip route add 10.0.0.5/32 via ipip5 \n"
                    ...
                    u"ip route add 100.0.6.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip6 use avf-0/0/4/0 \n"
                    u"set interface state ipip6 up \n"
                    u"ip route add 10.0.0.6/32 via ipip6 \n"
                    ...
                    u"ip route add 100.0.7.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip7 use avf-0/0/4/0 \n"
                    u"set interface state ipip7 up \n"
                    u"ip route add 10.0.0.7/32 via ipip7 \n"
                    ...
                    u"ip route add 100.0.8.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip8 use avf-0/0/4/0 \n"
                    u"set interface state ipip8 up \n"
                    u"ip route add 10.0.0.8/32 via ipip8 \n"
                    ...
                    u"ip route add 100.0.9.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip9 use avf-0/0/4/0 \n"
                    u"set interface state ipip9 up \n"
                    u"ip route add 10.0.0.9/32 via ipip9 \n"
                    ...
                    u"ip route add 100.0.10.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip10 use avf-0/0/4/0 \n"
                    u"set interface state ipip10 up \n"
                    u"ip route add 10.0.0.10/32 via ipip10 \n"
                    ...
                    u"ip route add 100.0.11.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip11 use avf-0/0/4/0 \n"
                    u"set interface state ipip11 up \n"
                    u"ip route add 10.0.0.11/32 via ipip11 \n"
                    ...
                    u"ip route add 100.0.12.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip12 use avf-0/0/4/0 \n"
                    u"set interface state ipip12 up \n"
                    u"ip route add 10.0.0.12/32 via ipip12 \n"
                    ...
                    u"ip route add 100.0.13.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip13 use avf-0/0/4/0 \n"
                    u"set interface state ipip13 up \n"
                    u"ip route add 10.0.0.13/32 via ipip13 \n"
                    ...
                    u"ip route add 100.0.14.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip14 use avf-0/0/4/0 \n"
                    u"set interface state ipip14 up \n"
                    u"ip route add 10.0.0.14/32 via ipip14 \n"
                    ...
                    u"ip route add 100.0.15.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip15 use avf-0/0/4/0 \n"
                    u"set interface state ipip15 up \n"
                    u"ip route add 10.0.0.15/32 via ipip15 \n"
                    ...
                    u"ip route add 100.0.16.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip16 use avf-0/0/4/0 \n"
                    u"set interface state ipip16 up \n"
                    u"ip route add 10.0.0.16/32 via ipip16 \n"
                    ...
                    u"ip route add 100.0.17.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip17 use avf-0/0/4/0 \n"
                    u"set interface state ipip17 up \n"
                    u"ip route add 10.0.0.17/32 via ipip17 \n"
                    ...
                    u"ip route add 100.0.18.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip18 use avf-0/0/4/0 \n"
                    u"set interface state ipip18 up \n"
                    u"ip route add 10.0.0.18/32 via ipip18 \n"
                    ...
                    u"ip route add 100.0.19.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip19 use avf-0/0/4/0 \n"
                    u"set interface state ipip19 up \n"
                    u"ip route add 10.0.0.19/32 via ipip19 \n"
                    ...
                    u"ip route add 100.0.20.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip20 use avf-0/0/4/0 \n"
                    u"set interface state ipip20 up \n"
                    u"ip route add 10.0.0.20/32 via ipip20 \n"
                    ...
                    u"ip route add 100.0.21.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip21 use avf-0/0/4/0 \n"
                    u"set interface state ipip21 up \n"
                    u"ip route add 10.0.0.21/32 via ipip21 \n"
                    ...
                    u"ip route add 100.0.22.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip22 use avf-0/0/4/0 \n"
                    u"set interface state ipip22 up \n"
                    u"ip route add 10.0.0.22/32 via ipip22 \n"
                    ...
                    u"ip route add 100.0.23.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip23 use avf-0/0/4/0 \n"
                    u"set interface state ipip23 up \n"
                    u"ip route add 10.0.0.23/32 via ipip23 \n"
                    ...
                    u"ip route add 100.0.24.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip24 use avf-0/0/4/0 \n"
                    u"set interface state ipip24 up \n"
                    u"ip route add 10.0.0.24/32 via ipip24 \n"
                    ...
                    u"ip route add 100.0.25.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip25 use avf-0/0/4/0 \n"
                    u"set interface state ipip25 up \n"
                    u"ip route add 10.0.0.25/32 via ipip25 \n"
                    ...
                    u"ip route add 100.0.26.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip26 use avf-0/0/4/0 \n"
                    u"set interface state ipip26 up \n"
                    u"ip route add 10.0.0.26/32 via ipip26 \n"
                    ...
                    u"ip route add 100.0.27.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip27 use avf-0/0/4/0 \n"
                    u"set interface state ipip27 up \n"
                    u"ip route add 10.0.0.27/32 via ipip27 \n"
                    ...
                    u"ip route add 100.0.28.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip28 use avf-0/0/4/0 \n"
                    u"set interface state ipip28 up \n"
                    u"ip route add 10.0.0.28/32 via ipip28 \n"
                    ...
                    u"ip route add 100.0.29.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip29 use avf-0/0/4/0 \n"
                    u"set interface state ipip29 up \n"
                    u"ip route add 10.0.0.29/32 via ipip29 \n"
                    ...
                    u"ip route add 100.0.30.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip30 use avf-0/0/4/0 \n"
                    u"set interface state ipip30 up \n"
                    u"ip route add 10.0.0.30/32 via ipip30 \n"
                    ...
                    u"ip route add 100.0.31.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip31 use avf-0/0/4/0 \n"
                    u"set interface state ipip31 up \n"
                    u"ip route add 10.0.0.31/32 via ipip31 \n"
                    ...
                    u"ip route add 100.0.32.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip32 use avf-0/0/4/0 \n"
                    u"set interface state ipip32 up \n"
                    u"ip route add 10.0.0.32/32 via ipip32 \n"
                    ...
                    u"ip route add 100.0.33.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip33 use avf-0/0/4/0 \n"
                    u"set interface state ipip33 up \n"
                    u"ip route add 10.0.0.33/32 via ipip33 \n"
                    ...
                    u"ip route add 100.0.34.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip34 use avf-0/0/4/0 \n"
                    u"set interface state ipip34 up \n"
                    u"ip route add 10.0.0.34/32 via ipip34 \n"
                    ...
                    u"ip route add 100.0.35.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip35 use avf-0/0/4/0 \n"
                    u"set interface state ipip35 up \n"
                    u"ip route add 10.0.0.35/32 via ipip35 \n"
                    ...
                    u"ip route add 100.0.36.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip36 use avf-0/0/4/0 \n"
                    u"set interface state ipip36 up \n"
                    u"ip route add 10.0.0.36/32 via ipip36 \n"
                    ...
                    u"ip route add 100.0.37.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip37 use avf-0/0/4/0 \n"
                    u"set interface state ipip37 up \n"
                    u"ip route add 10.0.0.37/32 via ipip37 \n"
                    ...
                    u"ip route add 100.0.38.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip38 use avf-0/0/4/0 \n"
                    u"set interface state ipip38 up \n"
                    u"ip route add 10.0.0.38/32 via ipip38 \n"
                    ...
                    u"ip route add 100.0.39.1/24 via 200.0.0.1 avf-0/0/4/0 \n"
                    u"set interface unnumbered ipip39 use avf-0/0/4/0 \n"
                    u"set interface state ipip39 up \n"
                    u"ip route add 10.0.0.39/32 via ipip39 \n",
                queues=kwargs[u"queues"],
                jumbo_frames=kwargs[u"jumbo"]
            )
        self.machines[name].add_vfio_pci_if(
    ...
    def _c_vpp_2vfpt_ethip4_nat44ed_h1024_p63_s64512(self, **kwargs):
        """Instantiate one VM with vpp_2vfpt_ethip4-nat44ed-h1024-p63-s64512
        configuration.
        ...
        if u"DUT1" in name:
            ...
            self.machines[name].configure_kernelvm_vnf(
                ...
                arpif1=u"avf-0/0/3/0",
                nat=u"" \
                    u"set interface nat44 in avf-0/0/4/0 out avf-0/0/3/0 \n"
