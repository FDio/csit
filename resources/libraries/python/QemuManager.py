...
class QemuManager:
    ...
    def construct_vms_on_node(self, **kwargs):
        ...
        for nf_chain in range(1, nf_chains + 1):
            for nf_node in range(1, nf_nodes + 1):
                qemu_id = kwargs.pop(
                    u"qemu_id", (nf_chain - 1) * nf_nodes + nf_node)
    ...
    def _c_iperf3_server(self, **kwargs):
        """Instantiate one VM with iperf3_server configuration.
    ...
    def _c_iperf3_client(self, **kwargs):
        """Instantiate one VM with iperf3_client configuration.
