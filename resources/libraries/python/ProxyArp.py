...
class ProxyArp(object):
    ...
    @staticmethod
    def vpp_proxy_arp_add_del(node, lo_ip4_addr, hi_ip4_addr):
        """Enable proxy ARP on a range addresses.
        ...
        with VatTerminal(node) as vat:
            vat.vat_terminal_exec_cmd_from_template("proxy_arp_add_del.vat",
