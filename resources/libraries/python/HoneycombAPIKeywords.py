...
class OperationsKeywords(object):
    ...
    def poll_oper_data(node):
        ...
        Note: This is not very reliable way how to poll operational data. This
        keyword is only temporary workaround and will be removed when this
...
class InterfaceKeywords(object):
    ...
    @staticmethod
    def get_cfg_info_about_all_vpp_interfaces(node):
    ...
    @staticmethod
    def get_cfg_info_about_vpp_interface(node, interface):
        ...
        intfs = InterfaceKeywords.get_cfg_info_about_all_vpp_interfaces(node)
        for intf in intfs:
    ...
    @staticmethod
    def get_oper_info_about_all_vpp_interfaces(node):
    ...
    @staticmethod
    def get_oper_info_about_vpp_interface(node, interface):
        ...
        intfs = InterfaceKeywords.get_oper_info_about_all_vpp_interfaces(node)
        for intf in intfs:
            if intf["name"] == interface:
                return intf
        return {}
    ...
    @staticmethod
    def add_bridge_domain_to_interface(node, interface, brd_name,
                                       split_horizon_group=None,
                                       bridged_virtual_interface=None):
        """Add a new bridge domain to an interface and set its parameters.

        :param node: Honeycomb node.
        :param interface: The name of interface.
        :param brd_name: Bridge domain name.
        :param split_horizon_group: Split-horizon group name.
        :param bridged_virtual_interface: The bridged virtual interface.
        :type node: dict
        :type interface: str
        :type brd_name: str
        :type split_horizon_group: str
        :type bridged_virtual_interface: str
        :return: Content of response.
        :rtype: bytearray
        :raises HoneycombError: If the interface is not present on the node.
        """
        ...
        intfs = InterfaceKeywords.get_cfg_info_about_all_vpp_interfaces(node)
        v3po_l2 = {"bridge-domain": str(brd_name)}
        if split_horizon_group:
            v3po_l2["split-horizon-group"] = str(split_horizon_group)
        if bridged_virtual_interface:
            v3po_l2["bridged-virtual-interface"] = \
                str(bridged_virtual_interface)
        for intf in intfs:
            if intf["name"] == interface:
...
class BridgeDomainKeywords(object):
    ...
    @staticmethod
    def _create_json_bridge_domain_info(name="brd_name", **kwargs):
    ...
    @staticmethod
    def create_bridge_domain(node, name="brd_name", flood=True,
                             forward=True, learn=True, uu_flood=True,
        ...
        existing_brds = BridgeDomainKeywords.\
            get_cfg_info_about_all_bridge_domains(node, True)
    ...
    @staticmethod
    def get_oper_info_about_all_bridge_domains(node):
    ...
    @staticmethod
    def get_oper_info_about_bridge_domain(node, name):
        ...
        br_domains = BridgeDomainKeywords.\
            get_oper_info_about_all_bridge_domains(node)
    ...
    @staticmethod
    def get_cfg_info_about_all_bridge_domains(node, ignore_404=False):
    ...
    @staticmethod
    def get_cfg_info_about_bridge_domain(node, name):
        ...
        br_domains = BridgeDomainKeywords.\
            get_cfg_info_about_all_bridge_domains(node)
        for br_domain in br_domains:
            if br_domain["name"] == name:
                return br_domain
        return {}
