...
class DpdkUtil:
    ...
    def get_testpmd_pmd_options(**kwargs):
        ...
        options.add_if_from_dict(
            u"disable-link-check", u"pmd_disable_link_check", kwargs
        )
        ...
        options.add_if_from_dict(
            u"no-lsc-interrupt", u"pmd_no_lsc_interrupt", kwargs
        )
    ...
    def start_dpdk_app_on_all_duts(
        start_function, check_function, nodes, topology_info, phy_cores,
        rx_queues, jumbo_frames, rxd, txd,
    ):
        """
