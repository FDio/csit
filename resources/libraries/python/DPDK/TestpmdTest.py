...
class TestpmdTest:
    ...
    @staticmethod
    def start_testpmd(node, if1_pci, if2_pci, compute_info, jumbo):
        ...
        :param compute_info: Output of CpuUtils.get_affinity_vswitch.
        :param jumbo: Indication if the jumbo frames are used (True) or
            not (False).
        :type node: dict
        :type if1_pci: str
        :type if2_pci: str
        :type compute_info: dict
        :type jumbo: bool
        ...
        testpmd_args = DpdkUtil.get_testpmd_args(
            ...
            pmd_rxd=compute_info[u"rxd_count_int"],
            pmd_txd=compute_info[u"txd_count_int"],
            pmd_rxq=compute_info[u"rxq_count_int"],
            pmd_txq=compute_info[u"rxq_count_int"],
            pmd_nb_cores=compute_info[u"dp_count_int"],
