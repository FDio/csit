...
class L3fwdTest:
    ...
    def start_l3fwd_on_all_duts(
        ...
        def start_function(dut_name):
            """Call start_l3fwd with added static arguments.

            FIXME: params, types.
            """
            dut_node, if1, if2, cpu_dp, dp_count, rxq_count = DpdkUtil._vals(
                nodes=nodes,
                dut_name=dut_name,
        ...
        start_dpdk_app_on_all_duts(
            start_function=start_function,
            check_function=L3fwdTest.is_l3fwd_ready,
            nodes=nodes,
            topology_info=topology_info,
            phy_cores=phy_cores,
            rx_queues=rx_queues,
    ...
    @staticmethod
    def get_adj_mac(nodes: dict, node: dict, if1: str, if2: str) -> None:
        """
