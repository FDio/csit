...
class WireGuardUtil:
    ...
    def _wireguard_create_tunnel_interface_on_dut(
            ...
            keepalive_time, raddr_range, dut_private_key, peer_pubkey):
            ...
            traffic_addr = ip_address(
                peer_allowed_ips[0][u'address'][u'un'][u'ip4']
            )
            prefix_len = peer_allowed_ips[0][u'len']
    ...
    def vpp_wireguard_create_tunnel_interface_on_duts(
            ...
            WireGuardUtil._wireguard_create_tunnel_interface_on_dut(
                ...
                keepalive_time, raddr_range, dut1_privatekey, dut2_pubkey
            )
            ...
            WireGuardUtil._wireguard_create_tunnel_interface_on_dut(
                ...
                keepalive_time, raddr_range, dut2_privatekey, dut1_pubkey
            )
