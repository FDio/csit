...
class WireGuardUtil:
    ...
    def _wireguard_create_tunnel_interface_on_dut(
            ...
            :param raddr_ip: Policy selector remote IPv4/IPv6 start address for 
                the first tunnel in direction node2->node1(in dut1)
                node1->node2(in dut2).
            :param raddr_range: Mask specifying range of Policy selector Remote
                IPv4/IPv6 addresses. Valid values are from 1 to 32 in case of
                IPv4 and to 128 in case of IPv6.
