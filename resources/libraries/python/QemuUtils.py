...
class QemuUtils(object):
    ...
    def __init__(self, qemu_id=1):
        ...
        self._qmp_sock = '/tmp/qmp{}.sock'.format(self._qemu_id)
        # QEMU Guest Agent socket
        self._qga_sock = '/tmp/qga{}.sock'.format(self._qemu_id)
        self._qemu_opt = {}
        # Default 1 CPU.
    ...
    def qemu_start(self):
        ...
        qga = '-chardev socket,path={},server,nowait,id=qga0 ' \
