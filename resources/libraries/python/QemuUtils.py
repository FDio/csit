...
class QemuUtils(object):
    ...
    def create_kernelvm_config_vpp(self, **kwargs):
        ...
        #vpp_config.add_plugin('enable', 'abf_plugin.so')
        #vpp_config.add_plugin('enable', 'acl_plugin.so')
        #vpp_config.add_plugin('enable', 'avf_plugin.so')
        #vpp_config.add_plugin('enable', 'cdp_plugin.so')
        ...
        #vpp_config.add_plugin('enable', 'ct6_plugin.so')
        vpp_config.add_plugin('enable', 'dpdk_plugin.so')
        #vpp_config.add_plugin('enable', 'flowprobe_plugin.so')
        ####vpp_config.add_plugin('enable', 'gbp_plugin.so')
        #vpp_config.add_plugin('enable', 'gtpu_plugin.so')
        #vpp_config.add_plugin('enable', 'hs_apps_plugin.so')
        #vpp_config.add_plugin('enable', 'http_static_plugin.so')
        #vpp_config.add_plugin('enable', 'igmp_plugin.so')
        #vpp_config.add_plugin('enable', 'ikev2_plugin.so')
        #vpp_config.add_plugin('enable', 'ila_plugin.so')
        #vpp_config.add_plugin('enable', 'ioam_plugin.so')
        #vpp_config.add_plugin('enable', 'ixge_plugin.so')
        #vpp_config.add_plugin('enable', 'l2e_plugin.so')
        #vpp_config.add_plugin('enable', 'l3xc_plugin.so')
        #vpp_config.add_plugin('enable', 'lacp_plugin.so')
        #vpp_config.add_plugin('enable', 'lb_plugin.so')
        vpp_config.add_plugin('enable', 'mactime_plugin.so')
        ##vpp_config.add_plugin('enable', 'map_plugin.so')
        vpp_config.add_plugin('enable', 'memif_plugin.so')
        vpp_config.add_plugin('enable', 'nat_plugin.so')
        vpp_config.add_plugin('enable', 'nsh_plugin.so')
        vpp_config.add_plugin('enable', 'nsim_plugin.so')
        vpp_config.add_plugin('enable', 'perfmon_plugin.so')
        vpp_config.add_plugin('enable', 'pppoe_plugin.so')
        vpp_config.add_plugin('enable', 'quic_plugin.so')
        vpp_config.add_plugin('enable', 'rdma_plugin.so')
        vpp_config.add_plugin('enable', 'sctp_plugin.so')
        ####vpp_config.add_plugin('enable', 'srv6ad_plugin.so')
        ####vpp_config.add_plugin('enable', 'srv6am_plugin.so')
        ####vpp_config.add_plugin('enable', 'srv6as_plugin.so')
        ####vpp_config.add_plugin('enable', 'stn_plugin.so')
        ####vpp_config.add_plugin('enable', 'svs_plugin.so')
        ####vpp_config.add_plugin('enable', 'tlsmbedtls_plugin.so')
        ####vpp_config.add_plugin('enable', 'tlsopenssl_plugin.so')
        ####vpp_config.add_plugin('enable', 'unittest_plugin.so')
        ####vpp_config.add_plugin('enable', 'vmxnet3_plugin.so')
