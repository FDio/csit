...
class QemuOptions(object):
    """QEMU option class to store various parameters. Class can store input
    parameters, QEMU command line parameters."""
    ...
    def __str__(self):
        """Return space separated string of key value pairs. String
        representation of all parameters prefixed by dash. This can be used for
        Qemu comand line for examaple.
