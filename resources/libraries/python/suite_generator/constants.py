...
DIR_TESTS_IN = "../../../.."
# The directory to store generated suites:
DIR_TESTS_OUT = "generated"
...
NIC_DRIVER_TO_TAG = {
    "vfio-pci": "DRV_VFIO_PCI",  # For backward compatibilty, "_" is prefered.
    "vfio_pci": "DRV_VFIO_PCI",
    "avf": "DRV_AVF",
    "rdma-core": "DRV_RDMA_CORE",
    "rdma_core": "DRV_RDMA_CORE",
    "mlx5-core": "DRV_MLX5_CORE",
...
NIC_DRIVER_TO_PLUGINS = {
    "vfio-pci": "dpdk_plugin.so",  # For backward compatibilty, "_" is prefered.
    "vfio_pci": "dpdk_plugin.so",
    "avf": "avf_plugin.so",
...
NIC_DRIVER_TO_VFS = {
    "vfio-pci": "nic_vfs}= | 0",  # For backward compatibilty, "_" is prefered.
    "vfio_pci": "nic_vfs}= | 0",
    "avf": "nic_vfs}= | 1",
    "rdma-core": "nic_vfs}= | 0",
    "mlx5_core": "nic_vfs}= | 0",
...
PERF_TYPE_TO_SUITE_DOC_VER = {
        "mrr": """rification:** In MaxReceivedRate tests TG sends traffic at \\
