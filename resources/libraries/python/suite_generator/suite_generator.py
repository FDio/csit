...
csit-2n-spr-perftest mrrANDnic_intel-e810cqANDdrv_avfAND1cAND64bANDeth-l2patch
...
def suite_generator(args) -> int:
    ...
    test_tag_string = args.test_tag_string
    ...
    logging.info(
        ...
        f"Test tag string: {test_tag_string}\n"
...
def parse_args():
    ...
    parser.add_argument(
        "--test-tag-string", required=False, type=str, default=str(),
        help=("The test tag string from trigger which triggered this build.")
    )
    parser.add_argument(
