...
https://jenkins.fd.io/view/vpp/job/vpp-csit-verify-perf-master-ubuntu2404-x86_64-2n-zn2/8/consoleFull
TEST_TAG_STRING='mrrANDnic_intel-xxv710ANDdrv_avfAND1cANDeth-l2patch !1518b !imix'
...
clear; ./suite_generator.py --gen-tests-dir generated --job csit-vpp-perf-report-iterative-2506-2n-icx --trigger-params "2n-icx-vpp-iterative ndrpdr"
clear; ./suite_generator.py --gen-tests-dir generated --job csit-vpp-perf-verify-master-2n-spr --trigger-params "mrrANDnic_intel-e810cqANDdrv_avfAND1cAND64bANDeth-l2patch"
clear; ./suite_generator.py --gen-tests-dir generated --job csit-vpp-perf-verify-master-2n-spr --trigger-params ""

clear; ./suite_generator.py --gen-tests-dir generated --job csit-vpp-perf-report-coverage-2506-2n-icx --trigger-params "2n-spr-vpp-cov-ip4-11 ndrpdr"

clear; ./suite_generator.py --gen-tests-dir generated --job csit-vpp-perf-report-iterative-2506-2n-icx --trigger-params "2n-icx-vpp-soak"


VPP:

clear; ./suite_generator.py --gen-tests-dir generated --job vpp-csit-bisect-master-ubuntu2404-x86_64-2n-icx --trigger-params "8e641af04 mrrANDnic_intel-*ANDdrv_avfAND1cAND64bANDeth-l2xcbase-eth-2vhostvr1024-1vm-vppl2xc"
clear; ./suite_generator.py --gen-tests-dir generated --job vpp-csit-bisect-master-ubuntu2404-x86_64-2n-icx --trigger-params "8e641af04 mrrANDnic_intel-*ANDdrv_avfAND1cAND64bANDeth-l2xcbase-eth-2vhostvr1024-1vm-vppl2xc 2n-spr-vpp-cov-ip4-11"


clear; ./suite_generator.py --gen-tests-dir generated --job vpp-csit-verify-perf-master-ubuntu2404-aarch64-2n-grc --trigger-params "nic_*ANDdrv_mlx*AND1cANDethip4ipsec1000tnlsw-ip4base-int-aes256gcm-udir nic_*ANDdrv_mlx*AND1cANDethip4ipsec1000tnlsw-ip4base-policy-aes256gcm-udir !soak"

https://jenkins.fd.io/job/csit-vpp-perf-verify-master-2n-spr/271/console
...
def suite_generator(args) -> int:
    ...
    logging.info(
        ...
        f"Trigger params:  {trigger_params if trigger_params else 'Not specified'}\n"
    ...
    try:
        ...
        logging.critical(f"The directory '{test_dir}' cannot be created.\n{err}")
        return 1
    ...
    try:
        ...
        logging.critical(f"The directory '{output_dir}' cannot be created.\n{err}")
        return 1
