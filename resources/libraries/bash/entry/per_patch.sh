...
#        either unify other bootstraps with this (if the API supports building
#        and testing 2 builds), or reimplement bootstraps as a new entry
...
source "${BASH_FRAGMENT_DIR}/perpatch/build_vpp_ubuntu_amd64.sh" || die 1 "Source failed."
source "${BASH_FRAGMENT_DIR}/perpatch/compare_test_results.sh" || die 1 "Source failed."
source "${BASH_FRAGMENT_DIR}/perpatch/download_builds.sh" || die 1 "Source failed."
source "${BASH_FRAGMENT_DIR}/perpatch/prepare_build_parent.sh" || die 1 "Source failed."
source "${BASH_FRAGMENT_DIR}/perpatch/prepare_test_parent.sh" || die 1 "Source failed."
source "${BASH_FRAGMENT_DIR}/perpatch/prepare_test_new.sh" || die 1 "Source failed."
source "${BASH_FRAGMENT_DIR}/perpatch/select_perpatch_tags.sh" || die 1 "Source failed."
source "${BASH_FRAGMENT_DIR}/perpatch/set_vpp_dir.sh" || die 1 "Source failed."
...
set_vpp_dir || die 1 "Function call failed."
