...
source "${BASH_FRAGMENT_DIR}/prepare_build_parent.sh"
source "${BASH_FRAGMENT_DIR}/build_vpp_ubuntu_amd64.sh" "PARENT"
source "${BASH_FRAGMENT_DIR}/prepare_test_new.sh"
#
#source "${BASH_FRAGMENT_DIR}/download_builds.sh"

source "${BASH_FRAGMENT_DIR}/select_topology.sh" "2n" "skx"
source "${BASH_FRAGMENT_DIR}/select_perpatch_tags.sh"
source "${BASH_FRAGMENT_DIR}/activate_virtualenv.sh"
source "${BASH_FRAGMENT_DIR}/reserve_testbed.sh"
source "${BASH_FRAGMENT_DIR}/compose_pybot_arguments.sh"
source "${BASH_FRAGMENT_DIR}/clean_testbeds.sh"
source "${BASH_FRAGMENT_DIR}/run_pybot.sh" 10
source "${BASH_FRAGMENT_DIR}/fail_fast.sh"
source "${BASH_FRAGMENT_DIR}/prepare_test_parent.sh"
source "${BASH_FRAGMENT_DIR}/run_pybot.sh" 10
source "${BASH_FRAGMENT_DIR}/fail_fast.sh"
source "${BASH_FRAGMENT_DIR}/unreserve_testbed.sh"
source "${BASH_FRAGMENT_DIR}/compare_test_results.sh"
