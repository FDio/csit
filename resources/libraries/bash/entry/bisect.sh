...
git status
git checkout old
# The following (22689) is the lower bound for bisection.
# As the rebase has lead to non-deterministic hashes,
# We need to search for it by Change-Id.
hash_22689=$(git --no-pager log --format=format:%H -1 --grep "Change-Id: I071f5face0d489dc967cce1edcffbc1f8fac5c7e")
git reset --hard "${hash_22689}"
git checkout new
