...
# We want to cover both "die" and normal end of script.
# To that we need to trap two signals, and add "|| true" to avoid
# failure from double execution.
trap "git bisect reset; deactivate || true" EXIT RETURN
