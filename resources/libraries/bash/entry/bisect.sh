...
#  - Changelog, merged to master 2018-08-26, real release is unclear.
# 2019-08-20:
...
#git checkout "67a6dcbc4490582abd0b1fc2a6cac822520b6a3c~" || die
git checkout "d743dffcd0e423d796612119baa86b4c17641b98" || die
git describe
git bisect new || die
build_vpp_ubuntu_amd64 "NEW" || die
set_aside_current_build_artifacts "5afea129ed0c85f5313791d1d55fed6cdcc079c7" || die
#set_aside_current_build_artifacts "b6103105f99e0c7f210a9596f205a1efd21b626f" || die
#set_aside_current_build_artifacts "8921dc675458b238fc03c5aed53d3462bcdbdb3c" || die
#set_aside_current_build_artifacts "4d11b6cecaa9c1be20aa149bc8779f197f6393ed" || die
git describe
