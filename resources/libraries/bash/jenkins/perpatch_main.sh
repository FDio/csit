...
# Not a fragment, but a top-level script file.
#
# Assumptions:
...
source "${BASH_LIBRARY_DIR}/build_vpp_ubuntu_amd64.sh" "NEW"
source "${BASH_LIBRARY_DIR}/prepare_build_parent.sh"
source "${BASH_LIBRARY_DIR}/build_vpp_ubuntu_amd64.sh" "PARENT"
...
source "${BASH_LIBRARY_DIR}/activate_virtualenv.sh"
...
source "${BASH_LIBRARY_DIR}/run_pybot.sh" 10
source "${BASH_LIBRARY_DIR}/fail_fast.sh"
