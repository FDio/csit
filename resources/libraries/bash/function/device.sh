...
function read_env_variables () {
    ...
    TG_PCIDEVS=("${CSIT_TG_INTERFACES_PCI}")
    TG_DRIVERS=("${CSIT_TG_INTERFACES_DRV}")
    DUT1_PCIDEVS=("${CSIT_DUT1_INTERFACES_PCI}")
    DUT1_DRIVERS=("${CSIT_DUT1_INTERFACES_DRV}")
}
...
EOF
    ...
    for port in $(seq "${#DUT1_NETDEVS[*]}"); do
...
EOF
    ...
    CSIT_TG_INTERFACES="${CSIT_TG_INTERFACES}"
    CSIT_TG_INTERFACES_PCI="${TG_PCIDEVS[@]}"
    CSIT_TG_INTERFACES_DRV="${TG_DRIVERS[@]}"
    CSIT_DUT1_INTERFACES="${CSIT_DUT1_INTERFACES}"
    CSIT_DUT1_INTERFACES_PCI="${DUT1_PCIDEVS[@]}"
    CSIT_DUT1_INTERFACES_DRV="${DUT1_DRIVERS[@]}"
    set +a
}
