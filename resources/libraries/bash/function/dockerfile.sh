...
function generate_dpkg_dockerfile () {
    # Create docker file for Debian based system with prepared VPP artifacts in worokdir.
    #
    # Variables read:
    # - CSIT_DIR - Path to existing root of local CSIT git repository.
    # - VPP_DEVICE_IMAGE - Underlaying docker image version
    # Variables set:
...
function generate_rpm_dockerfile () {
    # Create docker file for RedHat based system with prepared VPP artifacts in worokdir.
    #
    # Variables read:
    # - CSIT_DIR - Path to existing root of local CSIT git repository.
    # - VPP_DEVICE_IMAGE - Underlaying docker image version
