...
function build_vpp_ubuntu () {
    ...
    sed -i 's/e4a16beb76a6c63af1600dd4d1d752b8/086b8a6804bbf531dd86895e948df30b/' "${VPP_DIR}/build/external/packages/octeon-roc.mk"
    git diff
    fgrep -rn 'e4a16beb76a6c63af1600dd4d1d752b8'
