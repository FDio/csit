...
function generate_docs () {
    ...
    from_dir="${CSIT_DIR}/resources/libraries/python/"
    to_dir="${WORKING_DIR}/resources/libraries/python/"
    command="rsync -a --include '*/'"
    ${command} --include '*.py' --exclude '*' "${from_dir}" "${to_dir}"
    cp "${CSIT_DIR}/resources/__init__.py" "${WORKING_DIR}/resources/"
    cp "${CSIT_DIR}/resources/libraries/__init__.py" "${WORKING_DIR}/resources/libraries/"
    from_dir="${CSIT_DIR}/resources/libraries/robot/"
