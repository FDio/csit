...
function cdash_deploy () {

    # Deploy CDash content.
    #
    # Variable read:
    ...
    cdash_verify || die "Failed to call CDash verify!."
    terraform_apply || die "Failed to call terraform apply!"

    export application_version="$(terraform output application_version)"
...
function cdash_verify () {

    # Verify CDash integrity.
    #
    # Variable read:
    # - ${CSIT_DIR} - CSIT main directory.
    # Functions called:
    ...
    export TF_VAR_application_version="1.${BUILD_ID}"
