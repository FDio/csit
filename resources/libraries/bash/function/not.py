...
tags_all = set([
    ...
    '1vswitch', '2_node_single_link_topo', '2c', '2r1c', '2r2c', '2r4c', '2r6c',
    '2r8c', '2vm', '2vnf', '3_node_double_link_topo', '3_node_single_link_topo',
    ...
    'nic_intel-xxv710', 'oacl', 'parallel', 'perftest', 'pipeline',
    'police_mark', 'scale', 'sfc_controller', 'single_memif', 'src_user_1',
    'src_user_10', 'src_user_100', 'src_user_1000', 'src_user_2000',
    'src_user_4000', 'srv6', 'srv6_1sid', 'srv6_2sid_decap',
    'srv6_2sid_nodecap', 'srv6_proxy', 'srv6_proxy_dyn', 'srv6_proxy_masq',
    'srv6_proxy_stat', 'tnl_1000', 'vhost', 'vhost_1024', 'vlan_1', 'vlan_10',
    'vlan_100', 'vlan_1k', 'vm', 'vpp_agent', 'vts', 'vxlan', 'vxlan_1',
    'vxlan_10', 'vxlan_100', 'vxlan_1k'])
