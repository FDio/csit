...
function select_tags () {
    ...
    case "${TEST_CODE}" in
        ...
        *"ndrpdr-weekly"* )
            readarray test_tag_array < "${BASH_FUNCTION_DIR}/ndrpdr-weekly.txt"
            ;;
        *"mrr-daily"* )
            readarray test_tag_array < "${BASH_FUNCTION_DIR}/mrr-daily.txt"
            ;;
        *"mrr-weekly"* )
            readarray test_tag_array < "${BASH_FUNCTION_DIR}/mrr-weekly.txt"
            ;;
        * )
