...
# - ${DOWNLOAD_DIR}/../../vpp-agent - Created, vpp-agent git repo si cloned there.
...
# FIXME: Is this really parent of ${CSIT_DIR}? How do we know it is writeable?
cd ../..
...
docker_image="$( readlink -e "prod_vpp_agent.tar.gz" | tr '\n' ' ' )"
