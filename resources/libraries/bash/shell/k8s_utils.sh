...
function k8s_utils.calico_delete {
    # Calico yaml URL or file
    k8s_calico=$1

    # Delete resources
    kubectl delete -f ${k8s_calico}  || \
        { echo "Failed to delete ${k8s_calico}"; exit 1; }
}
...
function k8s_utils.contiv_delete {
    # Contiv yaml URL or file
    k8s_contiv=$1

    # Delete resources
    kubectl delete -f ${k8s_contiv} || \
        { echo "Failed to apply ${k8s_contiv}"; exit 1; }
}
...
function k8s_utils.csit_namespace_deploy {
    # CSIT namespace yaml URL or file
    k8s_csit_namespace=$1

    # Apply resources
    kubectl apply -f ${k8s_csit_namespace}  || \
        { echo "Failed to apply ${k8s_csit_namespace}"; exit 1; }
}

function k8s_utils.csit_namespace_delete {
    # CSIT namespace yaml URL or file
    k8s_csit_namespace=$1

    # Delete resources
    kubectl delete -f ${k8s_csit_namespace}  || \
        { echo "Failed to delete ${k8s_csit_namespace}"; exit 1; }
}
