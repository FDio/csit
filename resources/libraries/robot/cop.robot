...
| | ... | *Arguments:*
| | ...
| | ... | - {TG} : Node where to start/end. Type: dictionary
| | ... | - {DUT1} - Next node from start. Type: dictionary
| | ... | - {DUT2} - Third node. Type: dictionary
| | ...
| | ... | *Return:*
| | ...
| | ... | - No value returned
...
| | ... | *Arguments:*
| | ...
| | ... | - {DUT1} - First node. Type: dictionary
| | ...
| | ... | *Return:*
| | ...
| | ... | - No value returned
...
| | ... | *Example:*
| | ...
| | ... | \| | Set IPv4 Interface Addresses \| ${DUT1}
| | ...
| | [Arguments] | ${DUT1}
...
| | ...
| | ... | - {DUT1} - First node. Type: dictionary
| | ... | - {DUT2} - Second node. Type: dictionary
| | ...
| | ... | *Return:*
| | ...
| | ... | - No value returned
...
| | ... | *Example:*
| | ...
| | ... | \| Set IPv6 Interface Addresses \| ${DUT1} \| ${DUT2}
| | ...
| | [Arguments] | ${DUT1} | ${DUT2}
| | VPP Set IF IPv6 Addr | ${DUT1} | ${dut1_if1} | ${dut1_if1_ip} |
| | ... | ${ip_prefix}
| | VPP Set IF IPv6 Addr | ${DUT1} | ${dut1_if2} | ${dut1_if2_ip} |
| | ... | ${ip_prefix}
| | VPP Set IF IPv6 Addr | ${DUT2} | ${dut2_if1} | ${dut2_if1_ip} |
| | ... | ${ip_prefix}
| | VPP Set IF IPv6 Addr | ${DUT2} | ${dut2_if2} | ${dut2_if2_ip} |
| | ... | ${ip_prefix}
