...
| | ...
| | [Arguments] | ${node} | ${ip1} | ${ip2} | ${ip3} | ${ip4} | ${vm_name}
| | Qemu Set Node | ${node}
| | ${vm}= | Qemu Start
| | ${vhost1}= | Get Vhost User If Name By Sock | ${vm} | ${sock1}
| | Setup Network Namespace | ${vm} | nmspace1 | ${vhost1} | ${ip1}
| | Setup Network Namespace | ${vm} | nmspace2 | ${vhost2} | ${ip2}
| | Setup Network Namespace | ${vm} | nmspace3 | ${vhost3} | ${ip3}
| | Setup Network Namespace | ${vm} | nmspace4 | ${vhost4} | ${ip4}
