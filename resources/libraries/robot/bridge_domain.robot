...
| | ... | \| dut2_vhost_if2 \|
| | [Arguments] | ${node} | ${sock1} | ${sock2} | ${vhost_if1}="vhost_if1"
| | ... | ${vhost_if2}="vhost_if2"
| | ${${vhost_if1}}= | Vpp Create Vhost User Interface | ${dut_node} | ${sock1}
| | ${${vhost_if2}}= | Vpp Create Vhost User Interface | ${dut_node} | ${sock2}
