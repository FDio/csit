...
| | ${dut1s_mac_address}= | Get Interface Mac | ${DUT1} | ${dut1s_to_dut1}
| | ${dut2s_mac_address}= | Get Interface Mac | ${DUT2} | ${dut2s_to_dut2}
| | Setup Arp On Dut | ${DUT1} | ${DUT1_INT_NAME} | ${dut2s_ip_address} | ${dut2s_mac_address}
| | Setup Arp On Dut | ${DUT2} | ${DUT2_INT_NAME} | ${dut1s_ip_address} | ${dut1s_mac_address}
