...
| | ${DUT1_INT_INDEX}= | Run Keyword If | ${DUT1_INT_INDEX} is None | Get Interface Sw Index | ${DUT1} | ${DUT1_INT_NAME}
| |                    | ... | ELSE | Set Variable | ${DUT1_INT_INDEX}
| | ${DUT2_INT_INDEX}= | Run Keyword If | ${DUT2_INT_INDEX} is None | Get Interface Sw Index | ${DUT2} | ${DUT2_INT_NAME}
...
| | ${dut1s_vlan_name} | ${dut1s_vlan_index}= | Create Vlan Subinterface | ${DUT1} | ${INT1} | ${VLAN}
| | ${dut2s_vlan_name} | ${dut2s_vlan_index}= | Create Vlan Subinterface | ${DUT2} | ${INT2} | ${VLAN}
