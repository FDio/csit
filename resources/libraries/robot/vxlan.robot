...
| | ...                                 | ${duts_ip_address_prefix} | ${dut2s_ip_address} | ${BID} | ${VLANID}
...
| | ...                                 | ${duts_ip_address_prefix} | ${dut1s_ip_address} | ${BID} | ${VLANID}
...
| | ${EGRESS_INT_NAME} | ${EGRESS_INT_INDEX}= | Run Keyword If | ${VLANID} == ${NONE} | Return Interface and Index | ${DUT} | ${EGRESS}
