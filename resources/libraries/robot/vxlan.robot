...
# TODO: All VPPs are ready to pass traffic KW, for now sleep
| | Sleep | 5
#| | &{test_nodes}= | Create Dictionary | TG=&{TG} | DUT1=${DUT1} | DUT2=${DUT2}
#| | All Vpp Interfaces Ready Wait | ${test_nodes}
