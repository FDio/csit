...
| | ... | dst | 20.20.20.0 | hit_next_index=${policer_index1}
| | ... | opaque_index=${pre_color}
...
| | ... | ${dut} | ip4 | dst | 255.255.255.0
| | Vpp Configures Classify Session L3 | ${dut} | permit | ${table_idx2} | ip4
| | ... | dst | 10.10.10.0 | hit_next_index=${policer_index2}
| | ... | opaque_index=${pre_color}
...
| | ${pre_color}= | Policer Classify Get Precolor | exceed_color
| | Vpp Configures Classify Session L3 | ${dut1} | permit | ${table_idx1} | ip6
| | ... | dst | 2001:2::0 | hit_next_index=${policer_index1}
| | ... | opaque_index=${pre_color}
| | Policer Classify Set Interface | ${dut1} | ${dut1_if1} | ${table_idx1}
| | ...
| | ${dut2_status} | ${value}= | Run Keyword And Ignore Error
...
| | ... | Mark_and_Transmit | Transmit | ${t} | exceed_dscp=${dscp}
| | ${table_idx2} | @{rest}= | Vpp Creates Classify Table L3
| | ... | ${dut} | ip6 | dst | ffff:ffff:ffff:ffff:ffff:ffff:ffff:0
| | Vpp Configures Classify Session L3 | ${dut} | permit | ${table_idx2} | ip6
| | ... | dst | 2001:2::0 | hit_next_index=${policer_index2}
| | ... | opaque_index=${pre_color}
| | Policer Classify Set Interface | ${dut} | ${dut_if2} | ${table_idx2}
