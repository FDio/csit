...
| | ... | *Example:*
| |
| | ... | \| Set up LDP NGINX on DUT node \| ${dut} |${mode}\
...
| | Apply startup configuration on all NGINX DUT | ${dut} | ${phy_cores}
...
| | ${cpu_idle_str}= | Get cpu idle str | ${dut} | ${numa}
...
| | ... | ${nginx_server}
| | Taskset Idle Cores To Nginx Pid | ${dut} | ${cpu_idle_str}
...
| | ... | ${tls_tcp} | ${ciphers} | ${files} | ${mode} | ${r_total}
| | ... | ${listen_port}
