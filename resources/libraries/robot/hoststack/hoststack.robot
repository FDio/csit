...
| | ... | Type: string
| | ... | - ${sess_v4_sess_halfopen_tbl_buckets} - Number of IPv4 session
| | ... | half open table buckets Type: string
| | ... | - ${sess_v4_sess_halfopen_tbl_mem} - IPv4 session half open
| | ... | table memory size Type: string
| | ... | - ${sess_v4_sess_lcl_endpt_tbl_buckets} - Number of IPv4 session
| | ... | local endpoint table buckets Type: string
| | ... | - ${sess_v4_sess_lcl_endpt_tbl_mem} - IPv4 session local endpoint
| | ... | table memory size Type: string
| |
| | ... | *Example:*
| |
...
| | ... | ${sess_v4_sess_halfopen_tbl_buckets}=${vpp_hoststack_attr}[sess_v4_sess_halfopen_tbl_buckets]
| | ... | ${sess_v4_sess_halfopen_tbl_mem}=${vpp_hoststack_attr}[sess_v4_sess_halfopen_tbl_mem]
| | ... | ${sess_v4_sess_lcl_endpt_tbl_buckets}=${vpp_hoststack_attr}[sess_v4_sess_lcl_endpt_tbl_buckets]
| | ... | ${sess_v4_sess_lcl_endpt_tbl_mem}=${vpp_hoststack_attr}[sess_v4_sess_lcl_endpt_tbl_mem]
| |
...
| | Set To Dictionary | ${vpp_hoststack_attr}
| | ... | sess_v4_sess_halfopen_tbl_buckets
| | ... | ${sess_v4_sess_halfopen_tbl_buckets}
| | Set To Dictionary | ${vpp_hoststack_attr}
| | ... | sess_v4_sess_halfopen_tbl_mem | ${sess_v4_sess_halfopen_tbl_mem}
| | Set To Dictionary | ${vpp_hoststack_attr}
| | ... | sess_v4_sess_lcl_endpt_tbl_buckets
| | ... | ${sess_v4_sess_lcl_endpt_tbl_buckets}
| | Set To Dictionary | ${vpp_hoststack_attr}
| | ... | sess_v4_sess_lcl_endpt_tbl_mem | ${sess_v4_sess_lcl_endpt_tbl_mem}
