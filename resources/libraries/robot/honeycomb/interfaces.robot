...
| | ... | ${api_data['ietf-ip:ipv6']['address'][0]['netmask']}
| | Should be equal | ${fib_address}
...
| | ... | - address - IP address to set. Type: string
| | ... | - netmask - subnet mask to set. Type: string
| | ... | - mtu - value of maximum transmission unit to set. Type: integer
| | ... | - vrf-id - ID number of a VPN to set on interface. Type: integer
| | ...
| | ... | *Example:*
| | ...
| | ... | \| Honeycomb sets interface ethernet and routing configuration \
