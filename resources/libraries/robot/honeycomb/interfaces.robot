...
| | ${api_data}= | interfaceAPI.Get interface oper data | ${node} | ${interface}
| | Should be equal
| | ... | ${address} | ${api_data['ietf-ip:ipv4']['address'][0]['ip']}
| | Should be equal
| | ... | ${netmask} | ${api_data['ietf-ip:ipv4']['address'][0]['netmask']}
| | :FOR | ${key} | IN | @{settings.keys()}
| | | Should be equal
...
| | ${api_data}= | interfaceAPI.Get interface oper data | ${node} | ${interface}
| | Should be equal
| | ... | ${address} | ${api_data['ietf-ip:ipv6']['address'][0]['ip']}
| | Should be equal
| | ... | ${prefix} | ${api_data['ietf-ip:ipv6']['address'][0]['netmask']}
| | :FOR | ${key} | IN | @{settings.keys()}
| | | Should be equal
