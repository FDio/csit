...
| Honeycomb adds Lisp Map Request Mode
| | [Documentation] | Uses Honeycomb API to configure a List Map Request Mode.
| | ...
| | ... | *Arguments:*
| | ... | - node - Information about a DUT node. Type: dictionary
| | ... | - data - Lisp settings to use. Type: dictionary
...
| | ... | *Example:*
| | ...
| | ... | \| Honeycomb adds List Map Request Mode \| ${nodes['DUT1']}\
| | ... | \| ${data} \|
| | ...
| | [Arguments] | ${node} | ${data}
| | ...
| | Configure Lisp Map Request Mode | ${node} | ${data}
...
| | ... | *Arguments:*
| | ... | - node - Information about a DUT node. Type: dictionary
| | ... | - map_register - Set boolean value of map register. Type: bool
| | ...
| | ... | *Example:*
| | ...
...
| | ... | \| True \|
| | ...
| | [Arguments] | ${node} | ${map_register}
| | ...
| | Set Map Register | ${node} | ${map_register}

| Honeycomb sets Lisp Map request
| | [Documentation] | Uses Honeycomb API to configure Lisp map request.
| | ...
| | ... | *Arguments:*
| | ... | - node - Information about a DUT node. Type: dictionary
| | ... | - map_register - Set boolean value of map request. Type: bool
| | ...
| | ... | *Example:*
| | ...
| | ... | \| Honeycomb adds Lisp Map request \| ${nodes['DUT1']} \
| | ... | \| True \|
| | ...
| | [Arguments] | ${node} | ${map_register}
| | ...
| | Set Map Request Mode | ${node} | ${map_register}
...
| | ... | *Arguments:*
| | ... | - node - Information about a DUT node. Type: dictionary
| | ... | - ip_address - IP address for the Map Server. Type: string
| | ...
| | ... | *Example:*
| | ...
...
| | [Arguments] | ${node} | ${ip_address}
| | ...
| | Add Map Server | ${node} | ${ip_address}
...
| | ... | *Arguments:*
| | ... | - node - Information about a DUT node. Type: dictionary
| | ... | - ip_address - IP address that should be referenced in Map Server.\
| | ... | Type: string
| | ...
| | ... | *Example:*
| | ...
...
| | ${data}= | Get Lisp operational data | ${node}
| | ${data}= | Set Variable | ${data['lisp-state']['lisp-feature-data']}
| | ${data}= | Set Variable | ${data['map-servers']['map-server'][0]}
| | Should be equal | ${data['ip-address']} | ${ip_address}
...
| | Should be equal | ${data[0]['map-server']} | ${ip_address}
...
| | ... | *Arguments:*
| | ... | - node - Information about a DUT node. Type: dictionary
| | ... | - state - Desired state - "enabled". Type: string Type: string
| | ...
| | ... | *Example:*
| | ...
...
| | ... | *Arguments:*
| | ... | - node - Information about a DUT node. Type: dictionary
| | ... | - state - Desired state - "enable". Type: string
| | ...
| | ... | *Example:*
| | ...
| | ... | \| Honeycomb enables Lisp RLOC feature\
...
| | ... | *Arguments:*
| | ... | - node - Information about a DUT node. Type: dictionary
| | ... | - state - state of PETR config - enabled.\
| | ... | Type: string
| | ...
| | ... | *Example:*
| | ...
...
| | ... | *Arguments:*
| | ... | - node - Information about a DUT node. Type: dictionary
| | ... | - state - state of RLOC config - enabled.\
| | ... | Type: string
| | ...
| | ... | *Example:*
| | ...
