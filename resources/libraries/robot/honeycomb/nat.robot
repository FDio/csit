...
| Library | resources.libraries.python.SNAT.NATUtil
...
| | ... | Type: string
| | ... | - delete - Optional. Use "del" to remove configuration. Type: str
| | ...
| | ... | *Example:*
| | ...
| | ... | \| Honeycomb configures NAT on interface \| ${nodes['DUT1']} \
| | ... | \| GigabitEthernet0/8/0 \| outbound \| del \|
| | [Arguments] | ${node} | ${interface} | ${direction} | ${delete}=${NONE}
| | Configure NAT on interface
| | ... | ${node} | ${interface} | ${direction} | ${delete}
