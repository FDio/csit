...
| | ... | *Arguments:*
| | ... | - node - information about a DUT node. Type: dictionary
| | ... | - name - name of an ACL table. Type: string
| | ...
| | ... | *Example:*
| | ...
| | ... | \| Honeycomb removes ACL table \| ${nodes['DUT1']} \| table0 \|
| | [Arguments] | ${node} | ${name}
| | Remove classify table | ${node} | ${name}
...
| | | Should be equal | ${data['${key}']} | ${settings['${key}']}
...
| | ...
| | [Arguments] | ${node} | ${settings}
| | ${data}= | Get classify table data | ${node} | ${settings['index']}
| | :FOR | ${key} | IN | @{data.keys()}
| | | Should be equal | ${settings['${key}']} | ${data['${key}']}
...
| | ... | *Arguments:*
| | ... | - node - information about a DUT node. Type: dictionary
| | ... | - index - VPP internal index of an ACL table. Type: int
| | ...
| | ... | *Example:*
| | ...
...
| | ... | Get classify table data | ${node} | ${index}
...
| | ... | ${node} | ${table_index} | ${settings['index']}
| | :FOR | ${key} | IN | @{data.keys()}
| | | Should be equal | ${settings['${key}']} | ${data['${key}']}
...
| | ... | \| ${0} \| 00:00:00:00:00:00:01:02:03:04:05:06:00:00:00:00 \|
