...
| | [Documentation] | Retrieves the operational data about the specified L2 FIB
| | ... | entry and checks if they are as expected.
| | ...
| | ... | *Arguments:*
| | ... | - node - Information about a DUT node. Type: dictionary
| | ... | - bd_name - Name of the bridge domain. Type: string
...
| | [Documentation] | Retrieves the operational data about the specified L2 FIB
| | ... | entry using VAT and checks if it is as expected.
| | ...
| | ... | *Arguments:*
| | ... | - node - Information about a DUT node. Type: dictionary
