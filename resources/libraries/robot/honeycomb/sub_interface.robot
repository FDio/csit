...
| Honeycomb tries to remove sub-interface
| | [Documentation] | Remove a sub-interface using Honeycomb API.
| | ...
| | ... | *Arguments:*
| | ... | - node - information about a DUT node. Type: dictionary
...
| | ...
| | ... | *Example:*
| | ... | \| Honeycomb removes sub-interface\
| | ... | \| ${nodes['DUT1']} \| sub_test \|
| | ...
...
| | Run keyword if | ${vat_data['sub_dot1ad']} == ${1}
| | ... | Should be equal as strings | ${sub_settings['vlan-type']} | 802dot1ad
| | Run keyword if | ${vat_data['sub_dot1ad']} == ${0}
| | ... | Should be equal as strings | ${sub_settings['vlan-type']} | 802dot1q
...
| | [Documentation] | Honeycomb creates a bridge domain and adds it to the\
| | ... | sub-interface.
| | ...
| | ... | *Arguments:*
| | ... | - node - information about a DUT node. Type: dictionary
...
| | ... | string
| | ... | - bd_name - The name of bridge domain to be added to sub-interface.\
| | ... | Type: string
| | ... | - sub_bd_setings - Parameters to be set while adding the bridge\
| | ... | domain to the sub-interface. Type: dictionary
| | ...
| | ... | *Example:*
| | ... | \| Honeycomb adds bridge domain to sub-interface\
...
| | ... | - interface - name of an sub-interface on the specified node. Type:\
| | ... | string
| | ... | - setings - Parameters to be set while adding the bridge domain to\
| | ... | the sub-interface. Type: dictionary
| | ...
| | ... | *Example:*
| | ... | \| Sub-interface bridge domain configuration from Honeycomb should be\
...
| | ...
| | ... | *Example:*
| | ... | \| Honeycomb sets rewrite tag \| ${nodes['DUT1']} \| sub_test \|
| | ...
...
| | ...
| | ... | *Example:*
| | ... | \| Rewrite tag value from Honeycomb should be\
| | ... | \| ${nodes['DUT1']} \| sub_test \| ${rw_params} \|
| | ...
| | [Arguments] | ${node} | ${sub_interface} | ${rw_params}
...
| Honeycomb tries to set wrong rewrite tag
...
| Honeycomb tries to set sub-interface up
