...
| Honeycomb tries to set sub-interface down
| | [Documentation] | Honeycomb tries to set sub-interface down and expects\
| | ... | error.
| | ...
| | ... | *Arguments:*
| | ... | - node - information about a DUT node. Type: dictionary
...
| | [Arguments] | ${node} | ${sub_interface}
| | Run keyword and expect error | *HoneycombError: * was not successful. * 500.
| | ... | interfaceAPI.Set interface down | ${node} | ${sub_interface}
