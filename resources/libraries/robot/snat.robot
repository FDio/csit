...
#| | Add arp on dut | ${dut1} | ${dut1_if1} | 10.0.0.4 | ${tg_if1_mac}
#| | Add arp on dut | ${dut1} | ${dut1_if1} | 10.0.0.5 | ${tg_if1_mac}
#| | Add arp on dut | ${dut1} | ${dut1_if1} | 10.0.0.6 | ${tg_if1_mac}
#| | Add arp on dut | ${dut1} | ${dut1_if1} | 10.0.0.7 | ${tg_if1_mac}
#| | Add arp on dut | ${dut1} | ${dut1_if1} | 10.0.0.8 | ${tg_if1_mac}
#| | Add arp on dut | ${dut1} | ${dut1_if1} | 10.0.0.9 | ${tg_if1_mac}
#| | Add arp on dut | ${dut1} | ${dut1_if1} | 10.0.0.10 | ${tg_if1_mac}
#| | Add arp on dut | ${dut1} | ${dut1_if1} | 10.0.0.11 | ${tg_if1_mac}
...
| | Vpp Route Add | ${dut2} | 100.0.0.0 | 24 | 11.0.0.1 | ${dut2_if1}
| | ...
| | Set inside and outside interfaces | ${dut1} | ${dut1_if1} | ${dut1_if2}
#| | Set deterministic mode for SNAT | ${dut1} | 10.0.0.0 | 24 | 100.0.0.0 | 30
| | Set deterministic mode for SNAT | ${dut1} | 10.0.0.0 | 18 | 100.0.0.0 | 30
| | ...
| | Set inside and outside interfaces | ${dut2} | ${dut2_if1} | ${dut2_if2}
#| | Set deterministic mode for SNAT | ${dut2} | 100.0.0.0 | 24 | 200.0.0.0 | 30
| | Set deterministic mode for SNAT | ${dut2} | 100.0.0.0 | 30 | 200.0.0.0 | 30
