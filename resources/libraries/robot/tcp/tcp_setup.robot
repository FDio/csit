...
| | Set Interface Address | ${dut1} | ${dut1_if1} | 196.168.10.2 | 24
| | Set Interface Address | ${dut1} | ${dut1_if1} | 196.168.20.2 | 24
| | Set Interface Address | ${dut1} | ${dut1_if1} | 196.168.30.2 | 24
| | Set Interface Address | ${dut1} | ${dut1_if1} | 196.168.40.2 | 24
...
| | ... | *Example:*
| | ...
| | ... | \| Set up HTTP server on the VPP node \| 400 \|4096 \| 2g \|
| | ...
