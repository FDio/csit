...
| | | ... | ${${dut}_${ilayer}1_${id}}[0]
| | | ... | ${${dut}_${ilayer}2_${id}}[0]
| | END
...
| | Configure L2XC
| | ... | ${dut1} | ${DUT1_${ilayer}1}[0] | ${dut1s_vxlan}
| | ${dut2s_vxlan}= | Create VXLAN interface
| | ... | ${dut2} | 24 | 172.16.0.2 | 172.16.0.1
| | Configure L2XC
| | ... | ${dut2} | ${DUT2_${ilayer}2}[0] | ${dut2s_vxlan}
...
| | Configure L2XC
| | ... | ${dut1} | ${DUT1_${ilayer}1}[0] | ${vhost_if1}
| | Configure L2XC
...
| | Run Keyword If | '${dut2_status}' == 'PASS'
| | ... | Configure L2XC | ${dut2} | ${DUT2_${ilayer}2}[0] | ${vhost_if2}
...
| | Configure L2XC
| | ... | ${dut2} | ${DUT2_${ilayer}2}[0] | ${vhost_if2}
