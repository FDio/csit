...
| | | ... | ${nodes['${dut}']} | ${${dut}_${ilayer}1_${id}}[0] | ${id}
| | | Add Interface To L2 BD
| | | ... | ${nodes['${dut}']} | ${${dut}_${ilayer}2_${id}}[0] | ${id}
| | END
...
| | Add interface to bridge domain
| | ... | ${nodes['${dut}']} | ${${dut}_${ilayer}1_${nf_chain}}[0]
| | ... | ${bd_id1}
| | Add interface to bridge domain
| | ... | ${nodes['${dut}']} | ${${dut}_${ilayer}2_${nf_chain}}[0]
| | ... | ${bd_id2}
...
| | ... | ${dut1} | ${DUT1_${ilayer}2}[0] | 172.16.0.1 | 24
| | VPP Interface Set IP Address
| | ... | ${dut2} | ${DUT2_${ilayer}1}[0] | 172.16.0.2 | 24
| | VPP Add IP Neighbor
| | ... | ${dut1} | ${DUT1_${ilayer}2}[0] | 172.16.0.2
| | ... | ${DUT2_${ilayer}1_mac}[0]
| | VPP Add IP Neighbor
| | ... | ${dut2} | ${DUT2_${ilayer}1}[0] | 172.16.0.1
| | ... | ${DUT1_${ilayer}2_mac}[0]
...
| | ... | ${dut1} | ${1} | ${DUT1_${ilayer}1}[0] | ${dut1s_vxlan}
| | Set Interface State
| | ... | ${dut1} | ${dut1s_vxlan} | up
| | VPP Add L2 Bridge Domain
| | ... | ${dut2} | ${1} | ${DUT2_${ilayer}2}[0] | ${dut2s_vxlan}
| | Set Interface State
| | ... | ${dut2} | ${dut2s_vxlan} | up
...
| | ... | node=${dut1}
| | ... | node_vxlan_if=${DUT1_${ilayer}2}[0]
| | ... | node_vlan_if=${DUT1_${ilayer}1}[0]
| | ... | op_node=${dut2}
| | ... | op_node_if=${DUT2_${ilayer}1}[0]
...
| | Vpp create multiple VXLAN IPv4 tunnels
| | ... | node=${dut2}
| | ... | node_vxlan_if=${DUT2_${ilayer}1}[0]
| | ... | node_vlan_if=${DUT2_${ilayer}2}[0]
| | ... | op_node=${dut1}
| | ... | op_node_if=${DUT1_${ilayer}2}[0]
| | ... | n_tunnels=${vxlan_count}
| | ... | vni_start=${vni_start}
...
| | ... | ${dut1} | ${DUT1_${ilayer}2}[0]
| | ... | ${dut2} | ${DUT2_${ilayer}1}[0] | SUB_ID=${subid}
| | ... | ELSE | Initialize VLAN dot1q sub-interfaces in circular topology
| | ... | ${dut1} | ${DUT1_${ilayer}2}[0] | SUB_ID=${subid}
| | Run Keyword If | '${dut2_status}' == 'PASS'
...
| | Run Keyword If | '${dut2_status}' == 'PASS'
| | ... | Add interface to bridge domain | ${dut2} | ${DUT2_${ilayer}2}[0]
| | ... | ${bd_id2}
...
| | Set interfaces in path up
| | VPP Add L2 Bridge Domain
| | ... | ${dut1} | ${1} | ${DUT1_${ilayer}1}[0] | ${DUT1_${ilayer}2}[0]
| | Configure L2XC
| | ... | ${dut2} | ${DUT2_${ilayer}1}[0] | ${DUT2_${ilayer}2}[0]
| | Configure MACIP ACLs
| | ... | ${dut1} | ${DUT1_${ilayer}1}[0] | ${DUT1_${ilayer}2}[0]
