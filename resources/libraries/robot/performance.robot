...
| |      | ${${dut1_vif1_mac}}= | Get Vhost User Mac By Sw Index
| |      | ... | ${dut1} | ${dut1_vif1_idx}
| |      | ${${dut1_vif2_mac}}= | Get Vhost User Mac By Sw Index
| |      | ... | ${dut1} | ${dut1_vif2_idx}
| |      | ${${dut2_vif1_mac}}= | Get Vhost User Mac By Sw Index
| |      | ... | ${dut2} | ${dut2_vif1_idx}
| |      | ${${dut2_vif2_mac}}= | Get Vhost User Mac By Sw Index
| |      | ... | ${dut2} | ${dut2_vif2_idx}
| |      | Set Test Variable | ${${dut1_vif1_mac}}
| |      | Set Test Variable | ${${dut1_vif2_mac}}
| |      | Set Test Variable | ${${dut2_vif1_mac}}
...
| |      | ... | ${dut1-vhost-${number}-if2_mac} | skip=${vpp_cpus}
...
| |      | ... | ${dut2-vhost-${number}-if2_mac} | skip=${vpp_cpus}
| |      | ... | count=${vm_cpus} | qemu_id=${number}
| |      | Set To Dictionary | ${dut2_vm_refs} | DUT2_VM${number} | ${vm2}
