...
| | IP addresses are set on interfaces | ${dut2} | ${dut1_if1} | 2.2.2.2 | 30
| | IP addresses are set on interfaces | ${dut2} | ${dut1_if2} | 3.3.3.2 | 30
| | Vpp Route Add | ${dut1} | 10.10.10.0 | 32 | 1.1.1.1 | ${dut1_if1}
| | ... | count=${count}
| | Vpp Route Add | ${dut1} | 20.20.20.0 | 32 | 2.2.2.2 | ${dut1_if2}
| | ... | count=${count}
| | Vpp Route Add | ${dut2} | 10.10.10.0 | 32 | 2.2.2.1 | ${dut2_if1}
| | ... | count=${count}
| | Vpp Route Add | ${dut2} | 20.20.20.0 | 32 | 3.3.3.1 | ${dut2_if2}
| | ... | count=${count}
| | All Vpp Interfaces Ready Wait | ${nodes}
