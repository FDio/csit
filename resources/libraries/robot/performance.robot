...
*** Keywords ***
| Performance global Variables Setup
| | [Documentation] | Setup performance global Variables
| | ...
| | ... | _NOTE:_ This KW sets following suite variables:
| | ... | - ${glob_loss_acceptance} - Loss accpetance treshold
| | ... | - ${glob_loss_acceptance_type} - Loss accpetance treshold type
| | ...
...
| | ...             | ${rate} | ${framesize} | ${topology_type}
| | Partial traffic loss accepted | ${loss_acceptance}
