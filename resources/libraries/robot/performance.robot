...
| | ... |                                       Frame, ip header and Lisp
| | ... |                                       header.
| | ... | - ${10Ge_lisp_iph_linerate_pps_1470B} - Maximum number of packet per
| | ... |                                         second for 10GE with 1475B L2
| | ... |                                         Frame, ip header and
| | ... |                                         Lisp header.
...
| | ${10Ge_lisp_iph_linerate_pps_1470B}= | Set Variable | 812743
...
| | Set Suite Variable | ${10Ge_lisp_iph_linerate_pps_1470B}
...
| | ${tg1_if2_mac}= | Get Interface MAC | ${tg} | ${tg_if2}
| | ${dut1_if2_mac}= | Get Interface MAC | ${dut1} | ${dut1_if2}
| | ${dut2_if2_mac}= | Get Interface MAC | ${dut2} | ${dut2_if1}
