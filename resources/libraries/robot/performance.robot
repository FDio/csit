...
| | ...                    | ${tg1_if2_mac}
| | Vpp Route Add | ${dut1} | 2001:2::0 | ${prefix} | 2001:4::2 | ${dut1_if2}
| | Vpp Route Add | ${dut1} | 2001:1::0 | ${prefix} | 2001:3::2 | ${dut1_if1}
| | Vpp Route Add | ${dut2} | 2001:1::0 | ${prefix} | 2001:4::1 | ${dut2_if1}
| | Vpp Route Add | ${dut2} | 2001:2::0 | ${prefix} | 2001:5::2 | ${dut2_if2}
