...
| | ... |                                       Frame, ip header and Lisp
| | ... |                                       header.
| | ... | - ${10Ge_lisp_iph_linerate_pps_1478B} - Maximum number of packet per
| | ... |                                         second for 10GE with 1478B L2
| | ... |                                         Frame, ip header and
| | ... |                                         Lisp header.
...
| | ${10Ge_lisp_iph_linerate_pps_1478B}= | Set Variable | 808538
...
| | Set Suite Variable | ${10Ge_lisp_iph_linerate_pps_1478B}
