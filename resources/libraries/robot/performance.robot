...
| | Vpp set IPv6 neighbour | ${dut1} | ${dut1_if1} | 2001:1::2 | ${tg1_if1_mac}
| | Vpp set IPv6 neighbour | ${dut2} | ${dut2_if2} | 2001:2::2 | ${tg1_if2_mac}
| | Vpp set IPv6 neighbour | ${dut1} | ${dut1_if2} | 2001:3::2 | ${dut2_if1_mac}
| | Vpp set IPv6 neighbour | ${dut2} | ${dut2_if1} | 2001:3::1 | ${dut1_if2_mac}
