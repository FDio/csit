...
| | VPP Set If IPv6 Addr | ${dut2} | ${dut2_if2} | 2001:5::1 | ${prefix}
| | Vpp nodes ra suppress link layer | ${nodes}
...
| | ...                    | ${tg1_if2_mac}
| | Vpp Route Add Count | ${dut1} | 2001:2::0 | ${prefix} | 2001:4::2
| | ...                 |${dut1_if2} | count=${count}
| | Vpp Route Add Count | ${dut1} | 2001:1::0 | ${prefix} | 2001:3::2
| | ...                 |${dut1_if2} | count=${count}
| | Vpp Route Add Count | ${dut2} | 2001:1::0 | ${prefix} | 2001:4::1
| | ...                 |${dut1_if2} | count=${count}
| | Vpp Route Add Count | ${dut2} | 2001:2::0 | ${prefix} | 2001:5::2
| | ...                 |${dut1_if2} | count=${count}
