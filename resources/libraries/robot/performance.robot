...
| | ... |                                   header.
| | ... | - ${10Ge_lisp_linerate_pps_1518B} - Maximum number of packet per
| | ... |                                     second for 10GE with 1518B L2
...
| | ... |                                       Frame, ip header and Lisp
| | ... |                                       header.
| | ... | - ${10Ge_lisp_iph_linerate_pps_1518B} - Maximum number of packet per
| | ... |                                         second for 10GE with 1518B L2
| | ... |                                         Frame, ip header and
| | ... |                                         Lisp header.
| | ... | - ${10Ge_lisp_iph_linerate_pps_1522B} - Maximum number of packet per
| | ... |                                         second for 10GE with 1522B L2
| | ... |                                         Frame, ip header and
| | ... |                                         Lisp header.
...
| | ${10Ge_lisp_linerate_pps_1518B}= | Set Variable | 808538
...
| | ${10Ge_lisp_iph_linerate_pps_1518B}= | Set Variable | 788146
| | ${10Ge_lisp_iph_linerate_pps_1522B}= | Set Variable | 786163
...
| | Set Suite Variable | ${10Ge_lisp_linerate_pps_1518B}
...
| | Set Suite Variable | ${10Ge_lisp_iph_linerate_pps_1518B}
| | Set Suite Variable | ${10Ge_lisp_iph_linerate_pps_1522B}
