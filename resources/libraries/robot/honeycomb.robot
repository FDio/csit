...
| Library | resources/libraries/python/HTTPRequests.py
...
| | ...
| | ... | _Used variables and constants:_
| | ...
| | ... | Defined in resources/libraries/python/constants.py:_
| | ... | - RESOURCES_TPL_HC  - path to honeycomb templates directory
| | ...
| | ... | Defined in resources/libraries/python/topology.py:_
...
| | Add VPP to topology | ${nodes} | ${header}
...
| Honeycomb report VPP node configuration
...
| | :FOR | ${item} | IN | @{reply}
| | | Should match regexp | ${item} | ^vpp\\d{1,2}$