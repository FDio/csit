...
| | ${locator_set_values}= | Generate Lisp Locator Set Test Values |
...
| | Lisp Locator Set Should Be Equal
...
| | ...
| | [Arguments] | ${DUT1} | ${locator_set_number}
| | ${locator_set_values}= | Generate Lisp Locator Set Reset Test Values |
| | ...                    | ${DUT1} | ${locator_set_number}
| | Set Test Variable | ${locator_set_values}
...
| | ${set_eid} = | Generate Lisp Local Eid Test Value
...
| | ${set_map_resolver} = | Generate Lisp Map Resolver
