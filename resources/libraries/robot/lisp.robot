...
| | [Documentation] | Test if the locator_set is set correct on VPP.
| | ...
| | ... | *Arguments:*
| | ... | - ${dut_node} - DUT node. Type: dictionary
| | ...
...
| | [Documentation] | Test if all locator_set are unset.
| | ...
| | ... | *Arguments:*
| | ... | - ${dut_node} - DUT node. Type: dictionary
| | ...
...
| | [Documentation] | Test if the map resolver address is set correct on VPP.
| | ...
| | ... | *Arguments:*
| | ... | - ${dut_node} - DUT node. Type: dictionary
| | ...
