...
| | ...
| | ... | *Example:*
| | ... | \| Given Lisp locator_set data is prepared \| ${nodes['dut_node']} \
| | ... | \| ${locator_set_number} \|
| | ...
...
| | ... |                           that will be set on the VPP node.
| | ...
| | ... | *Example:*
| | ... | \| When Lisp locator_set data is set \| ${nodes['dut_node']} \|
| | ...
| | [Arguments] | ${dut_node}
...
| | ... | _NOTE:_ This KW sets following test case variables:
| | ... | - ${locator_set_values} - Generate locator_set data
| | ... |                           that were set to VPP node.
| | ... | - ${show_locator_set} - Locator_set data from VPP node.
| | ...
| | ... | *Example:*
| | ... | \| Then Lisp locator_set is set correct \| ${nodes['dut_node']} |\
| | ...
| | [Arguments] | ${dut_node}
...
| | ...
| | ... | *Example:*
| | ... | \| Then Lisp locator_set should be unset \| ${nodes['dut_node']} \|
| | ...
| | [Arguments] | ${dut_node}
| | ${show_locator_set}= | Vpp Show Lisp Locator Set | ${dut_node}
...
| | ... |    are prepared \| ${nodes['dut_node']} \| ${locator_set_number} \|
| | ...
| | [Arguments] | ${dut_node} | ${locator_set_number}
...
| | ...
| | ... | *Example:*
| | ... | \| Given Lisp eid address is prepared \| ${nodes['dut_node']} \
...
| | ...
| | ... | *Example:*
| | ... | \| When Lisp eid address is set \| ${nodes['dut_node']} \|
| | ...
| | [Arguments] | ${dut_node}
...
| | ...
| | ... | _NOTE:_ This KW sets following test case variables:
| | ... | - ${set_eid} - Generate eid data which will be set to the VPP node.
| | ... | - ${show_eid} - Eid data from VPP node.
| | ...
| | ... | *Example:*
...
| | ...
| | ... | _NOTE:_ This KW sets following test case variables:
| | ... | - ${set_eid} - Generate eid data which was set to the VPP node.
| | ...
| | ... | *Example:*
| | ... | \| When Delete all lisp eid address form VPP \
| | ... | \| ${nodes['dut_node']} \|
| | ...
| | [Arguments] | ${dut_node}
...
| | ...
| | ... | *Example:*
| | ... | \| Then Lisp eid table should be empty \| ${nodes['dut_node']} \|
| | ...
| | [Arguments] | ${dut_node}
| | ${show_eid}= | Vpp Show Lisp Local Eid Table | ${dut_node}
...
| | ... | \| ${nodes['dut_node']} \| ${map_resolver_ipv4_num} \
...
| | ...
| | ... | *Example:*
| | ... | \| When Lisp map resolver address is set \| ${nodes['dut_node']} \|
| | ...
| | [Arguments] | ${dut_node}
...
| | ... |                         to the VPP node.
| | ... | - ${show_map_resolver} - Map resolver data from the VPP node.
| | ...
| | ... | *Example:*
