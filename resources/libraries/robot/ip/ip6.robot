...
| |
| | VPP Add IP Neighbor
| | ... | ${dut1} | ${DUT1_${int}1}[0] | 2001:1::2 | ${TG_${int}1_mac}[0]
...
| | VPP Add IP Neighbor
| | ... | ${dut} | ${dut_if2} | 2001:2::2 | ${TG_${int}2_mac}[0]
| |
...
| | Vpp All Ra Suppress Link Layer | ${nodes}
| | VPP Add IP Neighbor
| | ... | ${dut1} | ${DUT1_${int}1}[0] | 2001:3::2 | ${TG_${int}1_mac}[0]
| | Run Keyword If | '${dut2_status}' == 'PASS'
| | ... | VPP Add Ip Neighbor
...
| | VPP Add IP Neighbor
| | ... | ${dut} | ${dut_if2} | 2001:5::2 | ${TG_${int}2_mac}[0]
...
| | ... | ${prefix}
| | VPP Add IP Neighbor
| | ... | ${dut1} | ${DUT1_${int}1}[0]} | 2001:100::2 | ${TG_${int}1_mac}[0]
| | VPP Add IP Neighbor
| | ... | ${dut1} | ${DUT1_${int}2}[0] | 2001:200::2 | ${TG_${int}2_mac}[0]
...
| | VPP Add IP Neighbor
| | ... | ${dut1} | ${DUT1_${int}1}[0] | 2002:1::1 | ${TG_${int}1_mac}[0]
| | Run Keyword If | '${dut2_status}' == 'PASS'
| | ... | VPP Add Ip Neighbor
...
| | VPP Add IP Neighbor
| | ... | ${dut} | ${dut_if2} | 2002:3::1 | ${TG_${int}2_mac}[0]
| | VPP Interface Set IP Address
