...
| | ... | Vpp Route Add | ${dut1} | ${remote_host1_ip4}
| | ... | ${remote_host_ip4_prefix} | ${tg_if1_ip4} | ${dut1_if1}
| | Run Keyword Unless
| | ... | '${remote_host2_ip4}' == '${NONE}' or '${dut2_status}' == 'PASS'
| | ... | Vpp Route Add | ${dut1} | ${remote_host2_ip4}
| | ... | ${remote_host_ip4_prefix} | ${tg_if2_ip4} | ${dut1_if2}
| | Run Keyword Unless
| | ... | '${remote_host2_ip4}' == '${NONE}' or '${dut2_status}' == 'FAIL'
| | ... | Vpp Route Add | ${dut1} | ${remote_host2_ip4}
| | ... | ${remote_host_ip4_prefix} | ${dut2_if1_ip4} | ${dut1_if2}
| | Run Keyword Unless
| | ... | '${remote_host1_ip4}' == '${NONE}' or '${dut2_status}' == 'FAIL'
| | ... | Vpp Route Add | ${dut2} | ${remote_host1_ip4}
| | ... | ${remote_host_ip4_prefix} | ${dut1_if2_ip4} | ${dut2_if1}
| | Run Keyword Unless
| | ... | '${remote_host2_ip4}' == '${NONE}' or '${dut2_status}' == 'FAIL'
| | ... | Vpp Route Add | ${dut2} | ${remote_host2_ip4}
| | ... | ${remote_host_ip4_prefix} | ${tg_if2_ip4} | ${dut2_if2}
