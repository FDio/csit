...
| |
| | VPP Add IP Neighbor
| | ... | ${dut1} | ${DUT1_${int}1}[0] | 10.10.10.2 | ${TG_${int}1_mac}[0]
...
| | VPP Add IP Neighbor
| | ... | ${dut} | ${dut_if2} | 20.20.20.2 | ${TG_${int}2_mac}[0]
| |
...
| |
| | VPP Add IP Neighbor
| | ... | ${dut1} | ${DUT1_${int}1}[0] | 1.1.1.1 | ${TG_${int}1_mac}[0]
| | Run Keyword If | '${dut2_status}' == 'PASS'
| | ... | VPP Add IP Neighbor
...
| | ... | ELSE | Set Variable | ${DUT1_${int}2}[0]
| | VPP Add IP Neighbor
| | ... | ${dut} | ${dut_if2} | 3.3.3.1 | ${TG_${int}2_mac}[0]
...
| | VPP Add IP Neighbor
| | ... | ${dut1} | ${DUT1_${int}1}[0] | 100.0.0.2 | ${TG_${int}1_mac}[0]
| | VPP Add IP Neighbor
| | ... | ${dut1} | ${DUT1_${int}2}[0] | 200.0.0.2 | ${TG_${int}2_mac}[0]
...
| | ... | interface=${DUT1_${int}1}[0] | vrf=${fib_table_2}
...
| | ... | ${dut1} | ${DUT1_${int}1}[0] | 100.0.0.2 | ${TG_${int}1_mac}[0]
| | VPP Add IP Neighbor
| | ... | ${dut2} | ${DUT2_${int}2}[0] | 200.0.0.2 | ${TG_${int}2_mac}[0]
| | Vpp Route Add | ${dut1} | 10.0.0.0 | 8 | gateway=100.0.0.2
| | ... | interface=${DUT1_${int}1}[0] | vrf=${fib_table_1}
