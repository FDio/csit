...
| | ... | VPP Add IP Neighbor
| | ... | ${dut1} | ${dut1_if2} | ${dut2_if1_ip4} | ${dut2_if1_mac}
| | Run Keyword If | '${dut2_status}' == 'PASS'
| | ... | VPP Add IP Neighbor
| | ... | ${dut2} | ${dut2_if1} | ${dut1_if2_ip4} | ${dut1_if2_mac}
...
| | VPP Add IP Neighbor | ${dut} | ${dut_if2} | ${tg_if2_ip4} | ${tg_if2_mac}
| |
...
| |
| | Run Keyword If | '${dut2_status}' == 'PASS'
| | ... | Vpp Route Add | ${dut1} | ${dut2_if2_ip4} | 24 | gateway=${dut2_if1_ip4}
| | ... | interface=${dut1_if2}
| | Run Keyword If | '${dut2_status}' == 'PASS'
| | ... | Vpp Route Add | ${dut2} | ${dut1_if1_ip4} | 24 | gateway=${dut1_if2_ip4}
| | ... | interface=${dut2_if1}
| |
