...
| | ...
| | ... | - {tg} : Node to execute scripts on (TG). Type: dictionary
...
| | ...
| | [Arguments] | ${tg} | ${src_ip} | ${dst_ip} | ${tx_src_port} |
...
| | ... | \| 08:00:27:a2:52:5b \| eth3 \| 08:00:27:4d:ca:7a \| 08:00:27:7d:fd:10
| | ...
| | ... | _NOTE:_ Return code 10 means no packet reached destination:
| | ...
| | [Arguments] | ${tg} | ${src_ip} | ${dst_ip} | ${tx_src_port} |
| | ... | ${tx_src_mac} | ${tx_dst_mac} | ${rx_port} | ${rx_src_mac} |
| | ... | ${rx_dst_mac}
...
| | ... | send_icmp_check_headers.py | ${tg} | ${args}
l