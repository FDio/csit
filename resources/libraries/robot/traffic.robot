...
| | ... | - tx_port - Interface of TG-if1. Type: string
| | ... | - tx_mac - MAC address of TG-if1. Type: string
| | ... | - rx_port - Interface of TG-if2. Type: string
| | ... | - rx_mac - MAC address of DUT1-if1. Type: string
| | ... | - protocol - Type of protocol. Type: string
| | ... | - source_port - Source TCP/UDP port. Type: string
| | ... | - destination_port - Destination TCP/UDP port. Type: string
| | ...
| | ... | *Return:*
| | ... | - No value returned
| | ...
