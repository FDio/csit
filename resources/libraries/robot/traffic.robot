...
| | ... | - r_enc - Remote Encryption key. Type: string
| | ... | - r_auth - Remote Integrity key. Type: string
| | ... | - l_spi - Local SPI. Type: integer
| | ... | - l_enc - Local Encryption key. Type: string
| | ... | - l_auth - Local Integrity key. Type: string
| | ...
| | ... | *Return:*
| | ... | - No value returned
| | ...
