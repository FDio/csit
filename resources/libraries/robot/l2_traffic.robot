...
| | ${args}= | Run Keyword Unless | '${encaps}' == '${EMPTY}' | Catenate
| | ... | ${args} | --encaps ${encaps} | --vlan1 ${vlan1}
| | ... | ELSE | Set Variable | ${args}
| | ${args}= | Run Keyword Unless | '${vlan2}' == '${EMPTY}' | Catenate
| | ... | ${args} | --vlan2 ${vlan2}
| | ... | ELSE | Set Variable | ${args}
| | ${args}= | Run Keyword Unless | '${encaps_rx}' == '${EMPTY}' | Catenate
| | ... | ${args} | --encaps_rx ${encaps_rx}
| | ... | ELSE | Set Variable | ${args}
| | ${args}= | Run Keyword Unless | '${vlan1_rx}' == '${EMPTY}' | Catenate
| | ... | ${args} | --vlan1_rx ${vlan1_rx}
| | ${args}= | Run Keyword Unless | '${vlan2_rx}' == '${EMPTY}' | Catenate
| | ... | ${args} | --vlan2_rx ${vlan2_rx}
