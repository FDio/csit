...
| | ${args1}= | Run Keyword If | '${args1}' == 'None' | Set Variable | ${EMPTY}
| | ...      | ELSE | Set Variable | ${args1}
| | ${args2}= | Run Keyword Unless | '${vlan2}' == '${EMPTY}' | Catenate | ${args} | --vlan2 ${vlan2}
| | ${args2}= | Run Keyword If | '${args2}' == 'None' | Set Variable | ${EMPTY}
| | ...      | ELSE | Set Variable | ${args2}
| | ${args}= |  Catenate | ${args} | ${args1} | ${args2}
