...
| | ... | behaviour on the given DUT node.
| | ...
| | ... | *Arguments:*
...
| | ... | *Example:*
| | ...
| | ... | \| Configure SR Policy on DUT \| ${nodes['DUT1']} \| A:: \| B:: \
| | ... | \| C:: \|
| | ... | \| Configure SR Policy on DUT \| ${nodes['DUT2']} \| D:: \| E:: \
| | ... | \| F:: \| mode=insert \|
| | ...
| | [Arguments] | ${dut_node} | ${bsid} | @{sid_list} | ${mode}=encap
| | ...
...
| | ... | - mask - IP address mask (Optional, default value: None; required for
| | ... | L3 mode). Type: integer
| | ...
| | ... | *Example:*
| | ...
...
| | ... | \| ip_address=2001::1 \| mask=64 \|
| | ...
| | [Arguments] | ${dut_node} | ${mode} | ${bsid}
| | ... | ${interface}=${None} | ${ip_addr}=${None} | ${mask}=${None}
| | ...
| | Configure SR Steer | ${dut_node} |${mode} | ${bsid}
| | ... | interface=${interface} | ip_addr=${ip_addr} | mask=${mask}
