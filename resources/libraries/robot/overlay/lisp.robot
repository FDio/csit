...
| | ... | \| Configure path for LISP test \|
| | ...
#| | ${dut1_if2}= | Vpp Create Loopback | ${dut1}
...
#| | And VPP IP Probe | ${dut1} | ${dut1_if2} | ${dut_if2_ip4}
| | VPP Add IP Neighbor
...
#| | Vpp Route Add
#| | ... | ${dut1} | ${src_ip4} | ${ip4_plen} | gateway=${dut_if1_ip4}
#| | ... | interface=${dut1_if1}
#| | Vpp Route Add
#| | ... | ${dut1} | ${tg_if2_ip4} | ${ip4_plen} | gateway=${dut_if2_ip4}
#| | ... | interface=${dut1_if2}
#| | Set Test Variable | ${dut_src_ip} | ${dut_if2_ip4}
...
| | VPP Interface Set IP Address
| | ... | ${dut1} | ${dut1_if2} | ${dut_lo_ip6} | ${ip6_plen}
| | VPP Add IP Neighbor
