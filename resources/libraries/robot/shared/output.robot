...
|
| Library | resources.libraries.python.StateDatabase | import.${SUITE NAME}
...
| | resources.libraries.python.StateDatabase.Database Update | key=${super_key} | value=${value}
...
| | ... | *Example:* FIXME.
| |
| | resources.libraries.python.StateDatabase.Database Dump | filename=${OUTPUT DIR}/json.log
