...
| | ... | configuration file.
| |
| | Run keyword | DUT1.Add DPDK Dev Parameter | ${DUT1_${int}2_pci}[0]
| | ... | vlan-strip-offload | off
| | Run keyword | DUT2.Add DPDK Dev Parameter | ${DUT2_${int}1_pci}[0]
| | ... | vlan-strip-offload | off
...
| | Run keyword | DUT1.Add DPDK Dev Parameter | ${DUT1_${int}2_pci}[0]
| | ... | vlan-strip-offload | off
| | Run keyword | DUT1.Add DPDK Dev Parameter | ${DUT1_${int}4_pci}[0]
| | ... | vlan-strip-offload | off
| | Run keyword | DUT2.Add DPDK Dev Parameter | ${DUT2_${int}1_pci}[0]
| | ... | vlan-strip-offload | off
| | Run keyword | DUT2.Add DPDK Dev Parameter | ${DUT2_${int}3_pci}[0]
| | ... | vlan-strip-offload | off
