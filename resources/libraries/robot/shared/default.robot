...
| | ... | *Example:*
| |
| | ... | \| Add NAT translation memory to all DUTs \| value=2048 \|
| |
| | [Arguments] | ${translation_memory_size}=1024
| |
| | FOR | ${dut} | IN | @{duts}
| | | Run keyword | ${dut}.Add NAT translations memory | value=${translation_memory_size}
| | END
