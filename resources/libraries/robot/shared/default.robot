...
| | | Run keyword | ${dut}.Add Plugin Disable | "acl_plugin.so"
| | | Run keyword | ${dut}.Add Plugin Disable | "flowprobe_plugin.so"
| | | Run keyword | ${dut}.Add Plugin Disable | "gtpu_plugin.so"
| | | Run keyword | ${dut}.Add Plugin Disable | "ila_plugin.so"
| | | Run keyword | ${dut}.Add Plugin Disable | "ioam_plugin.so"
| | | Run keyword | ${dut}.Add Plugin Disable | "ixge_plugin.so"
| | | Run keyword | ${dut}.Add Plugin Disable | "kubeproxy_plugin.so"
| | | Run keyword | ${dut}.Add Plugin Disable | "l2e_plugin.so"
| | | Run keyword | ${dut}.Add Plugin Disable | "lb_plugin.so"
| | | Run keyword | ${dut}.Add Plugin Disable | "memif_plugin.so"
| | | Run keyword | ${dut}.Add Plugin Disable | "nat_plugin.so"
| | | Run keyword | ${dut}.Add Plugin Disable | "pppoe_plugin.so"
| | | Run keyword | ${dut}.Add Plugin Disable | "sixrd_plugin.so"
| | | Run keyword | ${dut}.Add Plugin Disable | "stn_plugin.so"
