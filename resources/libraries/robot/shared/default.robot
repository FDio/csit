...
| Add NAT translation buckets to all DUTs
| | [Documentation] | Add NAT configuration to all DUTs.
| |
| | ... | *Arguments:*
| | ... | - nat_mode - NAT mode. Type: string, default value: deterministic
...
| | ... | *Example:*
| |
| | ... | \| Add NAT translation buckets to all DUTs \| value=2048 \|
| |
| | [Arguments] | ${translation_buckets}=1024
| |
| | FOR | ${dut} | IN | @{duts}
| | | Run keyword | ${dut}.Add NAT translation buckets | value=${translation_buckets}
| | END
