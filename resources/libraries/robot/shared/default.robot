...
| | ... | configuration on all DUTs. Based on the SMT configuration if enabled\
| | ... | keyword will automatically map also the sibling logical cores.\
...
| | | ... | Evaluate | int(${cpu_count_int}*2) | ELSE | ${thr_count_int}
