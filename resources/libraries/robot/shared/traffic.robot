...
| |
| | [Arguments] | ${node} | ${tx_interface} | ${rx_interface} | ${tx_dst_mac}
| | ... | ${rx_src_mac} | ${src_ip} | ${dst_ip} | ${dut1_bsid}
| | ... | ${dut1_srcsid} | ${dut1_dstsid1} | ${dut2_srcsid} | ${dut2_dstsid1}
...
| | ... | --tx_src_mac ${tx_src_mac} | --tx_dst_mac ${tx_dst_mac}
| | ... | --rx_src_mac ${rx_src_mac} | --rx_dst_mac ${rx_dst_mac}
| | ... | --src_ip ${src_ip} | --dst_ip ${dst_ip} | --dir0_bsid ${dut1_bsid}
| | ... | --dir0_srcsid ${dut1_srcsid} | --dir0_dstsid1 ${dut2_dstsid1}
| | ... | --dir0_dstsid2 ${dut2_dstsid2} | --dir1_srcsid ${dut2_srcsid}
| | ... | --dir1_dstsid1 ${dut1_dstsid1} | --dir1_dstsid2 ${dut1_dstsid2}
| | ... | --decap ${decap}
