...
| | | ... | host_dir=${host_dir} | guest_dir=${guest_dir} | image=${image}
| | | ... | cpu_count=${cpu_count} | cpu_skip=${skip_cpus} | smt_used=${False}
| | | ... | cpuset_mems=${cpu_node} | cpu_shared=${False} | env=${env}
| | | ... | count=${count}
...
| | | ... | name=${dut}_${group} | node=${nodes['${dut}']}
| | | ... | image=${image} | cpu_count=${1} | cpu_skip=${0} | smt_used=${False}
| | | ... | cpuset_mems=${cpu_node} | cpu_shared=${True} | publish=${publish}
| | | ... | command=${command}
| | Append To List | ${container_groups} | ${group}
