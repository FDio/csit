...
| | | ... | name=${dut}_${group} | node=${nodes['${dut}']} | host_dir=/tmp
| | | ... | image=${image} | cpu_cnt=${cpu_cnt} | skip_cnt=${skip_cpus}
| | | ... | cpu_node=${cpu_node} | smt_used=${False} | cpu_shared=${False}
| | | ... | count=${count}

| Create ETCD containers on all DUTs
...
| | | ... | node=${nodes['${dut}']} | name=${dut}_${group}
...
| Create Kafka containers on all DUTs
