...
| | |
| | | ${if1_avf_arr}= | Run Keyword Unless | '${${dut}_if1_1_status}' == 'PASS'
| | | ... | Init AVF interface | ${nodes['${dut}']} | ${${dut}_if1}
| | | ... | numvfs=${1} | osi_layer=${osi_layer}
| | | ${if1_1_avf_arr}= | Run Keyword If | '${${dut}_if1_1_status}' == 'PASS'
| | | ... | Init AVF interface | ${nodes['${dut}']} | ${${dut}_if1_1}
| | | ... | numvfs=${1} | osi_layer=${osi_layer}
| | | ${if1_2_avf_arr}= | Run Keyword If | '${${dut}_if1_2_status}' == 'PASS'
| | | ... | Init AVF interface | ${nodes['${dut}']} | ${${dut}_if1_2}
| | | ... | numvfs=${1} | osi_layer=${osi_layer}
| | |
| | | ${if2_avf_arr}= | Run Keyword Unless | '${${dut}_if2_1_status}' == 'PASS'
| | | ... | Init AVF interface | ${nodes['${dut}']} | ${${dut}_if2}
| | | ... | numvfs=${1} | osi_layer=${osi_layer}
| | | ${if2_1_avf_arr}= | Run Keyword If | '${${dut}_if2_1_status}' == 'PASS'
| | | ... | Init AVF interface | ${nodes['${dut}']} | ${${dut}_if2_1}
| | | ... | numvfs=${1} | osi_layer=${osi_layer}
| | | ${if2_2_avf_arr}= | Run Keyword If | '${${dut}_if2_2_status}' == 'PASS'
