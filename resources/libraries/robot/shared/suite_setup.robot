...
| | | ... | ${${dut}_vf${i}} | ${_vf}
| | | Set Suite Variable
| | | ... | ${${dut}_vf${i}_ip4_addr} | ${${dut}_pf${i}_ip4_addr}
| | | Set Suite Variable
| | | ... | ${${dut}_vf${i}_ip4_prefix} | ${${dut}_pf${i}_ip4_prefix}
| | | Set Suite Variable
| | | ... | ${${dut}_vf${i}_mac} | ${_mac}
| | | Set Suite Variable
| | | ... | ${${dut}_vf${i}_vlan} | ${_vlan}
| | | Set Suite Variable
| | | ... | ${prev_layer} | vf
| | END
...
| | ... | ${tg} | ${tg_if1} | ${tg_if2}
| | ... | ${dut1} | ${dut1_${prev_layer}1}[0]
| | ... | ${dut${duts_count}} | ${dut${duts_count}_${prev_layer}2}[0]
| | ... | ${osi_layer}
