...
| | ... | - count - Number of baseline interfaces. Type: integer
| | ...
| | ... | *Example:*
| | ...
...
| | ...
| | ... | *Arguments:*
| | ... | - count - Number of untagged interfaces. Type: integer
| | ...
| | ... | *Example:*
| | ...
...
| | ... | *Example:*
| | ...
| | ... | \| Initialize layer bonding on node \| DUT1 \| xor \| l34 \|
| | ...
...
| | Set Test Variable | ${${dut_str}_bond_1_1} | ${if_index}
| | Set Test Variable | ${${dut_str}_bond_1_2} | ${if_index}
...
| | ... | *Example:*
| | ...
| | ... | \| Initialize layer bonding \| xor \| l34 \|
| | ...
| | [Arguments] | ${bond_mode}=xor | ${lb_mode}=l34
| | ...
| | :FOR | ${dut} | IN | @{duts}
| | | Initialize layer bonding on node
...
| | ... | *Example:*
| | ...
| | ... | \| Initialize layer dot1q on node \| DUT1 \| 1 \|
| | ...
| | [Arguments] | ${dut} | ${count}=${1}
| | ...
| | ${dut_str}= | Convert To Lowercase | ${dut}
