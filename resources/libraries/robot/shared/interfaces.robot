...
| | | FOR | ${pci} | IN | @{${dut}_pf_pci}
| | | | ${curr_driver}= | Get PCI dev driver | ${dut} | ${pci}
| | | | Continue For Loop If | ${curr_driver} is ${None}
| | | | Run Keyword If | '${curr_driver}!='vfio-pci'
| | | | ... | PCI Driver Unbind | ${dut} | ${pci}
| | | END
