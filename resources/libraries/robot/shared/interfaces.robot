...
| |
| | Set Test Variable
| | ... | ${${dut}_${int}${pf}_ip4_addr} | ${${dut}_${int}${pf}_ip4_addr}
| | Set Test Variable
| | ... | ${${dut}_${int}${pf}_mac} | ${${dut}_${int}${pf}_mac}
| | Set Test Variable
| | ... | ${${dut}_${int}${pf}_pci} | ${${dut}_${int}${pf}_pci}
| | Set Test Variable
| | ... | ${${dut}_${int}${pf}_vlan} | ${${dut}_${int}${pf}_vlan}
...
| | | ${_mac}= | Get Interface MAC
| | | ... | ${nodes['${dut}']} | ${_avf}
| | | Set List Value | ${${dut}_${int}${pf}} | ${vf} | ${_avf}
| | | Insert Into List | ${${dut}_vf${pf}_mac} | ${vf} | ${_mac}
| | | Insert Into List | ${${dut}_vf${pf}_vlan} | ${vf} | ${_vlan}
| | END
...
| | ${_vlan}= | Get Variable Value | \${${dut}_${int}${pf}_vlan}
