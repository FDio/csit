...
| | FOR | ${pf} | IN RANGE | 1 | ${nic_pfs} + 1
| | | ${_vf}=
| | | ... | Copy List | ${${dut}_pf${pf}}
| | | ${_ip4_addr}=
| | | ... | Copy List | ${${dut}_pf${pf}_ip4_addr}
| | | ${_ip4_prefix}=
| | | ... | Copy List | ${${dut}_pf${pf}_ip4_prefix}
| | | ${_mac}=
| | | ... | Copy List | ${${dut}_pf${pf}_mac}
| | | ${_pci}=
| | | ... | Copy List | ${${dut}_pf${pf}_pci}
| | | ${_vlan}=
| | | ... | Copy List | ${${dut}_pf${pf}_vlan}
| | | Set Test Variable
| | | ... | ${${dut}_vf${pf}} | ${_vf}
| | | Set Test Variable
...
| |
| | ${_vf}=
| | ... | Copy List | ${${dut}_prevf${pf}}
| | ${_ip4_addr}=
| | ... | Copy List | ${${dut}_prevf${pf}_ip4_addr}
| | ${_ip4_prefix}=
| | ... | Copy List | ${${dut}_prevf${pf}_ip4_prefix}
| | ${_mac}=
| | ... | Copy List | ${${dut}_prevf${pf}_mac}
| | ${_pci}=
| | ... | Copy List | ${${dut}_prevf${pf}_pci}
| | ${_vlan}=
| | ... | Copy List | ${${dut}_prevf${pf}_vlan}
| | Set Test Variable
| | ... | ${${dut}_vf${pf}} | ${_vf}
| | Set Test Variable
| | ... | ${${dut}_vf${pf}_ip4_addr} | ${_ip4_addr}
