...
| | | ... | ${if2_vlan}
| | | Run Keyword If | ${create} and ${id} > ${1}
...
| | | ${if1_index}= | Set Variable If | ${if_index} is ${None}
| | | ... | ${${dut_str}_dot1q_${id}_1}
| | | ${if2_index}= | Set Variable If | ${if_index} is ${None}
| | | ... | ${${dut_str}_dot1q_${id}_2}
