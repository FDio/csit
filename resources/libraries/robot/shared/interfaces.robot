...
| | FOR | ${pf} | IN RANGE | 1 | ${nic_pfs} + 1
| | | Set Test Variable
| | | ... | ${${dut}_vf${pf}} | ${${dut}_${int}${pf}}
| | | Set Test Variable
| | | ... | ${${dut}_vf${pf}_ip4_addr} | ${${dut}_${int}${pf}_ip4_addr}
| | | Set Test Variable
| | | ... | ${${dut}_vf${pf}_mac} | ${${dut}_${int}${pf}_mac}
| | | Set Test Variable
| | | ... | ${${dut}_vf${pf}_pci} | ${${dut}_${int}${pf}_pci}
| | | Set Test Variable
| | | ... | ${${dut}_vf${pf}_vlan} | ${${dut}_${int}${pf}_vlan}
| | END
...
| | | Insert Into List | ${${dut}_vf${pf}_mac} | ${vf} | ${_mac}
| | | Insert Into List | ${${dut}_vf${pf}_vlan} | ${vf} | ${_vlan}
| | END
...
| | Insert Into List | ${${dut}_vf${pf}_mac} | 0 | ${_mac}
| | Insert Into List | ${${dut}_vf${pf}_vlan} | 0 | ${_vlan}
