...
| | ... | Variable Should Exist | @{${dut_str}_${prev_layer}${pf}_1}
| | ${_id}= | Set Variable If | '${_chains}' == 'PASS' | _1 | ${EMPTY}
| | FOR | ${if} | IN | @{${dut_str}_${prev_layer}${pf}${_id}}
...
| | FOR | ${vf} | IN RANGE | 0 | ${nic_vfs}
| | | ${_vlan}= | Get Interface Vlan
| | | ... | ${nodes['${dut}']} | ${${dut_str}_${prev_layer}${pf}}[${vf}]
...
| | | ... | ${nodes['${dut}']} | ${_avf}
| | | Set List Value
| | | ... | ${${dut_str}_${prev_layer}${pf}} | ${vf} | ${_avf}
| | | Insert Into List
| | | ... | ${${dut_str}_${prev_layer}${pf}_mac} | ${vf} | ${_mac}
| | | Insert Into List
| | | ... | ${${dut_str}_${prev_layer}${pf}_vlan} | ${vf} | ${_vlan}
| | END
...
| | | Set Test Variable
| | | ... | ${${dut_str}_${prev_layer}${pf}_${id}}
| | | ... | ${${dut_str}_${prev_layer}${pf}}
| | END
...
| | ... | ${nodes['${dut}']} | ${${dut_str}_${prev_layer}1_1} | ${if_index}
| | VPP Enslave Physical Interface
| | ... | ${nodes['${dut}']} | ${${dut_str}_${prev_layer}2_1} | ${if_index}
| | FOR | ${id} | IN RANGE | 1 | ${count} + 1
| | | Set Test Variable | ${${dut_str}_bond1_${id}} | ${if_index}
| | | Set Test Variable | ${${dut_str}_bond2_${id}} | ${if_index}
| | END
...
| | | ... | ${${dut_str}_dot1q${pf}_1} | ${_dot1q}
| | | ${_dot1q}= | Create List | ${_dot1q}
| | | Set Test Variable | ${${dut_str}_dot1q${pf}_${id}} | ${_dot1q}
| | END
...
| | ... | *Example:*
| |
| | ... | \| Initialize layer dot1q on node for chain \| DUT1 \
| | ... | \| 1 \| 1 \| True \|
| |
...
| | ... | ${NONE} | ${NONE}
| | ${default}= | Evaluate | ${pf} * ${100} + ${id} - ${1}
| | ${_vlan}= | Get Variable Value | \${${dut_str}_${pf}_vlan1}
| | ${_vlan}= | Set Variable If | '${_vlan}' != '${NONE}'
| | ... | ${_vlan} | ${default}
| | ${_name} | ${_index}= | Create Vlan Subinterface
| | ... | ${nodes['${dut}']} | ${${dut_str}_${prev_layer}${pf}_${id}}[0]
| | ... | ${_vlan}
...
| | ... | ${nodes['${dut}']} | ${${dut_str}_${prev_layer}${pf}_1}[0]
| | ... | 172.${pf}6.0.1 | 24
| | FOR | ${id} | IN RANGE | ${start} | ${count} + 1
...
| | | ... | interface=${${dut_str}_${prev_layer}${pf}_${id}}[0]
| | | Set VXLAN Bypass
| | | ... | ${nodes['${dut}']} | ${${dut_str}_${prev_layer}${pf}_${id}}[0]
| | | ${_ip4vxlan}= | Create List | ${_ip4vxlan}
| | | Set Test Variable
| | | ... | ${${dut_str}_ip4vxlan${pf}_${id}} | ${_ip4vxlan}
| | END
...
| |
| | ... | *Arguments:*
| | ... | - dut - DUT node data. Type: dictionary
| |
| | [Arguments] | ${dut}
| |
