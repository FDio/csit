...
| | [Arguments] | ${tg1_node} | ${dut1_node} | ${dut2_node} | ${tg2_node}
...
| | ... | ${dut_int_mac} | ${src_ip} | ${dst_ip}
| | Run Keyword And Expect Error | Traffic script execution failed
| | ... | Run Traffic Script On Node | send_ip6_icmp.py | ${tg} | ${args}
