...
| | Configure SR Policy on DUT | ${dut1} | ${dut1_bsid} | @{sid_list_dir0}
| | Configure SR Steer on DUT | ${dut1} | L3 | ${dut1_bsid}
| | ... | ip_addr=${dut2_sid1} | prefix=${sid_prefix}
...
| | Configure SR Policy on DUT | ${dut2} | ${dut2_bsid} | @{sid_list_dir1}
| | Configure SR Steer on DUT | ${dut2} | L3 | ${dut2_bsid}
| | ... | ip_addr=${dut1_sid2} | prefix=${sid_prefix}
