...
| | ${tg1_if2_mac}= | Get Interface MAC | ${tg} | ${tg_if2}
| | VPP Add IP Neighbor | ${dut1} | ${dut1_if1} | 1.1.1.1 | ${tg1_if1_mac}
| | VPP Add IP Neighbor | ${dut1} | ${dut1_if2} | 2.2.2.2 | ${tg1_if2_mac}
...
| | ${dut2_if1_mac}= | Get Interface MAC | ${dut2} | ${dut2_if1}
| | VPP Add IP Neighbor | ${dut1} | ${dut1_if1} | 1.1.1.1 | ${tg1_if1_mac}
| | VPP Add IP Neighbor | ${dut1} | ${dut1_if2} | 2.2.2.2 | ${dut2_if1_mac}
| | VPP Add IP Neighbor | ${dut2} | ${dut2_if1} | 2.2.2.1 | ${dut1_if2_mac}
| | VPP Add IP Neighbor | ${dut2} | ${dut2_if2} | 3.3.3.2 | ${tg1_if2_mac}
| | Vpp Route Add | ${dut1} | 10.10.10.0 | 24 | gateway=1.1.1.1
| | ... | interface=${dut1_if1} | vrf=${fib_table_1}
| | Vpp Route Add | ${dut1} | 20.20.20.0 | 24 | gateway=2.2.2.2
| | ... | interface=${dut1_if2} | vrf=${fib_table_2}
