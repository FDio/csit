...
| | | ... | dut1-vhost-${number}-if2 | feature_mask=disable_mrg_rxbuf
...
| | | ... | dut2-vhost-${number}-if2 | feature_mask=disable_mrg_rxbuf
...
| | | ... | ${dut}-vhost-${number}-if2 | feature_mask=disable_mrg_rxbuf
...
| | ... | ${tag_rewrite}
| | Configure vhost interfaces for L2BD forwarding | ${dut1}
| | ... | ${sock1} | ${sock2} | feature_mask=disable_mrg_rxbuf
