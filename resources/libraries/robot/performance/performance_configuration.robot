...
| | ... | qemu_id=${qemu_id} | smp=${nf_cpus_count} | mem=${4096} | vnf=${vnf}
| | ... | img=${perf_vm_kernel} | WITH NAME | ${vm_name}
| | Run keyword | ${vm_name}.Configure KernelVM VNF
| | ... | mac1=52:54:00:00:${qemu_id}:01 | mac2=52:54:00:00:${qemu_id}:02
| | ... | vif1_mac=${eth0_mac} | vif2_mac=${eth1_mac}
...
| | | ${sock1}= | Set Variable | /var/run/vpp/sock-${qemu_id}-1
| | | ${sock2}= | Set Variable | /var/run/vpp/sock-${qemu_id}-2
| | | ${nf_name}= | Set Variable | ${TEST NAME}${dut}_VM${qemu_id}
...
| Configure chains of NFs connected via vhost-user via manager
| | [Documentation]
| | ... | Start 1..N chains of 1..N QEMU guests (VNFs) with two vhost-user\
| | ... | interfaces and interconnecting NF.
| | ...
...
| | Run Keyword | vnf_manager.Start All VMs
| | Run Keyword | vnf_manager.Set Affinity All VMs
