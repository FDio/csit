...
| | | ... | dut1-vhost-${number}-if2 | feature_mask=disable_indirect_desc
...
| | | ... | ${dut}-vhost-${number}-if2 | feature_mask=disable_indirect_desc
...
| | ... | ${tag_rewrite}
| | Configure vhost interfaces for L2BD forwarding | ${dut1}
| | ... | ${sock1} | ${sock2} | feature_mask=disable_indirect_desc
