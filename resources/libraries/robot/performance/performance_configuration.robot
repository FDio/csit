...
| | ... | ${None} | ${dut2_nh} | ${None} | ${dut2-memif-1-if1}
| | ... | ${dut2-memif-1-if2} | ${dut1_sid1} | @{sid_list_dir0}
...
| | ... | ${None} | ${dut1_nh} | ${None} | ${dut1-memif-1-if1}
| | ... | ${dut1-memif-1-if2} | ${dut2_sid2} | @{sid_list_dir1}
| | ... | ELSE IF | "${behavior}" == "dynamic_proxy"
| | ... | Configure SR LocalSID on DUT | ${dut1} | ${dut1_sid2} | end.ad
| | ... | out_if=${dut1-memif-1-if1}
