...
| | | Vpp Route Add | ${nodes['${dut}']} | ${tg_if2_net} | 24 | vrf=${fib_table_1}
| | | ... | gateway=${ip_net_memif1}.1 | interface=${memif1}
| | | ... | multipath=${TRUE}
| | | Vpp Route Add | ${nodes['${dut}']} | ${tg_if1_net} | 24 | vrf=${fib_table_2}
| | | ... | gateway=${ip_net_memif2}.1 | interface=${memif2}
| | | ... | multipath=${TRUE}
...
| | | ... | ${memif_if2_key}
| | | Add arp on dut | ${dut} | ${memif1}
| | | ... | ${ip_net_memif2}.1 | ${memif_if2_mac}
| | | Add arp on dut | ${dut} | ${memif2}
