...
| Initialize underlay ethip4vxlan
| | [Documentation]
...
| | ... | *Example:*
| | ...
| | ... | \| Initialize underlay ethip4vxlan \| DUT1 \| 1 \|
| | ...
| | [Arguments] | ${dut} | ${nf_chain}=${1}
| | ...
| | ${dut_str}= | Convert To Lowercase | ${dut}
...
| | VPP Add IP Neighbor
| | ... | ${nodes['${dut}']} | ${${dut_str}_if1} | 172.16.${s}.2 | ${prev_mac}
| | VPP Add IP Neighbor
| | ... | ${nodes['${dut}']} | ${${dut_str}_if2} | 172.26.${s}.2 | ${next_mac}
| | VPP Route Add
...
| | Set VXLAN Bypass | ${nodes['${dut}']} | ${${dut_str}_if1}
| | Set VXLAN Bypass | ${nodes['${dut}']} | ${${dut_str}_if2}
...
| | ... | - underlay - Underlay encapsulation [if|ethip4vxlan]. Type: string
| | ...
| | ... | *Note:*
| | ... | Socket paths for VM are defined in following format:
| | ... | - /var/run/vpp/sock-\${VM_ID}-1
...
| | :FOR | ${dut} | IN | @{duts}
| | | Run Keyword
| | | ... | Initialize underlay ${underlay} | ${dut} | nf_chain=${nf_chain}
| | | Initialize L2 bridge domains with Vhost-User on node
