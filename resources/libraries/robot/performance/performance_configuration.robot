...
| Initialize IPv4 policer 2r3c-${t} in ${x}-node circular topology
| | [Documentation]
...
| | ${dut}= | Run Keyword If | '${x}' == '3' | Set Variable | ${dut2}
| | ... | ELSE IF | '${x}' == '2' | Set Variable | ${dut1}
| | ... | ELSE | Fail | Unsupported topology: ${x}-node
| | ${dut_if2}= | Run Keyword If | '${x}' == '3' | Set Variable | ${dut2_if2}
| | ... | ELSE IF | '${x}' == '2' | Set Variable | ${dut1_if2}
| | ... | ELSE | Fail | Unsupported topology: ${x}-node
| | Run Keyword If | '${x}' == '2' | Policer Set Name | policer2
