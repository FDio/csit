...
| Initialize L2 bridge domains with Vhost-User and VXLANoIPv4 in 2-node circular topology
| | [Documentation]
| | ... | Create two Vhost-User interfaces on the defined VPP nodes. Add each
| | ... | Vhost-User interface into L2 bridge domains with learning enabled
| | ... | with physical inteface.
| | ... | Setup VXLANoIPv4 between DUT and TG by connecting physical and vxlan
...
| | ... | 24
| | Configure IP addresses on interfaces | ${dut1} | ${dut1_if2} | 172.16.1.1
| | ... | 24
| | ${dut1s_vxlan}= | Create VXLAN interface | ${dut1} | 24
| | ... | 172.16.0.1 | 172.17.0.2
| | ${dut2s_vxlan}= | Create VXLAN interface | ${dut1} | 24
| | ... | 172.16.1.1 | 172.17.1.2
| | ${tg_if1_mac}= | Get Interface MAC | ${tg} | ${tg_if1}
| | ${tg_if2_mac}= | Get Interface MAC | ${tg} | ${tg_if2}
| | Add arp on dut | ${dut1} | ${dut1_if1} | 172.16.0.2 | ${tg_if1_mac}
| | Add arp on dut | ${dut1} | ${dut1_if2} | 172.16.1.2 | ${tg_if2_mac}
| | Vpp Route Add | ${dut1} | 172.17.0.0 | 24 | 172.16.0.2 | ${dut1_if1}
| | Vpp Route Add | ${dut1} | 172.17.1.0 | 24 | 172.16.1.2 | ${dut1_if2}
| | Configure vhost interfaces for L2BD forwarding | ${dut1}
| | ... | ${sock1} | ${sock2}
| | Add interface to bridge domain | ${dut1} | ${vhost_if1} | ${bd_id1}
| | Add interface to bridge domain | ${dut1} | ${dut1s_vxlan} | ${bd_id1}
| | Add interface to bridge domain | ${dut1} | ${vhost_if2} | ${bd_id2}
| | Add interface to bridge domain | ${dut1} | ${dut2s_vxlan} | ${bd_id2}
