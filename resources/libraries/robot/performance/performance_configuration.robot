...
| | | ... | Set Interface State | ${nodes['${dut}']} | ${${dut}_if2} |
...
| | ... | - bond_mode - Link bonding mode. Type: string
| | ... | - lb_mode - Load balance mode. Type: string
| | ... | - double_link - Use two links between DUTs if True. Type: boolean
| | ...
| | ... | *Example:*
| | ...
...
| | ... | \| Initialize L2 bridge domains with Vhost-User and VLAN with VPP\
| | ... | link bonding in a 3-node circular topology \| 1 \| 2 \| /tmp/sock1 \
| | ... | \| /tmp/sock2 \| 10 \| pop-1 \| xor \| l34 \| double_link=${TRUE} \|
| | ...
| | [Arguments] | ${bd_id1} | ${bd_id2} | ${sock1} | ${sock2} | ${subid}
| | ... | ${tag_rewrite} | ${bond_mode} | ${lb_mode} | ${double_link}=${FALSE}
| | ...
| | Run Keyword Unless | ${double_link} | Set interfaces in path up
| | Run Keyword If | ${double_link} | Set interfaces in path with double link between DUTs up
| | ${dut1_eth_bond_if1}= | VPP Create Bond Interface | ${dut1} | ${bond_mode}
| | ... | ${lb_mode}
| | Set Interface State | ${dut1} | ${dut1_eth_bond_if1} | up
| | VPP Set interface MTU | ${dut1} | ${dut1_eth_bond_if1}
| | Run Keyword Unless | ${double_link} | VPP Enslave Physical Interface
| | ... | ${dut1} | ${dut1_if2} | ${dut1_eth_bond_if1}
| | Run Keyword If | ${double_link} | VPP Enslave Physical Interface
