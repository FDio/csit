...
| | | Configure IP addresses on interfaces
| | | ... | ${dut1} | ${dut1_if2} | ${dut1_ip} | 24
| | | ... | ${dut2} | ${dut2_if1} | ${dut2_ip} | 24
| | | Add arp on dut | ${dut1} | ${dut1_if2} | ${dut2_ip} | ${dut2_if1_mac}
| | | Add arp on dut | ${dut2} | ${dut2_if1} | ${dut1_ip} | ${dut1_if2_mac}
| | | ${dut1_vxlan}= | Create VXLAN interface | ${dut1} | 24
| | | ... | ${dut1_ip} | ${dut2_ip}
| | | ${dut2_vxlan}= | Create VXLAN interface | ${dut2} | 24
| | | ... | ${dut2_ip} | ${dut1_ip}
| | | Add interface to bridge domain | ${dut1} | ${dut1_vxlan} | ${bd_id1}
| | | Add interface to bridge domain | ${dut2} | ${dut2_vxlan} | ${bd_id1}
| | | ${tg_if1_mac} = | Int To Mac | ${tg_if1_mac_int}
| | | ${tg_if2_mac} = | Int To Mac | ${tg_if12mac_int}
| | | Vpp Add L2fib Entry | ${dut1} | ${tg_if1_mac_int} | ${dut1_if1} | ${bd_id}
| | | Vpp Add L2fib Entry | ${dut2} | ${tg_if2_mac_int} | ${dut2_if2} | ${bd_id}
| | | Vpp Add L2fib Entry | ${dut1} | ${tg_if2_mac_int} | ${dut1_vxlan}
| | | ... | ${bd_id}
| | | Vpp Add L2fib Entry | ${dut2} | ${tg_if1_mac_int} | ${dut2_vxlan}
| | | ... | ${bd_id}
