...
| | ... | - ${trex_stream2_subnet} - IP subnet used by T-Rex in direction 1->0.
| | ... | Type: string
| | ... | - ${trex_if1_mac} - Source MAC address of traffic stream 1.
| | ... | Type: string
| | ... | - ${trex_if2_mac} - Source MAC address of traffic stream 2.
| | ... | Type: string
| | ... | - ${trex_mac_mask} - MAC address mask for traffic streams.
...
| | ${acl0}= | Catenate | ${acl}
| | ... | ipv4 ${acl_action} ip ${trex_stream1_subnet} mac ${trex_if1_mac}
| | ... | mask ${trex_mac_mask}
| | ${acl1}= | Catenate | ${acl}
| | ... | ipv4 ${acl_action} ip ${trex_stream2_subnet} mac ${trex_if2_mac}
| | ... | mask ${trex_mac_mask}
