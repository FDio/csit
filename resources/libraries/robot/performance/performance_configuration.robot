...
| | ... | ip_limit=${ip_limit} | tg_if_to_vxlan_mac_start=${tg_if2_mac_start}
| | ... | tg_if_to_vlan_mac_start=${tg_if1_mac_start} | mac_step=${mac_step}
...
| | ... | ip_limit=${ip_limit} | tg_if_to_vxlan_mac_start=${tg_if1_mac_start}
| | ... | tg_if_to_vlan_mac_start=${tg_if2_mac_start} | mac_step=${mac_step}
| | ... | mac_limit=${mac_limit} | bd_id_start=${bd_id_start}
