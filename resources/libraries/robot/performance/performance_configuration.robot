...
| | Configure SR Steer on DUT | ${dut1} | L3 | ${dut1_bsid}
| | ... | ip_addr=${tg_if2_ip6_subnet} | prefix=${sid_prefix}
| | ${dut2_out_if}= | Get Interface Name | ${dut2} | ${dut2-memif-1-if1}
| | ${dut2_in_if}= | Get Interface Name | ${dut2} | ${dut2-memif-1-if2}
| | Run Keyword If | "${behavior}" == "static_proxy"
| | ... | Configure SR LocalSID on DUT | ${dut2} | ${dut2_sid1} | end.as
| | ... | ${None} | ${dut2_nh} | ${None} | ${dut2_out_if}
| | ... | ${dut2_in_if} | ${dut1_sid1} | @{sid_list_dir0}
| | ... | ELSE IF | "${behavior}" == "dynamic_proxy"
| | ... | Configure SR LocalSID on DUT | ${dut2} | ${dut2_sid1} | end.ad
| | ... | next_hop=${dut2_nh} | out_if=${dut2_out_if}
| | ... | in_if=${dut2_in_if}
...
| | Configure SR Steer on DUT | ${dut2} | L3 | ${dut2_bsid}
| | ... | ip_addr=${tg_if1_ip6_subnet} | prefix=${sid_prefix}
| | ${dut1_out_if}= | Get Interface Name | ${dut1} | ${dut1-memif-1-if1}
| | ${dut1_in_if}= | Get Interface Name | ${dut1} | ${dut1-memif-1-if2}
| | Run Keyword If | "${behavior}" == "static_proxy"
| | ... | Configure SR LocalSID on DUT | ${dut1} | ${dut1_sid2} | end.as
| | ... | ${None} | ${dut1_nh} | ${None} | ${dut1_out_if}
| | ... | ${dut1_in_if} | ${dut2_sid2} | @{sid_list_dir1}
| | ... | ELSE IF | "${behavior}" == "dynamic_proxy"
...
| | ... | next_hop=${dut1_nh} | out_if=${dut1_out_if}
| | ... | in_if=${dut1_in_if}
| | ... | ELSE | Fail | Unsupported behaviour: ${behavior}
