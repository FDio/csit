...
| | ... | \| \${30.0} \| \${1.0} \| \${2} \| ${600.0} \| ${2} \|
| | ...
| | [Arguments] | ${frame_size} | ${traffic_profile} | ${maximum_transmit_rate}
...
| | ... | ${traffic_profile} | ${20000} | ${maximum_transmit_rate*2}
...
| | ... | ${traffic_profile} | ${min_rate} | ${maximum_transmit_rate*2}
...
| | ... | \| ${False} \| ${0} | ${1} \|
| | ...
| | [Arguments] | ${rate} | ${frame_size} | ${traffic_profile}
...
| | ... | ${frame_size} | ${traffic_profile} | ${subsamples} | ${unidirection}
| | ... | ${tx_port} | ${rx_port}
