...
| | ... | Fail if the resulting lower bounds hav too high drop fraction.
| | ...
| | ... | *Arguments:*
...
| | ... | ${intermediate_phases}=${2} | ${timeout}=${300.0}
| | ...
| | ${result}= | Perform optimized Trex ndrpdr search | ${frame_size}
| | ... | ${topology_type} | ${fail_rate} | ${line_rate}
| | ... | allowed_drop_fraction=${allowed_drop_fraction}
| | ... | final_relative_width=${final_relative_width}
| | ... | final_trial_duration=${final_trial_duration}
| | ... | initial_trial_duration=${initial_trial_duration}
| | ... | intermediate_phases=${intermediate_phases} | timeout=${timeout}
