...
| | [Documentation]
| | ... | Optionally, perform a trial to ramp-up (set state on DUTs).
...
| |
| | ... | *Test variables read:*
| | ... | - ramp_up_duration - Duration of ramp-up period [s]. Type: float
| | ... | If zero, the ramp-up phase is skipped.
| | ... | - ramp_up_rate - Rate [pps] for sending packets in ramp-up.
...
| | Run Keyword If | ${ramp_up_duration} | Send traffic on tg
