...
| | ... | ${\n}The following list contains the (bidirectional) receive rates
| | ... | from individual trials, in packets per second.${\n}Each of
| | ... | the ${subsamples} trials had duration of ${trial_duration} seconds.
| | Set Test Message | ${message}
| | Set Test Message | ${\n}Maximum Receive Rate Results ${results}
| | ... | append=yes
