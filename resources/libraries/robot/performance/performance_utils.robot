...
| | ${pdr_per_stream}= | Evaluate | ${rate_sum} / float(${traffic_directions})
...
| | Set Test Message | ${message_prefix} ${result.latency}${\n} | append=${True}
