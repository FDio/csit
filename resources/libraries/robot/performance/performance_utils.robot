...
| | Set Test Message | RAW_RESULTS: ${total_sent} sent,
| | Set Test Message | ${total_received} received pkts | append=yes
| | Set Test Message | (over ${perf_trial_duration} seconds) | append=yes
