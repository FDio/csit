...
| | ... | ${nodes} | profile=vpp_runtime.yaml | pids=${setup_vpp_pids}
| | Stop traffic on tg
...
| |
| | Run Telemetry On All DUTs
| | ... | ${nodes} | profile=vpp_clear_stats.yaml | pids=${setup_vpp_pids}
...
| |
| | Run Telemetry On All DUTs
| | ... | ${nodes} | profile=vpp_show_stats.yaml | pids=${setup_vpp_pids}
