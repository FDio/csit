...
| | Vpp Route Add | ${dut} | ${tg_lo_ip4} | ${ip4_plen} | ${tg_if_ip4}
| | ...           | ${dut_if}
...
| | ... | \| Setup Topology for IPv6 IPsec testing \|
| | Setup Path for IPsec testing
| | VPP Set If IPv6 Addr | ${dut} | ${dut_if} | ${dut_if_ip6} | ${ip6_plen}
| | VPP Set If IPv6 Addr | ${dut} | ${dut_lo} | ${dut_lo_ip6} | ${ip6_plen}
| | Add IP Neighbor | ${dut} | ${dut_if} | ${tg_if_ip6} | ${tg_if_mac}
| | Vpp All RA Suppress Link Layer | ${nodes}
| | Vpp Route Add | ${dut} | ${tg_lo_ip6} | ${ip6_plen} | ${tg_if_ip6}
| | ...           | ${dut_if}
