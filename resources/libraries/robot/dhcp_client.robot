...
| | ... |   specified, the hostname is not check). Type: string
| | ...
| | ... | *Return:*
| | ... | - No value returned.
| | ...
...
| | ... | *Arguments:*
| | ... | - tg_node - TG node. Type: dictionary
| | ... | - tg_interface - TGs interface where listen for DHCP DISCOVER,
...
| | ... | - client_mac - DHCP clients MAC address. Type: string
...
| | ...
| | ... | *Raises:*
| | ... | - Exception - if no DHCP REQUEST is received.
| | ... | - Exception - if DHCP REQUEST with wrong XID is received.
| | ...
| | ... | *Example:*
| | ...
...
| | [Documentation] | Run script that sends to the DHCP client IP configuration.
| | ...
| | ... | *Arguments:*
| | ... | - tg_node - TG node. Type: dictionary
| | ... | - tg_interface - TGs interface where listen for DHCP DISCOVER,
