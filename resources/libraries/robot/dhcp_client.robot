...
| Library  | resources.libraries.python.Dhcp.Client
| Library  | resources.libraries.python.TrafficScriptExecutor
| Documentation | DHCP Client specific keywords.

*** Keywords ***
| Check DHCP DISCOVER header
| | [Documentation] | Check DHCP message id contains all required fields.
| | ...
| | ... | *Arguments:*
...
| | ... | - hostname - DHCP clients hostname (Optional). Type: string
| | ...
| | ... | *Return:*
| | ... | - No value returned
| | ...
