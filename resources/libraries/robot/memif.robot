...
| | ... | - ${${memif_if1}} - Second Memif interface.
| | ...
| | ... | *Example:*
| | ...
| | ... | \| Set up memif interfaces on DUT node \
...
| | ... | \| Set up memif interfaces on DUT node \
| | ... | \| ${nodes['DUT2']} \| /tmp/sock1 \| /tmp/sock2 \| dut2_memif_if1 \
| | ... | \| dut2_memif_if2 \|
| | [Arguments] | ${dut_node} | ${sock1} | ${sock2} | ${memif_if1}=memif_if1
| | ... | ${memif_if1}=memif_if2
| | ${memif_1}= | Create memif interface | ${dut_node} | ${sock1}
| | ${memif_2}= | Create memif interface | ${dut_node} | ${sock2}
| | Set Interface State | ${dut_node} | ${memif_1} | up
| | Set Interface State | ${dut_node} | ${memif_2} | up
| | Set Test Variable | ${${memif_if1}} | ${memif_1}
| | Set Test Variable | ${${memif_if1}} | ${memif_2}
...
| |      | ... | ${sock1} | ${sock2} | dut1-memif-${number}-if1
...
| |      | ... | ${sock1} | ${sock2} | dut2-memif-${number}-if1
