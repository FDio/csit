...
def main():
    ...
    args = TrafficScriptArg(
        [
            u"tx_mac", u"rx_mac", u"src_ip", u"dst_ip",
    ...
    if valid_ipv4(src_ip) and valid_ipv4(dst_ip):
        ...
        ValueError(u"Invalid IP version!")
    ...
    if protocol.upper() == u"TCP":
        ...
        raise ValueError(u"Invalid protocol type!")
    wait_step = 2
    ...
    while True:
        ether = rxq.recv(wait_step, ignore=sent_packets)
        if ether is None:
    ...
    if TCP in ether:
        print (u"TCP packet received.")

    elif UDP in ether:
        print (u"UDP packet received.")
    else:
        raise RuntimeError(u"Not an TCP or UDP packet received " /
            f"{ether!r}")
