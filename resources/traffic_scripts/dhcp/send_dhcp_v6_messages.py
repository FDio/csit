...
def advertise(rx_if, tx_if, dhcp_multicast_ip, link_local_ip, proxy_ip,
...
def reply(rx_if, tx_if, dhcp_multicast_ip, link_local_ip, proxy_ip, server_ip,
...
def main():
    ...
    # ADVERTISE
    advertise(tx_if, rx_if, dhcp_multicast_ip, link_local_ip, proxy_ip,
              server_ip, server_mac, interface_id)
    ...
    # REPLY
    reply(tx_if, rx_if, dhcp_multicast_ip, link_local_ip, proxy_ip, server_ip,
          server_mac, interface_id)
