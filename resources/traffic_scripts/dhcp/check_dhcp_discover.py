...
def main():
    ...
    if bootp.op != boot_request:
        raise RuntimeError("BOOTP op error.")
    print "BOOTP op: OK"
    ...
    if bootp.yiaddr != '0.0.0.0':
        raise RuntimeError("BOOTP yiaddr error.")
    print "BOOTP yiaddr: OK"

    if bootp.siaddr != '0.0.0.0':
        raise RuntimeError("BOOTP siaddr error.")
    print "BOOTP siaddr: OK"

    if bootp.giaddr != '0.0.0.0':
        raise RuntimeError("BOOTP giaddr error.")
    print "BOOTP giaddr: OK"
    ...
    if bootp.file != 128*'\x00':
        raise RuntimeError("BOOTP boot file error.")
    print "BOOTP boot file: OK"
