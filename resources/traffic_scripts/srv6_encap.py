...
def check_srv6(
        pkt_recv, src_mac, dst_mac, src_ip, dst_ip, dir0_srcsid, dir0_dstsid1,
        dir0_dstsid2):
    ...
    :param dir0_srcsid: Source SID for SR in direction 0.
    :param dir0_dstsid1: Destination SID1 in direction 0.
    :param dir0_dstsid2: Destination SID2 in direction 0.
    :type pkt_recv: scapy.Ether
    :type src_mac: str
    :type dst_mac: str
    :type src_ip: str
    :type dst_ip: str
    :type dir0_srcsid: str
    :type dir0_dstsid1: str
    :type dir0_dstsid2: str
    ...
    if ip6_pkt.src != dir0_srcsid:
        raise RuntimeError(
            f"Outer IPv6 packet has invalid source address: "
            f"{ip6_pkt.src} should be: {dir0_srcsid}"
        )
    if ip6_pkt.dst != dir0_dstsid1:
        raise RuntimeError(
            f"Outer IPv6 packet has invalid destination address: "
            f"{ip6_pkt.dst} should be: {dir0_dstsid1}"
        )
    if dir0_dstsid2 == u"None":
        ...
        if ip6_pkt.addresses != [dir0_dstsid2, dir0_dstsid1]:
            raise RuntimeError(
                f"Segment Routing Header has invalid addresses: "
                f"{ip6_pkt.addresses} should be: {[dir0_dstsid2, dir0_dstsid1]}"
            )
...
def main():
    ...
    args = TrafficScriptArg(
        [
            ...
            u"src_ip", u"dst_ip", u"dir0_bsid", u"dir0_srcsid", u"dir0_dstsid1",
            u"dir0_dstsid2", u"dir1_srcsid", u"dir0_dstsid2", u"dir1_dstsid2",
            u"decap"
        ]
    )
    ...
    dir0_bsid = args.get_arg(u"dir0_bsid")
