...
def main():
    ...
    args = TrafficScriptArg(
        [
            ...
            u"src_ip", u"dst_ip", u"dut1_bsid", u"dut1_srcsid", u"dut1_dstsids",
            u"dut2_srcsid", u"dut2_dstsids", u"decap"
        ]
    )
    ...
    dut1_dstsids = args.get_arg(u"dut1_dstsids")
    dut2_srcsid = args.get_arg(u"dut2_srcsid")
    dut2_dstsids = args.get_arg(u"dut2_dstsids")
