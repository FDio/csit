...
rib_oper_template = {
    "loc-rib": {"tables": [
        ...
        {
            "afi": "bgp-types:ipv4-address-family",
            "safi": "bgp-labeled-unicast:labeled-unicast-"
...
rib_operational = deepcopy(rib_oper_template)
rib_operational["loc-rib"]["tables"][0]["bgp-inet:ipv4-routes"]["ipv4-route"] =\
    dut1_route["bgp-inet:ipv4-route"]
...
rib_ip6_operational = deepcopy(rib_ip6_oper_template)
rib_ip6_operational["loc-rib"]["tables"][0]["bgp-inet:ipv6-routes"]\
