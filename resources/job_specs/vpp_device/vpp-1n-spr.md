...
0c AND 64b AND scapy AND x710 AND drv_vfio_pci AND ethip4-flow-ip4-gtpu
##### ethip4-flow-ip4-ipsec-ah
0c AND 64b AND scapy AND x710 AND drv_vfio_pci AND ethip4-flow-ip4-ipsec-ah
##### ethip4-flow-ip4-ipsec-esp
0c AND 64b AND scapy AND x710 AND drv_vfio_pci AND ethip4-flow-ip4-ipsec-esp
##### ethip4-flow-ip4-l2tpv3oip
0c AND 64b AND scapy AND x710 AND drv_vfio_pci AND ethip4-flow-ip4-l2tpv3oip
##### ethip4-flow-ip4-ntuple-tcp
0c AND 64b AND scapy AND x710 AND drv_vfio_pci AND ethip4-flow-ip4-ntuple-tcp
##### ethip4-flow-ip4-ntuple-udp
0c AND 64b AND scapy AND x710 AND drv_vfio_pci AND ethip4-flow-ip4-ntuple-udp
##### ethip4-flow-ip4-tcp
0c AND 64b AND scapy AND x710 AND drv_vfio_pci AND ethip4-flow-ip4-tcp
##### ethip4-flow-ip4-udp
0c AND 64b AND scapy AND x710 AND drv_vfio_pci AND ethip4-flow-ip4-udp
##### ethip6-flow-ip6-ntuple-tcp
0c AND 64b AND scapy AND x710 AND drv_vfio_pci AND ethip6-flow-ip6-ntuple-tcp
##### ethip6-flow-ip6-ntuple-udp
0c AND 64b AND scapy AND x710 AND drv_vfio_pci AND ethip6-flow-ip6-ntuple-udp
##### ethip6-flow-ip6-tcp
0c AND 64b AND scapy AND x710 AND drv_vfio_pci AND ethip6-flow-ip6-tcp
##### ethip6-flow-ip6-udp
0c AND 64b AND scapy AND x710 AND drv_vfio_pci AND ethip6-flow-ip6-udp
## ./interfaces
### intel-x710
#### dpdk-vfio-pci
