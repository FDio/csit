...
2c AND 1518b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec40tnlsw-ip4base-int-aes128cbc-hmac512sha
4c AND 1518b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec40tnlsw-ip4base-int-aes128cbc-hmac512sha
1c AND imix AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec40tnlsw-ip4base-int-aes128cbc-hmac512sha
2c AND imix AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec40tnlsw-ip4base-int-aes128cbc-hmac512sha
4c AND imix AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec40tnlsw-ip4base-int-aes128cbc-hmac512sha
...
4c AND 1518b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec40tnlsw-ip4base-int-aes256gcm
...
3c AND 1518b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha
4c AND 1518b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha
2c AND imix AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha
3c AND imix AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha
...
3c AND 1518b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes256gcm
4c AND 1518b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes256gcm
2c AND imix AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes256gcm
3c AND imix AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec1tnlswasync-scheduler-ip4base-int-aes256gcm
...
3c AND 1518b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec8tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha
4c AND 1518b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec8tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha
2c AND imix AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec8tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha
3c AND imix AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec8tnlswasync-scheduler-ip4base-int-aes128cbc-hmac512sha
...
3c AND 1518b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec8tnlswasync-scheduler-ip4base-int-aes256gcm
4c AND 1518b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec8tnlswasync-scheduler-ip4base-int-aes256gcm
2c AND imix AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec8tnlswasync-scheduler-ip4base-int-aes256gcm
3c AND imix AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4ipsec8tnlswasync-scheduler-ip4base-int-aes256gcm
...
1c AND 64b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4gtpusw-ip4base
2c AND 64b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4gtpusw-ip4base
4c AND 64b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4gtpusw-ip4base
##### ethip4gtpuhw-ip4base
1c AND 64b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4gtpuhw-ip4base
2c AND 64b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4gtpuhw-ip4base
4c AND 64b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4gtpuhw-ip4base
##### ethip4udpwireguard1tnlsw-ip4base
1c AND 64b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4udpwireguard1tnlsw-ip4base
2c AND 64b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4udpwireguard1tnlsw-ip4base
4c AND 64b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip4udpwireguard1tnlsw-ip4base
### intel-e810xxv
#### dpdk-vfio-pci
##### ethip4gtpusw-ip4base
...
1c AND 78b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip6srhip6-ip6base-srv6proxy-dyn
2c AND 78b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip6srhip6-ip6base-srv6proxy-dyn
4c AND 78b AND ndrpdr AND cx6dx AND drv_rdma_core AND ethip6srhip6-ip6base-srv6proxy-dyn
