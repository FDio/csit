...
Stream profile:
 ...
 - Direction 0 --> 1:
   ...
   - Destination IP address range: 20.0.0.0 - 20.0.0.2
 - Direction 1 --> 0:
   - Source IP address range:      20.0.0.1
   - Destination IP address range: 10.0.0.0 - 10.0.0.2
"""
...
class TrafficStreams(TrafficStreamsBaseClass):
    ...
    def __init__(self):
        ...
        self.p2_dst_start_mac = '02:02:00:00:00:00'  # mask: 00:00:00:FF:FF:FF
        self.p2_dst_end_mac = '02:02:00:00:00:01'  # mask: 00:00:00:FF:FF:FF
