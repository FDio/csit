...
Stream profile:
 ...
 - Packet: ETH / IPv6 /
 - Direction 0 --> 1:
   - Source IP address range:      2001:1::3 - 2001:1::FF
   - Destination IP address range: 2001:2::2
 - Direction 1 --> 0:
   - Source IP address range:      2001:2::3 - 2001:2::FF
...
class TrafficStreams(TrafficStreamsBaseClass):
    ...
    def __init__(self):
        ...
        self.p1_src_start_ip = '2001:1::3'
        self.p1_src_end_ip = '2001:1::FF'
        self.p1_dst_start_ip = '2001:2::2'

        self.p2_src_start_ip = '2001:2::3'
        self.p2_src_end_ip = '2001:2::FF'
