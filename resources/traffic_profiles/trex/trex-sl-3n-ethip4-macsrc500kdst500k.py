...
class TrafficStreams(TrafficStreamsBaseClass):
    ...
    def define_packets(self):
        ...
        # Direction 0 --> 1
        vm1 = STLScVmRaw([STLVmFlowVar(name=u"mac_src",
                                       min_value=0,
                                       max_value=self.clients-1,
                                       size=4, op=u"inc"),
                          STLVmFlowVar(name=u"mac_dst",
                                       min_value=0,
                                       max_value=self.clients-1,
                                       size=4, op=u"inc"),
                          STLVmWrFlowVar(fv_name=u"mac_src", pkt_offset= 8),
                          STLVmWrFlowVar(fv_name=u"mac_dst", pkt_offset= 2),
        ...
        # Direction 1 --> 0
        vm2 = STLScVmRaw([STLVmFlowVar(name=u"mac_src",
                                       min_value=0,
                                       max_value=self.clients-1,
                                       size=4, op=u"inc"),
                          STLVmFlowVar(name=u"mac_dst",
