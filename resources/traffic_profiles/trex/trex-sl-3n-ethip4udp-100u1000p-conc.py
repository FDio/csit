    ...
    def define_packets(self):
        ...
        vm1 = STLScVmRaw([
            ...
            STLVmTupleGen(ip_min=self.p1_dst_start_ip,
                          ...
                          name=u"tuple1_dst"),
            STLVmWrFlowVar(fv_name=u"tuple1_src.ip", pkt_offset=u"IP.src"),
            STLVmWrFlowVar(fv_name=u"tuple1_dst.ip", pkt_offset=u"IP.dst"),
            STLVmFixIpv4(offset=u"IP"),
            STLVmWrFlowVar(fv_name=u"tuple1_src.port", pkt_offset=u"UDP.sport"),
            STLVmWrFlowVar(fv_name=u"tuple1_dst.port", pkt_offset=u"UDP.dport")
        ])
        # Direction 0 --> 1
        vm2 = STLScVmRaw([
            ...
            STLVmTupleGen(ip_min=self.p2_dst_start_ip,
                          ...
                          name=u"tuple2_dst"),
            STLVmWrFlowVar(fv_name=u"tuple2_src.ip", pkt_offset=u"IP.src"),
            STLVmWrFlowVar(fv_name=u"tuple2_dst.ip", pkt_offset=u"IP.dst"),
            STLVmFixIpv4(offset=u"IP"),
            STLVmWrFlowVar(fv_name=u"tuple2_src.port", pkt_offset=u"UDP.sport"),
            STLVmWrFlowVar(fv_name=u"tuple2_dst.port", pkt_offset=u"UDP.dport")
        ])
