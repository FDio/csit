...
Stream profile:
 ...
 - Direction 0 --> 1:
   - VLAN range:                       100 - 101
   - Source IP address:                172.17.0.2 - 172.17.1.2
   - Destination IP address:           172.16.0.1 - 172.16.1.1
 ...
 - Direction 1 --> 0:
   - VLAN range:                       100 - 101
   - Source IP address:                172.27.0.2 - 172.27.1.2
   - Destination IP address:           172.26.0.1 - 172.26.1.1
   - Source UDP port:                  random(1024-65535)
   - Destination UDP port:             4789
   - VXLAN VNI:                        0 - 1
