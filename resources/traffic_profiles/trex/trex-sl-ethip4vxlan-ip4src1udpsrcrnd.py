...
class TrafficStreams(TrafficStreamsBaseClass):
    ...
    def define_packets(self):
        ...
        vm1 = STLScVmRaw([
            ...
            STLVmWrFlowVar(fv_name=u'nf_id', pkt_offset=28),
            STLVmWrFlowVar(fv_name=u'src_port', pkt_offset=u'UDP.sport'),
            STLVmWrFlowVar(fv_name=u'nf_id', pkt_offset=48),
            STLVmWrFlowVar(fv_name=u'in_mac', pkt_offset=54),
            STLVmWrFlowVar(fv_name=u'in_mac', pkt_offset=60),
