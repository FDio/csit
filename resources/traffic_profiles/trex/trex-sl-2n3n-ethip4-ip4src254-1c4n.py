...
class TrafficStreams(TrafficStreamsBaseClass):
    ...
    def define_packets(self):
        ...
        # Direction 0 --> 1
        base_pkt_a = (
            Ether(dst=self.p1_dst_start_mac) /
        ...
        # Direction 1 --> 0
        base_pkt_b = (
            Ether(dst=self.p2_dst_start_mac) /
        ...
        vm1 = STLScVmRaw(
            [
                STLVmFlowVar(
                    ...
                    size=1, step=self.nf_nodes, op=u"inc"),
                STLVmWrFlowVar(fv_name=u"mac_dst", pkt_offset=4),
                STLVmFlowVar(
                    name=u"src",
                    min_value=self.p1_src_start_ip,
                    max_value=self.p1_src_end_ip,
                    size=4, op=u"inc"),
                STLVmWrFlowVar(fv_name=u"src", pkt_offset=u"IP.src"),
        ...
        vm2 = STLScVmRaw(
            [
                STLVmFlowVar(
                    ...
                    size=1, step=self.nf_nodes, op=u"inc"),
                STLVmWrFlowVar(
                    fv_name=u"mac_dst", pkt_offset=4),
                STLVmFlowVar(
                    name=u"src",
                    ...
                    size=4, op=u"inc"),
                STLVmWrFlowVar(
                    fv_name=u"src", pkt_offset=u"IP.src"),
                STLVmFixIpv4(
                    offset=u"IP")
            ]
        )
