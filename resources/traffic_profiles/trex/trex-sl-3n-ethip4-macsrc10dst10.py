...
Stream profile:
 ...
 - Packet: ETH / IP /
 - Direction 0 --> 1:
   - Source MAC address range:      ca:fe:00:00:00:00 - ca:fe:00:00:00:09
   - Destination MAC address range: fa:ce:00:00:00:00 - fa:ce:00:00:00:09
   - Source IP address range:       10.0.0.0 - 10.0.0.9
   - Destination IP address range:  20.0.0.0 - 20.0.0.9
 - Direction 1 --> 0:
   - Source MAC address range:      fa:ce:00:00:00:00 - fa:ce:00:00:00:09
   - Destination MAC address range: ca:fe:00:00:00:00 - ca:fe:00:00:00:09
   - Source IP address range:       20.0.0.0 - 20.0.0.9
   - Destination IP address range:  10.0.0.0 - 10.0.0.9
"""
...
class TrafficStreams(TrafficStreamsBaseClass):
    ...
    def __init__(self):
        ...
        self.p1_src_end_ip = '10.0.0.9'

        self.p1_dst_start_ip = '20.0.0.0'
        self.p1_dst_end_ip = '20.0.0.9'

        self.p2_src_start_ip = '20.0.0.0'
        self.p2_src_end_ip = '20.0.0.9'

        self.p2_dst_start_ip = '10.0.0.0'
        self.p2_dst_end_ip = '10.0.0.9'
