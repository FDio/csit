...
Stream profile:
 ...
 - Direction 0 --> 1:
   ...
   - Destination IP address range: 20.0.0.0 - 20.0.243.95
 - Direction 1 --> 0:
   - Source IP address range:      20.0.0.1
   - Destination IP address range: 10.0.0.0 - 10.0.243.95
"""
...
class TrafficStreams(TrafficStreamsBaseClass):
    ...
    def __init__(self):
        ...
        self.p1_dst_end_ip = '20.0.243.95'

        self.p2_src_start_ip = '20.0.0.1'
        self.p2_dst_start_ip = '10.0.0.0'
        self.p2_dst_end_ip = '10.0.243.95'
