...
Stream profile:
 ...
 - Direction 0 --> 1:
   - VLAN range:                       100 - 100
   - Source IP address:                172.17.0.2 - 172.17.0.2
   - Destination IP address:           172.16.0.1 - 172.16.0.1
   - Source UDP port:                  random(1024-65535)
   - Destination UDP port:             4789
   - VXLAN VNI:                        0 - 0
   - Payload source MAC address:       00:aa:aa:00:00:00 - 00:aa:aa:00:00:ff
   - Payload source IP address:        10.0.0.2
   - Payload destination MAC address:  00:bb:bb:00:00:00 - 00:bb:bb:00:00:ff
   - Payload destination IP address:   10.0.0.1
 - Direction 1 --> 0:
   - VLAN range:                       100 - 100
   - Source IP address:                172.27.0.2 - 172.27.0.2
   - Destination IP address:           172.26.0.1 - 172.26.0.1
   - Source UDP port:                  random(1024-65535)
   - Destination UDP port:             4789
   - VXLAN VNI:                        0 - 0
   - Payload source MAC address:       00:bb:bb:00:00:00 - 00:bb:bb:00:00:ff
   - Payload source IP address:        10.0.0.1
   - Payload destination MAC address:  00:aa:aa:00:00:00 - 00:aa:aa:00:00:ff
...
class TrafficStreams(TrafficStreamsBaseClass):
    ...
    def define_packets(self):
        ...
        vm1 = STLScVmRaw([
            ...
            STLVmFlowVar(name='src_mac', size=2, op='inc',
                         min_value=0, max_value=255),
            STLVmFlowVar(name='src_port', size=2, op='random',
                         min_value=1024, max_value=65535),
            STLVmFlowVar(name='vlan_id', size=2, op='inc',
                         min_value=100 + self.nf_chains,
                         max_value=100 + self.nf_chains),
            STLVmWrFlowVar(fv_name='vlan_id', pkt_offset="Dot1Q.vlan"),
        ...
        vm2 = STLScVmRaw([
            ...
            STLVmFlowVar(name='src_port', size=2, op='random',
                         min_value=1024, max_value=65535),
            STLVmFlowVar(name='vlan_id', size=2, op='inc',
                         min_value=100, max_value=100 + self.nf_chains - 1),
            STLVmWrFlowVar(fv_name='vlan_id', pkt_offset="Dot1Q.vlan"),
            STLVmWrFlowVar(fv_name='nf_id', pkt_offset=28),
            STLVmWrFlowVar(fv_name='nf_id', pkt_offset=32),
            STLVmWrFlowVar(fv_name='nf_id', pkt_offset=48),
