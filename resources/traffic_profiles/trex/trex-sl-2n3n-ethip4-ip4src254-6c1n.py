...
Stream profile:
 ...
 - Packet: ETH / IP /
 - Direction 0 --> 1:
   - Destination MAC address: 52:54:00:00:01:01 : 52:54:00:00:03:01
   - Source IP address range:      10.10.10.1 - 10.10.10.254
   - Destination IP address range: 20.20.20.1
 - Direction 1 --> 0:
    - Destination MAC address: 52:54:00:00:02:02 : 52:54:00:00:04:02
...
class TrafficStreams(TrafficStreamsBaseClass):
    ...
    def define_packets(self):
        ...
        vm2 = STLScVmRaw([STLVmFlowVar(name="mac_dst",
                                       ...
                                       max_value=self.nf_chains*self.nf_nodes+1,
                                       size=1, step=self.nf_nodes, op="inc"),
                          STLVmWrFlowVar(fv_name="mac_dst", pkt_offset=4),
                          STLVmFlowVar(name="src",
