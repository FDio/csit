...
if [ "${#}" -ne "0" ]; then
    ...
    wget -q "fast.dpdk.org/rel/dpdk-16.07.tar.xz"
    ...
    wget -q "https://nexus.fd.io/tldk/libpcap-dev_1.5.3-2_all.deb" -P ./TLDK-tests/tldk_deplibs
    wget -q "https://nexus.fd.io/tldk/libpcap0.8-dev_1.5.3-2_amd64.deb" -P ./TLDK-tests/tldk_deplibs
fi
