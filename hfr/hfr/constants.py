...
class Constants:
    ...
    DEFAULT_PATH_CONFIG = "hfr/configuration/app_conf.yaml"

    # Operational data
    DEFAULT_PATH_OPER = "/data"
    DEFAULT_OPER_DATA = "hfr_oper/data.json"
    DEFAULT_CSV_DATA = "hfr_oper/data.csv"
    DEFAULT_TESTBED_DATA = "hfr_oper/testbeds.csv"
    ...
    # Run again the cancelled runs?
    DEFAULT_RE_RUN_CANCELLED = False
    ...
    # Max waiting time for GHA run status to be changed to "in_progress"
    DEFAULT_MAX_TIME_FOR_RUN = 1200  # seconds
    ...
    HFR_RUN_STATUS = (
        ...
        "cancelled" # by GHA (e.g. timeout) or HFR
    )
