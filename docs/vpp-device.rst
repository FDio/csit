...
All DUT servers are to be managed and provisioned via the Ansible set of tasks
under *vpp-device* role.

SRIOV VF initialization is done by systemd service initialized during startup.
