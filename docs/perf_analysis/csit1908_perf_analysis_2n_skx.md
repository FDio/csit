...
4. resolution
  - report updates
    - TODO TF do not calculate delta [%], instead insert a marker
...
4. resolution
  - csit code updates:
    - TODO PM rename above tests to s/-1vm/-1vm-vppip4/, as these are
      new tests
    - TODO PM add tests with testpmd in vm as per previous releases
  ...
  - report updates:
    ...
    - TODO TF IMPORTANT NOTE: all tests from select-list must be listed
