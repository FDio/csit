...
------|--------------------------------------------------------------|--------------------------------------------------------------------
  1   | [csit/issues/4087](https://github.com/FDio/csit/issues/4087) | 2n-aws: Infrequent error 11 when dpdk plugin initializes interface.
  2   | [csit/issues/4088](https://github.com/FDio/csit/issues/4088) | Occasional timeout in iperf vhost non-gso.
  3   | [csit/issues/4089](https://github.com/FDio/csit/issues/4089) | 2n-zn2 iavf 2c: PDR fails due to delayed packets.
...
**#** | **Github issue number**                                      | **Issue Description**
------|--------------------------------------------------------------|----------------------------------------------------------------------
  1   | [csit/issues/4085](https://github.com/FDio/csit/issues/4085) | hoststack: udp tests with iperf and ldpreload are faster with strace.
