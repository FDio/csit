...
------|--------------------------------------------------------------|-----------------------------------------
  1   | [csit/issues/4140](https://github.com/FDio/csit/issues/4140) | udpquic: signum=11 on quic set fifo-size
...
------|--------------------------------------------------------------|-----------------------------------------------------------------------------------------------------
  ...
  9   | [csit/issues/4011](https://github.com/FDio/csit/issues/4011) | [CSIT-1929] Lossy trials in nat udp mlx5 and avf tests
 ...
 16   | [csit/issues/4030](https://github.com/FDio/csit/issues/4030) | [CSIT-1948] NICs do not consistently distribute tunnels over RXQs depending on model or plugin
 17   | [csit/issues/4033](https://github.com/FDio/csit/issues/4033) | [CSIT-1951] Combination of AVF and vhost drops all 9000B packets
 18   | [csit/issues/4043](https://github.com/FDio/csit/issues/4043) | [CSIT-1962] 3n-icx, 3na-spr: Udpquicscale tests sometimes fail with various symptoms
 19   | [csit/issues/4044](https://github.com/FDio/csit/issues/4044) | [CSIT-1963] 3n-icxd: Various symptoms pointing to hardware (cable/nic/driver) issues
 20   | [csit/issues/4045](https://github.com/FDio/csit/issues/4045) | [CSIT-1964] 3nb-spr, 3n-snr: Wireguardhw tests are likely to crash
 21   | [vpp/issues/3597](https://github.com/FDio/vpp/issues/3597)   | dev_iavf: Unable to use more queues than offered initially
 22   | [csit/issues/4073](https://github.com/FDio/csit/issues/4073) | Tests combining iavf+jumbo gradually run out of buffers for rx
 23   | [csit/issues/4076](https://github.com/FDio/csit/issues/4076) | 3n-icx: vhost mounting /dev failed
 24   | [csit/issues/4088](https://github.com/FDio/csit/issues/4088) | Occasional timeout in iperf vhost non-gso
 25   | [csit/issues/4089](https://github.com/FDio/csit/issues/4089) | 2n-zn2 iavf 2c: PDR fails due to delayed packets
 26   | [csit/issues/4090](https://github.com/FDio/csit/issues/4090) | crypto engine error in 1tnl wireguardhw test
 27   | [csit/issues/4091](https://github.com/FDio/csit/issues/4091) | udpquicbase fails due to: Echo connect failed
 28   | [csit/issues/4092](https://github.com/FDio/csit/issues/4092) | udp ldpreload fails on no test data retrieved
 29   | [csit/issues/4094](https://github.com/FDio/csit/issues/4094) | 3n-oct: unsent packets even at min load
 30   | [csit/issues/4096](https://github.com/FDio/csit/issues/4096) | rare crash in nginx tests
 31   | [csit/issues/4097](https://github.com/FDio/csit/issues/4097) | 2n-zn2 iavf: two-band structure in 1c mrr tests
 32   | [vpp/issues/3628](https://github.com/FDio/vpp/issues/3628)   | ip: route APIs are not thread safe
 33   | [csit/issues/4106](https://github.com/FDio/csit/issues/4106) | Unstable performance of ldpreload+tcp tests
 34   | [csit/issues/4113](https://github.com/FDio/csit/issues/4113) | 2n-grc: rarely, Linux is too slow to re-detect interfaces after VPP kill
 35   | [csit/issues/4118](https://github.com/FDio/csit/issues/4118) | GTPUhw jumbo has zero traffic due to tx_errors
...
------|--------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------
  ...
  7   | [csit/issues/4095](https://github.com/FDio/csit/issues/4095) | jumbo+iavf buffer alloc error: loadbalancer
  8   | [vpp/issues/3624](https://github.com/FDio/vpp/issues/3624)   | perfmon: asan reports global-buffer-overflow on Intel Xeons
  9   | [vpp/issues/3627](https://github.com/FDio/vpp/issues/3627)   | ASAN: VPP silently quits after 41560
 10   | [vpp/issues/3647](https://github.com/FDio/vpp/issues/3647)   | VPP crash in bad GTPUhw jumbo test since 43754
 11   | [csit/issues/4112](https://github.com/FDio/csit/issues/4112) | tests relying on docker fail on 3n-alt
...
**#** | **Github issue number**                                      | **Issue Description**
------|--------------------------------------------------------------|------------------------------------------------------------------------
  1   | [csit/issues/4029](https://github.com/FDio/csit/issues/4029) | [CSIT-1947] Rare VPP crash in nat avf tests
  2   | [vpp/issues/3579](https://github.com/FDio/vpp/issues/3579)   | [VPP-2118] 3n spr: Unusable performance of ipsec tests with SHA_256_128
  3   | [csit/issues/4066](https://github.com/FDio/csit/issues/4066) | 2n-icx: iavf bus error in one run
  4   | [csit/issues/4087](https://github.com/FDio/csit/issues/4087) | 2n-aws: Infrequent error 11 when dpdk plugin initializes interface
  5   | [csit/issues/4117](https://github.com/FDio/csit/issues/4117) | Zero traffic in GTPUhw jumbo tests
...
**#** | **Github issue number**                                      | **Issue Description**
------|--------------------------------------------------------------|---------------------------------------------
  1   | [csit/issues/4110](https://github.com/FDio/csit/issues/4110) | ARM (expected) anomalies near 2025-08-30
  2   | [csit/issues/4114](https://github.com/FDio/csit/issues/4114) | ip6 regressions end of November 2025
  3   | [csit/issues/4137](https://github.com/FDio/csit/issues/4137) | rls2610: Investigate ipsec anomalies
  4   | [csit/issues/4138](https://github.com/FDio/csit/issues/4138) | 2n-grc geneve regression around 2025-12-01
  5   | [csit/issues/4139](https://github.com/FDio/csit/issues/4139) | 2n-zn2 rdma ip4 regression around 2025-11-03
