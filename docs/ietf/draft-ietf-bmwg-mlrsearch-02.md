...
TODO: RFC2544 uses "tester", but also "test equipment".
Is there a difference? If yes, what exactly is "tester"?
...
so they are still sending them when next measurement starts.
...
(Very large buffers, non-determinism, warm up, perf decrease over time, ...)
...
### TODO: Short duration trials

### TODO: MRR as reasonable start

### TODO: Non-zero loss ratios

### TODO: Concurrent ratio search

### TODO: Load selection heuristics and shortcuts

## Strictness

TODO: Is this talk about vendors desirable?
...
thus leaving less freedom for vendors to achieve higher Throughput
for non-deterministic DUTs.

## Violations of RFC2544

It is possible to achieve even faster search times by violating
