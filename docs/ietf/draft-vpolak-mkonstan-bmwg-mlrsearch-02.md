...
* Packet rates transmitted by traffic generator and received by SUT/DUT
  are the same rate in each direction, in other words the load is symmetric.
...
* Multiple Intermediate Phases:
  ...
  * Search:
    ...
    * Each phase halves the previous width goal.
      ...
      * Only one bound than needs to be re-measured with new duration.
...
7. Pessimistic external search.
   * Valid bound becoming invalid on re-measurement with higher duration
     ...
     invalid bounds before the external search find a valid one.
...
(using input values as above).
Each of four columns show one bound, both aggregate bidirectional
offered load (in megapackets per second) and trial duration (in seconds).
Loss ratio is not shown, but invalid bounds are marked with a plus sign.
The first line is the result of the initial phase (MRR as valid upper bound,
MRR2 as invalid lower bound), the last line is the final search output.

|  NDR lower    | NDR upper    |  PDR lower    |  PDR upper    |
| ------------: | -----------: | ------------: | ------------: |
| +9.4372 1.000 | 10.547 1.000 | +9.4372 1.000 |  10.547 1.000 |
|  6.0534 1.000 | 9.4372 1.000 |  6.0534 1.000 |  9.4372 1.000 |
|  7.5583 1.000 | 9.4372 1.000 |  7.5583 1.000 |  9.4372 1.000 |
|  8.4456 1.000 | 9.4372 1.000 |  8.4456 1.000 |  9.4372 1.000 |
|  8.9276 1.000 | 9.4372 1.000 |  8.9276 1.000 |  9.4372 1.000 |
|  8.9276 1.000 | 9.1789 1.000 |  9.1789 1.000 |  9.4372 1.000 |
|  9.0524 1.000 | 9.1789 1.000 |  9.1789 1.000 |  9.4372 1.000 |
|  9.0524 1.000 | 9.1789 1.000 |  9.1789 1.000 |  9.3071 1.000 |
|  9.1154 5.477 | 9.1789 1.000 |  9.1789 1.000 |  9.3071 1.000 |
|  9.1154 5.477 | 9.1789 1.000 |  9.2428 5.477 |  9.3071 1.000 |
|  9.1154 5.477 | 9.1789 5.477 |  9.2428 5.477 |  9.3071 1.000 |
|  9.1154 5.477 | 9.1789 5.477 |  9.2428 5.477 | +9.3071 5.477 |
|  9.1154 5.477 | 9.1789 5.477 |  9.3071 5.477 |  9.6873 5.477 |
|  9.1154 5.477 | 9.1789 5.477 |  9.3071 5.477 |  9.4953 5.477 |
|  9.1154 5.477 | 9.1789 5.477 |  9.3071 5.477 |  9.4008 5.477 |
|  9.1154 5.477 | 9.1471 30.00 |  9.3071 5.477 |  9.4008 5.477 |
|  9.1154 5.477 | 9.1471 30.00 |  9.3071 5.477 |  9.3538 30.00 |
| +9.1154 30.00 | 9.1471 30.00 |  9.3071 5.477 |  9.3538 30.00 |
|  8.9347 30.00 | 9.1154 30.00 |  9.3071 5.477 |  9.3538 30.00 |
|  9.0246 30.00 | 9.1154 30.00 |  9.3071 5.477 |  9.3538 30.00 |
|  9.0699 30.00 | 9.1154 30.00 |  9.3071 5.477 |  9.3538 30.00 |
|  9.0699 30.00 | 9.1154 30.00 |  9.3071 30.00 |  9.3538 30.00 |
