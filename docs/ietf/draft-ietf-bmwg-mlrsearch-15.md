...
but those are not required in this documents
...
This document will introduce specific terms that function in analogous roles
as upper-bound and lower-bound in binary search,
...
The biggest difference between MLRsearch and [RFC2544] [Binary Search](#binary-search)
