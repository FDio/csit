...
* Multiple load selection heuristics to save time
 by avoiding unnecessarily narrow intervals.
...
TODO: Is it possible to make MLRsearch fully compliant with RFC2544
at least for some specific parameter values?
