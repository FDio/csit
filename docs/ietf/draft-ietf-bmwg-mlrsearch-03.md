...
{::comment}
I have rewritten above section making it shorter and removing
...
{::comment}
I have edited above section making it shorter, removing repetitions and
unclear terms. See below.
{:/comment}

Searching for multiple loss ratio goals also helps to describe the DUT
...
{::comment}
MLRsearch is about searching for multiple throughputs at multiple packet
loss ratios. If so, why don't call it Multiple Loss Ratio search
criteria? Instead of referring to abstracted "general" criteria or
criterion?
{:/comment}
...
{::comment}
This should be clear from the description, without a need for a separate
section.
{:/comment}
...
{::comment}
Above paragraph is redundant.
Isn't this a common experience that noise can be masked out by just 
accepting higher loss?
{:/comment}
