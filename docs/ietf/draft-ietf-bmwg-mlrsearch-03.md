...
{::comment}
TODO: Some of above are clear, some are not. Some apply only to final
phase, some are not. There should be a description of the ordered list
of search criteria per each phase, capturing how they are evaluated per
phase, how do they change/evolve while progressing through phases, and
how they apply in the final phase. Summary of it should be captured
here, with the functional description in the "MLRsearch
