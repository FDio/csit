...
Emergence of software networking DUTs with frequent software updates and
a number of different packet processing modes drives the requirement of
...
For each criterion, MLRsearch returns tight enough
...
{::comment}
This section looks incomplete to me. 
Ordered search criteria should be described more completely than it is right now IMV.
In general it is hard to follow.
{:/comment}
...
until sum of the overall sub-trial durations reaches
...
(as opposed to offered load values required by RFC 2889),
