...
* Be conservative when encountering loss inversion.
...
* Requre less strict width condition for earlier phases.
* External search when previous bound becomes invalid.
* Use FRMOL and forwarding rate at it to initialize early phases.
* Allow uneven interval splits to save some bisects.
