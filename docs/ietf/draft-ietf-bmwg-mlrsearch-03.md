...
Search for final lower and upper bounds is performed one-by-one
for an ordered list of criteria, where a criterion includes:
...
overall search time, result repeatability and RFC2544 compliance.
