...
<mark>~~[VP] DONE for MK: Unmark this paragrah and delete your comment from the definition:
...
but the test report MUST explicitly mention how non-constant the traffic is.~~</mark>
...
<mark>~~DONE mk edit note: Above sentence does not make sense to me.
...
<mark>~~[VP] DONE for MK: Unmark text above and delete your note (also from section title).~~</mark>
...
<mark>~~DONE mk edit note: How does it look if GFTD is 60secs per
RFC2544? And when GFTD is 30secs? And when GFTD is 15secs? And
7.5secs?~~</mark>

<mark>~~[VP] DONE for MK: Review the linked discussion, the unmark and delete.~~</mark>
...
<mark>~~[VP] DONE for MK: Trial-Effective-Duration is optional.
Trial Duration Sum is fundamental, but now has examples in the specification.
Please review and clear your P0 notes if good enough.~~</mark>
...
Determining which trial exactly is defined in [MLRsearch Specification](#MLRsearch-Specification),
...
<mark>~~[VP] DONE for MK: Re-review after the "hard limit" paragraphs were added.~~</mark>
...
Note that comparing <mark>the best and the worst case</mark>, the same Relevant Lower Bound value
may result in the Conditional Throughput differing up to the Goal Loss Ratio.

<mark>mk edit note: It is unclear what "best and worst case" is here. Are those referring to [Trials with Single Duration] section?</mark>
