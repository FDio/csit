...
<mark>[VP] TODO: New, review after ir/regular results are defined properly.</mark>
...
<mark>~~[VP] DONE for MK: Revew the three new paragraphs above. MK LGTM.~~</mark>
...
<mark>~~[VP] DONE for MK: Revew the preceding new paragraph. MK LGTM.~~</mark>
...
<mark>~~[VP] DONE for MK: Review paragraph above, edited to address previous MKP1. MK LGTM.~~</mark>
...
<mark>~~[VP] DONE for MK: the above got edited to address previous MKP2.  MK LGTM.~~</mark>
...
<mark>~~[VP] DONE for MK: Used non-capitalized generic "search results" above,
so people remember overview instead of reading ahead. Was MKP2.  MK LGTM.~~</mark>
...
<mark>~~[VP] DONE for MK: Edited, was MKP2. MK LGTM.~~</mark>
...
<mark>[VP] TODO for MK1: Previous notes got MKP1 after I deleted them.
Recheck those issues got addressed in other subsections.</mark>
...
<mark>MKP2 MK note: Discussion paragraphs are ambiguous and incomplete.
Requires work.</mark>
...
<mark>MKP2 [VP] TODO: Soft-define irregular here, better.</mark>

<mark>MKP2 MLRsearch specification puts requirements on regular Goal Result instances.
Any instance that does not meet the requirements is deemed irregular.</mark>


<mark>MKP2 Some of the attributes of a regular Goal Result instance are required,
...
<mark>MKP2 A typical irregular result is when all trials at the max load
...
<mark>~~[VP] DONE for MK: Review the following paragpah. MK LGTM.~~</mark>
...
<mark>MKP2 [VP] TODO: Add link to RFC2544 Goal subsection here.</mark>
...
should have specific reference link.</mark>
...
<mark>MKP2 [VP] TODO: Link to RFC2544 Goal.</mark>
