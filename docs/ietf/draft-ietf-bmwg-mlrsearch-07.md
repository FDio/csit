...
<mark>~~DONE: Each RFC reference should mentions specific subsection.~~</mark>
...
<mark>mk edit note: Isn't this definition clear enough. Why additonal wordy "decoration" implied by this TODO?</mark>
...
This section focuses on additional considerations, intuitions and motivations pertaining to MLRsearch methodology.

<mark>~~Familiarity with MLRsearch specification is not required here,
so this section can act as an introduction.~~</mark>
...
from MLRsearch specification.~~</mark>
...
<mark>than the Relevant Lower Bound, especially for non-zero Goal Loss Ratio values,</mark>
<mark>the actual definition is more complicated than the definition of the Relevant</mark>
<mark>Lower Bound.</mark>

<mark>mk edit note: Preceding paragraphs create an expectation that Conditional Throughput is directly related if not equal to the Relevant Lower Bound. But this paragraph negates that, without giving any explanation. This needs to be rewritten.</mark>
...
<mark>mk edit note: This paragraph adds to the confusion. Further reference to other "intuitive values" and feelings is unlikely to help the reader to understand what is meant by Conditional Throughput. This needs to be rewritten, hence Priority-Zero, or P0 TODO here.</mark>
...
<mark>mk edit note: In summary, this section needs much crispier explanation of how (and if/when) Conditional Throughput is different from the Relevant Lower Bound, for specific goal. This is fundamental to MLRsearch, hence Priority-Zero, or P0 TODO here.</mark>
