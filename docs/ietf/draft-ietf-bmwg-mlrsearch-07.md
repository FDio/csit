...
<mark>[VP] TODO: Move the following somewhere after MLRsearch
...
<mark>mk edit note: Bizarre ... i can't find tester definition in
...
<mark>[VP] TODO: New idea. Compare the tester to an ordinary router
...
<mark>[VP] TODO: That new idea warants some discussion in "DUT within SUT",
...
<mark>[VP] TODO: Mention [RFC2544] (section 11. Modifiers) here.</mark>
...
<mark>"Questions around what is the correct number of frames that should
...
<mark>[VP] TODO: Subsections that define Goal Result attributes.</mark>

<mark>mk2 TODO for VP: There is no mention of any "sum" or "sums" in [Goal Result]
...
<mark>mk edit note: I can't see any of these attributes mentioned in
...
<mark>[VP] TODO: 2544 and 2285 care about half-duplex media. Should we?</mark>
...
<mark>mk edit note: This shouldn't be covered here, but elsewhere, if at
...
<mark>mk edit note: This does not make sense here. Above line is not
needed and needs to be removed.</mark>
...
<mark>mk edit note: And if we need it, shouldn't it say: The Manager may
...
<mark>mk edit note: This is unclear and looks like mental shortcut.
...
<mark>mk edit note: Renamed this section from "Further Explanations", as
...
<mark>mk edit note: Suggest to remove crossed-out text, as it is
...
<mark>[VP] TODO: Still not sure what to do with this subsection.
...
Note that when comparing <mark>the best (all zero loss) and worst case (all loss
...
<mark>mk edit note: Isn't this going off on a tangent, hypothesising and
...
<mark>MK to VP: My preference would be to avoid extensive sections on
...
<mark>[VP] TODO: Introduce quantiles properly by incorporating the below.</mark>
...
<mark>mk2 TODO for VP: Above is not making it clearer at all. Can't we really not explain the spectrum and exceed ratio with just percentiles and quantiles?</mark>
...
<mark>P0 TODO for VP: please address the "q-value" edit note points
...
<mark>mk edit note: This is future looking and hand wavy without
...
<mark>mk edit note: I do not get the defintion of optimistic and
pessmistic exceed ratios. Please define or describe what they
are.</mark>

<mark>mk edit note: and what is the "effective loss ratio" vs just loss
...
<mark>mk edit note: It may be worth adding why that is. i.e. because
...
<mark>[VP] TODO: Conversely, when Goal Width do not match well,
