...
<mark>~~mk edit note: removed "the" preceding any references to "MLRsearch
specification" - 6 instances only.~~</mark>

<mark>~~DONE mk: Recheck the definition dependencies go bottom-up.~~</mark>

<mark>~~mk edit note: addressed with hyperlinks to sections.
MLRspecification reads okay, the rest is to be completed. This TODO is
replaced with the overarching goal of content and explanation clarity
and unambiguity, avoid "hand waving" and non-specific reference
like "later chapter/section", "other chapter/section", "later"
or "earlier", or "in another place".~~</mark>

<mark>~~For additional motivations, explanations, and other comments see
other chapters.~~</mark>
...
<mark>~~TODO mk: Separate Requirements and Recommendations/Suggestions
paragraphs? (currently requirements are in discussion subsections -
discussion should only clarify things without adding new
requirements)~~</mark>

<mark>~~TODO mk: Which dependency order?(applies specifically to
discussion)~~</mark>
...
<mark>~~mk edit note: I think it is useful to use upper case letter for
names of components, as it distinguishes them in the text and makes it
clear to the reader that it Manager means a system components vs say a
management function. Applied it above, but leaving as is in the rest of
the document.~~</mark>

<mark>MKP2 [VP] TODO: Move the following somewhere after MLRsearch
specification chapter. Controller implementation may be agnostic to
Measurer implementation. Measurer implementation has to be familiar
with both. </mark>
...
Only four existing terms are mentioned in this section and used in the
following MLRsearch definitions. Other existing terms are mentioned in
discussion paragraphs. 

<mark>~~mk edit note: - is this redundant now? TODO VP: List those other
existing terms.~~</mark>

<mark>~~mk edit note: - is this redundant now? TODO: Mention DUT and
tester here, not in subsections?~~</mark>
...
<mark>MKP3 [VP] TODO: Instead, see RFC2285 on how to direct reader to RFCs.</mark>
...
<mark>MKP3 mk edit note: Bizarre ... i can't find tester definition in
...
<mark>MKP2 mk edit note: Above line is not needed and needs to be removed.</mark>

<mark>MKP2 [VP] TODO: I am not sure. Maybe just move to a different chapter
...
<mark>MKP2 mk TODO for VP: deletion of "and constant" from definition works.
And additional text you added in Discussion above addresses my point.
Thank you."</mark>
...
<markMKP2 >[VP] TODO: Also mention input frame rate [RFC2544] (23. Trial description).</mark>
...
<mark>MKP2 [VP] TODO: Do not mention the Measurer yet.</mark>
...
<mark>MKP2 [VP] TODO: Bi- and multi- directional belongs here.</mark>

<mark>MKP2 [VP] TODO: Bursty traffic also should be mentioned here.</mark>

<mark>MKP2 [VP] TODO: Mention [RFC2544] (section 11. Modifiers) here.</mark>
...
<mark>~~mk edit note: Wording is simple, short and good. Above line is not
needed and needs to be removed.~~</mark>
...
<mark>MKP2 [VP] TODO: Search goals not defined yet!
...
this document in section [Controller Output](#Controller-Output). For
example, the Conditional Throughput for this goal is computed only from
...
<mark>MKP1 See later sections for details on which sums.</mark>

<mark>MKP1 mk edit note: Which sections?</mark>

<mark>MKP1 [VP] TODO: Subsections that define Goal Result attributes.</mark>

<mark>MKP1 mk2 TODO for VP: There is no mention of any "sum" or "sums" in [Goal Result]
(#Goal-Result) subsection. Shouldn't it point to [Logic of Load
Classification](#Logic-of-Load-Classification) section instead?</mark>

Informally, the impact of lossy trials is controlled by this value.
Effectively, Goal Exceed Ratio is a percentage of full-length trials that may be lossy
without the load being classified as [An Upper Bound](#An-Upper-Bound).

<mark>~~[VP] TODO for MK: Replaced and shortened the example.
No mention of quantiles, not even the median.
I relied on "percentage is ratio in a different unit" shortcut.~~</mark>

<mark>~~mk2: Looks much better, thank you. But the reference to
specific section/subsection is still required.~~</mark>
...
for search stopping condition purposes.

<mark>MKP2 mk edit note: Is "search stopping conditions" described anywhere?
...
The meaning of listed attributes is formally given only by their effect
on the Controller Output attributes
(defined in section [Search Result](#Search-Result)).

<mark>MKP2 mk edit note: I can't see any of these attributes mentioned in
[Search Result](#Search-Result). Either they have to be added there, or
this sentence to be changed or removed.</mark>
...
are passed (as if) outside the visibility of the Controller.

<mark>MKP2 mk edit note: Unclear sentence. "are passed" where and by whom and what for?</mark>
...
This is THE goal implied by RFC2544. Calling it an example feels wrong.~~</mark>

<mark>~~mk3 note: Agree. Renamed.~~</mark>
...
so once again I do not like to call it an example.~~</mark>
...
<mark>MKP1 mk edit note: This shouldn't be covered here, but elsewhere, if at
all. Above line is not needed and needs to be removed.</mark>

<mark>MKP1 [VP] TODO: Introduce "a bounds"
...
### <mark>~~P0 TODO Upper Bound~~</mark>

<mark>MKP2 remove all of this section</mark>

Definition:

Relative to a search goal, any load is classified as an upper bound
if the procedure described in [Appendix A: Load Classification](#Appendix-A\:-Load-Classification) says so.

<mark>mk P0 TODO VP: I do not see a need for the Upper Bound definition.
Relevant Upper Bound definition and section is good enough for me. In fact separate wordy
definitions, with duplicate text summarizing what Appendix A describes
add to confusion.</mark>
...
<mark>mk TODO VP: I do not see a need for the Lower Bound definition.
Relevant Lower Bound definition and section is good enough for me.  In
fact separate wordy definitions, with duplicate text summarizing what
Appendix A describes add to confusion.</mark> 
...
Simply, the smallest load among upper bounds (of this search goal) at the end.
...
<mark>MKP2 [VP] TODO: Mention min load here?</mark>

<mark>MKP2 [VP] TODO: Allow zero as implicit lower bound that needs no trials?
...
<mark>~~mk edit note: Why is this needed here and not elsewhere e.g. in
[Trial Result](#Trial-Result) section, if at all? Above line is not
needed and needs to be removed.~~</mark>

### Goal Result

<mark>MKP2 mk edit note: Discussion paragraphs are ambiguous and incomplete.
Requires work.</mark>
...
<mark>MKP2 TODO: Separate definition for regular instances?</mark>

<mark>~~mk edit note: Definitions of regular and irregular Goal Result
instance is missing. Above sentence needs to be edited or
removed.~~</mark>

<mark>MKP2 [VP] SOLVED: Irregular and Regular results will have separate definitions.</mark>

<mark>MKP2 [VP] TODO: Add those definitions.</mark>

<mark>MKP2 [VP] TODO: Only then remove this set of marked comments.</mark>
...
Regular Goal Result instances are the ones that have Relevant Upper Bound and Relevant Lower Bound values.

Irregular Goal Result instances are the ones that do not have either Relevant Upper Bound values or Relevant Lower Bound values, or both.
...
<mark>MKP2 (TODO: trial results here if not before)</mark>

<mark>MKP2 mk edit note: This does not make sense here. Above line is not
needed and needs to be removed.</mark>
...
as irregular according to this section.
...
<mark>~~mk edit note: this is an example not a definition. Definitions of
regular and irregular Goal Result instance is missing. Above sentence
needs to be edited or removed.~~</mark>
...
<mark>MKP1 [VP] TODO: Or allow derivatives like ir/regular flag?</mark>
...
<mark>~~mk edit note: Why is it needed here and now? If needed, can we
move it to future work that is out of scope or other considerations
that are out of scope of this document?~~</mark>
...
<mark>MKP2 [VP] TODO: Double-check "instance" is introduced properly enough.</mark>
...
<mark>MKP2 Goal Width or other attributes act directly as requirements
...
The Manager may use the Measurer or other system components
to perform other tests, e.g. back-to-back frames,
as the Controller is only replacing the search from
[RFC2544] (section 26.1 Throughput).

<mark>MKP2 mk edit note: Is above sentence needed? What value does it bring?</mark>

<mark>MKP2 mk edit note: And if we need it, shouldn't it say: The Manager may
use the Controller or other system components to perform other tests,
e.g. back-to-back frames, as the Controller is only replacing the
search from [RFC2544] (section 26.1 Throughput).</mark>
...
<mark>~~mk edit note: I took freedom to rename it, removed Definition and
Discussion sub-headers and adjusted the first paragraph accordingly.
...
~~<mark>mk edit note: I don't see any conditions or conditional compliance
being specified in RFC2544 section 26.1. IOW this sentence doesn't make
sense.~~</mark>

can be understood as a MLRsearch architecture,
assuming there is enough data to reconstruct the Relevant Upper Bound.
<mark>MKP2 TODO: Move the Search Goal instance for 2544 compliant search here.</mark>

<mark>MKP2 mk edit note: This is unclear and looks like mental shortcut.
There is mention of compliance with RFC2544 in [Purpose and Scope]
(#Purpose-and-Scope) and in [[RFC2544] Compliance](#\
[RFC2544\]-Compliance) . Do you mean moving content from these sections
into here, or something else?</mark>
...
<mark>~~TODO: Does the test procedure need to be able to produce a
regular search result?~~</mark>

<mark>~~mk edit note: Above line is not needed and needs to be removed.~~</mark>

<mark>~~TODO: Modularity, e.g. freedom to swap Measurer hardware and
Controller software as long as the Manager understands communication
protocols of both?~~</mark>
...
<mark>MKP2 mk edit note: Renamed this section from "Further Explanations", as
it better reflects the content.</mark>

<mark>MKP2 [VP] I suggest to review chapter/section names
...
<mark>~~mk edit note: What value does this sentence bring to this
specification? If it's about spec evolving over time with code based on
the challenges and problems faced, and this spec following that
journey, then it should be described like that. Otherwise the text
should be removed.~~</mark>

The code in <mark>~~(any version of)~~</mark> MLRsearch <mark>library</mark> fully determines
the search process (for a given set of configuration parameters),
leaving no space for deviations.

<mark>MKP2 mk3 note: any references to library, should have specific reference link.</mark>
...
<mark>MKP2 mk edit note: "library" or "specification"? I prefer the latter.</mark>
...
<mark>~~mk DONE for VP: I get that Trial-Effective-Duration is optional
...
here. Just saying that duration sum has a big impact is not
enough :).~~</mark>

<mark>~~mk note: Clear enough now, with text additions [ Trial Effective
Duration] and minor edit above. LGTM.~~</mark>

<mark>~~DONE VP to MK: The CSIT reason is ASTF tests where we want to hit
each session once. That means the real traffic duration
is scale divided by Trial Load, and Trial Duration value is ignored.
small scale trials are faster than 1s, large scale trials are longer.
I want to control test duration, so I use real duration
as the Trial Effective Duration. That way small scale test gests more trials,
large scale test gets less trials. Repeatability is still as bad as before,
but at least type of test is less important for job duration.
And of course, for STL tests, the current inevitable 0.45s overhead between
1s trials is already too much, forget about 2s+5s from RFC2544 trial description.
Simply, I do not want to REQUIRE something I know CSIT will violate.
See also (search for) newly added "allowed if makes worse" principle.~~</mark>

<mark>~~mk note: It's fine. No further explanations required. Thank you.~~</mark>
...
<mark>~~mk DONE for VP: All of the following paragraphs are good
...
<mark>~~DONE VP to MK:
"Trial Forwarding Rate of a full-length trial at the Relevant Lower Bound"
is the simple part. Explaining which trial gets selected is tricky.
Especially if I say q-quantile when I mean something else entirely. :(~~</mark>
...
<mark>~~[VP] DONE for MK: Edited the marked part. Good now?~~</mark>

<mark>~~mk2 note: LGTM.~~</mark>
...
<mark>~~mk DONE for VP: I have reviewed again, text looks good, but to
...
<mark>MKP2 [VP] TODO: Mention also comparability of CT.</mark>
...
<mark>MKP2 [VP] TODO: All-caps recommendations should move to spec chapter.</mark>
...
<mark>MKP2 [VP] TODO: Replace with reference to RFC2544 Goal.</mark>
...
<mark>MKP2 [VP] TODO: Shorten, RFC2544 Goal subsection is detailed enough.</mark>
...
<mark>~~The definitions here~~ </mark>Descriptions in this section are
wordy and implementers should read [MLRsearch Specification]
(#MLRsearch-Specification) section and Appendices for more concise
definitions.
...
spectrum. <mark>~~First, two heavy definitions are needed.~~</mark>
...
<mark>~~mk edit note: Two sentences above "silently" introduce a new
function, "performance probability function", describing it as
a "probability mass function of a discrete probabiility distribution",
without introducing performance probability concept anywhere in the
document, incl. any probability distribution aspects.~~</mark>

<mark>MKP1 These functions are related to the SUT performance spectrum,
as sampled by the trials in the set.</mark>

<mark>~~mk edit note: How are they related  the SUT performance spectrum?
Why are they mentioned here? What role do they play?~~</mark>

<mark>~~DONE VP to MK: Separate subsection on probabilistic distributions?~~</mark>

<mark>MKP1 MK to VP: My preference would be to avoid extensive sections on
probability distributions and probability functions. So if you want to
add, keep ti short please, stick to standard terms and provide relevant
references. No epics.</mark> 
...
<mark>MKP2 P0 TODO for VP: please address the "q-value" edit note points
raised earlier in the document.</mark>
...
<mark>MKP2 mk edit note: I do not get how this statements are true, as they
...
<mark>MKP2 mk edit note: and what is the "effective loss ratio" vs just loss
ratio? Or are they the same thing?</mark>
...
<mark>In this scenario, we want the load classification NOT to classify the load
...
- One minus the Goal Exceed Ratio is called the <mark>~~inceed~~</mark> subceed ratio.
<mark>MKP2 mk edit note: no "inceed" word in English language. I checked.
Need alternative. "subceed" for now.</mark>
...
<mark>~~mk edit note: Why would anyone want to use trials with longer
duration? Do you mean soak test here, or something else?~~</mark>
...
# <mark>~~Current practices?~~</mark>

<mark>MKP2 remove this paragraph for now.</mark>
...
<mark>MKP4 mk3 note: out of scope here, subject for future work.</mark>

# Addressed Problems

<mark>MKP1 all of this section requires updating based on the updated content. And it is for information only anyways. In fact not sure it's needed. Maybe in appendix for posterity.</mark>
...
<mark>MKP3 [VP] TODO: Unify reference style (brackets, spaces, section numbers and names).</mark>
