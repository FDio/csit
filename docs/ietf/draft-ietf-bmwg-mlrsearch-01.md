...
First intermetiate phase starts, trial duration still 1.0 seconds.
No lower bound, performing external search downwards (for NDR).
Measurement 4, intended load 4936605.579021453 pps,
...
Second intermetiate phase starts, trial duration 5.477225575051661 seconds.
