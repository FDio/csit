...
Both topologies are shown in figures below.
    ...
    +-----------------------------------------------------------+
        |  |                                  |  |   Physical
        |  |                                  |  |   Interfaces
Figure: NF chain topology forming a service instance.
    ...
    +-----------------------------------------------------------+
        |  |                                  |  |   Physical
        |  |                                  |  |   Interfaces
Figure: NF pipeline topology forming a service instance.
...
2. Pipeline packet path
   ...
   * Host data-plane is involved in packet forwarding operations between
    ...
    +----X--------------------------------------X---------------+
        |X |                                  | X|   Physical
        |X |                                  | X|   Interfaces
Figure: Snake packet path thru NF chain topology.
    ...
    +----X--------------------------------------X---------------+
        |X |                                  | X|   Physical
        |X |                                  | X|   Interfaces
Figure: Pipeline packet path thru NF pipeline topology.
