...
informative:
  [ETSI TST VSPERF]
  [BSDP] https://fd.io/wp-content/uploads/sites/34/2019/03/benchmarking_sw_data_planes_skx_bdx_mar07_2019.pdf
  [mlrsearch-draft]
  [plrsearch-draft]
  [LFN FD.io]
  [CNCF CNF Testbed] [TODO link]
  [TRex]
  [CSIT-1901-testbed-2n-skx] https://docs.fd.io/csit/rls1901/report/introduction/physical_testbeds.html#node-xeon-skylake-2n-skx
  [CSIT-1901-test-enviroment] https://docs.fd.io/csit/rls1901/report/vpp_performance_tests/test_environment.html
  [CSIT-1901-nfv-density-methodology] https://docs.fd.io/csit/rls1901/report/introduction/methodology_nfv_service_density.html
  [CSIT-1901-nfv-density-results] https://docs.fd.io/csit/rls1901/report/vpp_performance_tests/nf_service_density/index.html
  [CNCF-CNF-Testbed-Results] Packet.net 2n-skx
  [CNCF-CNF-Testbed-Results] https://github.com/cncf/cnf-testbed/blob/master/comparison/doc/cncf-cnfs-results-summary.md
...
performance of multiple NFV service instances, each composed of multiple software
...
* Legend to table
  * Header row
    * application - network application with optimized data-plane, a
      vSwitch or Network Function (NF).
...
configurations that have been benchmarked in open-source: i) in [LFN
FD.io CSIT], a continuous testing and data-plane benchmarking project,
and ii) as part of CNCF CNF Testbed initiative [CNCF CNF Testbed].
...
* Testbed: [CNCF-CNF-Testbed-Results]
