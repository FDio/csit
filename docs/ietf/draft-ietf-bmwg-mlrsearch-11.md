...
as specified for example in [TST-009] and [RFC2544]
...
{::comment}
    ...
    MK: TODO. We do not have any section in this document covering
...
{::comment}
    ...
    VP: TODO: Should we explicitly mention that
...
{::comment}
    ...
    VP: TODO: Re-check usage of Implementation.
...
{::comment}
    ...
    VP: TODO: Downgrade the last sentence from draft to e-mail?
...
{::comment}
    ...
    TODO: Separate short descriptions from further discussions. Everywhere.
...
{::comment}
    ...
    VP: TODO: Mention the YANG draft as a possible avenue?
...
in test report (becoming the sum of per-interface forwarding rate values).
