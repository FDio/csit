...
That means, the search needs both Max Load and Min Load values,
...
- The sum od Trial Effective Duration values of all full-length high-loss trials is called the full-length high-loss sum.
- The sum od Trial Effective Duration values of all full-length low-loss trials is called the full-length low-loss sum.
- The sum od Trial Effective Duration values of all short high-loss trials is called the short high-loss sum.
- The sum od Trial Effective Duration values of all short low-loss trials is called the short low-loss sum.
...
- The maximum of zero and excess sum is called the positive excess sum.
- The full-length high-loss sum plus the positive excess sum is called the high-loss sum.
- The the high-loss sum plus the full-length low-loss sum is called the measured sum.
...
- The high-loss sum plus the missing sum is called the pessimistic high loss sum.
- The high-loss sum divided by the whole sum is called the optimistic exceed ratio.
- The pessimistic high-loss sum divided by the whole sum is called the pessimistic exceed ratio.
...
- The sum od Trial Effective Duration values of all full-length high-loss trials is called the full-length high-loss sum.
- The sum od Trial Effective Duration values of all full-length low-loss trials is called the full-length low-loss sum.
- The full-length high-loss sum plus the full-length low-loss sum is called the full-length sum.
- One minus the Goal Exceed Ratio is called the subceed ratio.
- Initialize variable called remaining sum to be equal to full-lengths sum multiplied by subseed ratio.
- Initialize variable called current loss ratio to be 100%.
...
- One minus the current loss ratio is called the current forwarding ratio.
- The current forwarding ratio multiplied by the Load value is called Conditional Throughput.
...
It is useful to introduce an "SUT expert" to contrast
...
the SUT expert can envision possible Trial Result.
...
TODO: Different types of dependence on Trial Duration here?
