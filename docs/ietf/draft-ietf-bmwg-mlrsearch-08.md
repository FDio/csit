...
Any such compliant test procedure is called MLRsearch implementation.
TODO: Check other appearances of "implementation".
...
If this is not the case, the test report MUST describe the Traffic Profile
in a way that implieas how Trial Forwarding Ratio should be calculated.
...
This section defines new terms for quantities
...
Informally, this prescribes the maximum amount of trials
performed at Goal Final Trial Duration the Controller may need
for a specific load.
...
signals the SUT may be unable to process this Trial Load.
...
It is the maximal value the Controller is allowed to use for Trial Loads.
...
a single Max Load value usually applies to all Search Goal instances.
...
While the terms defined in this section are no strictly needed
when formulating MLRsearch requirement, they simplify the language used
in discussion paragraphs and explanation chapters.

### Current and Final Quantities

TODO: Recall "the search" from overview?
...
When the set of all Trial Result instances performed at one Trial Load
are compared to one Search Goal instance,
...
although MLRsearch specification does not prescribe how.
...
TODO: consider moving this content as an intro to Load Classfiication Logic section.
...
TODO: Deduplicate with load classification logic chapter:
...
may still be a lower bound for another goal, and due to this other goal
...
This is formalized using two new notions,
...
Consequently, every trial result can have an impact
...
already described in [Trial Effective Duration]
(#Trial-Effective-Duration), why the repeat here.
...
TODO note: on another read I believe this section belongs to Load Classification Logic.

TODO: Link to definitions of short and full-length trials.
