...
This section uses informal language to describe two pieces of MLRsearch logic, Load
Classification and Conditional Throughput, 
...
For explanation clarity variables are taged as (I)nput, (T)emporary, (O)utput.
