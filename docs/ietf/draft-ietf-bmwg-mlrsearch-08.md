...
TODO-P1: Expand all below into proper text.

## Example Goals

TODO-P1: Find short codenames taht describe the goal, but keep also codes.
...
code 60f60s0.5l20e:
    ...
    (show nontrivial exceed ratio and class flip due to more trials)
    Goal Final Trial Duration = 60s
...
TODO-P1: Find short codenames that describe the point in time / results.

Added trials as time increases:

code 59x1s0l:

    1f120s.5l50e goal was in focus
...
Quantity                  | 60f60s0l0e  | 60f120s0l50e | 1f120s.5l50e | 60f60s0.5l20e
--------------------------|-------------|--------------|--------------|--------------
...
After 59x1s0l+60x1s100l (last undecided for 1f120s.5l50e):
...
After 60x1s0l+60x1s100l (first lb 1f120s.5l50e):
...
First Conditional Throughput: 1f120s.5l50e

TODO-P0: Show Conditional Throughput computation.

### Point 5

After 60x1s0l+60x1s100l+1x60s1l (60f60s0.5l20e flips to lb):
...
Second Conditional Throughput: 60f60s0.5l20e
...
Third Conditional Throughput: 60f120s0l50e
