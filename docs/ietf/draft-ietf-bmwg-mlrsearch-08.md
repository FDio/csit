...
- Conditional Throughput:
 ...
 - Defined in [Conditional Throughput](#Conditional-Throughput)

 - Discussed in [Generalized Throughput](#Generalized-Throughput)

- Constant Load:

 - Defined in [RFC1242] (section 3.4 Constant Load)

- Controller

 - Introduced in [Overview](#Overview)
...
- Frame Loss Rate:
 ...
 - Defined in [RFC1242] (section 3.6 Frame Loss Rate)
...
- Goal Duration Sum
 ...
 - Defined in [Goal Duration Sum](#Goal-Duration-Sum)

 - Discussed in [Exceed Ratio and Multiple Trials](#Exceed-Ratio-and-Multiple-Trials)

- Goal Exceed Ratio

 - Defined in [Goal Exceed Ratio](#Goal-Exceed-Ratio)
...
- Intended Load
 ...
 - Defined in [RFC2285] (section 3.5.1 Intended load (Iload))

- Irregular Goal Result

 - Defined in [Irregular Goal Result](#Irregular-Goal-Result)

- Load: Shorthand for Trial Load.

- Load Classification

 - Introduced in [Overview](#Overview)

 - Defined in [Load Classification](#Load-Classification)

 - Discussed in [Load Classification Logic](#Load-Classification-Logic)

- Loss Inversion

 - Introduced in [Inconsistent Trial Results](#Inconsistent-Trial-Results)

 - Discussed in [Loss Ratios and Loss Inversion](#Loss-Ratios-and-Loss-Inversion)
...
- Maximum Frame Rate:
 ...
 - Defined in [RFC2544] (section 20. Maximum frame rate)

- Maximum Offered Load:

 - Defined in [RFC2285] (3.5.3 Maximum offered load (MOL))
...
- Offered Load
 ...
 - Defined in [RFC2285] (Section 3.5.2 Offered load (Oload))
...
- Relevant Lower Bound
 ...
 - Defined in [Relevant Lower Bound](#Relevant-Lower-Bound)
...
- Search Duration
 ...
 - Introduced in [Purpose and Scope](#Purpose-and-Scope)
   and in [Long Search Duration](#Long-Search-Duration)
...
- Tester
 ...
 - Defined in [RFC2544] (section 6. Test set up)

- Throughput

 - Defined in [RFC1242] (section 3.17 Throughput)

 - Methodology specified in [RFC2544] (section 26.1 Throughput)
...
See [Compliance](#Compliance) section for important Search Goal instances.
