...
{::comment}
    ...
    ## Spectrum / behaviors / probabilities
    ...
    ## Scenario Analysis
     (same scenarios as in, but now following the algorithms)
    ### Scenario 1 Analysis
    ### Scenario 2 Analysis
    ...
...
- TODO: Replace with conservative_excess_sum?
- The result of adding the high-loss sum plus the full-length low-loss sum is called the measured sum.
...
- TODO: pessimistic_high_loss_sum = high_loss_sum + missing_sum?
...
(the Trial Resultss are independent).
...
TODO: Add the Conditional Throughput where applicable.
