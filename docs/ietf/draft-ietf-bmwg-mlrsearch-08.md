...
An explanation of the classification logic is given in the next section
...
TODO: Link to load classification introduction.
...
TODO: Move exceed ratio before loss inversion?
