...
attributes affect MLRsearch behavior and its load classification,
mainly in comparison to a simple bisection for [RFC2544] Throughput.

TODO Consider re-arrange the order of the following sub-sections to
align with Goal Terms section.
...
TODO: Subsection for binary search, to introduce upper/lower and tightest bounds?
...
TODO: Introduce good and bad trials there?

Comment: it is already in Load Classification Logic section, so why here?

{:/comment}

## Goal Width and Precision Control

TODO: Break circular relations between "tightest bounds" and "relevant bounds".
...
## Multiple Loss Ratios and Loss Inversion
...
MLRsearch will likely perform trials at even higher loads.
...
is referred to as loss inversion.

MLRsearch is conservative when dealing with loss inversion:
the upper bound is considered real, and the lower bound
is considered to be a fluke.

This is formalized using two new notions, [Relevant Upper Bound](#Relevant-Upper-Bound)
...
Consequence of this is that every trial result can have an impact
...
## Exceed Ratio and Performance Spectrum
...
It tells MLRsearch what ratio of trials (more specifically what ratio of trial seconds)
...
TODO question: why is this relevant here?
...
TODO: This does not belong to Search Goal Attributes section. Some
content should go to a separate section e.g. Conditional Throughput and
Forwarding Rate, some to Load Classification Logic.
...
The art of achieving shorter search times
...
However, as even splits optimize search duration at given precision,
...
# Appendix A: Load Classification Pseudocode
...
# Appendix B: Conditional Throughput Pseudocode
