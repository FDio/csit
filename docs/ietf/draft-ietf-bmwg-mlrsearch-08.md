...
This section focuses on additional explanations and usage of MLRsearch specification.
...
## Goal Width and Stopping Conditions

TODO edit: add reference to sec 3.5.5 upfront - reduce the intro.
...
TODO note: needs major edits as old text, too much repeated content from previous sections. add reference to sec 3.4.6 and 3.5.3.
...
TODO note: needs major edits after mergin two sections.
...
TODO note: add reference to sec 3.5.4.
...
TODO note: move below paragraph to specification.
...
TODO note: add reference to sec 3.5.2.
...
TODO note: section to be removed unless objections.
