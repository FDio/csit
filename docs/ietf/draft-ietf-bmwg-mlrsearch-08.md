...
{::comment}
DONE: Mention that the Relevant Lower Bound is such a definition?
{:/comment}

MLRserach introduces Relevant Lower Bound as such new quantity.
...
TODO-P2: Assert traffic is sent in C and received in C and D.
...
TODO-P2: Mention iload/oload difference is also out of scope.

TODO-P2: Mention duplicate, previous-trial and other "more than expected"
...
TODO-P2: Add link to explanation, probably in classification logic chapter.
...
The test report SHOULD make it clear what specific quantity is used as Goal Width.

TODO-P0: Is this MUST too strong?
TODO2: Too strong, let's use SHOULD instead.
...
TODO-P0: Move (parts of) this paragraph to overview:
...
TODO-P2: Create subsection for MLRsearch Implementation.
...
TODO-P2: How to unify with the Glossary?
...
TODO-P0: Maybe use "full-length" only when the duration is equal,
and "long" if not short (e.g. when equal or longer)?

### Load Classification

TODO-P1: Turn into a precise definition paragraph?
...
TODO-P2: Define "MLRsearch Implementation" here.

TODO-P2: Explain "MLRsearch" denotes "any MLRsearch Implementation"?
...
TODO-P2: Unify load adjectives: higher/lower xor larger/smaller. => higher/lowe
...
TODO-P3: Discuss chains of intermediate goals? Probably not.

TODO-P0 note: below to be removed once Load Classification Logic is done.
...
idea: same trial timeline for multiple goals
...
- Relevant Lower Bound: defined in [Relevant Lower Bound](#relevant-lower-bound), discussed in [Consevativeness and Relevant Bounds](#consevativeness-and-relevant-bounds).
