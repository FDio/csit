...
- Constant Load:
 ...
 - Defined in [RFC1242] (Section 3.4)
...
- Frame Loss Rate:
 ...
 - Defined in [RFC1242] (Section 3.6)
...
All three definitions specify that this value
...
already governed by [RFC2544] (Section 20) and [RFC2285] (3.5.3),
