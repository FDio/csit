...
[UTI NDRPDR](examples/output_uti/tests.vpp.perf.ip4.2n1l-25ge2p1xxv710-64b-8t4c-ethip4-ip4base-ndrpdr.json).
...
- [UTI NDRPDR](examples/output_uti/tests.vpp.perf.ip4.2n1l-25ge2p1xxv710-64b-8t4c-ethip4-ip4base-ndrpdr.json)
- [UTI NDRPDR CPS](examples/output_uti/tests.vpp.perf.ip4.2n1l-25ge2p1xxv710-64b-8t4c-avf-ethip4udp-nat44ed-h262144-p63-s16515072-cps-ndrpdr.json)

**MRR**

- [UTI MRR](examples/output_uti/tests.vpp.perf.l2.40ge2p1xl710-64b-4t4c-eth-l2patch-mrr.json)

**Soak**

- [UTI Soak](examples/output_uti/tests.vpp.perf.ip4.2n1l-25ge2p1xxv710-64b-2t1c-ethip4-ip4base-soak.json)

**Hoststack**

- [UTI Hoststack 1](examples/output_uti/tests.vpp.perf.hoststack.40ge2p1xl710-1280b-1t1c-eth-ip4udpquicscale1cl10s-vppecho-bps.json)
- [UTI Hoststack2 ](examples/output_uti/tests.vpp.perf.hoststack.40ge2p1xl710-64b-1t1c-eth-ip4tcpbase-nsim-ldpreload-iperf3-bps.json)

**Reconfiguration test**

- [UTI Reconfiguration tests](examples/output_uti/tests.vpp.perf.crypto.40ge2p1xl710-64b-4t4c-ethip4ipsec60000tnlsw-1atnl-ip4base-int-aes128cbc-hmac512sha-reconf.json)

**VPP Device Test**

- [UTI VPP Device Test](examples/output_uti/tests.vpp.device.ip4.64b-ethipv4-ip4base-dev.json)
