...
### intel-x520-da2
#### dpdk-vfio-pci
# Run more crypto tests in mrr-daily due to time constraints
# But leave the rest commented out here to document the difference between mrr-daily and ndrpdr
...
#1c AND 64b AND ndrpdr AND x520-da2 AND drv_vfio_pci AND ethip4ipsec1000tnlsw-ip4base-policy-aes128cbc-hmac512sha
#2c AND 64b AND ndrpdr AND x520-da2 AND drv_vfio_pci AND ethip4ipsec1000tnlsw-ip4base-policy-aes128cbc-hmac512sha
#4c AND 64b AND ndrpdr AND x520-da2 AND drv_vfio_pci AND ethip4ipsec1000tnlsw-ip4base-policy-aes128cbc-hmac512sha
## ./ip4
### intel-x520-da2
#### dpdk-vfio-pci
##### ethip4-ip4base
