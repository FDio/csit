<<<<<<< HEAD   (ad820b Infra: Increase shm-size)
=======
# 2n-tx2
### tests 87
### job hrs est. 6,09
...
1c AND 64b AND ndrpdr AND xl710 AND drv_vfio_pci AND ethip6-ip6base-iacldstbase
2c AND 64b AND ndrpdr AND xl710 AND drv_vfio_pci AND ethip6-ip6base-iacldstbase
4c AND 64b AND ndrpdr AND xl710 AND drv_vfio_pci AND ethip6-ip6base-iacldstbase
## ./ip6_tunnels
## ./l2
### intel-xl710
#### dpdk-vfio-pci
...
## ./vm_vhost
## ./vts
>>>>>>> CHANGE (9d510d tests: add 2n1l l2 acl tests, update 2n-tx2 specs)
