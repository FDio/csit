...
1c AND 64b AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-aes256gcm
2c AND 64b AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-aes256gcm
4c AND 64b AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-aes256gcm
1c AND 1518b AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-aes256gcm
2c AND 1518b AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-aes256gcm
4c AND 1518b AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-aes256gcm
1c AND imix AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-aes256gcm
2c AND imix AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-aes256gcm
4c AND imix AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-aes256gcm
##### ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-dir-aes256gcm
1c AND 64b AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-dir-aes256gcm
2c AND 64b AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-dir-aes256gcm
4c AND 64b AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-dir-aes256gcm
1c AND 1518b AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-dir-aes256gcm
2c AND 1518b AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-dir-aes256gcm
4c AND 1518b AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-dir-aes256gcm
1c AND imix AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-dir-aes256gcm
2c AND imix AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-dir-aes256gcm
4c AND imix AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-dir-aes256gcm
##### ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-rss-aes256gcm
1c AND 64b AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-rss-aes256gcm
2c AND 64b AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-rss-aes256gcm
4c AND 64b AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-rss-aes256gcm
1c AND 1518b AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-rss-aes256gcm
2c AND 1518b AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-rss-aes256gcm
4c AND 1518b AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-rss-aes256gcm
1c AND imix AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-rss-aes256gcm
2c AND imix AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-rss-aes256gcm
4c AND imix AND ndrpdr AND e810xxv AND drv_avf AND ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-flow-rss-aes256gcm
#### dpdk-vfio-pci
##### ethip4ipsec1000tnlsw-fixtnlip-ip4base-policy-aes256gcm
...
1c AND 1518b AND ndrpdr AND e810xxv AND drv_avf AND ethip4gtpusw-ip4base
2c AND 1518b AND ndrpdr AND e810xxv AND drv_avf AND ethip4gtpusw-ip4base
4c AND 1518b AND ndrpdr AND e810xxv AND drv_avf AND ethip4gtpusw-ip4base
1c AND imix AND ndrpdr AND e810xxv AND drv_avf AND ethip4gtpusw-ip4base
2c AND imix AND ndrpdr AND e810xxv AND drv_avf AND ethip4gtpusw-ip4base
4c AND imix AND ndrpdr AND e810xxv AND drv_avf AND ethip4gtpusw-ip4base
##### ethip4gtpuhw-ip4base
1c AND 64b AND ndrpdr AND e810xxv AND drv_avf AND ethip4gtpuhw-ip4base
2c AND 64b AND ndrpdr AND e810xxv AND drv_avf AND ethip4gtpuhw-ip4base
4c AND 64b AND ndrpdr AND e810xxv AND drv_avf AND ethip4gtpuhw-ip4base
1c AND 1518b AND ndrpdr AND e810xxv AND drv_avf AND ethip4gtpuhw-ip4base
2c AND 1518b AND ndrpdr AND e810xxv AND drv_avf AND ethip4gtpuhw-ip4base
4c AND 1518b AND ndrpdr AND e810xxv AND drv_avf AND ethip4gtpuhw-ip4base
1c AND imix AND ndrpdr AND e810xxv AND drv_avf AND ethip4gtpuhw-ip4base
2c AND imix AND ndrpdr AND e810xxv AND drv_avf AND ethip4gtpuhw-ip4base
4c AND imix AND ndrpdr AND e810xxv AND drv_avf AND ethip4gtpuhw-ip4base
#### dpdk-vfio-pci
##### ethip4gtpusw-ip4base
