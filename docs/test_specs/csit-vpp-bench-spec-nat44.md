...
- Formula: N(i)=[N(i-1) x 2^2) with N(0)=1'024, i=1,2,3...
- #hosts tested: 1'024, 4'096, 16'384, 65'536, 262'144, 1'048'576
- sharing-ratio: #sessions
  - 63:   64'512, 258'048, 1'032'192, 4'128'768, 16'515'072,  66'060'288
  - 126: 129'024, 516'096, 2'064'384, 8'257'536, 33'030'144, 132'120'576
...
Stream profile-1:
  ...
  - Direction 0 --> 1:
    ...
    - Destination IP address range: 12.0.0.0 - 12.0.0.255
    - Source UDP port range:        1024 - 1086
    - Destination UDP port range:   1024 - 2048
  - Direction 1 --> 0:
    - Source IP address range:      12.0.0.0 - 12.0.0.255
