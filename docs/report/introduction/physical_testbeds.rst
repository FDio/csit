    ...
    .. raw:: latex
        ...
        \begin{figure}[H]
            \centering
                ...
                \includegraphics[clip, trim=0cm 8cm 5cm 0cm, width=0.70\textwidth]{testbed-3n-hsw}
...
.. only:: latex
    ...
    .. raw:: latex
        ...
        \begin{figure}[H]
            \centering
                \graphicspath{{../_tmp/src/introduction/}}
                \includegraphics[clip, trim=0cm 8cm 5cm 0cm, width=0.70\textwidth]{testbed-3n-skx}
...
.. only:: latex
    ...
    .. raw:: latex
        ...
        \begin{figure}[H]
            \centering
                \graphicspath{{../_tmp/src/introduction/}}
                \includegraphics[clip, trim=0cm 8cm 5cm 0cm, width=0.70\textwidth]{testbed-2n-skx}
