...
Similarly in TPUT tests (packet throuput, counting both control and data packets),
we care about NAT44ed ability to forward packets,
...
for search algorthm packet loss ratio purposes.
...
Exactly as in UDP_TPUT, ipackets and opackets counters are used for counting
