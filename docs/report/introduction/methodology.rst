...
comparison between releases. Daily trending test subset of frame sizes
focusing on 64B (78B for IPv6) for all tests and IMIX for selected tests
(vhost, memif).
...
#. UIO driver - depends on topotlogy file definition.
