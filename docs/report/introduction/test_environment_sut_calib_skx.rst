...
Following sections include sample calibration data measured on a server used in Intel Xeon Skylake testbeds as specified in `CSIT Testbeds: Xeon Skx, Arm, Atom
