...
Counters collected per event:
  ...
  - cache-hierarchy
    - INTEL_CORE_E_MEM_LOAD_RETIRED_L1_HIT (0xd1, umask: 0x01)
    - INTEL_CORE_E_MEM_LOAD_RETIRED_L1_MISS (0xd1, umask: 0x08)
    - INTEL_CORE_E_MEM_LOAD_RETIRED_L2_MISS (0xd1, umask: 0x10)
    - INTEL_CORE_E_MEM_LOAD_RETIRED_L3_MISS (0xd1, umask: 0x20)
  - load-blocks
...
Counters collected per event:
  ...
  - inst-and-clock
    ...
    - CPU-CYCLES (0x3c)
  - cache-hierarchy
    - CACHE_REFERENCES (0x2e umask: 0x4f)
    - CACHE_MISSES (0x2e umask: 0x41)
