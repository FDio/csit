...
Offered load: Aggregate rate (measured in packets per second) of network traffic
aimed at device under test, the rate is kept constant for the duration
of trial measurement.
...
Traffic generator: Part of overall setup, distinct from the device under test.
