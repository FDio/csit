...
each of which may lead to arithmetic over- or underflow in different sub-terms.
...
Potentially, using more realistic fitting functions can provide better
...
interleaved by long periods of zero losses (as happens in Vhost test),
