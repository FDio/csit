|dpdk-release| vs. DPDK-18.02
-----------------------------

Relative DPDK performance comparison in measured for |dpdk-release| NDR
and PDR packet throughput in |csit-release| report is calculated against
