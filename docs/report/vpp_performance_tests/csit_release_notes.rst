...
+---+-----------------------------------------+-------------------------------------------------+-----------------------------------------------------------------+
| 3 | `CSIT-1234                              | Scale IPSecHW Interface mode throughput         | IPSec throughput regression - 1core deltas: NDR -32%, PDR -33%, |
|   | <https://jira.fd.io/browse/CSIT-1234>`_ | regression.                                     | MRR -38%. Affects IPSec HW Scale 1000tnl tests with Int mode.   |
+---+-----------------------------------------+-------------------------------------------------+-----------------------------------------------------------------+
| 4 | `CSIT-1242                              | VPP xl710 ip4base test 1core,                   | xl710 ip4base 1core CSIT-1807/1804 relative change:             |
|   | <https://jira.fd.io/browse/CSIT-1242>`_ | low NDR and PDR 64B throughput                  | NDR -19%, high stdev.                                           |
|   |                                         | in 3n-hsw testbeds,                             |                                                                 |
|   |                                         | in CSIT-1807 vs. CSIT-1804.                     |                                                                 |
+---+-----------------------------------------+-------------------------------------------------+-----------------------------------------------------------------+
| 5 | `CSIT-1243                              | VPP nat44 base test 2core,                      | ip4base-nat44 3n-skx/3n-hsw relative change:                    |
|   | <https://jira.fd.io/browse/CSIT-1243>`_ | low NDR and PDR 64B throughput                  | NDR -19%, PDR -22%.                                             |
|   |                                         | in 3n-skx testbeds,                             |                                                                 |
|   |                                         | compared to 3n-hsw testbeds.                    |                                                                 |
+---+-----------------------------------------+-------------------------------------------------+-----------------------------------------------------------------+
| 6 | `CSIT-1244                              | VPP lispip4 base test 2core,                    | ethip4lispip4-ip4base 3n-skx/3n-hsw relative change:            |
|   | <https://jira.fd.io/browse/CSIT-1244>`_ | low NDR and PDR 64B throughput                  | NDR -11%, PDR -18%.                                             |
|   |                                         | in 3n-skx testbeds,                             |                                                                 |
|   |                                         | compared to 3n-hsw testbeds.                    |                                                                 |
+---+-------------------------------------------------+-----------------------------------------+-----------------------------------------------------------------+
