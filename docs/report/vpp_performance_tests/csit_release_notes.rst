...
#. **VPP Performance Tests**
  ...
  - **MRR Throughput**: MRR (Maximum Receive Rate) test code has now
    ...
    MRR tests are used for continuous performance trending, for
    initial phase of MLRsearch and for comparison between VPP
    releases.
  ...
  - **MLRsearch Throughput**: MLRsearch algorithm has been introduced
    ...
    used binary search got converted to MLRsearch.
