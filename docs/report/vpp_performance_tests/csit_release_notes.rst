...
|    | <https://jira.fd.io/browse/CSIT-1790>`_ | After upgrading TRex to v2.88, we also needed to upgrade FVL firmware on TG machines,                     |
|    |                                         | to avoid high latency O(5msec) for all VPP and testpmd/l3fwd test cases.                                  |
+----+-----------------------------------------+-----------------------------------------------------------------------------------------------------------+
