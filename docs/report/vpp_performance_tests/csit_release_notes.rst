...
#. VPP PERFORMANCE TESTS
   ...
   - **AMD 2n-zn2 testbed**: New test bed available, VPP performance data will
     be added next week.
...
#. PRESENTATION AND ANALYTICS LAYER - _to be updated by Tibor_
...
+----+-----------------------------------------+-----------------------------------------------------------------------------------------------------------+
|  7 | `CSIT-1760                              | All Mellanox / rdma driver tests failing on LF testbed28.                                                 |
