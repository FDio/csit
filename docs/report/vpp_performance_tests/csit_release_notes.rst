...
#. VPP PERFORMANCE TESTS
   ...
   - **IPsec Reconfig tests**: Added tests measuring the impact of IPsec
...
#. PRESENTATION AND ANALYTICS LAYER
   ...
   - **Latency Graphs**: Min/Avg/Max group bar graphs are replaced with
     packet latency percentile distributon based on TRex latency
