...
The multi phase search as described above works well as an abstract algorithm,
but as drop rates have their specifics, more improvements can be implemented.

The following sections list such improvements.

The optimized algorithm has been added in experimental state for 1804 release.
