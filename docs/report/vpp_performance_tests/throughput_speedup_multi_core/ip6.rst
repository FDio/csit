...
graphs is VPP Phy-to-Phy performance with IPv6 Routed-Forwarding, including NDR
throughput (zero packet loss) and PDR throughput (<0.5% packet loss).
The speedup factor is the normalized throughput to throughput for 78B on 1 core,
showed as 1.

NDR Throughput
--------------

VPP NDR 78B packet throughput speedup is presented in the graphs below for
...
NDR Throughput for Phy-to-Phy IPv6 Routed-Forwarding used.*
...
PDR Throughput for Phy-to-Phy IPv6 Routed-Forwarding used.*
