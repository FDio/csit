...
.. raw:: html
    ...
    <center>
    <iframe id="01" onload="setIframeHeight(this.id)" width="700" frameborder="0" scrolling="no" src="../../_static/vpp/3n-tsh-x520-114b-1t1c-vts-l2switching-base-i40e-ndr.html"></iframe>
    <p><br></p>
    </center>
...
.. raw:: latex
    ...
    \begin{figure}[H]
        \centering
            ...
            \includegraphics[clip, trim=0cm 0cm 5cm 0cm, width=0.70\textwidth]{3n-tsh-x520-114b-1t1c-vts-l2switching-base-i40e-ndr}
            \label{fig:3n-tsh-x520-114b-1t1c-vts-l2switching-base-i40e-ndr}
    \end{figure}
...
.. raw:: html
    ...
    <center>
    <iframe id="02" onload="setIframeHeight(this.id)" width="700" frameborder="0" scrolling="no" src="../../_static/vpp/3n-tsh-x520-114b-1t1c-vts-l2switching-base-i40e-pdr.html"></iframe>
    <p><br></p>
    </center>
...
.. raw:: latex
    ...
    \begin{figure}[H]
        \centering
            \graphicspath{{../_build/_static/vpp/}}
            \includegraphics[clip, trim=0cm 0cm 5cm 0cm, width=0.70\textwidth]{3n-tsh-x520-114b-1t1c-vts-l2switching-base-i40e-pdr}
            \label{fig:3n-tsh-x520-114b-1t1c-vts-l2switching-base-i40e-pdr}
    \end{figure}
