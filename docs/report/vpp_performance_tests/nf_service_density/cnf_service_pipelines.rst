...
:index:`CNF Service Pipelines: 64B-1c-eth-l2bd-{2Y}memif-{Y}pipe-{XY}drc-vppip4-mrr`
...
:index:`CNF Service Pipelines: 64B-2c-eth-l2bd-{2Y}memif-{Y}pipe-{XY}drc-vppip4-mrr`
