...
:index:`Packet Latency: ipsec-3n-hsw-xl710-64b-1t1c-base_and_scale-ndr`
...
.. raw:: latex
    ...
    \begin{figure}[H]
        \centering
            ...
            \includegraphics[clip, trim=0cm 0cm 5cm 0cm, width=0.70\textwidth]{ipsec-3n-hsw-xl710-64b-1t1c-base_and_scale-ndr-lat}
...
:index:`Packet Latency: ipsec-3n-hsw-xl710-64b-2t2c-base_and_scale-ndr`
...
.. raw:: latex
    ...
    \begin{figure}[H]
        \centering
            \graphicspath{{../_build/_static/vpp/}}
            \includegraphics[clip, trim=0cm 0cm 5cm 0cm, width=0.70\textwidth]{ipsec-3n-hsw-xl710-64b-2t2c-base_and_scale-ndr-lat}
