...
.. toctree::
   ...
   vpp_performance_tests/throughput_speedup_multi_core
   vpp_performance_tests/packet_latency_graphs
   vpp_performance_tests/http_server_performance
   vpp_performance_tests/mdr_search
   vpp_performance_tests/test_environment
   vpp_performance_tests/documentation
...
.. toctree::
   ...
   dpdk_performance_tests/packet_throughput_graphs
   dpdk_performance_tests/packet_latency_graphs
...
.. toctree::
   :maxdepth: 2
   :caption: NSH SFC Functional Tests
...
.. toctree::
   ...
   detailed_test_results/vpp_performance_results
   detailed_test_results/vpp_mrr_results
   detailed_test_results/cot_performance_results
   detailed_test_results/dpdk_performance_results
   detailed_test_results/vpp_functional_results
   detailed_test_results/vpp_functional_results_centos
   detailed_test_results/honeycomb_functional_results
   detailed_test_results/nshsfc_functional_results

.. toctree::
   :maxdepth: 2
   :caption: Test Configuration

   test_configuration/vpp_performance_configuration
   test_configuration/vpp_mrr_configuration
   test_configuration/vpp_functional_configuration
   test_configuration/vpp_functional_configuration_centos

.. toctree::
   :maxdepth: 2
   :caption: Test Operational Data

   test_operational_data/vpp_performance_operational_data
