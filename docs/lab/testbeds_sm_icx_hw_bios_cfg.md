<<<<<<< HEAD   (295e9a feat(ansible): Add ICX)
<<<<<<< HEAD   (41b698 feat(pxe): Add ICX)
=======
...
s65-t37-sut1.   10.30.50.75.  1.00.21.  1.1.  F1.00.07. 0D000280.       A5.01.24.  8.30 0x8000a49d 1.2926.0. 2.17.4. 3.10 0x8000ad67 1.3106.0. 1.7.16.
...
```
>>>>>>> CHANGE (62c4aa feat(ansible): Add ICX)
=======
# SuperMicro Icelake Servers - HW and BIOS Configuration
...
```
>>>>>>> CHANGE (684430 feat(doc): Add ICX)
