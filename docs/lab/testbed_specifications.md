...
23. TODO-REVIEW Server-Type-H2: Purpose - SapphireRapids Xeon TG for FD.io full system performance testing.
    ...
    - NICs configuration:
        - Numa0: (x16, x16, x16 PCIe5.0 lanes)
            - PCIe Slot2 18:00.xx: MCX713106AS-VEAT ConnectX7-2p200GE Nvidia.
            - PCIe Slot4 3b:00.xx: MCX713106AS-VEAT ConnectX7-2p200GE Nvidia.
            - PCIe Slot9 5e:00.xx: MCX713106AS-VEAT ConnectX7-2p200GE Nvidia. (TODO-NOTE: Not preferred. Needed if 2-NUMA Trex does not work.)
        - Numa1: (x16, x16, x16 PCIe5.0 lanes)
            - PCIe Slot6 86:00.xx: MCX713106AS-VEAT ConnectX7-2p200GE Nvidia. (TODO-NOTE: Preferred. Needed if 2-NUMA Trex does work.)
            - PCIe Slot8 af:00.xx: MCX713106AS-VEAT ConnectX7-2p200GE Nvidia. (TODO-NOTE: Preferred. Needed if 2-NUMA Trex does work.)
            - PCIe Slot10 d8:00.xx: empty.
24. TODO-REVIEW Server-Type-H3: Purpose - SapphireRapids Xeon SUT for FD.io performance testing.
    ...
    - NICs configuration:
        ...
        - Numa1: (x16, x16, x16 PCIe5.0 lanes)
            - PCIe Slot6 86:00.xx: MCX713106AS-VEAT ConnectX7-2p200GE Nvidia.
            - PCIe Slot8 af:00.xx: e810-2CQDA2-2p100GE Intel. (TODO-NOTE: Preferred for 3-numa-node. Needs extra 3 NICs vs standard 2-node setup.)
            - PCIe Slot10 d8:00.xx: e810-XXVDA4-4p25GE Intel. (TODO-NOTE: Preferred for 3-numa-node. Needs extra 3 NICs vs standard 2-node setup.)
