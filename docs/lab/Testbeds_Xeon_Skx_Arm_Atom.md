...
[Marvell ThunderX2](https://www.marvell.com/server-processors/thunderx2-arm-processors/) | VPP device server | Being Provisioned | s27-t13-sut1 | 10.30.51.69 | 10.30.50.69 | 112 | 128GB | 3x40GbE QSFP+ XL710-QDA2 | Ubuntu 18.04
...
8. Type-8: Purpose - (Intel Xeon Processor) SUT for TCP/IP host stack tests.
    ...
    - NICs configuration:
        ...
        - Numa1: (x16, x16, x16 PCIe3.0 lanes)
            ...
            - PCIe Slot8 af:00.xx: empty.
            - PCIe Slot10 d8:00.xx: empty.
9. Type-9: Purpose - (Marvell ThunderX2 Processor) SUT for VPP_Device functional tests.
    - Quantity: 1
    - Physical connectivity:
        - IPMI and host management ports.
