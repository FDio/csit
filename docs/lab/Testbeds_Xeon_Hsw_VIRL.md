...
Cisco UCS-c240m4 servers based on Intel Xeon Haswell processors. Content has
been copied from
[FD.io CSIT testbeds wiki page: Xeon_Hsw](https://wiki.fd.io/view/CSIT/Testbeds:_Xeon_Hsw,_VIRL.).
