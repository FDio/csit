...
- [tg infra](#tg-infra)
- [sut and tg infra configg](#sut-and-tg-infra-config)
  ...
  + seq-1
    * calibration of c5n 2n and 3n instances
      - trex + ena-dpdk calibration
        + TODO1 create aws topology with TRex with loopback link
...
- sut and tg config
  + seq-1
    * hugepages
      ...
      - TODO investigate no noticable difference, telemetry analysis to be done
  + seq-2
    * core frequency
...
- seq-1: vpp telemetry
  + identify useful telemetry commands/outputs
    * TODO1 improve telemetry error handling
...
- seq-1: nomad
  + nomad backend
    * TODO1 reinstall host to 22.04
    * TODO2 nomad version bump
- seq-2: containers
  + jjb containers
    * TODO add 22.04
- seq-3: jobs
