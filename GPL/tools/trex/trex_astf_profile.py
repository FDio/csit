    ...
    try:
        ...
        if async_start:
            ...
            if traffic_directions > 1:
                ...
                l7_data += f"serverActiveFlows={s_act_flows}, "
                l7_data += f"serverEstablishedFlows={s_est_flows}, "
                ...
                if u"udp" in profile_file:
                    ...
                    l7_data += f"clientUdpClosed={c_udp_closed}, "
                    # Server
                    ...
                    l7_data += f"serverUdpClosed={s_udp_closed}, "
                elif u"tcp" in profile_file:
                    # Client
                    # Initiated connections
                    c_tcp_connatt = client_stats.get(u"tcps_connattempt", 0)
                    l7_data += f"clientTcpConnectInits={c_tcp_connatt}, "
                    # Established connections
                    ...
                    l7_data += f"clientTcpClosed={c_tcp_closed}, "
                    # Server
                    # Accepted connections
                    ...
                    l7_data += f"serverTcpConnects={s_tcp_connects}, "
                    # Closed connections
                    s_tcp_closed = server_stats.get(u"tcps_closed", 0)
                    l7_data += f"serverTcpClosed={s_tcp_closed}, "
            else:
        ...
        if client:
            if async_start:
                ...
                client.disconnect()
                print(
                    f"cps={mult!r}, totalReceived={total_rcvd}, "
