...
def main():
    ...
    args = TrafficScriptArg(
        [
            u"tg_src_mac", u"tg_dst_mac", u"src_ip_in", u"src_ip_out",
            u"dst_ip", u"dut_if1_mac", u"dut_if2_mac",  u"protocol",
    ...
    src_port = args.get_arg(u"src_port")
    dst_port = args.get_arg(u"dst_port")
