...
class TrafficProfile(TrafficProfileBaseClass):
    ...
    def define_profile(self):
        ...
        real_headers_size = 70  # 4B l1 crc + 14B l2 + 20B ipv4 + 32B tcp
        ...
        globinfo.tcp.initwnd = self.n_data_frames * 3
        # FIXME: ^ Random increases in attempt to change the 32768 default.
        # Ensure buffers are large enough so starting window works.
        globinfo.tcp.txbufsize = data_size * 9
        globinfo.tcp.rxbufsize = data_size * 9
