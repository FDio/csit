...
Stream profile:
 ...
 - Packet: ETH / IP / UDP
 - Direction 0 --> 1:
   - Source IP address range:      192.168.0.0 - 192.183.255.255
   - Destination IP address range: 20.0.0.0 - 20.15.255.255
...
class TrafficStreams(TrafficStreamsBaseClass):
    ...
    def __init__(self):
        ...
        self.p1_src_end_ip = u"192.183.255.255"
        self.p1_dst_start_ip = u"20.0.0.0"
        self.p1_dst_end_ip = u"20.15.255.255"
