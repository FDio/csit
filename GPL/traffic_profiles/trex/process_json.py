...
profile for TRex. The format of "compressed" JSON file is described below.
...
{
    "type": "<type>-seq",
    "start": <int|ip4|ip6|mac>,  # including, if not present, start = 0
...
{
    "type": "<type>-ivl",
    "start": [<int|ip4|ip6|mac>, ],  # list of random values
    "nr": <int>,
    "op": "inc|repeat"
}
