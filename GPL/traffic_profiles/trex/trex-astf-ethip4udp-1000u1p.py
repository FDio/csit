...
class TrafficProfile(TrafficProfileBaseClass):
    ...
    def __init__(self, **kwargs):
        ...
        self.p1_src_start_ip = u"192.168.0.1"
        self.p1_src_end_ip = u"192.168.3.233"
        self.p1_dst_start_ip = u"30.0.0.1"
        self.p1_dst_end_ip = u"30.0.3.233"
    ...
    def define_profile(self):
        ...
        """
        # client commands
        self.udp_req += (64 - (46 + len(self.udp_req))) * self.padding
        prog_c = ASTFProgram(stream=False)
        prog_c.send_msg(self.udp_req)  # size and fill not supported in v2.73
        prog_c.recv_msg(1)

        # server commands
        self.udp_res += (64 - (46 + len(self.udp_res))) * self.padding
