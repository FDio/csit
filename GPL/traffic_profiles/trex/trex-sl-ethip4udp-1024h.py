...
Stream profile:
 ...
 - Direction 1--> 0:
   - Source IP address range:      20.0.0.0 - 20.0.255.255
   - Destination IP address range: 68.142.68.0 - 68.142.68.0
   - Source UDP port range:        1025
   - Destination UDP port range:   1025
"""
...
class TrafficStreams(TrafficStreamsBaseClass):
    ...
    def __init__(self):
        ...
        self.p2_src_end_ip = u"20.0.255.255"
