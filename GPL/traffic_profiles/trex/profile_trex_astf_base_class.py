...
class TrafficProfileBaseClass:
    ...
    def create_profile(self):
        ...
        c_info.tcp.mss = 18
        c_info.tcp.initwnd = 20
        c_info.tcp.no_delay_counter = 65533
        c_info.tcp.no_delay = 1
        c_info.tcp.delay_ack_msec = 500
        ...
        s_info.tcp.mss = 18
        s_info.tcp.initwnd = 20
        s_info.tcp.no_delay_counter = 65533
        s_info.tcp.no_delay = 1
        s_info.tcp.delay_ack_msec = 500
