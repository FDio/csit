...
class TrafficStreams(TrafficStreamsBaseClass):
    ...
    def define_packets(self):
        ...
        # Direction 0 --> 1
        base_pkt_a = Ether(
            src=self.p1_src_start_mac, dst=self.p1_dst_start_mac
        ) / IP(src=self.p1_src_start_ip, dst=self.p1_dst_start_ip, proto=61)
        # Direction 1 --> 0
        base_pkt_b = Ether(
            src=self.p2_src_start_mac, dst=self.p2_dst_start_mac
        ) / IP(src=self.p2_src_start_ip, dst=self.p2_dst_start_ip, proto=61)
