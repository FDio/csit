...
Stream profile:
 ...
 - Direction 0 --> 1:
   ...
   - Destination IP address range: 20.0.0.1 - 20.0.15.157
 - Direction 1 --> 0:
   - Source IP address range:      20.0.0.1
   - Destination IP address range: 10.0.0.1 - 10.0.15.157
"""
...
class TrafficStreams(TrafficStreamsBaseClass):
    ...
    def __init__(self):
        ...
        self.p1_dst_end_ip = u"20.0.15.157"

        self.p2_src_start_ip = u"20.0.0.1"
        self.p2_dst_start_ip = u"10.0.0.1"
        self.p2_dst_end_ip = u"10.0.15.157"
