...
# from trex.stl.trex_stl_paclet_builder_scapy import CTRexVmInsFixHwCs
        ...
        vm2 = STLScVmRaw(
            [
                ...
                STLVmWrMaskFlowVar(
                    ...
                    pkt_cast_size=4,
                    mask=0xffffffff,
                    add_value=int(IPv4Address(self.p2_inner_src_start_ip)),
                ...
                STLVmWrMaskFlowVar(
                    ...
                    pkt_cast_size=4,
                    mask=0xffffffff,
                    add_value=int(IPv4Address(self.p2_inner_dst_start_ip)),
