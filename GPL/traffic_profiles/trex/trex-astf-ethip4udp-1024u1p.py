...
class TrafficProfile(TrafficProfileBaseClass):
    ...
    def __init__(self, **kwargs):
        ...
        self.p1_src_end_ip = u"192.168.4.1"
        self.p1_dst_start_ip = u"30.0.0.1"
        self.p1_dst_end_ip = u"30.0.4.1"
        ...
        self.udp_req += self._gen_padding(
            self.framesize, self.headers_size + len(self.udp_req)
        )
        self.udp_res += self._gen_padding(
            self.framesize, self.headers_size + len(self.udp_res)
        )
