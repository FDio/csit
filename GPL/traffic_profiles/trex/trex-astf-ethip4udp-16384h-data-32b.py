...
class TrafficProfile(TrafficProfileBaseClass):
    ...
    def __init__(self, **kwargs):
        ...
        self.delay = 34000000  # delay 34s (34,000,000 usec)
        self.limit = 1032192
    ...
    def define_profile(self):
        ...
        prog_c.set_keepalive_msg(80000)  # TODO calculate by delay and CPS
        ...
        prog_s.set_keepalive_msg(80000)  # TODO calculate by delay and CPS
