...
from scapy.fields import BitField, XByteField, XShortEnumField, X3BytesField, StrField
...
class GENEVEOptionsField(StrField):
    islist = 1
...
class GENEVE(Packet):
    ...
    def post_build(self, p, pay):
        ...
        if optionlen is None:
            ...
            p = chr(optionlen & 0x2f | orb(p[0]) & 0xc0) + p[1:]
        return p
...
class TrafficStreams(TrafficStreamsBaseClass):
    ...
    def define_packets(self):
        ...
        base_pkt_b /= Raw(load=(64 - len(base_pkt_b[Ether:2]))*b"0")
        # Direction 0 --> 1
        vm1 = STLScVmRaw(
            [
                STLVmFlowVar(
