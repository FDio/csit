...
class TrafficProfile(TrafficProfileBaseClass):
    ...
    def __init__(self, **kwargs):
        ...
        self.ndata = 10000
        self.delay = 5000000  # delay 5s (5,000,000 usec)
    ...
    def define_profile(self):
        ...
        :rtype: tuple
        """
        self.tcp_req += self._gen_padding(
            self.headers_size + len(self.tcp_req),
            1518
        )
        self.tcp_res += self._gen_padding(
            self.headers_size + len(self.tcp_res),
            1518
        )
