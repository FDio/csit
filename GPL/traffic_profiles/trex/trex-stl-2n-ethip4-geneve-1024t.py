...
Stream profile:
 ...
 - Direction 0 --> 1:
   - Packet: ETH / IP
   - Source IP address range:            10.128.1.0 - 10.132.1.255
   - Destination IP address range:       10.0.1.0 - 10.4.1.255
 - Direction 1 --> 0:
   - Packet: ETH / IP / UDP / GENEVE / ETH / IP
   - Outer Source IP address range:      1.1.1.1
   - Outer Destination IP address range: 1.1.1.2
   - Inner Source IP address range:      10.0.1.0 - 10.4.1.255
   - Inner Destination IP address range: 10.128.1.0 - 10.132.1.255
