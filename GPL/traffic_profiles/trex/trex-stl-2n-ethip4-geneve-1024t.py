...
class TrafficStreams(TrafficStreamsBaseClass):
    ...
    def define_packets(self):
        ...
        :rtype: tuple
        """
        p1_src_start_ip_int = IPv4Address(self.p1_src_start_ip)
        p1_dst_start_ip_int = IPv4Address(self.p1_dst_start_ip)
        p2_src_start_ip_int = IPv4Address(self.p2_src_start_ip)
        p2_dst_start_ip_int = IPv4Address(self.p2_dst_start_ip)
