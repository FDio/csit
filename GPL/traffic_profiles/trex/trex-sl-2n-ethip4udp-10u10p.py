...
Stream profile:
 ...
 - Packet: ETH / IP / UDP
 - Direction 0 --> 1:
   - Source IP address range:      20.0.0.0 - 20.0.0.10
   - Destination IP address range: 30.0.0.0
   - Source UDP port range:        1024 - 1034
   - Destination UDP port range:   1024
 - Direction 1 --> 0:
   - Source IP address range:      30.0.0.0
   - Destination IP address range: 200.0.0.0 - 200.0.0.10
   - Source UDP port range:        1024
   - Destination UDP port range:   2048 - 2058
"""
