...
Stream profile:
 ...
 - Direction 0 --> 1:
   ...
   - Destination IP address range: 20.0.0.0 - 20.0.0.15
 - Direction 1 --> 0:
   - Source IP address range:      20.0.0.1
   - Destination IP address range: 10.0.0.0 - 10.0.0.15
"""
