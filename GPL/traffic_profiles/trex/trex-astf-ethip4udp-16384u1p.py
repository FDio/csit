...
class TrafficProfile(TrafficProfileBaseClass):
    ...
    def __init__(self, **kwargs):
        ...
        self.p1_dst_start_ip = u"30.0.0.0"
        self.p1_dst_end_ip = u"30.0.63.255"

        self.udp_req = u"GET"
        self.udp_res = u"ACK"

        self.headers_size = 46  # 18B l2 + 20B ipv4 + 8B udp
    ...
    def define_profile(self):
        ...
        c_glob_info.tcp.keepinit = 20000
        c_glob_info.tcp.keepidle = 20000
        c_glob_info.tcp.keepintvl = 20000

        # server glob info
        s_glob_info = ASTFGlobalInfo()
        s_glob_info.tcp.keepinit = 20000
        s_glob_info.tcp.keepidle = 20000
        s_glob_info.tcp.keepintvl = 20000

        # template
        temp_c = ASTFTCPClientTemplate(
            program=prog_c,
            ip_gen=ip_gen,
            glob_info=c_glob_info
        )
        temp_s = ASTFTCPServerTemplate(program=prog_s, glob_info=s_glob_info)  # TODO: default association ?
