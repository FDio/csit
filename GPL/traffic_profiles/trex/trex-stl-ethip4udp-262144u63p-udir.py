...
Stream profile:
 - One stream sent in directions 0 --> 1.
 - Packet: ETH / IP / UDP
 - Direction 0 --> 1:
   - Source IP address range:      192.168.0.0 - 192.171.255.255
   - Destination IP address range: 20.0.0.0 - 20.3.255.255
...
class TrafficStreams(TrafficStreamsBaseClass):
    ...
    def __init__(self):
        ...
        self.p1_src_start_ip = "192.168.0.0"
        self.p1_src_end_ip = "192.171.255.255"
        self.p1_dst_start_ip = "20.0.0.0"
        self.p1_dst_end_ip = "20.3.255.255"

        # UDP ports used in packet headers.
        self.p1_src_start_udp_port = 1024
        self.p1_src_end_udp_port = 1086
        self.p1_dst_start_udp_port = 8080
        self.p1_dst_end_udp_port = 8080
