...
Stream profile:
 ...
 - Direction 0 --> 1:
   - Packet: ETH / IP
   - Source IP address range:            10.128.1.0 - 10.144.1.255
   - Destination IP address range:       10.0.1.0 - 10.16.1.255
 - Direction 1 --> 0:
   - Packet: ETH / IP / UDP / GENEVE / ETH / IP
   - Outer Source IP address range:      1.1.1.1
   - Outer Destination IP address range: 1.1.1.2
   - Inner Source IP address range:      10.0.1.0 - 10.16.1.255
   - Inner Destination IP address range: 10.128.1.0 - 10.144.1.255
...
class TrafficStreams(TrafficStreamsBaseClass):
    ...
    def __init__(self):
        ...
        self.p1_src_start_ip = IPv4Address(u"10.128.1.0")
        self.p1_dst_start_ip = IPv4Address(u"10.0.1.0")

        # IPs used in packet headers of Direction 1 --> 0.
        self.p2_outer_src_ip = u"1.1.1.1"
        self.p2_outer_dst_ip = u"1.1.1.2"

        self.p2_inner_src_start_ip = IPv4Address(u"10.0.1.0")
        self.p2_inner_dst_start_ip = IPv4Address(u"10.128.1.0")
    ...
    def define_packets(self):
        ...
        vm1 = STLScVmRaw(
            [
                STLVmFlowVar(
                    name=u"ip_src",
                    min_value=int(self.p1_src_start_ip),
                    max_value=int(
                ...
                STLVmFlowVar(
                    name=u"ip_dst",
                    min_value=int(self.p1_dst_start_ip),
                    max_value=int(
