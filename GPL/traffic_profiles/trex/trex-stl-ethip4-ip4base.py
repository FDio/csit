        ...
        vm1 = STLScVmRaw(
            [
                STLVmFlowVar(
                    ...
                    max_value=int(p1_src_ip_start + p1_src_ip_count),
                    size=4,
                    op=u"inc"
                ),
                STLVmWrFlowVar(
                ...
                STLVmFlowVar(
                    ...
                    max_value=int(p1_dst_ip_start + p1_dst_ip_count),
                    size=4,
                    op=u"inc"
                ),
                STLVmWrFlowVar(
        ...
        vm2 = STLScVmRaw(
            [
                STLVmFlowVar(
                    ...
                    max_value=int(p2_src_ip_start + p2_src_ip_count),
                    size=4,
                    op=u"inc"
                ),
                STLVmWrFlowVar(
                ...
                STLVmFlowVar(
                    ...
                    max_value=int(p2_dst_ip_start + p2_dst_ip_count),
                    size=4,
                    op=u"inc"
                ),
                STLVmWrFlowVar(
