...
class Layout:
    ...
    def _get_plotting_area(
        ...
        for col in df.columns:
            ...
            cols.append(
                {
                    "name": ["", col] if len(l_col) == 1 else l_col,
                    "id": col,
                    "deletable": False,
                    "selectable": False
                }
    ...
    def callbacks(self, app):
        ...
        def _update_application(
            ...
            if all((on_draw, selected["reference"]["set"],
                ...
                #     "Test Name",
                #     f"{r_name} Mean Value",
                #     f"{r_name} Standard Deviation",
                #     f"{selected['compare']['value']} Mean Value",
                #     f"{selected['compare']['value']} Standard Deviation",
                #     "Mean Value of Relative Change",
                #     "Standard Deviation of Relative Change"
                # ]
            else:
                row_sort = C.STYLE_DISABLED
