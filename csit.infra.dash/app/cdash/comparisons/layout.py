            ...
            if trigger.type == "url" and url_params:
                ...
                if trigger.idx == "dut":
                    ...
                    try:
                        ...
                        tbed = self._tbs[dut][dver][trigger.value]
                    ...
                    try:
                        dut = ctrl_panel.get("dut-val")
                        dver = ctrl_panel.get("dutver-val")
                        tbed = ctrl_panel.get("tbed-val")
                        nic = self._tbs[dut][dver][tbed][trigger.value]
                    ...
                    dver = ctrl_panel.get("dutver-val")
                    tbed = ctrl_panel.get("tbed-val")
                    nic = ctrl_panel.get("nic-val")
                    if all((dut, dver, tbed, nic, trigger.value, )):
                        driver = self._tbs[dut][dver][tbed][nic][trigger.value]
                        ctrl_panel.set({
                            "driver-val": trigger.value,
                    ...
                    selection = list()
                    for core in ctrl_panel.get("core-val"):
                        for fsize in ctrl_panel.get("frmsize-val"):
                            for ttype in ctrl_panel.get("ttype-val"):
                                selection.append({
                                    "dut": ctrl_panel.get("dut-val"),
                                    "dutver": ctrl_panel.get("dutver-val"),
                                    "tbed": ctrl_panel.get("tbed-val"),
                                    "nic": ctrl_panel.get("nic-val"),
                                    "driver": ctrl_panel.get("driver-val"),
                                    "core": core,
                                    "frmsize": fsize,
                                    "ttype": ttype
                                })
