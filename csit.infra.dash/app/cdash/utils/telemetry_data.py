...
class TelemetryData:
    ...
    def search_selected_metrics_by_labels(self, selection: dict) -> list:
        """
        """
        logging.info(self._unique_metrics_labels)
        ...
        return self._unique_metrics_labels
