...
def classify_anomalies(data):
    ...
    for sample in values:
        if group_samples_left < 1 or active_group is None:
            # Start emptying the next group.
            group_samples_left = 0
            while group_samples_left < 1:  # Ignore empty (should not happen).
            ...
            continue
        # We have not emptied the active group yet.
