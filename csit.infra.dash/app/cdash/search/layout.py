                ...
                try:
                    ...
                    if selection:
                        if selection["datatype"] == "trending":
                            ...
                            rls_opts = generate_options(
                                self._duts[selection["datatype"]]
                            )
                        ctrl_panel.set({
                            "datatype-val": selection["datatype"],
                            "dut-opt": generate_options(self._duts.keys()),
                            "dut-dis": C.STYLE_DISPLAY,
                            "dut-val": selection["dut"],
                            "release-opt": rls_opts,
                            "release-dis": C.STYLE_DISPLAY,
