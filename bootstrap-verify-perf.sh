...
TOPOLOGIES="topologies/available/lf_testbed1_2-node.yaml \
            topologies/available/lf_testbed2_2-node.yaml \
            topologies/available/lf_testbed3_2-node.yaml"
