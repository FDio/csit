...
function help () {
    ...
    die 1 "Usage: `basename $0` csit-[dpdk|vpp|kubernetes]-[2n-skx|3n-skx|3n-hsw]-[perftest|daily]"
}
...
# script is running in jenkins all will be archived to logs.fd.io.
[[ -n ${WORKSPACE-} ]] && {
