...
TOPOLOGIES="topologies/available/lf_2n_skx_testbed22.yaml"
# 23 will not work due to Trex compilation issue, 22 is fixed manually.
# topologies/available/lf_2n_skx_testbed21.yaml has bad disk on TG.
# s10-t24-tg1 - CABLING ISSUE
