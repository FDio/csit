...
#        wget -q "${VPP_REPO_URL}/vpp-plugins/${VPP_STABLE_VER}/vpp-plugins-${VPP_STABLE_VER}${VPP_CLASSIFIER}.deb" || exit
        VPP_URL="https://jenkins.fd.io/job/vpp-cpoc-verify-1801-ubuntu1604/18/artifact/build-root"
        VPP_VER="18.01.1-4~gccd374e~b18_amd64"
        ...
        wget -q "https://jenkins.fd.io/job/vpp-cpoc-verify-1801-ubuntu1604/18/artifact/dpdk/vpp-dpdk-dkms_17.11-vpp1_amd64.deb" || exit
        VPP_DEBS="$( readlink -f *.deb | tr '\n' ' ' )"
    fi
