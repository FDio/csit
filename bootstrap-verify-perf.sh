...
then
    ...
    then
        ...
        wget -q "https://jenkins.fd.io/job/vpp-test-poc-verify-1801-ubuntu1604/10/artifact/build-root/vpp_18.01.1-release_amd64.deb" || exit
        wget -q "https://jenkins.fd.io/job/vpp-test-poc-verify-1801-ubuntu1604/10/artifact/build-root/vpp-dbg_18.01.1-release_amd64.deb" || exit
        wget -q "https://jenkins.fd.io/job/vpp-test-poc-verify-1801-ubuntu1604/10/artifact/build-root/vpp-dev_18.01.1-release_amd64.deb" || exit
        wget -q "https://jenkins.fd.io/job/vpp-test-poc-verify-1801-ubuntu1604/10/artifact/build-root/vpp-lib_18.01.1-release_amd64.deb" || exit
        wget -q "https://jenkins.fd.io/job/vpp-test-poc-verify-1801-ubuntu1604/10/artifact/build-root/vpp-plugins_18.01.1-release_amd64.deb" || exit
