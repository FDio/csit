...
global:
  ...
  slack_api_url: 'https://hooks.slack.com/services/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'
...
route:
  receiver: 'fdio-slack-notifications'
...
receivers:
- name: 'fdio-mail-lists'
  email_configs:
  - to: 'alertmanager@lists.fd.io'
- name: 'fdio-mail-pmikus'
  email_configs:
  - to: 'pmikus@cisco.com'
- name: 'fdio-slack-notifications'
  slack_configs:
  - channel: '#fdio-infra-alerting'
    send_resolved: true
