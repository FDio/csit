...
module "elastic" {
  ...
  elastic_master_cpu            = 40000
  elastic_master_memory         = 40000
  elastic_master_rest_port      = 9200
  elastic_master_transport_port = 9300
  elastic_data_cpu              = 40000
  elastic_data_memory           = 40000
