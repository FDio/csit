...
%{ endif }
  ...
  #
  group "prod-group1-elastic-master" {
    ...
    #
    task "prod-task1-elastic-master" {
...
#        ]
      ...
      resources {
        ...
        network {
          port "rest" {
            static = ${master_rest_port}
          }
          port "transport" {
            static = ${master_transport_port}
          }
        }
      }
    }
  ...
  #     https://www.nomadproject.io/docs/job-specification/group.html
  #
  group "prod-group1-elastic-data" {
    # The "count" parameter specifies the number of the task groups that should
    # be running under this group. This value must be non-negative and defaults
    # to 1.
    count             = ${group_count}
