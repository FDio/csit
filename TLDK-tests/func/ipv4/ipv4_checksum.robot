...
| Documentation | *TLDK IPv4 checksum test suit.*
| ...
...
| | ${packet_num} | ${dest_ip} | ${is_ipv4}= | Get Pcap Info | ${tc01_file_prefix}
| | Exec the udpfwd test | ${dut_node} | ${dut_port} | ${tc01_file_prefix} | ${dest_ip} | ${is_ipv4}
| | ${checksum}= | Get the test result | ${dut_node} | ${dut_port} | ${tc01_file_prefix}
| | ${result}= | Convert To Integer | ${checksum}
| | Should Be Equal As Integers | ${result} | ${packet_num}
