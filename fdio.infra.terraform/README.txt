...
- Run terraform in a given root module folder depending on testbed topology
  Terraform will deploy instances and other resources, all of these resources
  can be later identified on AWS via Environment tag ("CSIT-AWS" used as default)
  Example:
    cd ./2n_aws_c5n
    terraform init
    terraform apply
