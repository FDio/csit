...
- Run the tests
  WORKAROUND: When running Trex 2.88 on Amazon's ENA NICs, some CSIT settings
  must be modified to ensure proper startup and operation, set them up
  using following environment variables prior to running a bootstrap script:
